...
- [Types only](/playground/app/index.html?runtime=none&validation=strict&client=promise&validateSide=both&coerce=true)
- [Zod validation](/playground/app/index.html?runtime=zod&validation=strict&client=promise&validateSide=both&coerce=true&runtimeTypes=true)
- [Effect client](/playground/app/index.html?runtime=effect&validation=strict&client=effect&validateSide=both&coerce=true&runtimeTypes=true)
- [Zod client, fetcher, TanStack Query, and MSW](/playground/app/index.html?runtime=zod&validation=strict&client=promise&validateSide=both&coerce=true&runtimeTypes=true&defaultFetcher=true&tanstack=true&msw=true)
