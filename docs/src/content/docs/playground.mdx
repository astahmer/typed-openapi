...
- [Types only](./app/index.html?runtime=none&validation=strict&client=promise&validateSide=both&coerce=true)
- [Zod validation](./app/index.html?runtime=zod&validation=strict&client=promise&validateSide=both&coerce=true&runtimeTypes=true)
- [Effect client](./app/index.html?runtime=effect&validation=strict&client=effect&validateSide=both&coerce=true&runtimeTypes=true)
- [Zod client, fetcher, TanStack Query, and MSW](./app/index.html?runtime=zod&validation=strict&client=promise&validateSide=both&coerce=true&runtimeTypes=true&defaultFetcher=true&tanstack=true&msw=true)
