...
For a complete Effect example covering branded IDs, encoded/decoded date-time
values, and direct `Schema.decodeUnknown*` usage, see
[Effect branding and decoding](./effect-branding-and-decoding/).
