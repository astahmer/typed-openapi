...
export const Pet = y.object({
  id: y
    ...
    .oneOf([
      y.number().required(),
      y.mixed(
        (value): value is any => value === undefined,
      ) as y.MixedSchema<undefined>,
    ])
    .required()
    .optional(),
  ...
  status: y
    ...
    .oneOf([
      y
        .mixed((value): value is "available" => value === "available")
        .required(),
...
export const get_FindPetsByStatus = {
  ...
  path: y
    .mixed(
      (value): value is "/pet/findByStatus" => value === "/pet/findByStatus",
    )
    .required(),
  parameters: y.object({
    query: y.object({
      status: y
        ...
        .oneOf([
          y
            ...
            .required(),
          y
            .mixed((value): value is "pending" => value === "pending")
            .required(),
          y.mixed((value): value is "sold" => value === "sold").required(),
        ])
        .required()
...
export const get_FindPetsByTags = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/pet/findByTags" => value === "/pet/findByTags")
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_GetPetById = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/pet/{petId}" => value === "/pet/{petId}")
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_UpdatePetWithForm = {
  ...
  response: y
    ...
    .required() as y.MixedSchema<unknown>,
};
...
export const post_UploadFile = {
  ...
  path: y
    .mixed(
      (value): value is "/pet/{petId}/uploadImage" => value === "/pet/{petId}/uploadImage",
    )
    .required(),
  parameters: y.object({
    query: y.object({
...
export const get_GetInventory = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/store/inventory" => value === "/store/inventory")
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
  response: y
    .mixed((value): value is any => true)
...
export const post_PlaceOrder = {
  method: y.mixed((value): value is "POST" => value === "POST").required(),
  path: y
    .mixed((value): value is "/store/order" => value === "/store/order")
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
  response: Order,
};
...
export const get_GetOrderById = {
  ...
  path: y
    .mixed(
      (value): value is "/store/order/{orderId}" => value === "/store/order/{orderId}",
    )
    .required(),
  parameters: y.object({
    path: y.object({
...
export const post_CreateUsersWithListInput = {
  ...
  path: y
    .mixed(
      (value): value is "/user/createWithList" => value === "/user/createWithList",
    )
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
  response: y
...
export const get_LoginUser = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/user/login" => value === "/user/login")
    .required(),
  parameters: y.object({
    query: y.object({
      username: y.string().required().optional(),
...
export const get_LogoutUser = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/user/logout" => value === "/user/logout")
    .required(),
  parameters: y.mixed((value): value is never => false).required(),
  response: y
    .mixed((value): value is any => true)
...
export const get_GetUserByName = {
  method: y.mixed((value): value is "GET" => value === "GET").required(),
  path: y
    .mixed((value): value is "/user/{username}" => value === "/user/{username}")
    .required(),
  parameters: y.object({
    path: y.object({
