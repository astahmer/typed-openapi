...
Coverage gaps called out as TS-5 / MSW-4 / AUTH-5 / XF-5 / CFG-4 are **resolved** by additional unit /
integration / e2e tests in subsequent jj revisions. Those tests lock current behavior (including known
bugs like AUTH-1 double Bearer and XF-1 none+bigint); they do **not** close the medium/high product
issues listed above.
