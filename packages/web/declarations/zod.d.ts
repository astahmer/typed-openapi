...
declare const util_d_explicitlyAborted: typeof explicitlyAborted;
...
declare const regexes_d_httpProtocol: typeof httpProtocol;
...
declare namespace regexes_d {
  export {
    ...
    regexes_d_httpProtocol as httpProtocol,
...
interface $ZodTypeDiscriminableInternals<Disc extends string = string> extends $ZodTypeInternals<unknown, {
    [K in Disc]?: unknown;
}> {
    propValues: PropValues;
}
...
declare const index_d_$ZodPreprocess: typeof $ZodPreprocess;
type index_d_$ZodPreprocessDef<B extends SomeType = $ZodType> = $ZodPreprocessDef<B>;
type index_d_$ZodPreprocessInternals<B extends SomeType = $ZodType> = $ZodPreprocessInternals<B>;
...
type index_d_$ZodSuperRefineParams = $ZodSuperRefineParams;
...
type index_d_$ZodTypeDiscriminable<Disc extends string = string> = $ZodTypeDiscriminable<Disc>;
type index_d_$ZodTypeDiscriminableInternals<Disc extends string = string> = $ZodTypeDiscriminableInternals<Disc>;
...
declare const z_ZodPreprocess: typeof ZodPreprocess;
...
declare const z_invertCodec: typeof invertCodec;
