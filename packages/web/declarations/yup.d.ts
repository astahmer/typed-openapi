...
declare abstract class Schema<TType = any, TContext = any, TDefault = any, TFlags extends Flags = ''> implements ISchema<TType, TContext, TFlags, TDefault>, StandardSchema<TType, ResolveFlags<TType, TFlags, TDefault>> {
    ...
    get ['~standard'](): StandardSchemaProps<TType, ResolveFlags<TType, TFlags, TDefault>>;
}
...
type TransformFunction<T extends AnySchema, C = any> = (this: T, value: any, originalValue: any, schema: T, options: CastOptions$1<C>) => any;
...
declare class Lazy<T, TContext = AnyObject, TFlags extends Flags = any> implements ISchema<T, TContext, TFlags, undefined> {
    ...
    get ['~standard'](): StandardSchemaProps<T, ResolveFlags<T, TFlags, undefined>>;
}
...
export { ArraySchema, BooleanSchema, DateSchema, Lazy, Lazy as LazySchema, MixedSchema, NumberSchema, ObjectSchema, Reference, Schema, StringSchema, TupleSchema, ValidationError, addMethod, create$2 as array, create$7 as bool, create$7 as boolean, create$4 as date, _default as defaultLocale, getIn, isSchema, create as lazy, create$8 as mixed, create$5 as number, create$3 as object, printValue, reach, create$9 as ref, setLocale, create$6 as string, create$1 as tuple };
export type { AnyMessageParams, AnyObject, AnyObjectSchema, AnySchema, InferType as Asserts, CastOptions, CreateErrorOptions, CustomSchemaMetadata, DefaultFromShape, DefaultThunk, Defined, Flags, ISchema, InferType, LocaleObject, MakePartial, Maybe, Message, MessageParams, MixedOptions, TypeGuard as MixedTypeGuard, NotNull, ObjectShape, Optionals, SchemaDescription, SchemaFieldDescription, SchemaInnerTypeDescription, SchemaLazyDescription, SchemaMetadata, SchemaObjectDescription, SchemaRefDescription, SchemaSpec, SetFlag, TestConfig, TestContext, TestFunction, TestOptions, ToggleDefault, TypeFromShape, UnsetFlag, ValidateOptions };
