/**
 * typia EffectApiClient — MSW / integration type parity (Effect success + error channel).
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/effect-client/typia/
 */
...
import {
  ...
  type get_LoginUser,
} from "../../../tmp/tstyche/effect-client/typia/client.ts";

const api = createEffectApiClient({
  fetch: async () => new Response("[]", { status: 200, headers: { "content-type": "application/json" } }),
});

describe("typia EffectApiClient", () => {
