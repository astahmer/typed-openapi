/**
 * typia promise ApiClient — MSW / integration type parity.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/runtimes/typia/
 */
...
} from "../../../tmp/tstyche/runtimes/typia/client.ts";
import type { TanstackQueryApiClient } from "../../../tmp/tstyche/runtimes/typia/tanstack.ts";

const api = createApiClient({
  fetch: async () => new Response("[]", { status: 200, headers: { "content-type": "application/json" } }),
});

describe("typia promise ApiClient", () => {
