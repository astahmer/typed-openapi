/**
 * zod3 promise ApiClient — MSW / integration type parity.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/runtimes/zod3/
 */
...
import type { TanstackQueryApiClient } from "../../../tmp/tstyche/runtimes/zod3/tanstack.ts";
