/**
 * typebox promise ApiClient — MSW / integration type parity.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/runtimes/typebox/
 */
...
} from "../../../tmp/tstyche/runtimes/typebox/client.ts";
import type { TanstackQueryApiClient } from "../../../tmp/tstyche/runtimes/typebox/tanstack.ts";

const api = createApiClient({
  fetch: async () => new Response("[]", { status: 200, headers: { "content-type": "application/json" } }),
});

describe("typebox promise ApiClient", () => {
