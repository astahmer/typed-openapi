/**
 * valibot promise ApiClient — MSW / integration type parity.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/runtimes/valibot/
 */
...
} from "../../../tmp/tstyche/runtimes/valibot/client.ts";
import type { TanstackQueryApiClient } from "../../../tmp/tstyche/runtimes/valibot/tanstack.ts";

const api = createApiClient({
  fetch: async () => new Response("[]", { status: 200, headers: { "content-type": "application/json" } }),
});

describe("valibot promise ApiClient", () => {
