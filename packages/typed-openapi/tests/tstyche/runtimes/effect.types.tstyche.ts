/**
 * effect promise ApiClient — MSW / integration type parity.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/runtimes/effect/
 */
...
} from "../../../tmp/tstyche/runtimes/effect/client.ts";
import type { TanstackQueryApiClient } from "../../../tmp/tstyche/runtimes/effect/tanstack.ts";

const api = createApiClient({
  fetch: async () => new Response("[]", { status: 200, headers: { "content-type": "application/json" } }),
});

describe("effect promise ApiClient", () => {
