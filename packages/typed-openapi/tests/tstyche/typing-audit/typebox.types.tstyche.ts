/**
 * typebox generated typing audit.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/typing-audit/typebox/
 */
...
} from "../../../tmp/tstyche/typing-audit/typebox/client-sidecar.ts";

const api = createApiClient({
  fetch: async () => new Response(null, { status: 204 }),
});

describe("typebox generated typing audit", () => {
