/**
 * zod3 generated typing audit.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/typing-audit/zod3/
 */
...
} from "../../../tmp/tstyche/typing-audit/zod3/client.ts";
...
} from "../../../tmp/tstyche/typing-audit/zod3/client-sidecar.ts";

const api = createApiClient({
  fetch: async () => new Response(null, { status: 204 }),
});

describe("zod3 generated typing audit", () => {
