/**
 * effect3 generated typing audit.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/typing-audit/effect3/
 */
...
} from "../../../tmp/tstyche/typing-audit/effect3/client.ts";
...
} from "../../../tmp/tstyche/typing-audit/effect3/client-sidecar.ts";

const api = createApiClient({
  fetch: async () => new Response(null, { status: 204 }),
});

describe("effect3 generated typing audit", () => {
