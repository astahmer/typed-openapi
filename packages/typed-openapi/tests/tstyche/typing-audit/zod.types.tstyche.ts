/**
 * zod generated typing audit.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/typing-audit/zod/
 */
...
} from "../../../tmp/tstyche/typing-audit/zod/client.ts";
...
} from "../../../tmp/tstyche/typing-audit/zod/client-sidecar.ts";

const api = createApiClient({
  fetch: async () => new Response(null, { status: 204 }),
});

describe("zod generated typing audit", () => {
