/**
 * typia generated typing audit.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/typing-audit/typia/
 */
...
} from "../../../tmp/tstyche/typing-audit/typia/client.ts";
...
} from "../../../tmp/tstyche/typing-audit/typia/client-sidecar.ts";

const api = createApiClient({
  fetch: async () => new Response(null, { status: 204 }),
});

describe("typia generated typing audit", () => {
