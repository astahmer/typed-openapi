/**
 * effect generated typing audit.
 * Fixtures: pnpm gen:tstyche-fixtures → tmp/tstyche/typing-audit/effect/
 */
...
} from "../../../tmp/tstyche/typing-audit/effect/client.ts";
...
} from "../../../tmp/tstyche/typing-audit/effect/client-sidecar.ts";

const api = createApiClient({
  fetch: async () => new Response(null, { status: 204 }),
});

describe("effect generated typing audit", () => {
