...
export const PostPassthroughToolApiPositiveResponse = z.object({ status: z.string(), data: z.object({ url: z.url(), status: z.number().int(), headers: z.record(z.string(), z.union([z.string(), z.array(z.string())])), data: z.unknown().optional() }), warnings: z.array(z.object({ message: z.string() })) });
...
export const GetIntegrationsIntegrationIdPositiveResponse = z.object({ status: z.string(), data: z.object({ id: z.string(), tool: z.object({ id: z.string(), label: z.string(), internal_label: z.string().nullable(), logo_url: z.url(), icon_url: z.url() }), category: z.enum(["HRIS", "ATS", "ASSESSMENT", "LMS"]), status: z.enum(["ACTIVE", "INVALID", "INACTIVE"]), setup_status: z.enum(["INCOMPLETE", "FINAL_SYNC_PENDING", "COMPLETED"]), end_user: z.object({ organization_name: z.string(), creator_email: z.string().regex(new RegExp("^(?!\\.)(?!.*\\.\\.)([\\w'+-.]*)[\\w+-]@([\\da-z][\\da-z-]*\\.)+[a-z]{2,}$")).nullable(), origin_id: z.string().nullable() }), scope_config: z.object({ id: z.string(), name: z.string().nullable() }), data_expired_at: z.iso.datetime().nullable(), created_at: z.iso.datetime(), beta: z.boolean(), read_models: z.array(z.object({ id: z.string(), label: z.string(), is_available: z.boolean(), coverage_status: z.enum(["SUPPORTED", "UNSUPPORTED", "NOT_IMPLEMENTED", "UNKNOWN"]), scope_config_setting: z.enum(["ENABLED", "DISABLED", "OPTIONAL"]), opted_out_by_customer: z.boolean(), fields: z.array(z.object({ id: z.string(), is_available: z.boolean(), coverage_status: z.enum(["SUPPORTED", "UNSUPPORTED", "NOT_IMPLEMENTED", "UNKNOWN"]), scope_config_setting: z.enum(["ENABLED", "DISABLED", "OPTIONAL"]), opted_out_by_customer: z.boolean() })) })), write_actions: z.array(z.object({ id: z.string(), label: z.string(), is_available: z.boolean(), coverage_status: z.enum(["SUPPORTED", "UNSUPPORTED", "NOT_IMPLEMENTED", "UNKNOWN"]), scope_config_setting: z.enum(["ENABLED", "DISABLED", "OPTIONAL"]), opted_out_by_customer: z.boolean(), fields: z.array(z.object({ id: z.string(), is_available: z.boolean(), coverage_status: z.enum(["SUPPORTED", "UNSUPPORTED", "NOT_IMPLEMENTED", "UNKNOWN"]) })) })) }) });
...
export const PostIntegrationsIntegrationIdRelinkPositiveResponse = z.object({ status: z.string(), data: z.object({ link: z.url() }) });
...
export const PostIntegrationsIntegrationIdSetupLinkPositiveResponse = z.object({ status: z.string(), data: z.object({ link: z.url() }) });
...
export const PostHrisProvisioningGroupsGroupIdSetupLinksPositiveResponse = z.object({ status: z.string(), data: z.object({ url: z.url(), expires_at: z.iso.datetime() }) });
...
export const GetAssessmentPackagesPositiveResponse = z.object({ status: z.string(), data: z.object({ packages: z.array(z.object({ id: z.string(), name: z.string(), description: z.string(), updated_at: z.iso.datetime().nullable(), type: z.enum(["BEHAVIORAL", "VIDEO_INTERVIEW", "SKILLS_TEST", "BACKGROUND_CHECK", "REFERENCE_CHECK"]).nullable() })) }) });
...
export const GetAiApplyPostingsPositiveResponse = z.object({ status: z.string(), data: z.object({ results: z.array(z.object({ id: z.string(), career_site: z.object({ id: z.string(), label: z.string() }), url: z.string(), job_code: z.string().nullable(), created_at: z.iso.datetime(), updated_at: z.iso.datetime(), archived_at: z.iso.datetime().nullable(), archived_reason: z.enum(["JOB_POSTING_TAKEN_OFFLINE", "MANUAL_ARCHIVE", "REMOVED_FROM_JOB_FEED"]).nullable(), availability: z.enum(["APPLYABLE", "PENDING", "ARCHIVED", "UNAVAILABLE"]) })), next: z.string().nullable() }) });

export type PostAiApplyPostingsPositiveResponse = z.infer<typeof PostAiApplyPostingsPositiveResponse>;
export const PostAiApplyPostingsPositiveResponse = z.object({ status: z.string(), data: z.object({ id: z.string(), career_site: z.object({ id: z.string(), label: z.string() }), url: z.string(), job_code: z.string().nullable(), created_at: z.iso.datetime(), updated_at: z.iso.datetime(), archived_at: z.iso.datetime().nullable(), archived_reason: z.enum(["JOB_POSTING_TAKEN_OFFLINE", "MANUAL_ARCHIVE", "REMOVED_FROM_JOB_FEED"]).nullable(), availability: z.enum(["APPLYABLE", "PENDING", "ARCHIVED", "UNAVAILABLE"]) }) });
...
export const PostAiApplyApplyPositiveResponse = z.object({ status: z.string(), data: z.object({ id: z.string(), posting_id: z.string(), status: z.string(), created_at: z.iso.datetime(), updated_at: z.iso.datetime() }) });
...
export const GetAiApplyApplicationsPositiveResponse = z.object({ status: z.string(), data: z.object({ results: z.array(z.object({ id: z.string(), job_posting_id: z.string(), status: z.enum(["SUBMITTED", "DUPLICATE", "PENDING", "FAILED"]), created_at: z.iso.datetime(), updated_at: z.iso.datetime() })), next: z.string().nullable() }) });
...
export const PostConnectCreateLinkPositiveResponse = z.object({ status: z.string(), data: z.object({ link: z.url() }) });
...
export const PostCustomDatevDownloadDocumentPositiveResponse = z.object({ status: z.string(), data: z.object({ data_url: z.url(), file_name: z.string(), content_type: z.string() }), warnings: z.array(z.object({ message: z.string() })) });
...
export const PostCustomDatevEmployeesEmployeeIdDownloadDocumentPositiveResponse = z.object({ status: z.string(), data: z.object({ data_url: z.url(), file_name: z.string(), content_type: z.string() }), warnings: z.array(z.object({ message: z.string() })) });
...
export const GetCustomDatevDataPushesPositiveResponse = z.object({ status: z.string(), data: z.object({ data_pushes: z.array(z.object({ id: z.string(), type: z.enum(["GENERAL", "PAYROLL"]), created_at: z.iso.datetime(), upload_jobs: z.array(z.object({ id: z.string(), file_name: z.string(), state: z.enum(["FAILED", "UPLOADED", "IMPORTED", "CORRUPTED", "DELETED", "AUTO_DELETED"]), file: z.string() })) })) }) });
