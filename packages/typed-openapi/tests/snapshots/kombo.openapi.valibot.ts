...
export const Schema6: v.GenericSchema<Schema6> = v.lazy(() => v.array(Schema4));

export type Schema4 = (string | number | boolean | Schema5 | Schema6)
export const Schema4: v.GenericSchema<Schema4> = v.lazy(() => v.union([v.string(), v.pipe(v.number(), v.minValue(-1.7976931348623157e+308)), v.boolean(), Schema5, Schema6]));
...
export type InferSchemaValue<T> = T extends v.GenericSchema ? v.InferOutput<T> : T extends object ? { [K in keyof T]: InferSchemaValue<T[K]> } : T;
