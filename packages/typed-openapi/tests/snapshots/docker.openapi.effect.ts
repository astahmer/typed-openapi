...
// <Schemas>
export const Port = Schema.Struct({ IP: Schema.optional(Schema.String), PrivatePort: Schema.Int, PublicPort: Schema.optional(Schema.Int), Type: Schema.Literals(["tcp", "udp", "sctp"]) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "IP": 1, "PrivatePort": 1, "PublicPort": 1, "Type": 1 }, key))));
export type Port = Schema.Schema.Type<typeof Port>;

export const MountPoint = Schema.Struct({ Type: Schema.optional(Schema.Literals(["bind", "volume", "tmpfs", "npipe", "cluster"])), Name: Schema.optional(Schema.String), Source: Schema.optional(Schema.String), Destination: Schema.optional(Schema.String), Driver: Schema.optional(Schema.String), Mode: Schema.optional(Schema.String), RW: Schema.optional(Schema.Boolean), Propagation: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Type": 1, "Name": 1, "Source": 1, "Destination": 1, "Driver": 1, "Mode": 1, "RW": 1, "Propagation": 1 }, key))));
export type MountPoint = Schema.Schema.Type<typeof MountPoint>;

export const DeviceMapping = Schema.Struct({ PathOnHost: Schema.optional(Schema.String), PathInContainer: Schema.optional(Schema.String), CgroupPermissions: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "PathOnHost": 1, "PathInContainer": 1, "CgroupPermissions": 1 }, key))));
export type DeviceMapping = Schema.Schema.Type<typeof DeviceMapping>;

export const DeviceRequest = Schema.Struct({ Driver: Schema.optional(Schema.String), Count: Schema.optional(Schema.Int), DeviceIDs: Schema.optional(Schema.Array(Schema.String)), Capabilities: Schema.optional(Schema.Array(Schema.Array(Schema.String))), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Driver": 1, "Count": 1, "DeviceIDs": 1, "Capabilities": 1, "Options": 1 }, key))));
export type DeviceRequest = Schema.Schema.Type<typeof DeviceRequest>;

export const ThrottleDevice = Schema.Struct({ Path: Schema.optional(Schema.String), Rate: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Path": 1, "Rate": 1 }, key))));
export type ThrottleDevice = Schema.Schema.Type<typeof ThrottleDevice>;

export const Mount = Schema.Struct({ Target: Schema.optional(Schema.String), Source: Schema.optional(Schema.String), Type: Schema.optional(Schema.Literals(["bind", "volume", "tmpfs", "npipe", "cluster"])), ReadOnly: Schema.optional(Schema.Boolean), Consistency: Schema.optional(Schema.String), BindOptions: Schema.optional(Schema.Struct({ Propagation: Schema.optional(Schema.Literals(["private", "rprivate", "shared", "rshared", "slave", "rslave"])), NonRecursive: Boolean_default_false_prop, CreateMountpoint: Boolean_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Propagation": 1, "NonRecursive": 1, "CreateMountpoint": 1 }, key))))), VolumeOptions: Schema.optional(Schema.Struct({ NoCopy: Boolean_default_false_prop, Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), DriverConfig: Schema.optional(Schema.Struct({ Name: Schema.optional(Schema.String), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Options": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NoCopy": 1, "Labels": 1, "DriverConfig": 1 }, key))))), TmpfsOptions: Schema.optional(Schema.Struct({ SizeBytes: Schema.optional(Schema.Int), Mode: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "SizeBytes": 1, "Mode": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Target": 1, "Source": 1, "Type": 1, "ReadOnly": 1, "Consistency": 1, "BindOptions": 1, "VolumeOptions": 1, "TmpfsOptions": 1 }, key))));
export type Mount = Schema.Schema.Type<typeof Mount>;

export const RestartPolicy = Schema.Struct({ Name: Schema.optional(Schema.Literals(["", "no", "always", "unless-stopped", "on-failure"])), MaximumRetryCount: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "MaximumRetryCount": 1 }, key))));
export type RestartPolicy = Schema.Schema.Type<typeof RestartPolicy>;

export const Resources = Schema.Struct({ CpuShares: Schema.optional(Schema.Int), Memory: Int_default_0_prop, CgroupParent: Schema.optional(Schema.String), BlkioWeight: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0), Schema.isLessThanOrEqualTo(1000))), BlkioWeightDevice: Schema.optional(Schema.Array(Schema.Struct({ Path: Schema.optional(Schema.String), Weight: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Path": 1, "Weight": 1 }, key)))))), BlkioDeviceReadBps: Schema.optional(Schema.Array(ThrottleDevice)), BlkioDeviceWriteBps: Schema.optional(Schema.Array(ThrottleDevice)), BlkioDeviceReadIOps: Schema.optional(Schema.Array(ThrottleDevice)), BlkioDeviceWriteIOps: Schema.optional(Schema.Array(ThrottleDevice)), CpuPeriod: Schema.optional(Schema.Int), CpuQuota: Schema.optional(Schema.Int), CpuRealtimePeriod: Schema.optional(Schema.Int), CpuRealtimeRuntime: Schema.optional(Schema.Int), CpusetCpus: Schema.optional(Schema.String), CpusetMems: Schema.optional(Schema.String), Devices: Schema.optional(Schema.Array(DeviceMapping)), DeviceCgroupRules: Schema.optional(Schema.Array(Schema.String)), DeviceRequests: Schema.optional(Schema.Array(DeviceRequest)), KernelMemoryTCP: Schema.optional(Schema.Int), MemoryReservation: Schema.optional(Schema.Int), MemorySwap: Schema.optional(Schema.Int), MemorySwappiness: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0), Schema.isLessThanOrEqualTo(100))), NanoCpus: Schema.optional(Schema.Int), OomKillDisable: Schema.optional(Schema.Boolean), Init: Schema.optional(Schema.NullOr(Schema.Boolean)), PidsLimit: Schema.optional(Schema.NullOr(Schema.Int)), Ulimits: Schema.optional(Schema.Array(Schema.Struct({ Name: Schema.optional(Schema.String), Soft: Schema.optional(Schema.Int), Hard: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Soft": 1, "Hard": 1 }, key)))))), CpuCount: Schema.optional(Schema.Int), CpuPercent: Schema.optional(Schema.Int), IOMaximumIOps: Schema.optional(Schema.Int), IOMaximumBandwidth: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "CpuShares": 1, "Memory": 1, "CgroupParent": 1, "BlkioWeight": 1, "BlkioWeightDevice": 1, "BlkioDeviceReadBps": 1, "BlkioDeviceWriteBps": 1, "BlkioDeviceReadIOps": 1, "BlkioDeviceWriteIOps": 1, "CpuPeriod": 1, "CpuQuota": 1, "CpuRealtimePeriod": 1, "CpuRealtimeRuntime": 1, "CpusetCpus": 1, "CpusetMems": 1, "Devices": 1, "DeviceCgroupRules": 1, "DeviceRequests": 1, "KernelMemoryTCP": 1, "MemoryReservation": 1, "MemorySwap": 1, "MemorySwappiness": 1, "NanoCpus": 1, "OomKillDisable": 1, "Init": 1, "PidsLimit": 1, "Ulimits": 1, "CpuCount": 1, "CpuPercent": 1, "IOMaximumIOps": 1, "IOMaximumBandwidth": 1 }, key))));
export type Resources = Schema.Schema.Type<typeof Resources>;

export const Limit = Schema.Struct({ NanoCPUs: Schema.optional(Schema.Int), MemoryBytes: Schema.optional(Schema.Int), Pids: Int_default_0_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NanoCPUs": 1, "MemoryBytes": 1, "Pids": 1 }, key))));
export type Limit = Schema.Schema.Type<typeof Limit>;

export const GenericResources = Schema.Array(Schema.Struct({ NamedResourceSpec: Schema.optional(Schema.Struct({ Kind: Schema.optional(Schema.String), Value: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Kind": 1, "Value": 1 }, key))))), DiscreteResourceSpec: Schema.optional(Schema.Struct({ Kind: Schema.optional(Schema.String), Value: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Kind": 1, "Value": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NamedResourceSpec": 1, "DiscreteResourceSpec": 1 }, key)))));
export type GenericResources = Schema.Schema.Type<typeof GenericResources>;

export const ResourceObject = Schema.Struct({ NanoCPUs: Schema.optional(Schema.Int), MemoryBytes: Schema.optional(Schema.Int), GenericResources: Schema.optional(GenericResources) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NanoCPUs": 1, "MemoryBytes": 1, "GenericResources": 1 }, key))));
export type ResourceObject = Schema.Schema.Type<typeof ResourceObject>;

export const HealthConfig = Schema.Struct({ Test: Schema.optional(Schema.Array(Schema.String)), Interval: Schema.optional(Schema.Int), Timeout: Schema.optional(Schema.Int), Retries: Schema.optional(Schema.Int), StartPeriod: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Test": 1, "Interval": 1, "Timeout": 1, "Retries": 1, "StartPeriod": 1 }, key))));
export type HealthConfig = Schema.Schema.Type<typeof HealthConfig>;

export const HealthcheckResult = Schema.NullOr(Schema.Struct({ Start: Schema.optional(Schema.String), End: Schema.optional(Schema.String), ExitCode: Schema.optional(Schema.Int), Output: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Start": 1, "End": 1, "ExitCode": 1, "Output": 1 }, key)))));
export type HealthcheckResult = Schema.Schema.Type<typeof HealthcheckResult>;

export const Health = Schema.NullOr(Schema.Struct({ Status: Schema.optional(Schema.Literals(["none", "starting", "healthy", "unhealthy"])), FailingStreak: Schema.optional(Schema.Int), Log: Schema.optional(Schema.Array(HealthcheckResult)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Status": 1, "FailingStreak": 1, "Log": 1 }, key)))));
export type Health = Schema.Schema.Type<typeof Health>;

export const PortBinding = Schema.Struct({ HostIp: Schema.optional(Schema.String), HostPort: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "HostIp": 1, "HostPort": 1 }, key))));
...
export const HostConfig = Resources.mapFields(Struct.assign((Schema.Struct({ Binds: Schema.optional(Schema.Array(Schema.String)), ContainerIDFile: Schema.optional(Schema.String), LogConfig: Schema.optional(Schema.Struct({ Type: Schema.optional(Schema.Literals(["json-file", "syslog", "journald", "gelf", "fluentd", "awslogs", "splunk", "etwlogs", "none"])), Config: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Type": 1, "Config": 1 }, key))))), NetworkMode: Schema.optional(Schema.String), PortBindings: Schema.optional(PortMap), RestartPolicy: Schema.optional(RestartPolicy), AutoRemove: Schema.optional(Schema.Boolean), VolumeDriver: Schema.optional(Schema.String), VolumesFrom: Schema.optional(Schema.Array(Schema.String)), Mounts: Schema.optional(Schema.Array(Mount)), ConsoleSize: Schema.optional(Schema.NullOr(Schema.Array(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))).check(Schema.isMinLength(2), Schema.isMaxLength(2)))), Annotations: Schema.optional(Schema.Record(Schema.String, Schema.String)), CapAdd: Schema.optional(Schema.Array(Schema.String)), CapDrop: Schema.optional(Schema.Array(Schema.String)), CgroupnsMode: Schema.optional(Schema.Literals(["private", "host"])), Dns: Schema.optional(Schema.Array(Schema.String)), DnsOptions: Schema.optional(Schema.Array(Schema.String)), DnsSearch: Schema.optional(Schema.Array(Schema.String)), ExtraHosts: Schema.optional(Schema.Array(Schema.String)), GroupAdd: Schema.optional(Schema.Array(Schema.String)), IpcMode: Schema.optional(Schema.String), Cgroup: Schema.optional(Schema.String), Links: Schema.optional(Schema.Array(Schema.String)), OomScoreAdj: Schema.optional(Schema.Int), PidMode: Schema.optional(Schema.String), Privileged: Schema.optional(Schema.Boolean), PublishAllPorts: Schema.optional(Schema.Boolean), ReadonlyRootfs: Schema.optional(Schema.Boolean), SecurityOpt: Schema.optional(Schema.Array(Schema.String)), StorageOpt: Schema.optional(Schema.Record(Schema.String, Schema.String)), Tmpfs: Schema.optional(Schema.Record(Schema.String, Schema.String)), UTSMode: Schema.optional(Schema.String), UsernsMode: Schema.optional(Schema.String), ShmSize: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))), Sysctls: Schema.optional(Schema.Record(Schema.String, Schema.String)), Runtime: Schema.optional(Schema.String), Isolation: Schema.optional(Schema.Literals(["default", "process", "hyperv"])), MaskedPaths: Schema.optional(Schema.Array(Schema.String)), ReadonlyPaths: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Binds": 1, "ContainerIDFile": 1, "LogConfig": 1, "NetworkMode": 1, "PortBindings": 1, "RestartPolicy": 1, "AutoRemove": 1, "VolumeDriver": 1, "VolumesFrom": 1, "Mounts": 1, "ConsoleSize": 1, "Annotations": 1, "CapAdd": 1, "CapDrop": 1, "CgroupnsMode": 1, "Dns": 1, "DnsOptions": 1, "DnsSearch": 1, "ExtraHosts": 1, "GroupAdd": 1, "IpcMode": 1, "Cgroup": 1, "Links": 1, "OomScoreAdj": 1, "PidMode": 1, "Privileged": 1, "PublishAllPorts": 1, "ReadonlyRootfs": 1, "SecurityOpt": 1, "StorageOpt": 1, "Tmpfs": 1, "UTSMode": 1, "UsernsMode": 1, "ShmSize": 1, "Sysctls": 1, "Runtime": 1, "Isolation": 1, "MaskedPaths": 1, "ReadonlyPaths": 1 }, key))))).fields));
export type HostConfig = Schema.Schema.Type<typeof HostConfig>;

export const ContainerConfig = Schema.Struct({ Hostname: Schema.optional(Schema.String), Domainname: Schema.optional(Schema.String), User: Schema.optional(Schema.String), AttachStdin: Boolean_default_false_prop, AttachStdout: Boolean_default_true_prop, AttachStderr: Boolean_default_true_prop, ExposedPorts: Schema.optional(Schema.NullOr(Schema.Record(Schema.String, Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)))))), Tty: Boolean_default_false_prop, OpenStdin: Boolean_default_false_prop, StdinOnce: Boolean_default_false_prop, Env: Schema.optional(Schema.Array(Schema.String)), Cmd: Schema.optional(Schema.Array(Schema.String)), Healthcheck: Schema.optional(HealthConfig), ArgsEscaped: NullOr_default_false_prop, Image: Schema.optional(Schema.String), Volumes: Schema.optional(Schema.Record(Schema.String, Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false))))), WorkingDir: Schema.optional(Schema.String), Entrypoint: Schema.optional(Schema.Array(Schema.String)), NetworkDisabled: Schema.optional(Schema.NullOr(Schema.Boolean)), MacAddress: Schema.optional(Schema.NullOr(Schema.String)), OnBuild: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), StopSignal: Schema.optional(Schema.NullOr(Schema.String)), StopTimeout: Schema.optional(Schema.NullOr(Schema.Int)), Shell: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Hostname": 1, "Domainname": 1, "User": 1, "AttachStdin": 1, "AttachStdout": 1, "AttachStderr": 1, "ExposedPorts": 1, "Tty": 1, "OpenStdin": 1, "StdinOnce": 1, "Env": 1, "Cmd": 1, "Healthcheck": 1, "ArgsEscaped": 1, "Image": 1, "Volumes": 1, "WorkingDir": 1, "Entrypoint": 1, "NetworkDisabled": 1, "MacAddress": 1, "OnBuild": 1, "Labels": 1, "StopSignal": 1, "StopTimeout": 1, "Shell": 1 }, key))));
export type ContainerConfig = Schema.Schema.Type<typeof ContainerConfig>;

export const EndpointIPAMConfig = Schema.NullOr(Schema.Struct({ IPv4Address: Schema.optional(Schema.String), IPv6Address: Schema.optional(Schema.String), LinkLocalIPs: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "IPv4Address": 1, "IPv6Address": 1, "LinkLocalIPs": 1 }, key)))));
export type EndpointIPAMConfig = Schema.Schema.Type<typeof EndpointIPAMConfig>;

export const EndpointSettings = Schema.Struct({ IPAMConfig: Schema.optional(EndpointIPAMConfig), Links: Schema.optional(Schema.Array(Schema.String)), Aliases: Schema.optional(Schema.Array(Schema.String)), NetworkID: Schema.optional(Schema.String), EndpointID: Schema.optional(Schema.String), Gateway: Schema.optional(Schema.String), IPAddress: Schema.optional(Schema.String), IPPrefixLen: Schema.optional(Schema.Int), IPv6Gateway: Schema.optional(Schema.String), GlobalIPv6Address: Schema.optional(Schema.String), GlobalIPv6PrefixLen: Schema.optional(Schema.Int), MacAddress: Schema.optional(Schema.String), DriverOpts: Schema.optional(Schema.NullOr(Schema.Record(Schema.String, Schema.String))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "IPAMConfig": 1, "Links": 1, "Aliases": 1, "NetworkID": 1, "EndpointID": 1, "Gateway": 1, "IPAddress": 1, "IPPrefixLen": 1, "IPv6Gateway": 1, "GlobalIPv6Address": 1, "GlobalIPv6PrefixLen": 1, "MacAddress": 1, "DriverOpts": 1 }, key))));
export type EndpointSettings = Schema.Schema.Type<typeof EndpointSettings>;

export const NetworkingConfig = Schema.Struct({ EndpointsConfig: Schema.optional(Schema.Record(Schema.String, EndpointSettings)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "EndpointsConfig": 1 }, key))));
export type NetworkingConfig = Schema.Schema.Type<typeof NetworkingConfig>;

export const Address = Schema.Struct({ Addr: Schema.optional(Schema.String), PrefixLen: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Addr": 1, "PrefixLen": 1 }, key))));
export type Address = Schema.Schema.Type<typeof Address>;

export const NetworkSettings = Schema.Struct({ Bridge: Schema.optional(Schema.String), SandboxID: Schema.optional(Schema.String), HairpinMode: Schema.optional(Schema.Boolean), LinkLocalIPv6Address: Schema.optional(Schema.String), LinkLocalIPv6PrefixLen: Schema.optional(Schema.Int), Ports: Schema.optional(PortMap), SandboxKey: Schema.optional(Schema.String), SecondaryIPAddresses: Schema.optional(Schema.NullOr(Schema.Array(Address))), SecondaryIPv6Addresses: Schema.optional(Schema.NullOr(Schema.Array(Address))), EndpointID: Schema.optional(Schema.String), Gateway: Schema.optional(Schema.String), GlobalIPv6Address: Schema.optional(Schema.String), GlobalIPv6PrefixLen: Schema.optional(Schema.Int), IPAddress: Schema.optional(Schema.String), IPPrefixLen: Schema.optional(Schema.Int), IPv6Gateway: Schema.optional(Schema.String), MacAddress: Schema.optional(Schema.String), Networks: Schema.optional(Schema.Record(Schema.String, EndpointSettings)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Bridge": 1, "SandboxID": 1, "HairpinMode": 1, "LinkLocalIPv6Address": 1, "LinkLocalIPv6PrefixLen": 1, "Ports": 1, "SandboxKey": 1, "SecondaryIPAddresses": 1, "SecondaryIPv6Addresses": 1, "EndpointID": 1, "Gateway": 1, "GlobalIPv6Address": 1, "GlobalIPv6PrefixLen": 1, "IPAddress": 1, "IPPrefixLen": 1, "IPv6Gateway": 1, "MacAddress": 1, "Networks": 1 }, key))));
export type NetworkSettings = Schema.Schema.Type<typeof NetworkSettings>;

export const GraphDriverData = Schema.Struct({ Name: Schema.String, Data: Schema.Record(Schema.String, Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Data": 1 }, key))));
...
export const ClusterVolumeSpec = Schema.Struct({ Group: Schema.optional(Schema.String), AccessMode: Schema.optional(Schema.Struct({ Scope: Schema_default_single_prop, Sharing: Schema_default_none_prop, MountVolume: Schema.optional(Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)))), Secrets: Schema.optional(Schema.Array(Schema.Struct({ Key: Schema.optional(Schema.String), Secret: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Key": 1, "Secret": 1 }, key)))))), AccessibilityRequirements: Schema.optional(Schema.Struct({ Requisite: Schema.optional(Schema.Array(Topology)), Preferred: Schema.optional(Schema.Array(Topology)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Requisite": 1, "Preferred": 1 }, key))))), CapacityRange: Schema.optional(Schema.Struct({ RequiredBytes: Schema.optional(Schema.Int), LimitBytes: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "RequiredBytes": 1, "LimitBytes": 1 }, key))))), Availability: Schema_default_active_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Scope": 1, "Sharing": 1, "MountVolume": 1, "Secrets": 1, "AccessibilityRequirements": 1, "CapacityRange": 1, "Availability": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Group": 1, "AccessMode": 1 }, key))));
export type ClusterVolumeSpec = Schema.Schema.Type<typeof ClusterVolumeSpec>;

export const ClusterVolume = Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Spec: Schema.optional(ClusterVolumeSpec), Info: Schema.optional(Schema.Struct({ CapacityBytes: Schema.optional(Schema.Int), VolumeContext: Schema.optional(Schema.Record(Schema.String, Schema.String)), VolumeID: Schema.optional(Schema.String), AccessibleTopology: Schema.optional(Schema.Array(Topology)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "CapacityBytes": 1, "VolumeContext": 1, "VolumeID": 1, "AccessibleTopology": 1 }, key))))), PublishStatus: Schema.optional(Schema.Array(Schema.Struct({ NodeID: Schema.optional(Schema.String), State: Schema.optional(Schema.Literals(["pending-publish", "published", "pending-node-unpublish", "pending-controller-unpublish"])), PublishContext: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NodeID": 1, "State": 1, "PublishContext": 1 }, key)))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Info": 1, "PublishStatus": 1 }, key))));
export type ClusterVolume = Schema.Schema.Type<typeof ClusterVolume>;

export const Volume = Schema.Struct({ Name: Schema.String, Driver: Schema.String, Mountpoint: Schema.String, CreatedAt: Schema.optional(Schema.String), Status: Schema.optional(Schema.Record(Schema.String, Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false))))), Labels: Schema.Record(Schema.String, Schema.String), Scope: Schema_default_local_prop, ClusterVolume: Schema.optional(ClusterVolume), Options: Schema.Record(Schema.String, Schema.String), UsageData: Schema.optional(Schema.NullOr(Schema.Struct({ Size: Int_default_neg_1_prop, RefCount: Int_default_neg_1_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Size": 1, "RefCount": 1 }, key)))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Driver": 1, "Mountpoint": 1, "CreatedAt": 1, "Status": 1, "Labels": 1, "Scope": 1, "ClusterVolume": 1, "Options": 1, "UsageData": 1 }, key))));
export type Volume = Schema.Schema.Type<typeof Volume>;

export const VolumeCreateOptions = Schema.Struct({ Name: Schema.optional(Schema.String), Driver: String_default_local_prop, DriverOpts: Schema.optional(Schema.Record(Schema.String, Schema.String)), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), ClusterVolumeSpec: Schema.optional(ClusterVolumeSpec) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Driver": 1, "DriverOpts": 1, "Labels": 1, "ClusterVolumeSpec": 1 }, key))));
export type VolumeCreateOptions = Schema.Schema.Type<typeof VolumeCreateOptions>;

export const VolumeListResponse = Schema.Struct({ Volumes: Schema.optional(Schema.Array(Volume)), Warnings: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Volumes": 1, "Warnings": 1 }, key))));
export type VolumeListResponse = Schema.Schema.Type<typeof VolumeListResponse>;

export const IPAMConfig = Schema.Struct({ Subnet: Schema.optional(Schema.String), IPRange: Schema.optional(Schema.String), Gateway: Schema.optional(Schema.String), AuxiliaryAddresses: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Subnet": 1, "IPRange": 1, "Gateway": 1, "AuxiliaryAddresses": 1 }, key))));
export type IPAMConfig = Schema.Schema.Type<typeof IPAMConfig>;

export const IPAM = Schema.Struct({ Driver: String_default_default_prop, Config: Schema.optional(Schema.Array(IPAMConfig)), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Driver": 1, "Config": 1, "Options": 1 }, key))));
export type IPAM = Schema.Schema.Type<typeof IPAM>;

export const NetworkContainer = Schema.Struct({ Name: Schema.optional(Schema.String), EndpointID: Schema.optional(Schema.String), MacAddress: Schema.optional(Schema.String), IPv4Address: Schema.optional(Schema.String), IPv6Address: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "EndpointID": 1, "MacAddress": 1, "IPv4Address": 1, "IPv6Address": 1 }, key))));
export type NetworkContainer = Schema.Schema.Type<typeof NetworkContainer>;

export const Network = Schema.Struct({ Name: Schema.optional(Schema.String), Id: Schema.optional(Schema.String), Created: Schema.optional(Schema.String), Scope: Schema.optional(Schema.String), Driver: Schema.optional(Schema.String), EnableIPv6: Schema.optional(Schema.Boolean), IPAM: Schema.optional(IPAM), Internal: Schema.optional(Schema.Boolean), Attachable: Schema.optional(Schema.Boolean), Ingress: Schema.optional(Schema.Boolean), Containers: Schema.optional(Schema.Record(Schema.String, NetworkContainer)), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Id": 1, "Created": 1, "Scope": 1, "Driver": 1, "EnableIPv6": 1, "IPAM": 1, "Internal": 1, "Attachable": 1, "Ingress": 1, "Containers": 1, "Options": 1, "Labels": 1 }, key))));
export type Network = Schema.Schema.Type<typeof Network>;

export const ErrorDetail = Schema.Struct({ code: Schema.optional(Schema.Int), message: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "message": 1 }, key))));
export type ErrorDetail = Schema.Schema.Type<typeof ErrorDetail>;

export const ProgressDetail = Schema.Struct({ current: Schema.optional(Schema.Int), total: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "current": 1, "total": 1 }, key))));
export type ProgressDetail = Schema.Schema.Type<typeof ProgressDetail>;

export const ImageID = Schema.Struct({ ID: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1 }, key))));
export type ImageID = Schema.Schema.Type<typeof ImageID>;

export const BuildInfo = Schema.Struct({ id: Schema.optional(Schema.String), stream: Schema.optional(Schema.String), error: Schema.optional(Schema.String), errorDetail: Schema.optional(ErrorDetail), status: Schema.optional(Schema.String), progress: Schema.optional(Schema.String), progressDetail: Schema.optional(ProgressDetail), aux: Schema.optional(ImageID) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1, "stream": 1, "error": 1, "errorDetail": 1, "status": 1, "progress": 1, "progressDetail": 1, "aux": 1 }, key))));
export type BuildInfo = Schema.Schema.Type<typeof BuildInfo>;

export const BuildCache = Schema.Struct({ ID: Schema.optional(Schema.String), Parent: Schema.optional(Schema.NullOr(Schema.String)), Parents: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))), Type: Schema.optional(Schema.Literals(["internal", "frontend", "source.local", "source.git.checkout", "exec.cachemount", "regular"])), Description: Schema.optional(Schema.String), InUse: Schema.optional(Schema.Boolean), Shared: Schema.optional(Schema.Boolean), Size: Schema.optional(Schema.Int), CreatedAt: Schema.optional(Schema.String), LastUsedAt: Schema.optional(Schema.NullOr(Schema.String)), UsageCount: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Parent": 1, "Parents": 1, "Type": 1, "Description": 1, "InUse": 1, "Shared": 1, "Size": 1, "CreatedAt": 1, "LastUsedAt": 1, "UsageCount": 1 }, key))));
export type BuildCache = Schema.Schema.Type<typeof BuildCache>;

export const CreateImageInfo = Schema.Struct({ id: Schema.optional(Schema.String), error: Schema.optional(Schema.String), errorDetail: Schema.optional(ErrorDetail), status: Schema.optional(Schema.String), progress: Schema.optional(Schema.String), progressDetail: Schema.optional(ProgressDetail) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1, "error": 1, "errorDetail": 1, "status": 1, "progress": 1, "progressDetail": 1 }, key))));
export type CreateImageInfo = Schema.Schema.Type<typeof CreateImageInfo>;

export const PushImageInfo = Schema.Struct({ error: Schema.optional(Schema.String), status: Schema.optional(Schema.String), progress: Schema.optional(Schema.String), progressDetail: Schema.optional(ProgressDetail) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "error": 1, "status": 1, "progress": 1, "progressDetail": 1 }, key))));
export type PushImageInfo = Schema.Schema.Type<typeof PushImageInfo>;

export const ErrorResponse = Schema.Struct({ message: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "message": 1 }, key))));
export type ErrorResponse = Schema.Schema.Type<typeof ErrorResponse>;

export const IdResponse = Schema.Struct({ Id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Id": 1 }, key))));
export type IdResponse = Schema.Schema.Type<typeof IdResponse>;

export const PluginMount = Schema.Struct({ Name: Schema.String, Description: Schema.String, Settable: Schema.Array(Schema.String), Source: Schema.String, Destination: Schema.String, Type: Schema.String, Options: Schema.Array(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Description": 1, "Settable": 1, "Source": 1, "Destination": 1, "Type": 1, "Options": 1 }, key))));
export type PluginMount = Schema.Schema.Type<typeof PluginMount>;

export const PluginDevice = Schema.Struct({ Name: Schema.String, Description: Schema.String, Settable: Schema.Array(Schema.String), Path: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Description": 1, "Settable": 1, "Path": 1 }, key))));
export type PluginDevice = Schema.Schema.Type<typeof PluginDevice>;

export const PluginEnv = Schema.Struct({ Name: Schema.String, Description: Schema.String, Settable: Schema.Array(Schema.String), Value: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Description": 1, "Settable": 1, "Value": 1 }, key))));
export type PluginEnv = Schema.Schema.Type<typeof PluginEnv>;

export const PluginInterfaceType = Schema.Struct({ Prefix: Schema.String, Capability: Schema.String, Version: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Prefix": 1, "Capability": 1, "Version": 1 }, key))));
export type PluginInterfaceType = Schema.Schema.Type<typeof PluginInterfaceType>;

export const PluginPrivilege = Schema.Struct({ Name: Schema.optional(Schema.String), Description: Schema.optional(Schema.String), Value: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Description": 1, "Value": 1 }, key))));
export type PluginPrivilege = Schema.Schema.Type<typeof PluginPrivilege>;

export const Plugin = Schema.Struct({ Id: Schema.optional(Schema.String), Name: Schema.String, Enabled: Schema.Boolean, Settings: Schema.Struct({ Mounts: Schema.Array(PluginMount), Env: Schema.Array(Schema.String), Args: Schema.Array(Schema.String), Devices: Schema.Array(PluginDevice) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Mounts": 1, "Env": 1, "Args": 1, "Devices": 1 }, key)))), PluginReference: Schema.optional(Schema.String), Config: Schema.Struct({ DockerVersion: Schema.optional(Schema.String), Description: Schema.String, Documentation: Schema.String, Interface: Schema.Struct({ Types: Schema.Array(PluginInterfaceType), Socket: Schema.String, ProtocolScheme: Schema.optional(Schema.Literals(["", "moby.plugins.http/v1"])) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Types": 1, "Socket": 1, "ProtocolScheme": 1 }, key)))), Entrypoint: Schema.Array(Schema.String), WorkDir: Schema.String, User: Schema.optional(Schema.Struct({ UID: Schema.optional(Schema.Int), GID: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "UID": 1, "GID": 1 }, key))))), Network: Schema.Struct({ Type: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Type": 1 }, key)))), Linux: Schema.Struct({ Capabilities: Schema.Array(Schema.String), AllowAllDevices: Schema.Boolean, Devices: Schema.Array(PluginDevice) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Capabilities": 1, "AllowAllDevices": 1, "Devices": 1 }, key)))), PropagatedMount: Schema.String, IpcHost: Schema.Boolean, PidHost: Schema.Boolean, Mounts: Schema.Array(PluginMount), Env: Schema.Array(PluginEnv), Args: Schema.Struct({ Name: Schema.String, Description: Schema.String, Settable: Schema.Array(Schema.String), Value: Schema.Array(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Description": 1, "Settable": 1, "Value": 1 }, key)))), rootfs: Schema.optional(Schema.Struct({ type: Schema.optional(Schema.String), diff_ids: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "type": 1, "diff_ids": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "DockerVersion": 1, "Description": 1, "Documentation": 1, "Interface": 1, "Entrypoint": 1, "WorkDir": 1, "User": 1, "Network": 1, "Linux": 1, "PropagatedMount": 1, "IpcHost": 1, "PidHost": 1, "Mounts": 1, "Env": 1, "Args": 1, "rootfs": 1 }, key)))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Id": 1, "Name": 1, "Enabled": 1, "Settings": 1, "PluginReference": 1, "Config": 1 }, key))));
export type Plugin = Schema.Schema.Type<typeof Plugin>;

export const NodeSpec = Schema.Struct({ Name: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Role: Schema.optional(Schema.Literals(["worker", "manager"])), Availability: Schema.optional(Schema.Literals(["active", "pause", "drain"])) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Labels": 1, "Role": 1, "Availability": 1 }, key))));
export type NodeSpec = Schema.Schema.Type<typeof NodeSpec>;

export const Platform = Schema.Struct({ Architecture: Schema.optional(Schema.String), OS: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Architecture": 1, "OS": 1 }, key))));
export type Platform = Schema.Schema.Type<typeof Platform>;

export const EngineDescription = Schema.Struct({ EngineVersion: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Plugins: Schema.optional(Schema.Array(Schema.Struct({ Type: Schema.optional(Schema.String), Name: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Type": 1, "Name": 1 }, key)))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "EngineVersion": 1, "Labels": 1, "Plugins": 1 }, key))));
export type EngineDescription = Schema.Schema.Type<typeof EngineDescription>;

export const TLSInfo = Schema.Struct({ TrustRoot: Schema.optional(Schema.String), CertIssuerSubject: Schema.optional(Schema.String), CertIssuerPublicKey: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "TrustRoot": 1, "CertIssuerSubject": 1, "CertIssuerPublicKey": 1 }, key))));
export type TLSInfo = Schema.Schema.Type<typeof TLSInfo>;

export const NodeDescription = Schema.Struct({ Hostname: Schema.optional(Schema.String), Platform: Schema.optional(Platform), Resources: Schema.optional(ResourceObject), Engine: Schema.optional(EngineDescription), TLSInfo: Schema.optional(TLSInfo) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Hostname": 1, "Platform": 1, "Resources": 1, "Engine": 1, "TLSInfo": 1 }, key))));
...
export const NodeStatus = Schema.Struct({ State: Schema.optional(NodeState), Message: Schema.optional(Schema.String), Addr: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "State": 1, "Message": 1, "Addr": 1 }, key))));
...
export const ManagerStatus = Schema.NullOr(Schema.Struct({ Leader: Boolean_default_false_prop, Reachability: Schema.optional(Reachability), Addr: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Leader": 1, "Reachability": 1, "Addr": 1 }, key)))));
export type ManagerStatus = Schema.Schema.Type<typeof ManagerStatus>;

export const Node = Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Spec: Schema.optional(NodeSpec), Description: Schema.optional(NodeDescription), Status: Schema.optional(NodeStatus), ManagerStatus: Schema.optional(ManagerStatus) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Description": 1, "Status": 1, "ManagerStatus": 1 }, key))));
export type Node = Schema.Schema.Type<typeof Node>;

export const SwarmSpec = Schema.Struct({ Name: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Orchestration: Schema.optional(Schema.NullOr(Schema.Struct({ TaskHistoryRetentionLimit: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "TaskHistoryRetentionLimit": 1 }, key)))))), Raft: Schema.optional(Schema.Struct({ SnapshotInterval: Schema.optional(Schema.Int), KeepOldSnapshots: Schema.optional(Schema.Int), LogEntriesForSlowFollowers: Schema.optional(Schema.Int), ElectionTick: Schema.optional(Schema.Int), HeartbeatTick: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "SnapshotInterval": 1, "KeepOldSnapshots": 1, "LogEntriesForSlowFollowers": 1, "ElectionTick": 1, "HeartbeatTick": 1 }, key))))), Dispatcher: Schema.optional(Schema.NullOr(Schema.Struct({ HeartbeatPeriod: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "HeartbeatPeriod": 1 }, key)))))), CAConfig: Schema.optional(Schema.NullOr(Schema.Struct({ NodeCertExpiry: Schema.optional(Schema.Int), ExternalCAs: Schema.optional(Schema.Array(Schema.Struct({ Protocol: Schema.optional(Schema.Literal("cfssl")), URL: Schema.optional(Schema.String), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)), CACert: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Protocol": 1, "URL": 1, "Options": 1, "CACert": 1 }, key)))))), SigningCACert: Schema.optional(Schema.String), SigningCAKey: Schema.optional(Schema.String), ForceRotate: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NodeCertExpiry": 1, "ExternalCAs": 1, "SigningCACert": 1, "SigningCAKey": 1, "ForceRotate": 1 }, key)))))), EncryptionConfig: Schema.optional(Schema.Struct({ AutoLockManagers: Schema.optional(Schema.Boolean) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "AutoLockManagers": 1 }, key))))), TaskDefaults: Schema.optional(Schema.Struct({ LogDriver: Schema.optional(Schema.Struct({ Name: Schema.optional(Schema.String), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Options": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "LogDriver": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Labels": 1, "Orchestration": 1, "Raft": 1, "Dispatcher": 1, "CAConfig": 1, "EncryptionConfig": 1, "TaskDefaults": 1 }, key))));
export type SwarmSpec = Schema.Schema.Type<typeof SwarmSpec>;

export const ClusterInfo = Schema.NullOr(Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Spec: Schema.optional(SwarmSpec), TLSInfo: Schema.optional(TLSInfo), RootRotationInProgress: Schema.optional(Schema.Boolean), DataPathPort: Schema.optional(Schema.Int), DefaultAddrPool: Schema.optional(Schema.Array(Schema.String)), SubnetSize: Schema.optional(Schema.Int.check(Schema.isLessThanOrEqualTo(29))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "TLSInfo": 1, "RootRotationInProgress": 1, "DataPathPort": 1, "DefaultAddrPool": 1, "SubnetSize": 1 }, key)))));
export type ClusterInfo = Schema.Schema.Type<typeof ClusterInfo>;

export const JoinTokens = Schema.Struct({ Worker: Schema.optional(Schema.String), Manager: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Worker": 1, "Manager": 1 }, key))));
export type JoinTokens = Schema.Schema.Type<typeof JoinTokens>;

export const Swarm = ClusterInfo.check(Schema.makeFilter((value) => Schema.is(Schema.Struct({ JoinTokens: Schema.optional(JoinTokens) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "JoinTokens": 1 }, key)))))(value)));
export type Swarm = Schema.Schema.Type<typeof Swarm>;

export const NetworkAttachmentConfig = Schema.Struct({ Target: Schema.optional(Schema.String), Aliases: Schema.optional(Schema.Array(Schema.String)), DriverOpts: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Target": 1, "Aliases": 1, "DriverOpts": 1 }, key))));
export type NetworkAttachmentConfig = Schema.Schema.Type<typeof NetworkAttachmentConfig>;

export const TaskSpec = Schema.Struct({ PluginSpec: Schema.optional(Schema.Struct({ Name: Schema.optional(Schema.String), Remote: Schema.optional(Schema.String), Disabled: Schema.optional(Schema.Boolean), PluginPrivilege: Schema.optional(Schema.Array(PluginPrivilege)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Remote": 1, "Disabled": 1, "PluginPrivilege": 1 }, key))))), ContainerSpec: Schema.optional(Schema.Struct({ Image: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Command: Schema.optional(Schema.Array(Schema.String)), Args: Schema.optional(Schema.Array(Schema.String)), Hostname: Schema.optional(Schema.String), Env: Schema.optional(Schema.Array(Schema.String)), Dir: Schema.optional(Schema.String), User: Schema.optional(Schema.String), Groups: Schema.optional(Schema.Array(Schema.String)), Privileges: Schema.optional(Schema.Struct({ CredentialSpec: Schema.optional(Schema.Struct({ Config: Schema.optional(Schema.String), File: Schema.optional(Schema.String), Registry: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Config": 1, "File": 1, "Registry": 1 }, key))))), SELinuxContext: Schema.optional(Schema.Struct({ Disable: Schema.optional(Schema.Boolean), User: Schema.optional(Schema.String), Role: Schema.optional(Schema.String), Type: Schema.optional(Schema.String), Level: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Disable": 1, "User": 1, "Role": 1, "Type": 1, "Level": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "CredentialSpec": 1, "SELinuxContext": 1 }, key))))), TTY: Schema.optional(Schema.Boolean), OpenStdin: Schema.optional(Schema.Boolean), ReadOnly: Schema.optional(Schema.Boolean), Mounts: Schema.optional(Schema.Array(Mount)), StopSignal: Schema.optional(Schema.String), StopGracePeriod: Schema.optional(Schema.Int), HealthCheck: Schema.optional(HealthConfig), Hosts: Schema.optional(Schema.Array(Schema.String)), DNSConfig: Schema.optional(Schema.Struct({ Nameservers: Schema.optional(Schema.Array(Schema.String)), Search: Schema.optional(Schema.Array(Schema.String)), Options: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Nameservers": 1, "Search": 1, "Options": 1 }, key))))), Secrets: Schema.optional(Schema.Array(Schema.Struct({ File: Schema.optional(Schema.Struct({ Name: Schema.optional(Schema.String), UID: Schema.optional(Schema.String), GID: Schema.optional(Schema.String), Mode: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "UID": 1, "GID": 1, "Mode": 1 }, key))))), SecretID: Schema.optional(Schema.String), SecretName: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "File": 1, "SecretID": 1, "SecretName": 1 }, key)))))), Configs: Schema.optional(Schema.Array(Schema.Struct({ File: Schema.optional(Schema.Struct({ Name: Schema.optional(Schema.String), UID: Schema.optional(Schema.String), GID: Schema.optional(Schema.String), Mode: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "UID": 1, "GID": 1, "Mode": 1 }, key))))), Runtime: Schema.optional(Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)))), ConfigID: Schema.optional(Schema.String), ConfigName: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "File": 1, "Runtime": 1, "ConfigID": 1, "ConfigName": 1 }, key)))))), Isolation: Schema.optional(Schema.Literals(["default", "process", "hyperv"])), Init: Schema.optional(Schema.NullOr(Schema.Boolean)), Sysctls: Schema.optional(Schema.Record(Schema.String, Schema.String)), CapabilityAdd: Schema.optional(Schema.Array(Schema.String)), CapabilityDrop: Schema.optional(Schema.Array(Schema.String)), Ulimits: Schema.optional(Schema.Array(Schema.Struct({ Name: Schema.optional(Schema.String), Soft: Schema.optional(Schema.Int), Hard: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Soft": 1, "Hard": 1 }, key)))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Image": 1, "Labels": 1, "Command": 1, "Args": 1, "Hostname": 1, "Env": 1, "Dir": 1, "User": 1, "Groups": 1, "Privileges": 1, "TTY": 1, "OpenStdin": 1, "ReadOnly": 1, "Mounts": 1, "StopSignal": 1, "StopGracePeriod": 1, "HealthCheck": 1, "Hosts": 1, "DNSConfig": 1, "Secrets": 1, "Configs": 1, "Isolation": 1, "Init": 1, "Sysctls": 1, "CapabilityAdd": 1, "CapabilityDrop": 1, "Ulimits": 1 }, key))))), NetworkAttachmentSpec: Schema.optional(Schema.Struct({ ContainerID: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ContainerID": 1 }, key))))), Resources: Schema.optional(Schema.Struct({ Limits: Schema.optional(Limit), Reservations: Schema.optional(ResourceObject) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Limits": 1, "Reservations": 1 }, key))))), RestartPolicy: Schema.optional(Schema.Struct({ Condition: Schema.optional(Schema.Literals(["none", "on-failure", "any"])), Delay: Schema.optional(Schema.Int), MaxAttempts: Int_default_0_prop, Window: Int_default_0_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Condition": 1, "Delay": 1, "MaxAttempts": 1, "Window": 1 }, key))))), Placement: Schema.optional(Schema.Struct({ Constraints: Schema.optional(Schema.Array(Schema.String)), Preferences: Schema.optional(Schema.Array(Schema.Struct({ Spread: Schema.optional(Schema.Struct({ SpreadDescriptor: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "SpreadDescriptor": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Spread": 1 }, key)))))), MaxReplicas: Int_default_0_prop, Platforms: Schema.optional(Schema.Array(Platform)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Constraints": 1, "Preferences": 1, "MaxReplicas": 1, "Platforms": 1 }, key))))), ForceUpdate: Schema.optional(Schema.Int), Runtime: Schema.optional(Schema.String), Networks: Schema.optional(Schema.Array(NetworkAttachmentConfig)), LogDriver: Schema.optional(Schema.Struct({ Name: Schema.optional(Schema.String), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Options": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "PluginSpec": 1, "ContainerSpec": 1, "NetworkAttachmentSpec": 1, "Resources": 1, "RestartPolicy": 1, "Placement": 1, "ForceUpdate": 1, "Runtime": 1, "Networks": 1, "LogDriver": 1 }, key))));
...
export const Task = Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Name: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Spec: Schema.optional(TaskSpec), ServiceID: Schema.optional(Schema.String), Slot: Schema.optional(Schema.Int), NodeID: Schema.optional(Schema.String), AssignedGenericResources: Schema.optional(GenericResources), Status: Schema.optional(Schema.Struct({ Timestamp: Schema.optional(Schema.String), State: Schema.optional(TaskState), Message: Schema.optional(Schema.String), Err: Schema.optional(Schema.String), ContainerStatus: Schema.optional(Schema.Struct({ ContainerID: Schema.optional(Schema.String), PID: Schema.optional(Schema.Int), ExitCode: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ContainerID": 1, "PID": 1, "ExitCode": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Timestamp": 1, "State": 1, "Message": 1, "Err": 1, "ContainerStatus": 1 }, key))))), DesiredState: Schema.optional(TaskState), JobIteration: Schema.optional(ObjectVersion) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Name": 1, "Labels": 1, "Spec": 1, "ServiceID": 1, "Slot": 1, "NodeID": 1, "AssignedGenericResources": 1, "Status": 1, "DesiredState": 1, "JobIteration": 1 }, key))));
export type Task = Schema.Schema.Type<typeof Task>;

export const EndpointPortConfig = Schema.Struct({ Name: Schema.optional(Schema.String), Protocol: Schema.optional(Schema.Literals(["tcp", "udp", "sctp"])), TargetPort: Schema.optional(Schema.Int), PublishedPort: Schema.optional(Schema.Int), PublishMode: Schema_default_ingress_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Protocol": 1, "TargetPort": 1, "PublishedPort": 1, "PublishMode": 1 }, key))));
export type EndpointPortConfig = Schema.Schema.Type<typeof EndpointPortConfig>;

export const EndpointSpec = Schema.Struct({ Mode: Schema_default_vip_prop, Ports: Schema.optional(Schema.Array(EndpointPortConfig)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Mode": 1, "Ports": 1 }, key))));
export type EndpointSpec = Schema.Schema.Type<typeof EndpointSpec>;

export const ServiceSpec = Schema.Struct({ Name: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), TaskTemplate: Schema.optional(TaskSpec), Mode: Schema.optional(Schema.Struct({ Replicated: Schema.optional(Schema.Struct({ Replicas: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Replicas": 1 }, key))))), Global: Schema.optional(Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)))), ReplicatedJob: Schema.optional(Schema.Struct({ MaxConcurrent: Int_default_1_prop, TotalCompletions: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "MaxConcurrent": 1, "TotalCompletions": 1 }, key))))), GlobalJob: Schema.optional(Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Replicated": 1, "Global": 1, "ReplicatedJob": 1, "GlobalJob": 1 }, key))))), UpdateConfig: Schema.optional(Schema.Struct({ Parallelism: Schema.optional(Schema.Int), Delay: Schema.optional(Schema.Int), FailureAction: Schema.optional(Schema.Literals(["continue", "pause", "rollback"])), Monitor: Schema.optional(Schema.Int), MaxFailureRatio: Schema.optional(Schema.Number), Order: Schema.optional(Schema.Literals(["stop-first", "start-first"])) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Parallelism": 1, "Delay": 1, "FailureAction": 1, "Monitor": 1, "MaxFailureRatio": 1, "Order": 1 }, key))))), RollbackConfig: Schema.optional(Schema.Struct({ Parallelism: Schema.optional(Schema.Int), Delay: Schema.optional(Schema.Int), FailureAction: Schema.optional(Schema.Literals(["continue", "pause"])), Monitor: Schema.optional(Schema.Int), MaxFailureRatio: Schema.optional(Schema.Number), Order: Schema.optional(Schema.Literals(["stop-first", "start-first"])) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Parallelism": 1, "Delay": 1, "FailureAction": 1, "Monitor": 1, "MaxFailureRatio": 1, "Order": 1 }, key))))), Networks: Schema.optional(Schema.Array(NetworkAttachmentConfig)), EndpointSpec: Schema.optional(EndpointSpec) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Labels": 1, "TaskTemplate": 1, "Mode": 1, "UpdateConfig": 1, "RollbackConfig": 1, "Networks": 1, "EndpointSpec": 1 }, key))));
export type ServiceSpec = Schema.Schema.Type<typeof ServiceSpec>;

export const Service = Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Spec: Schema.optional(ServiceSpec), Endpoint: Schema.optional(Schema.Struct({ Spec: Schema.optional(EndpointSpec), Ports: Schema.optional(Schema.Array(EndpointPortConfig)), VirtualIPs: Schema.optional(Schema.Array(Schema.Struct({ NetworkID: Schema.optional(Schema.String), Addr: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NetworkID": 1, "Addr": 1 }, key)))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Spec": 1, "Ports": 1, "VirtualIPs": 1 }, key))))), UpdateStatus: Schema.optional(Schema.Struct({ State: Schema.optional(Schema.Literals(["updating", "paused", "completed"])), StartedAt: Schema.optional(Schema.String), CompletedAt: Schema.optional(Schema.String), Message: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "State": 1, "StartedAt": 1, "CompletedAt": 1, "Message": 1 }, key))))), ServiceStatus: Schema.optional(Schema.Struct({ RunningTasks: Schema.optional(Schema.Int), DesiredTasks: Schema.optional(Schema.Int), CompletedTasks: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "RunningTasks": 1, "DesiredTasks": 1, "CompletedTasks": 1 }, key))))), JobStatus: Schema.optional(Schema.Struct({ JobIteration: Schema.optional(ObjectVersion), LastExecution: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "JobIteration": 1, "LastExecution": 1 }, key))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Endpoint": 1, "UpdateStatus": 1, "ServiceStatus": 1, "JobStatus": 1 }, key))));
export type Service = Schema.Schema.Type<typeof Service>;

export const ImageDeleteResponseItem = Schema.Struct({ Untagged: Schema.optional(Schema.String), Deleted: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Untagged": 1, "Deleted": 1 }, key))));
export type ImageDeleteResponseItem = Schema.Schema.Type<typeof ImageDeleteResponseItem>;

export const ServiceUpdateResponse = Schema.Struct({ Warnings: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Warnings": 1 }, key))));
export type ServiceUpdateResponse = Schema.Schema.Type<typeof ServiceUpdateResponse>;

export const ContainerSummary = Schema.Struct({ Id: Schema.optional(Schema.String), Names: Schema.optional(Schema.Array(Schema.String)), Image: Schema.optional(Schema.String), ImageID: Schema.optional(Schema.String), Command: Schema.optional(Schema.String), Created: Schema.optional(Schema.Int), Ports: Schema.optional(Schema.Array(Port)), SizeRw: Schema.optional(Schema.Int), SizeRootFs: Schema.optional(Schema.Int), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), State: Schema.optional(Schema.String), Status: Schema.optional(Schema.String), HostConfig: Schema.optional(Schema.Struct({ NetworkMode: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NetworkMode": 1 }, key))))), NetworkSettings: Schema.optional(Schema.Struct({ Networks: Schema.optional(Schema.Record(Schema.String, EndpointSettings)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Networks": 1 }, key))))), Mounts: Schema.optional(Schema.Array(MountPoint)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Id": 1, "Names": 1, "Image": 1, "ImageID": 1, "Command": 1, "Created": 1, "Ports": 1, "SizeRw": 1, "SizeRootFs": 1, "Labels": 1, "State": 1, "Status": 1, "HostConfig": 1, "NetworkSettings": 1, "Mounts": 1 }, key))));
export type ContainerSummary = Schema.Schema.Type<typeof ContainerSummary>;

export const Driver = Schema.Struct({ Name: Schema.String, Options: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Options": 1 }, key))));
export type Driver = Schema.Schema.Type<typeof Driver>;

export const SecretSpec = Schema.Struct({ Name: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Data: Schema.optional(Schema.String), Driver: Schema.optional(Driver), Templating: Schema.optional(Driver) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Labels": 1, "Data": 1, "Driver": 1, "Templating": 1 }, key))));
export type SecretSpec = Schema.Schema.Type<typeof SecretSpec>;

export const Secret = Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Spec: Schema.optional(SecretSpec) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1 }, key))));
export type Secret = Schema.Schema.Type<typeof Secret>;

export const ConfigSpec = Schema.Struct({ Name: Schema.optional(Schema.String), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)), Data: Schema.optional(Schema.String), Templating: Schema.optional(Driver) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Labels": 1, "Data": 1, "Templating": 1 }, key))));
export type ConfigSpec = Schema.Schema.Type<typeof ConfigSpec>;

export const Config = Schema.Struct({ ID: Schema.optional(Schema.String), Version: Schema.optional(ObjectVersion), CreatedAt: Schema.optional(Schema.String), UpdatedAt: Schema.optional(Schema.String), Spec: Schema.optional(ConfigSpec) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1 }, key))));
export type Config = Schema.Schema.Type<typeof Config>;

export const ContainerState = Schema.NullOr(Schema.Struct({ Status: Schema.optional(Schema.Literals(["created", "running", "paused", "restarting", "removing", "exited", "dead"])), Running: Schema.optional(Schema.Boolean), Paused: Schema.optional(Schema.Boolean), Restarting: Schema.optional(Schema.Boolean), OOMKilled: Schema.optional(Schema.Boolean), Dead: Schema.optional(Schema.Boolean), Pid: Schema.optional(Schema.Int), ExitCode: Schema.optional(Schema.Int), Error: Schema.optional(Schema.String), StartedAt: Schema.optional(Schema.String), FinishedAt: Schema.optional(Schema.String), Health: Schema.optional(Health) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Status": 1, "Running": 1, "Paused": 1, "Restarting": 1, "OOMKilled": 1, "Dead": 1, "Pid": 1, "ExitCode": 1, "Error": 1, "StartedAt": 1, "FinishedAt": 1, "Health": 1 }, key)))));
export type ContainerState = Schema.Schema.Type<typeof ContainerState>;

export const ContainerCreateResponse = Schema.Struct({ Id: Schema.String, Warnings: Schema.Array(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Id": 1, "Warnings": 1 }, key))));
export type ContainerCreateResponse = Schema.Schema.Type<typeof ContainerCreateResponse>;

export const ContainerWaitExitError = Schema.Struct({ Message: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Message": 1 }, key))));
export type ContainerWaitExitError = Schema.Schema.Type<typeof ContainerWaitExitError>;

export const ContainerWaitResponse = Schema.Struct({ StatusCode: Schema.Int, Error: Schema.optional(ContainerWaitExitError) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "StatusCode": 1, "Error": 1 }, key))));
export type ContainerWaitResponse = Schema.Schema.Type<typeof ContainerWaitResponse>;

export const SystemVersion = Schema.Struct({ Platform: Schema.optional(Schema.Struct({ Name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1 }, key))))), Components: Schema.optional(Schema.Array(Schema.Struct({ Name: Schema.String, Version: Schema.String, Details: Schema.optional(Schema.NullOr(Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false))))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Version": 1, "Details": 1 }, key)))))), Version: Schema.optional(Schema.String), ApiVersion: Schema.optional(Schema.String), MinAPIVersion: Schema.optional(Schema.String), GitCommit: Schema.optional(Schema.String), GoVersion: Schema.optional(Schema.String), Os: Schema.optional(Schema.String), Arch: Schema.optional(Schema.String), KernelVersion: Schema.optional(Schema.String), Experimental: Schema.optional(Schema.Boolean), BuildTime: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Platform": 1, "Components": 1, "Version": 1, "ApiVersion": 1, "MinAPIVersion": 1, "GitCommit": 1, "GoVersion": 1, "Os": 1, "Arch": 1, "KernelVersion": 1, "Experimental": 1, "BuildTime": 1 }, key))));
export type SystemVersion = Schema.Schema.Type<typeof SystemVersion>;

export const PluginsInfo = Schema.Struct({ Volume: Schema.optional(Schema.Array(Schema.String)), Network: Schema.optional(Schema.Array(Schema.String)), Authorization: Schema.optional(Schema.Array(Schema.String)), Log: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Volume": 1, "Network": 1, "Authorization": 1, "Log": 1 }, key))));
export type PluginsInfo = Schema.Schema.Type<typeof PluginsInfo>;

export const IndexInfo = Schema.NullOr(Schema.Struct({ Name: Schema.optional(Schema.String), Mirrors: Schema.optional(Schema.Array(Schema.String)), Secure: Schema.optional(Schema.Boolean), Official: Schema.optional(Schema.Boolean) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "Mirrors": 1, "Secure": 1, "Official": 1 }, key)))));
export type IndexInfo = Schema.Schema.Type<typeof IndexInfo>;

export const RegistryServiceConfig = Schema.NullOr(Schema.Struct({ AllowNondistributableArtifactsCIDRs: Schema.optional(Schema.Array(Schema.String)), AllowNondistributableArtifactsHostnames: Schema.optional(Schema.Array(Schema.String)), InsecureRegistryCIDRs: Schema.optional(Schema.Array(Schema.String)), IndexConfigs: Schema.optional(Schema.Record(Schema.String, IndexInfo)), Mirrors: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "AllowNondistributableArtifactsCIDRs": 1, "AllowNondistributableArtifactsHostnames": 1, "InsecureRegistryCIDRs": 1, "IndexConfigs": 1, "Mirrors": 1 }, key)))));
export type RegistryServiceConfig = Schema.Schema.Type<typeof RegistryServiceConfig>;

export const Runtime = Schema.Struct({ path: Schema.optional(Schema.String), runtimeArgs: Schema.optional(Schema.NullOr(Schema.Array(Schema.String))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "path": 1, "runtimeArgs": 1 }, key))));
...
export const OCIDescriptor = Schema.Struct({ mediaType: Schema.optional(Schema.String), digest: Schema.optional(Schema.String), size: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "mediaType": 1, "digest": 1, "size": 1 }, key))));
export type OCIDescriptor = Schema.Schema.Type<typeof OCIDescriptor>;

export const OCIPlatform = Schema.Struct({ architecture: Schema.optional(Schema.String), os: Schema.optional(Schema.String), "os.version": Schema.optional(Schema.String), "os.features": Schema.optional(Schema.Array(Schema.String)), variant: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "architecture": 1, "os": 1, "os.version": 1, "os.features": 1, "variant": 1 }, key))));
export type OCIPlatform = Schema.Schema.Type<typeof OCIPlatform>;

export const DistributionInspect = Schema.Struct({ Descriptor: OCIDescriptor, Platforms: Schema.Array(OCIPlatform) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Descriptor": 1, "Platforms": 1 }, key))));
...
export const get_ContainerList = {
  ...
  parameters: { query: Schema.optional(Schema.Struct({ all: Union_default_false_prop, limit: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), size: Union_default_false_prop, filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "all": 1, "limit": 1, "size": 1, "filters": 1 }, key))))) },
...
export const post_ContainerCreate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ name: Schema.optional(Schema.String.check(Schema.isPattern(new RegExp("^/?[a-zA-Z0-9][a-zA-Z0-9_.-]+$")))), platform: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1, "platform": 1 }, key))))), body: ContainerConfig.mapFields(Struct.assign((Schema.Struct({ HostConfig: Schema.optional(HostConfig), NetworkingConfig: Schema.optional(NetworkingConfig) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "HostConfig": 1, "NetworkingConfig": 1 }, key))))).fields)) },
...
export const get_ContainerTop = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ ps_args: String_default_neg_ef_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ps_args": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
  responses: { 200: Schema.Union([Schema.Struct({ Titles: Schema.optional(Schema.Array(Schema.String)), Processes: Schema.optional(Schema.Array(Schema.Array(Schema.String))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Titles": 1, "Processes": 1 }, key)))), Schema.Struct({ Titles: Schema.optional(Schema.Array(Schema.String)), Processes: Schema.optional(Schema.Array(Schema.Array(Schema.String))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Titles": 1, "Processes": 1 }, key))))]), 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const get_ContainerLogs = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ follow: Union_default_false_prop, stdout: Union_default_false_prop, stderr: Union_default_false_prop, since: Schema_default_0_prop, until: Schema_default_0_prop, timestamps: Union_default_false_prop, tail: String_default_all_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "follow": 1, "stdout": 1, "stderr": 1, "since": 1, "until": 1, "timestamps": 1, "tail": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const get_ContainerChanges = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const get_ContainerStats = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ stream: Union_default_true_prop, "one-shot": Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "stream": 1, "one-shot": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_ContainerResize = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ h: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), w: Schema.optional(Schema.NumberFromString.check(Schema.isInt())) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "h": 1, "w": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
  responses: { 200: Schema.Unknown, 404: Schema.Union([ErrorResponse, Schema.Unknown]), 500: ErrorResponse },
};
...
export const post_ContainerStart = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ detachKeys: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "detachKeys": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_ContainerStop = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ signal: Schema.optional(Schema.String), t: Schema.optional(Schema.NumberFromString.check(Schema.isInt())) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "signal": 1, "t": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
  responses: { 204: Schema.Unknown, 304: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_ContainerKill = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ signal: String_default_SIGKILL_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "signal": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_ContainerUpdate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: Resources.mapFields(Struct.assign((Schema.Struct({ RestartPolicy: Schema.optional(RestartPolicy) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "RestartPolicy": 1 }, key))))).fields)) },
  responses: { 200: Schema.Struct({ Warnings: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Warnings": 1 }, key)))), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ContainerRename = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
  responses: { 204: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 409: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_ContainerWait = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ condition: Schema_default_notneg_running_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "condition": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const delete_ContainerDelete = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ v: Union_default_false_prop, force: Union_default_false_prop, link: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "v": 1, "force": 1, "link": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const get_ContainerArchive = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ path: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "path": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const put_PutContainerArchive = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ path: Schema.String, noOverwriteDirNonDir: Schema.optional(Schema.String), copyUIDGID: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "path": 1, "noOverwriteDirNonDir": 1, "copyUIDGID": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: Schema.declare((v): v is Blob => typeof Blob !== "undefined" && v instanceof Blob) },
...
export const head_ContainerArchiveInfo = {
  ...
  responseHeaders: { 200: Schema.Struct({ "X-Docker-Container-Path-Stat": Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Docker-Container-Path-Stat": 1 }, key)))) },
};
...
export const post_ContainerPrune = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "filters": 1 }, key))))) },
  responses: { 200: Schema.Struct({ ContainersDeleted: Schema.optional(Schema.Array(Schema.String)), SpaceReclaimed: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ContainersDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const get_ImageList = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ all: Union_default_false_prop, filters: Schema.optional(Schema.String), "shared-size": Union_default_false_prop, digests: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "all": 1, "filters": 1, "shared-size": 1, "digests": 1 }, key))))) },
...
export const post_ImageBuild = {
  ...
  requestFormat: Schema.Literal("binary"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ dockerfile: String_default_Dockerfile_prop, t: Schema.optional(Schema.String), extrahosts: Schema.optional(Schema.String), remote: Schema.optional(Schema.String), q: Union_default_false_prop, nocache: Union_default_false_prop, cachefrom: Schema.optional(Schema.String), pull: Schema.optional(Schema.String), rm: Union_default_true_prop, forcerm: Union_default_false_prop, memory: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), memswap: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), cpushares: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), cpusetcpus: Schema.optional(Schema.String), cpuperiod: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), cpuquota: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), buildargs: Schema.optional(Schema.String), shmsize: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), squash: Schema.optional(Schema.Union([Schema.Boolean, Schema.String, Schema.Number]).pipe(Schema.decodeTo(Schema.Boolean, SchemaTransformation.transform({ decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })))), labels: Schema.optional(Schema.String), networkmode: Schema.optional(Schema.String), platform: Schema.optional(Schema.String), target: Schema.optional(Schema.String), outputs: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "dockerfile": 1, "t": 1, "extrahosts": 1, "remote": 1, "q": 1, "nocache": 1, "cachefrom": 1, "pull": 1, "rm": 1, "forcerm": 1, "memory": 1, "memswap": 1, "cpushares": 1, "cpusetcpus": 1, "cpuperiod": 1, "cpuquota": 1, "buildargs": 1, "shmsize": 1, "squash": 1, "labels": 1, "networkmode": 1, "platform": 1, "target": 1, "outputs": 1 }, key))))), header: Schema.optional(Schema.Struct({ "Content-type": Schema.optional(Schema.Literal("application/x-tar")), "X-Registry-Config": Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Content-type": 1, "X-Registry-Config": 1 }, key))))), body: Schema.declare((v): v is Blob => typeof Blob !== "undefined" && v instanceof Blob) },
...
export const post_BuildPrune = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ "keep-storage": Schema.optional(Schema.NumberFromString.check(Schema.isInt())), all: Schema.optional(Schema.Union([Schema.Boolean, Schema.String, Schema.Number]).pipe(Schema.decodeTo(Schema.Boolean, SchemaTransformation.transform({ decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })))), filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "keep-storage": 1, "all": 1, "filters": 1 }, key))))) },
  responses: { 200: Schema.Struct({ CachesDeleted: Schema.optional(Schema.Array(Schema.String)), SpaceReclaimed: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "CachesDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const post_ImageCreate = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ fromImage: Schema.optional(Schema.String), fromSrc: Schema.optional(Schema.String), repo: Schema.optional(Schema.String), tag: Schema.optional(Schema.String), message: Schema.optional(Schema.String), changes: Schema.optional(Schema.Array(Schema.String)), platform: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "fromImage": 1, "fromSrc": 1, "repo": 1, "tag": 1, "message": 1, "changes": 1, "platform": 1 }, key))))), header: Schema.optional(Schema.Struct({ "X-Registry-Auth": Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Registry-Auth": 1 }, key))))), body: Schema.String },
...
export const get_ImageInspect = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
...
export const get_ImageHistory = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
  responses: { 200: Schema.Array(Schema.Struct({ Id: Schema.String, Created: Schema.Int, CreatedBy: Schema.String, Tags: Schema.Array(Schema.String), Size: Schema.Int, Comment: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Id": 1, "Created": 1, "CreatedBy": 1, "Tags": 1, "Size": 1, "Comment": 1 }, key))))), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ImagePush = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ tag: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "tag": 1 }, key))))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))), header: Schema.Struct({ "X-Registry-Auth": Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Registry-Auth": 1 }, key)))) },
...
export const post_ImageTag = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ repo: Schema.optional(Schema.String), tag: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "repo": 1, "tag": 1 }, key))))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
...
export const delete_ImageDelete = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ force: Union_default_false_prop, noprune: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "force": 1, "noprune": 1 }, key))))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
...
export const get_ImageSearch = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ term: Schema.String, limit: Schema.optional(Schema.NumberFromString.check(Schema.isInt())), filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "term": 1, "limit": 1, "filters": 1 }, key)))) },
  responses: { 200: Schema.Array(Schema.Struct({ description: Schema.optional(Schema.String), is_official: Schema.optional(Schema.Boolean), is_automated: Schema.optional(Schema.Boolean), name: Schema.optional(Schema.String), star_count: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "description": 1, "is_official": 1, "is_automated": 1, "name": 1, "star_count": 1 }, key))))), 500: ErrorResponse },
};
...
export const post_ImagePrune = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "filters": 1 }, key))))) },
  responses: { 200: Schema.Struct({ ImagesDeleted: Schema.optional(Schema.Array(ImageDeleteResponseItem)), SpaceReclaimed: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ImagesDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const post_SystemAuth = {
  ...
  responses: { 200: Schema.Struct({ Status: Schema.String, IdentityToken: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Status": 1, "IdentityToken": 1 }, key)))), 204: Schema.Unknown, 401: ErrorResponse, 500: ErrorResponse },
};
...
export const get_SystemPing = {
  ...
  responseHeaders: { 200: Schema.Struct({ Swarm: Schema_default_inactive_prop, "Docker-Experimental": Schema.Boolean, "Cache-Control": String_default_noneg_cache_noneg_store_mustneg_revalida_prop, Pragma: String_default_noneg_cache_prop, "API-Version": Schema.String, "Builder-Version": String_default_2_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Swarm": 1, "Docker-Experimental": 1, "Cache-Control": 1, "Pragma": 1, "API-Version": 1, "Builder-Version": 1 }, key)))), 500: Schema.Struct({ "Cache-Control": String_default_noneg_cache_noneg_store_mustneg_revalida_prop, Pragma: String_default_noneg_cache_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Cache-Control": 1, "Pragma": 1 }, key)))) },
};
...
export const head_SystemPingHead = {
  ...
  parameters: Schema.Never,
  responses: { 200: Schema.String, 500: ErrorResponse },
  responseHeaders: { 200: Schema.Struct({ Swarm: Schema_default_inactive_prop, "Docker-Experimental": Schema.Boolean, "Cache-Control": String_default_noneg_cache_noneg_store_mustneg_revalida_prop, Pragma: String_default_noneg_cache_prop, "API-Version": Schema.String, "Builder-Version": Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Swarm": 1, "Docker-Experimental": 1, "Cache-Control": 1, "Pragma": 1, "API-Version": 1, "Builder-Version": 1 }, key)))) },
};
...
export const get_SystemEvents = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ since: Schema.optional(Schema.String), until: Schema.optional(Schema.String), filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "since": 1, "until": 1, "filters": 1 }, key))))) },
...
export const get_SystemDataUsage = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ type: Schema.optional(Schema.Array(Schema.Literals(["container", "image", "volume", "build-cache"]))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "type": 1 }, key))))) },
  responses: { 200: Schema.Union([Schema.Struct({ LayersSize: Schema.optional(Schema.Int), Images: Schema.optional(Schema.Array(ImageSummary)), Containers: Schema.optional(Schema.Array(ContainerSummary)), Volumes: Schema.optional(Schema.Array(Volume)), BuildCache: Schema.optional(Schema.Array(BuildCache)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "LayersSize": 1, "Images": 1, "Containers": 1, "Volumes": 1, "BuildCache": 1 }, key)))), Schema.Struct({ LayersSize: Schema.optional(Schema.Int), Images: Schema.optional(Schema.Array(ImageSummary)), Containers: Schema.optional(Schema.Array(ContainerSummary)), Volumes: Schema.optional(Schema.Array(Volume)), BuildCache: Schema.optional(Schema.Array(BuildCache)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "LayersSize": 1, "Images": 1, "Containers": 1, "Volumes": 1, "BuildCache": 1 }, key))))]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const get_ImageGetAll = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ names: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "names": 1 }, key))))) },
  responses: { 200: Schema.Unknown, 500: Schema.Unknown },
};
...
export const post_ImageLoad = {
  ...
  requestFormat: Schema.Literal("text"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ quiet: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "quiet": 1 }, key))))) },
...
export const post_ContainerExec = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: Schema.optional(Schema.Struct({ AttachStdin: Schema.optional(Schema.Boolean), AttachStdout: Schema.optional(Schema.Boolean), AttachStderr: Schema.optional(Schema.Boolean), ConsoleSize: Schema.optional(Schema.NullOr(Schema.Array(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))).check(Schema.isMinLength(2), Schema.isMaxLength(2)))), DetachKeys: Schema.optional(Schema.String), Tty: Schema.optional(Schema.Boolean), Env: Schema.optional(Schema.Array(Schema.String)), Cmd: Schema.optional(Schema.Array(Schema.String)), Privileged: Boolean_default_false_prop, User: Schema.optional(Schema.String), WorkingDir: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "AttachStdin": 1, "AttachStdout": 1, "AttachStderr": 1, "ConsoleSize": 1, "DetachKeys": 1, "Tty": 1, "Env": 1, "Cmd": 1, "Privileged": 1, "User": 1, "WorkingDir": 1 }, key))))) },
...
export const post_ExecStart = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: Schema.optional(Schema.Struct({ Detach: Schema.optional(Schema.Boolean), Tty: Schema.optional(Schema.Boolean), ConsoleSize: Schema.optional(Schema.NullOr(Schema.Array(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0))).check(Schema.isMinLength(2), Schema.isMaxLength(2)))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Detach": 1, "Tty": 1, "ConsoleSize": 1 }, key))))) },
...
export const put_VolumeUpdate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ version: Schema.NumberFromString.check(Schema.isInt()) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "version": 1 }, key)))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))), body: Schema.optional(Schema.Struct({ Spec: Schema.optional(ClusterVolumeSpec) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Spec": 1 }, key))))) },
...
export const delete_VolumeDelete = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ force: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "force": 1 }, key))))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
  responses: { 204: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 409: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_VolumePrune = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "filters": 1 }, key))))) },
  responses: { 200: Schema.Struct({ VolumesDeleted: Schema.optional(Schema.Array(Schema.String)), SpaceReclaimed: Schema.optional(Schema.Int) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "VolumesDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const get_NetworkInspect = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ verbose: Union_default_false_prop, scope: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "verbose": 1, "scope": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_NetworkCreate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: Schema.Struct({ Name: Schema.String, CheckDuplicate: Schema.optional(Schema.Boolean), Driver: String_default_bridge_prop, Internal: Schema.optional(Schema.Boolean), Attachable: Schema.optional(Schema.Boolean), Ingress: Schema.optional(Schema.Boolean), IPAM: Schema.optional(IPAM), EnableIPv6: Schema.optional(Schema.Boolean), Options: Schema.optional(Schema.Record(Schema.String, Schema.String)), Labels: Schema.optional(Schema.Record(Schema.String, Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Name": 1, "CheckDuplicate": 1, "Driver": 1, "Internal": 1, "Attachable": 1, "Ingress": 1, "IPAM": 1, "EnableIPv6": 1, "Options": 1, "Labels": 1 }, key)))) },
  responses: { 201: Schema.Struct({ Id: Schema.optional(Schema.String), Warning: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Id": 1, "Warning": 1 }, key)))), 403: ErrorResponse, 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_NetworkConnect = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: Schema.optional(Schema.Struct({ Container: Schema.optional(Schema.String), EndpointConfig: Schema.optional(EndpointSettings) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Container": 1, "EndpointConfig": 1 }, key))))) },
...
export const post_NetworkDisconnect = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: Schema.optional(Schema.Struct({ Container: Schema.optional(Schema.String), Force: Schema.optional(Schema.Boolean) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "Container": 1, "Force": 1 }, key))))) },
  responses: { 200: Schema.Unknown, 403: Schema.Union([ErrorResponse, ErrorResponse]), 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_NetworkPrune = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ filters: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "filters": 1 }, key))))) },
  responses: { 200: Schema.Struct({ NetworksDeleted: Schema.optional(Schema.Array(Schema.String)) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "NetworksDeleted": 1 }, key)))), 500: ErrorResponse },
};
...
export const get_GetPluginPrivileges = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ remote: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "remote": 1 }, key)))) },
...
export const post_PluginPull = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ remote: Schema.String, name: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "remote": 1, "name": 1 }, key)))), header: Schema.optional(Schema.Struct({ "X-Registry-Auth": Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Registry-Auth": 1 }, key))))), body: Schema.Array(PluginPrivilege) },
...
export const post_PluginEnable = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ timeout: Schema_default_0_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "timeout": 1 }, key))))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
  responses: { 200: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_PluginDisable = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ force: Schema.optional(Schema.Union([Schema.Boolean, Schema.String, Schema.Number]).pipe(Schema.decodeTo(Schema.Boolean, SchemaTransformation.transform({ decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "force": 1 }, key))))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
  responses: { 200: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_PluginUpgrade = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ remote: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "remote": 1 }, key)))), path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))), header: Schema.optional(Schema.Struct({ "X-Registry-Auth": Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Registry-Auth": 1 }, key))))), body: Schema.Array(PluginPrivilege) },
  responses: { 204: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_PluginCreate = {
  ...
  requestFormat: Schema.Literal("text"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))) },
...
export const post_PluginSet = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ name: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1 }, key)))), body: Schema.Array(Schema.String) },
  responses: { 204: Schema.Unknown, 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const delete_NodeDelete = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ force: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "force": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_NodeUpdate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ version: Schema.NumberFromString.check(Schema.isInt()) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "version": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: NodeSpec },
...
export const post_SwarmInit = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: Schema.optional(Schema.Struct({ ListenAddr: Schema.optional(Schema.String), AdvertiseAddr: Schema.optional(Schema.String), DataPathAddr: Schema.optional(Schema.String), DataPathPort: Schema.optional(Schema.Int), DefaultAddrPool: Schema.optional(Schema.Array(Schema.String)), ForceNewCluster: Schema.optional(Schema.Boolean), SubnetSize: Schema.optional(Schema.Int), Spec: Schema.optional(SwarmSpec) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ListenAddr": 1, "AdvertiseAddr": 1, "DataPathAddr": 1, "DataPathPort": 1, "DefaultAddrPool": 1, "ForceNewCluster": 1, "SubnetSize": 1, "Spec": 1 }, key))))) },
...
export const post_SwarmJoin = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: Schema.optional(Schema.Struct({ ListenAddr: Schema.optional(Schema.String), AdvertiseAddr: Schema.optional(Schema.String), DataPathAddr: Schema.optional(Schema.String), RemoteAddrs: Schema.optional(Schema.Array(Schema.String)), JoinToken: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ListenAddr": 1, "AdvertiseAddr": 1, "DataPathAddr": 1, "RemoteAddrs": 1, "JoinToken": 1 }, key))))) },
...
export const post_SwarmLeave = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ force: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "force": 1 }, key))))) },
...
export const get_SwarmUnlockkey = {
  ...
  responseFormat: Schema.Literal("json"),
  parameters: Schema.Never,
  responses: { 200: Schema.Union([Schema.Struct({ UnlockKey: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "UnlockKey": 1 }, key)))), Schema.Struct({ UnlockKey: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "UnlockKey": 1 }, key))))]), 500: Schema.Union([ErrorResponse, ErrorResponse]), 503: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_SwarmUnlock = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: Schema.optional(Schema.Struct({ UnlockKey: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "UnlockKey": 1 }, key))))) },
...
export const get_ServiceList = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ filters: Schema.optional(Schema.String), status: Schema.optional(Schema.Union([Schema.Boolean, Schema.String, Schema.Number]).pipe(Schema.decodeTo(Schema.Boolean, SchemaTransformation.transform({ decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })))) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "filters": 1, "status": 1 }, key))))) },
...
export const post_ServiceCreate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { header: Schema.optional(Schema.Struct({ "X-Registry-Auth": Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Registry-Auth": 1 }, key))))), body: Schema.StructWithRest(ServiceSpec, [Schema.Record(Schema.String, Schema.Unknown)]) },
  responses: { 201: Schema.Struct({ ID: Schema.optional(Schema.String), Warning: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ID": 1, "Warning": 1 }, key)))), 400: ErrorResponse, 403: ErrorResponse, 409: ErrorResponse, 500: ErrorResponse, 503: ErrorResponse },
};
...
export const get_ServiceInspect = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ insertDefaults: Union_default_false_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "insertDefaults": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_ServiceUpdate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ version: Schema.NumberFromString.check(Schema.isInt()), registryAuthFrom: Schema_default_spec_prop, rollback: Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "version": 1, "registryAuthFrom": 1, "rollback": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), header: Schema.optional(Schema.Struct({ "X-Registry-Auth": Schema.optional(Schema.String) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Registry-Auth": 1 }, key))))), body: Schema.StructWithRest(ServiceSpec, [Schema.Record(Schema.String, Schema.Unknown)]) },
...
export const get_ServiceLogs = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ details: Union_default_false_prop, follow: Union_default_false_prop, stdout: Union_default_false_prop, stderr: Union_default_false_prop, since: Schema_default_0_prop, timestamps: Union_default_false_prop, tail: String_default_all_prop }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "details": 1, "follow": 1, "stdout": 1, "stderr": 1, "since": 1, "timestamps": 1, "tail": 1 }, key))))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))) },
...
export const post_SecretUpdate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ version: Schema.NumberFromString.check(Schema.isInt()) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "version": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: SecretSpec },
  responses: { 200: Schema.Unknown, 400: Schema.Union([ErrorResponse, ErrorResponse]), 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]), 503: Schema.Union([ErrorResponse, ErrorResponse]) },
};
...
export const post_ConfigUpdate = {
  ...
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.Struct({ version: Schema.NumberFromString.check(Schema.isInt()) }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "version": 1 }, key)))), path: Schema.Struct({ id: Schema.String }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "id": 1 }, key)))), body: ConfigSpec },
  responses: { 200: Schema.Unknown, 400: Schema.Union([ErrorResponse, ErrorResponse]), 404: Schema.Union([ErrorResponse, ErrorResponse]), 500: Schema.Union([ErrorResponse, ErrorResponse]), 503: Schema.Union([ErrorResponse, ErrorResponse]) },
};
