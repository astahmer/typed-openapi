...
export type ImageInspect = Partial<{
  ...
  RootFS: { Type: string; Layers?: Array<string> };
...
export type Plugin = {
  ...
  Config: {
    ...
    Interface: { Types: Array<PluginInterfaceType>; Socket: string; ProtocolScheme?: "" | "moby.plugins.http/v1" };
    Entrypoint: Array<string>;
    WorkDir: string;
    User?: Partial<{ UID: number; GID: number }>;
    Network: { Type: string };
    ...
    rootfs?: Partial<{ type: string; diff_ids: Array<string> }>;
  };
};
...
export type SystemVersion = Partial<{
  ...
  Components: Array<{ Name: string; Version: string; Details?: Partial<{}> | null }>;
  Version: string;
  ApiVersion: string;
...
export const post_ContainerCreate = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ name: string; platform: string }>>(),
    body: typia.createIs<ContainerConfig & Partial<{ HostConfig: HostConfig; NetworkingConfig: NetworkingConfig }>>(),
  },
  responses: {
    201: isContainerCreateResponse,
    400: isErrorResponse,
    404: isErrorResponse,
    409: isErrorResponse,
    500: isErrorResponse,
...
export const get_ContainerTop = {
  ...
  responses: {
    200: typia.createIs<Partial<{ Titles: Array<string>; Processes: Array<Array<string>> }>>(),
    404: isErrorResponse,
    500: isErrorResponse,
  },
};
...
export const get_ContainerStats = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ stream: boolean; "one-shot": boolean }>>(),
    path: typia.createIs<{ id: string }>(),
  },
...
export const post_ContainerStop = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ signal: string; t: number }>>(),
    path: typia.createIs<{ id: string }>(),
  },
  responses: {
    204: typia.createIs<unknown>(),
...
export const post_ContainerUpdate = {
  ...
  parameters: {
    path: typia.createIs<{ id: string }>(),
    body: typia.createIs<Resources & Partial<{ RestartPolicy: RestartPolicy }>>(),
  },
  responses: {
    200: typia.createIs<Partial<{ Warnings: Array<string> }>>(),
    404: isErrorResponse,
    500: isErrorResponse,
  },
};
...
export const post_ContainerAttach = {
  ...
  responses: {
    101: typia.createIs<unknown>(),
    200: typia.createIs<unknown>(),
    400: typia.createIs<unknown>(),
    404: typia.createIs<unknown>(),
    500: typia.createIs<unknown>(),
  },
};
...
export const post_ContainerWait = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ condition: "not-running" | "next-exit" | "removed" }>>(),
    path: typia.createIs<{ id: string }>(),
  },
...
export const delete_ContainerDelete = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ v: boolean; force: boolean; link: boolean }>>(),
    path: typia.createIs<{ id: string }>(),
  },
  responses: {
    204: typia.createIs<unknown>(),
...
export const put_PutContainerArchive = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<{ path: string; noOverwriteDirNonDir?: string; copyUIDGID?: string }>(),
    path: typia.createIs<{ id: string }>(),
...
export const post_ContainerPrune = {
  ...
  responses: {
    200: typia.createIs<Partial<{ ContainersDeleted: Array<string>; SpaceReclaimed: number }>>(),
    500: isErrorResponse,
  },
};
...
export const get_ImageList = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ all: boolean; filters: string; "shared-size": boolean; digests: boolean }>>(),
  },
...
export const post_ImageBuild = {
  ...
  parameters: {
    ...
    >(),
    header: typia.createIs<Partial<{ "Content-type": "application/x-tar"; "X-Registry-Config": string }>>(),
    body: typia.createIs<Blob>(),
  },
...
export const post_BuildPrune = {
  ...
  responses: {
    200: typia.createIs<Partial<{ CachesDeleted: Array<string>; SpaceReclaimed: number }>>(),
    500: isErrorResponse,
  },
};
...
export const post_ImageCreate = {
  ...
  parameters: {
    ...
    >(),
    header: typia.createIs<Partial<{ "X-Registry-Auth": string }>>(),
    body: typia.createIs<string>(),
  },
...
export const get_ImageHistory = {
  ...
  responses: {
    200: typia.createIs<
      Array<{ Id: string; Created: number; CreatedBy: string; Tags: Array<string>; Size: number; Comment: string }>
    >(),
    404: isErrorResponse,
    500: isErrorResponse,
  },
...
export const post_ImagePush = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ tag: string }>>(),
    path: typia.createIs<{ name: string }>(),
    header: typia.createIs<{ "X-Registry-Auth": string }>(),
  },
  responses: { 200: typia.createIs<unknown>(), 404: isErrorResponse, 500: isErrorResponse },
};
...
export const post_ImageTag = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ repo: string; tag: string }>>(),
    path: typia.createIs<{ name: string }>(),
  },
  responses: {
    201: typia.createIs<unknown>(),
    400: isErrorResponse,
    404: isErrorResponse,
    409: isErrorResponse,
    500: isErrorResponse,
...
export const delete_ImageDelete = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ force: boolean; noprune: boolean }>>(),
    path: typia.createIs<{ name: string }>(),
  },
  responses: {
    200: typia.createIs<Array<ImageDeleteResponseItem>>(),
    404: isErrorResponse,
    409: isErrorResponse,
    500: isErrorResponse,
  },
...
export const post_ImagePrune = {
  ...
  parameters: { query: typia.createIs<Partial<{ filters: string }>>() },
  responses: {
    200: typia.createIs<Partial<{ ImagesDeleted: Array<ImageDeleteResponseItem>; SpaceReclaimed: number }>>(),
    500: isErrorResponse,
  },
};
...
export const post_SystemAuth = {
  ...
  responses: {
    200: typia.createIs<{ Status: string; IdentityToken?: string }>(),
    204: typia.createIs<unknown>(),
    401: isErrorResponse,
    500: isErrorResponse,
  },
...
export const get_SystemPing = {
  ...
  responseHeaders: {
    ...
    500: typia.createIs<{ "Cache-Control": string; Pragma: string }>(),
  },
};
...
export const post_ExecStart = {
  ...
  parameters: {
    path: typia.createIs<{ id: string }>(),
    body: typia.createIs<Partial<{ Detach: boolean; Tty: boolean; ConsoleSize: Array<number> | null }>>(),
  },
...
export const put_VolumeUpdate = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<{ version: number }>(),
    path: typia.createIs<{ name: string }>(),
    body: typia.createIs<Partial<{ Spec: ClusterVolumeSpec }>>(),
  },
  responses: {
    200: typia.createIs<unknown>(),
    400: isErrorResponse,
...
export const post_VolumePrune = {
  ...
  parameters: { query: typia.createIs<Partial<{ filters: string }>>() },
  responses: {
    200: typia.createIs<Partial<{ VolumesDeleted: Array<string>; SpaceReclaimed: number }>>(),
    500: isErrorResponse,
  },
};
...
export const get_NetworkInspect = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<Partial<{ verbose: boolean; scope: string }>>(),
    path: typia.createIs<{ id: string }>(),
  },
...
export const post_NetworkCreate = {
  ...
  responses: {
    201: typia.createIs<Partial<{ Id: string; Warning: string }>>(),
    403: isErrorResponse,
    404: isErrorResponse,
    500: isErrorResponse,
  },
...
export const post_NetworkConnect = {
  ...
  parameters: {
    path: typia.createIs<{ id: string }>(),
    body: typia.createIs<Partial<{ Container: string; EndpointConfig: EndpointSettings }>>(),
  },
...
export const post_NetworkDisconnect = {
  ...
  parameters: {
    path: typia.createIs<{ id: string }>(),
    body: typia.createIs<Partial<{ Container: string; Force: boolean }>>(),
  },
  responses: { 200: typia.createIs<unknown>(), 403: isErrorResponse, 404: isErrorResponse, 500: isErrorResponse },
};
...
export const post_PluginPull = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<{ remote: string; name?: string }>(),
    header: typia.createIs<Partial<{ "X-Registry-Auth": string }>>(),
    body: typia.createIs<Array<PluginPrivilege>>(),
  },
...
export const post_PluginUpgrade = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<{ remote: string }>(),
    path: typia.createIs<{ name: string }>(),
    header: typia.createIs<Partial<{ "X-Registry-Auth": string }>>(),
    body: typia.createIs<Array<PluginPrivilege>>(),
  },
...
export const post_ServiceCreate = {
  ...
  parameters: {
    header: typia.createIs<Partial<{ "X-Registry-Auth": string }>>(),
    body: typia.createIs<ServiceSpec & Record<string, unknown>>(),
  },
  responses: {
    201: typia.createIs<Partial<{ ID: string; Warning: string }>>(),
    400: isErrorResponse,
...
export const post_ServiceUpdate = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: {
    query: typia.createIs<{ version: number; registryAuthFrom?: "spec" | "previous-spec"; rollback?: string }>(),
    path: typia.createIs<{ id: string }>(),
    header: typia.createIs<Partial<{ "X-Registry-Auth": string }>>(),
    body: typia.createIs<ServiceSpec & Record<string, unknown>>(),
  },
  responses: {
    200: isServiceUpdateResponse,
    400: isErrorResponse,
    404: isErrorResponse,
    500: isErrorResponse,
    503: isErrorResponse,
