...
// <Schemas>
export const Port = type({ "IP?": type("string"), PrivatePort: type("number.integer"), "PublicPort?": type("number.integer"), Type: type.enumerated("tcp", "udp", "sctp") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "IP": 1, "PrivatePort": 1, "PublicPort": 1, "Type": 1 }, key)));
export type Port = typeof Port.infer;

export const MountPoint = type({ Type: type.enumerated("bind", "volume", "tmpfs", "npipe", "cluster"), Name: type("string"), Source: type("string"), Destination: type("string"), Driver: type("string"), Mode: type("string"), RW: type("boolean"), Propagation: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1, "Name": 1, "Source": 1, "Destination": 1, "Driver": 1, "Mode": 1, "RW": 1, "Propagation": 1 }, key)));
export type MountPoint = typeof MountPoint.infer;

export const DeviceMapping = type({ PathOnHost: type("string"), PathInContainer: type("string"), CgroupPermissions: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "PathOnHost": 1, "PathInContainer": 1, "CgroupPermissions": 1 }, key)));
export type DeviceMapping = typeof DeviceMapping.infer;

export const DeviceRequest = type({ Driver: type("string"), Count: type("number.integer"), DeviceIDs: type("string").array(), Capabilities: type("string").array().array(), Options: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Driver": 1, "Count": 1, "DeviceIDs": 1, "Capabilities": 1, "Options": 1 }, key)));
export type DeviceRequest = typeof DeviceRequest.infer;

export const ThrottleDevice = type({ Path: type("string"), Rate: type("number.integer >= 0") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Path": 1, "Rate": 1 }, key)));
export type ThrottleDevice = typeof ThrottleDevice.infer;

export const Mount = type({ Target: type("string"), Source: type("string"), Type: type.enumerated("bind", "volume", "tmpfs", "npipe", "cluster"), ReadOnly: type("boolean"), Consistency: type("string"), BindOptions: type({ Propagation: type.enumerated("private", "rprivate", "shared", "rshared", "slave", "rslave"), NonRecursive: "boolean = false", CreateMountpoint: "boolean = false" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Propagation": 1, "NonRecursive": 1, "CreateMountpoint": 1 }, key))), VolumeOptions: type({ NoCopy: "boolean = false", Labels: type({ "[string]": type("string") }), DriverConfig: type({ Name: type("string"), Options: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NoCopy": 1, "Labels": 1, "DriverConfig": 1 }, key))), TmpfsOptions: type({ SizeBytes: type("number.integer"), Mode: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "SizeBytes": 1, "Mode": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Target": 1, "Source": 1, "Type": 1, "ReadOnly": 1, "Consistency": 1, "BindOptions": 1, "VolumeOptions": 1, "TmpfsOptions": 1 }, key)));
export type Mount = typeof Mount.infer;

export const RestartPolicy = type({ Name: type.enumerated("", "no", "always", "unless-stopped", "on-failure"), MaximumRetryCount: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "MaximumRetryCount": 1 }, key)));
export type RestartPolicy = typeof RestartPolicy.infer;

export const Resources = type({ CpuShares: type("number.integer"), Memory: "number.integer = 0", CgroupParent: type("string"), BlkioWeight: type("0 <= number.integer <= 1000"), BlkioWeightDevice: type({ Path: type("string"), Weight: type("number.integer >= 0") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Path": 1, "Weight": 1 }, key))).array(), BlkioDeviceReadBps: ThrottleDevice.array(), BlkioDeviceWriteBps: ThrottleDevice.array(), BlkioDeviceReadIOps: ThrottleDevice.array(), BlkioDeviceWriteIOps: ThrottleDevice.array(), CpuPeriod: type("number.integer"), CpuQuota: type("number.integer"), CpuRealtimePeriod: type("number.integer"), CpuRealtimeRuntime: type("number.integer"), CpusetCpus: type("string"), CpusetMems: type("string"), Devices: DeviceMapping.array(), DeviceCgroupRules: type("string").array(), DeviceRequests: DeviceRequest.array(), KernelMemoryTCP: type("number.integer"), MemoryReservation: type("number.integer"), MemorySwap: type("number.integer"), MemorySwappiness: type("0 <= number.integer <= 100"), NanoCpus: type("number.integer"), OomKillDisable: type("boolean"), Init: type("boolean").or(type("null")), PidsLimit: type("number.integer").or(type("null")), Ulimits: type({ Name: type("string"), Soft: type("number.integer"), Hard: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Soft": 1, "Hard": 1 }, key))).array(), CpuCount: type("number.integer"), CpuPercent: type("number.integer"), IOMaximumIOps: type("number.integer"), IOMaximumBandwidth: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "CpuShares": 1, "Memory": 1, "CgroupParent": 1, "BlkioWeight": 1, "BlkioWeightDevice": 1, "BlkioDeviceReadBps": 1, "BlkioDeviceWriteBps": 1, "BlkioDeviceReadIOps": 1, "BlkioDeviceWriteIOps": 1, "CpuPeriod": 1, "CpuQuota": 1, "CpuRealtimePeriod": 1, "CpuRealtimeRuntime": 1, "CpusetCpus": 1, "CpusetMems": 1, "Devices": 1, "DeviceCgroupRules": 1, "DeviceRequests": 1, "KernelMemoryTCP": 1, "MemoryReservation": 1, "MemorySwap": 1, "MemorySwappiness": 1, "NanoCpus": 1, "OomKillDisable": 1, "Init": 1, "PidsLimit": 1, "Ulimits": 1, "CpuCount": 1, "CpuPercent": 1, "IOMaximumIOps": 1, "IOMaximumBandwidth": 1 }, key)));
export type Resources = typeof Resources.infer;

export const Limit = type({ NanoCPUs: type("number.integer"), MemoryBytes: type("number.integer"), Pids: "number.integer = 0" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NanoCPUs": 1, "MemoryBytes": 1, "Pids": 1 }, key)));
export type Limit = typeof Limit.infer;

export const GenericResources = type({ NamedResourceSpec: type({ Kind: type("string"), Value: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Kind": 1, "Value": 1 }, key))), DiscreteResourceSpec: type({ Kind: type("string"), Value: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Kind": 1, "Value": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NamedResourceSpec": 1, "DiscreteResourceSpec": 1 }, key))).array();
export type GenericResources = typeof GenericResources.infer;

export const ResourceObject = type({ NanoCPUs: type("number.integer"), MemoryBytes: type("number.integer"), GenericResources: GenericResources }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NanoCPUs": 1, "MemoryBytes": 1, "GenericResources": 1 }, key)));
export type ResourceObject = typeof ResourceObject.infer;

export const HealthConfig = type({ Test: type("string").array(), Interval: type("number.integer"), Timeout: type("number.integer"), Retries: type("number.integer"), StartPeriod: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Test": 1, "Interval": 1, "Timeout": 1, "Retries": 1, "StartPeriod": 1 }, key)));
export type HealthConfig = typeof HealthConfig.infer;

export const HealthcheckResult = type({ Start: type("string.date"), End: type("string"), ExitCode: type("number.integer"), Output: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Start": 1, "End": 1, "ExitCode": 1, "Output": 1 }, key))).or(type("null"));
export type HealthcheckResult = typeof HealthcheckResult.infer;

export const Health = type({ Status: type.enumerated("none", "starting", "healthy", "unhealthy"), FailingStreak: type("number.integer"), Log: HealthcheckResult.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Status": 1, "FailingStreak": 1, "Log": 1 }, key))).or(type("null"));
export type Health = typeof Health.infer;

export const PortBinding = type({ HostIp: type("string"), HostPort: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "HostIp": 1, "HostPort": 1 }, key)));
...
export const FilesystemChange = type({ Path: type("string"), Kind: ChangeType }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Path": 1, "Kind": 1 }, key)));
export type FilesystemChange = typeof FilesystemChange.infer;

export const ImageInspect = type({ Id: type("string"), RepoTags: type("string").array(), RepoDigests: type("string").array(), Parent: type("string"), Comment: type("string"), Created: type("string"), Container: type("string"), ContainerConfig: ContainerConfig, DockerVersion: type("string"), Author: type("string"), Config: ContainerConfig, Architecture: type("string"), Variant: type("string").or(type("null")), Os: type("string"), OsVersion: type("string").or(type("null")), Size: type("number.integer"), VirtualSize: type("number.integer"), GraphDriver: GraphDriverData, RootFS: type({ Type: type("string"), "Layers?": type("string").array() }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1, "Layers": 1 }, key))), Metadata: type({ LastTagTime: type("string").or(type("null")) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "LastTagTime": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "RepoTags": 1, "RepoDigests": 1, "Parent": 1, "Comment": 1, "Created": 1, "Container": 1, "ContainerConfig": 1, "DockerVersion": 1, "Author": 1, "Config": 1, "Architecture": 1, "Variant": 1, "Os": 1, "OsVersion": 1, "Size": 1, "VirtualSize": 1, "GraphDriver": 1, "RootFS": 1, "Metadata": 1 }, key)));
export type ImageInspect = typeof ImageInspect.infer;

export const ImageSummary = type({ Id: type("string"), ParentId: type("string"), RepoTags: type("string").array(), RepoDigests: type("string").array(), Created: type("number.integer"), Size: type("number.integer"), SharedSize: type("number.integer"), "VirtualSize?": type("number.integer"), Labels: type({ "[string]": type("string") }), Containers: type("number.integer") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "ParentId": 1, "RepoTags": 1, "RepoDigests": 1, "Created": 1, "Size": 1, "SharedSize": 1, "VirtualSize": 1, "Labels": 1, "Containers": 1 }, key)));
export type ImageSummary = typeof ImageSummary.infer;

export const AuthConfig = type({ username: type("string"), password: type("string"), email: type("string"), serveraddress: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "username": 1, "password": 1, "email": 1, "serveraddress": 1 }, key)));
export type AuthConfig = typeof AuthConfig.infer;

export const ProcessConfig = type({ privileged: type("boolean"), user: type("string"), tty: type("boolean"), entrypoint: type("string"), arguments: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "privileged": 1, "user": 1, "tty": 1, "entrypoint": 1, "arguments": 1 }, key)));
export type ProcessConfig = typeof ProcessConfig.infer;

export const ObjectVersion = type({ Index: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Index": 1 }, key)));
...
export const ClusterVolumeSpec = type({ Group: type("string"), AccessMode: type({ Scope: type.enumerated("single", "multi"), Sharing: type.enumerated("none", "readonly", "onewriter", "all"), MountVolume: type({  }).partial().narrow((data) => Object.keys(data).every((key) => false)), Secrets: type({ Key: type("string"), Secret: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Key": 1, "Secret": 1 }, key))).array(), AccessibilityRequirements: type({ Requisite: Topology.array(), Preferred: Topology.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Requisite": 1, "Preferred": 1 }, key))), CapacityRange: type({ RequiredBytes: type("number.integer"), LimitBytes: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "RequiredBytes": 1, "LimitBytes": 1 }, key))), Availability: type.enumerated("active", "pause", "drain") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Scope": 1, "Sharing": 1, "MountVolume": 1, "Secrets": 1, "AccessibilityRequirements": 1, "CapacityRange": 1, "Availability": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Group": 1, "AccessMode": 1 }, key)));
export type ClusterVolumeSpec = typeof ClusterVolumeSpec.infer;

export const ClusterVolume = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Spec: ClusterVolumeSpec, Info: type({ CapacityBytes: type("number.integer"), VolumeContext: type({ "[string]": type("string") }), VolumeID: type("string"), AccessibleTopology: Topology.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "CapacityBytes": 1, "VolumeContext": 1, "VolumeID": 1, "AccessibleTopology": 1 }, key))), PublishStatus: type({ NodeID: type("string"), State: type.enumerated("pending-publish", "published", "pending-node-unpublish", "pending-controller-unpublish"), PublishContext: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NodeID": 1, "State": 1, "PublishContext": 1 }, key))).array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Info": 1, "PublishStatus": 1 }, key)));
export type ClusterVolume = typeof ClusterVolume.infer;

export const Volume = type({ Name: type("string"), Driver: type("string"), Mountpoint: type("string"), "CreatedAt?": type("string"), "Status?": type({ "[string]": type({  }).partial().narrow((data) => Object.keys(data).every((key) => false)) }), Labels: type({ "[string]": type("string") }), Scope: type.enumerated("local", "global"), "ClusterVolume?": ClusterVolume, Options: type({ "[string]": type("string") }), "UsageData?": type({ Size: "number.integer = -1", RefCount: "number.integer = -1" }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Size": 1, "RefCount": 1 }, key))).or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Driver": 1, "Mountpoint": 1, "CreatedAt": 1, "Status": 1, "Labels": 1, "Scope": 1, "ClusterVolume": 1, "Options": 1, "UsageData": 1 }, key)));
export type Volume = typeof Volume.infer;

export const VolumeCreateOptions = type({ Name: type("string"), Driver: "string = \"local\"", DriverOpts: type({ "[string]": type("string") }), Labels: type({ "[string]": type("string") }), ClusterVolumeSpec: ClusterVolumeSpec }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Driver": 1, "DriverOpts": 1, "Labels": 1, "ClusterVolumeSpec": 1 }, key)));
export type VolumeCreateOptions = typeof VolumeCreateOptions.infer;

export const VolumeListResponse = type({ Volumes: Volume.array(), Warnings: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Volumes": 1, "Warnings": 1 }, key)));
export type VolumeListResponse = typeof VolumeListResponse.infer;

export const IPAMConfig = type({ Subnet: type("string"), IPRange: type("string"), Gateway: type("string"), AuxiliaryAddresses: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Subnet": 1, "IPRange": 1, "Gateway": 1, "AuxiliaryAddresses": 1 }, key)));
export type IPAMConfig = typeof IPAMConfig.infer;

export const IPAM = type({ Driver: "string = \"default\"", Config: IPAMConfig.array(), Options: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Driver": 1, "Config": 1, "Options": 1 }, key)));
export type IPAM = typeof IPAM.infer;

export const NetworkContainer = type({ Name: type("string"), EndpointID: type("string"), MacAddress: type("string"), IPv4Address: type("string"), IPv6Address: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "EndpointID": 1, "MacAddress": 1, "IPv4Address": 1, "IPv6Address": 1 }, key)));
export type NetworkContainer = typeof NetworkContainer.infer;

export const Network = type({ Name: type("string"), Id: type("string"), Created: type("string"), Scope: type("string"), Driver: type("string"), EnableIPv6: type("boolean"), IPAM: IPAM, Internal: type("boolean"), Attachable: type("boolean"), Ingress: type("boolean"), Containers: type({ "[string]": NetworkContainer }), Options: type({ "[string]": type("string") }), Labels: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Id": 1, "Created": 1, "Scope": 1, "Driver": 1, "EnableIPv6": 1, "IPAM": 1, "Internal": 1, "Attachable": 1, "Ingress": 1, "Containers": 1, "Options": 1, "Labels": 1 }, key)));
export type Network = typeof Network.infer;

export const ErrorDetail = type({ code: type("number.integer"), message: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "code": 1, "message": 1 }, key)));
export type ErrorDetail = typeof ErrorDetail.infer;

export const ProgressDetail = type({ current: type("number.integer"), total: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "current": 1, "total": 1 }, key)));
export type ProgressDetail = typeof ProgressDetail.infer;

export const ImageID = type({ ID: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1 }, key)));
export type ImageID = typeof ImageID.infer;

export const BuildInfo = type({ id: type("string"), stream: type("string"), error: type("string"), errorDetail: ErrorDetail, status: type("string"), progress: type("string"), progressDetail: ProgressDetail, aux: ImageID }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1, "stream": 1, "error": 1, "errorDetail": 1, "status": 1, "progress": 1, "progressDetail": 1, "aux": 1 }, key)));
export type BuildInfo = typeof BuildInfo.infer;

export const BuildCache = type({ ID: type("string"), Parent: type("string").or(type("null")), Parents: type("string").array().or(type("null")), Type: type.enumerated("internal", "frontend", "source.local", "source.git.checkout", "exec.cachemount", "regular"), Description: type("string"), InUse: type("boolean"), Shared: type("boolean"), Size: type("number.integer"), CreatedAt: type("string"), LastUsedAt: type("string").or(type("null")), UsageCount: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Parent": 1, "Parents": 1, "Type": 1, "Description": 1, "InUse": 1, "Shared": 1, "Size": 1, "CreatedAt": 1, "LastUsedAt": 1, "UsageCount": 1 }, key)));
export type BuildCache = typeof BuildCache.infer;

export const CreateImageInfo = type({ id: type("string"), error: type("string"), errorDetail: ErrorDetail, status: type("string"), progress: type("string"), progressDetail: ProgressDetail }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1, "error": 1, "errorDetail": 1, "status": 1, "progress": 1, "progressDetail": 1 }, key)));
export type CreateImageInfo = typeof CreateImageInfo.infer;

export const PushImageInfo = type({ error: type("string"), status: type("string"), progress: type("string"), progressDetail: ProgressDetail }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "error": 1, "status": 1, "progress": 1, "progressDetail": 1 }, key)));
export type PushImageInfo = typeof PushImageInfo.infer;

export const ErrorResponse = type({ message: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "message": 1 }, key)));
export type ErrorResponse = typeof ErrorResponse.infer;

export const IdResponse = type({ Id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1 }, key)));
export type IdResponse = typeof IdResponse.infer;

export const PluginMount = type({ Name: type("string"), Description: type("string"), Settable: type("string").array(), Source: type("string"), Destination: type("string"), Type: type("string"), Options: type("string").array() }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Source": 1, "Destination": 1, "Type": 1, "Options": 1 }, key)));
export type PluginMount = typeof PluginMount.infer;

export const PluginDevice = type({ Name: type("string"), Description: type("string"), Settable: type("string").array(), Path: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Path": 1 }, key)));
export type PluginDevice = typeof PluginDevice.infer;

export const PluginEnv = type({ Name: type("string"), Description: type("string"), Settable: type("string").array(), Value: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Value": 1 }, key)));
export type PluginEnv = typeof PluginEnv.infer;

export const PluginInterfaceType = type({ Prefix: type("string"), Capability: type("string"), Version: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Prefix": 1, "Capability": 1, "Version": 1 }, key)));
export type PluginInterfaceType = typeof PluginInterfaceType.infer;

export const PluginPrivilege = type({ Name: type("string"), Description: type("string"), Value: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Value": 1 }, key)));
export type PluginPrivilege = typeof PluginPrivilege.infer;

export const Plugin = type({ "Id?": type("string"), Name: type("string"), Enabled: type("boolean"), Settings: type({ Mounts: PluginMount.array(), Env: type("string").array(), Args: type("string").array(), Devices: PluginDevice.array() }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Mounts": 1, "Env": 1, "Args": 1, "Devices": 1 }, key))), "PluginReference?": type("string"), Config: type({ "DockerVersion?": type("string"), Description: type("string"), Documentation: type("string"), Interface: type({ Types: PluginInterfaceType.array(), Socket: type("string"), "ProtocolScheme?": type.enumerated("", "moby.plugins.http/v1") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Types": 1, "Socket": 1, "ProtocolScheme": 1 }, key))), Entrypoint: type("string").array(), WorkDir: type("string"), "User?": type({ UID: type("number.integer"), GID: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "UID": 1, "GID": 1 }, key))), Network: type({ Type: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1 }, key))), Linux: type({ Capabilities: type("string").array(), AllowAllDevices: type("boolean"), Devices: PluginDevice.array() }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Capabilities": 1, "AllowAllDevices": 1, "Devices": 1 }, key))), PropagatedMount: type("string"), IpcHost: type("boolean"), PidHost: type("boolean"), Mounts: PluginMount.array(), Env: PluginEnv.array(), Args: type({ Name: type("string"), Description: type("string"), Settable: type("string").array(), Value: type("string").array() }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Value": 1 }, key))), "rootfs?": type({ type: type("string"), diff_ids: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "type": 1, "diff_ids": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "DockerVersion": 1, "Description": 1, "Documentation": 1, "Interface": 1, "Entrypoint": 1, "WorkDir": 1, "User": 1, "Network": 1, "Linux": 1, "PropagatedMount": 1, "IpcHost": 1, "PidHost": 1, "Mounts": 1, "Env": 1, "Args": 1, "rootfs": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Name": 1, "Enabled": 1, "Settings": 1, "PluginReference": 1, "Config": 1 }, key)));
export type Plugin = typeof Plugin.infer;

export const NodeSpec = type({ Name: type("string"), Labels: type({ "[string]": type("string") }), Role: type.enumerated("worker", "manager"), Availability: type.enumerated("active", "pause", "drain") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Role": 1, "Availability": 1 }, key)));
export type NodeSpec = typeof NodeSpec.infer;

export const Platform = type({ Architecture: type("string"), OS: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Architecture": 1, "OS": 1 }, key)));
export type Platform = typeof Platform.infer;

export const EngineDescription = type({ EngineVersion: type("string"), Labels: type({ "[string]": type("string") }), Plugins: type({ Type: type("string"), Name: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1, "Name": 1 }, key))).array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "EngineVersion": 1, "Labels": 1, "Plugins": 1 }, key)));
export type EngineDescription = typeof EngineDescription.infer;

export const TLSInfo = type({ TrustRoot: type("string"), CertIssuerSubject: type("string"), CertIssuerPublicKey: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "TrustRoot": 1, "CertIssuerSubject": 1, "CertIssuerPublicKey": 1 }, key)));
export type TLSInfo = typeof TLSInfo.infer;

export const NodeDescription = type({ Hostname: type("string"), Platform: Platform, Resources: ResourceObject, Engine: EngineDescription, TLSInfo: TLSInfo }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Hostname": 1, "Platform": 1, "Resources": 1, "Engine": 1, "TLSInfo": 1 }, key)));
...
export const NodeStatus = type({ State: NodeState, Message: type("string"), Addr: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "State": 1, "Message": 1, "Addr": 1 }, key)));
...
export const ManagerStatus = type({ Leader: "boolean = false", Reachability: Reachability, Addr: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Leader": 1, "Reachability": 1, "Addr": 1 }, key))).or(type("null"));
export type ManagerStatus = typeof ManagerStatus.infer;

export const Node = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Spec: NodeSpec, Description: NodeDescription, Status: NodeStatus, ManagerStatus: ManagerStatus }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Description": 1, "Status": 1, "ManagerStatus": 1 }, key)));
export type Node = typeof Node.infer;

export const SwarmSpec = type({ Name: type("string"), Labels: type({ "[string]": type("string") }), Orchestration: type({ TaskHistoryRetentionLimit: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "TaskHistoryRetentionLimit": 1 }, key))).or(type("null")), Raft: type({ SnapshotInterval: type("number.integer"), KeepOldSnapshots: type("number.integer"), LogEntriesForSlowFollowers: type("number.integer"), ElectionTick: type("number.integer"), HeartbeatTick: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "SnapshotInterval": 1, "KeepOldSnapshots": 1, "LogEntriesForSlowFollowers": 1, "ElectionTick": 1, "HeartbeatTick": 1 }, key))), Dispatcher: type({ HeartbeatPeriod: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "HeartbeatPeriod": 1 }, key))).or(type("null")), CAConfig: type({ NodeCertExpiry: type("number.integer"), ExternalCAs: type({ Protocol: type("'cfssl'"), URL: type("string"), Options: type({ "[string]": type("string") }), CACert: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Protocol": 1, "URL": 1, "Options": 1, "CACert": 1 }, key))).array(), SigningCACert: type("string"), SigningCAKey: type("string"), ForceRotate: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NodeCertExpiry": 1, "ExternalCAs": 1, "SigningCACert": 1, "SigningCAKey": 1, "ForceRotate": 1 }, key))).or(type("null")), EncryptionConfig: type({ AutoLockManagers: type("boolean") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "AutoLockManagers": 1 }, key))), TaskDefaults: type({ LogDriver: type({ Name: type("string"), Options: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "LogDriver": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Orchestration": 1, "Raft": 1, "Dispatcher": 1, "CAConfig": 1, "EncryptionConfig": 1, "TaskDefaults": 1 }, key)));
export type SwarmSpec = typeof SwarmSpec.infer;

export const ClusterInfo = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Spec: SwarmSpec, TLSInfo: TLSInfo, RootRotationInProgress: type("boolean"), DataPathPort: type("number.integer"), DefaultAddrPool: type("string").array(), SubnetSize: type("number.integer <= 29") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "TLSInfo": 1, "RootRotationInProgress": 1, "DataPathPort": 1, "DefaultAddrPool": 1, "SubnetSize": 1 }, key))).or(type("null"));
export type ClusterInfo = typeof ClusterInfo.infer;

export const JoinTokens = type({ Worker: type("string"), Manager: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Worker": 1, "Manager": 1 }, key)));
export type JoinTokens = typeof JoinTokens.infer;

export const Swarm = ClusterInfo.and(type({ JoinTokens: JoinTokens }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "JoinTokens": 1 }, key))));
export type Swarm = typeof Swarm.infer;

export const NetworkAttachmentConfig = type({ Target: type("string"), Aliases: type("string").array(), DriverOpts: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Target": 1, "Aliases": 1, "DriverOpts": 1 }, key)));
export type NetworkAttachmentConfig = typeof NetworkAttachmentConfig.infer;

export const TaskSpec = type({ PluginSpec: type({ Name: type("string"), Remote: type("string"), Disabled: type("boolean"), PluginPrivilege: PluginPrivilege.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Remote": 1, "Disabled": 1, "PluginPrivilege": 1 }, key))), ContainerSpec: type({ Image: type("string"), Labels: type({ "[string]": type("string") }), Command: type("string").array(), Args: type("string").array(), Hostname: type("string"), Env: type("string").array(), Dir: type("string"), User: type("string"), Groups: type("string").array(), Privileges: type({ CredentialSpec: type({ Config: type("string"), File: type("string"), Registry: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Config": 1, "File": 1, "Registry": 1 }, key))), SELinuxContext: type({ Disable: type("boolean"), User: type("string"), Role: type("string"), Type: type("string"), Level: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Disable": 1, "User": 1, "Role": 1, "Type": 1, "Level": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "CredentialSpec": 1, "SELinuxContext": 1 }, key))), TTY: type("boolean"), OpenStdin: type("boolean"), ReadOnly: type("boolean"), Mounts: Mount.array(), StopSignal: type("string"), StopGracePeriod: type("number.integer"), HealthCheck: HealthConfig, Hosts: type("string").array(), DNSConfig: type({ Nameservers: type("string").array(), Search: type("string").array(), Options: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Nameservers": 1, "Search": 1, "Options": 1 }, key))), Secrets: type({ File: type({ Name: type("string"), UID: type("string"), GID: type("string"), Mode: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "UID": 1, "GID": 1, "Mode": 1 }, key))), SecretID: type("string"), SecretName: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "File": 1, "SecretID": 1, "SecretName": 1 }, key))).array(), Configs: type({ File: type({ Name: type("string"), UID: type("string"), GID: type("string"), Mode: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "UID": 1, "GID": 1, "Mode": 1 }, key))), Runtime: type({  }).partial().narrow((data) => Object.keys(data).every((key) => false)), ConfigID: type("string"), ConfigName: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "File": 1, "Runtime": 1, "ConfigID": 1, "ConfigName": 1 }, key))).array(), Isolation: type.enumerated("default", "process", "hyperv"), Init: type("boolean").or(type("null")), Sysctls: type({ "[string]": type("string") }), CapabilityAdd: type("string").array(), CapabilityDrop: type("string").array(), Ulimits: type({ Name: type("string"), Soft: type("number.integer"), Hard: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Soft": 1, "Hard": 1 }, key))).array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Image": 1, "Labels": 1, "Command": 1, "Args": 1, "Hostname": 1, "Env": 1, "Dir": 1, "User": 1, "Groups": 1, "Privileges": 1, "TTY": 1, "OpenStdin": 1, "ReadOnly": 1, "Mounts": 1, "StopSignal": 1, "StopGracePeriod": 1, "HealthCheck": 1, "Hosts": 1, "DNSConfig": 1, "Secrets": 1, "Configs": 1, "Isolation": 1, "Init": 1, "Sysctls": 1, "CapabilityAdd": 1, "CapabilityDrop": 1, "Ulimits": 1 }, key))), NetworkAttachmentSpec: type({ ContainerID: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ContainerID": 1 }, key))), Resources: type({ Limits: Limit, Reservations: ResourceObject }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Limits": 1, "Reservations": 1 }, key))), RestartPolicy: type({ Condition: type.enumerated("none", "on-failure", "any"), Delay: type("number.integer"), MaxAttempts: "number.integer = 0", Window: "number.integer = 0" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Condition": 1, "Delay": 1, "MaxAttempts": 1, "Window": 1 }, key))), Placement: type({ Constraints: type("string").array(), Preferences: type({ Spread: type({ SpreadDescriptor: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "SpreadDescriptor": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Spread": 1 }, key))).array(), MaxReplicas: "number.integer = 0", Platforms: Platform.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Constraints": 1, "Preferences": 1, "MaxReplicas": 1, "Platforms": 1 }, key))), ForceUpdate: type("number.integer"), Runtime: type("string"), Networks: NetworkAttachmentConfig.array(), LogDriver: type({ Name: type("string"), Options: type({ "[string]": type("string") }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "PluginSpec": 1, "ContainerSpec": 1, "NetworkAttachmentSpec": 1, "Resources": 1, "RestartPolicy": 1, "Placement": 1, "ForceUpdate": 1, "Runtime": 1, "Networks": 1, "LogDriver": 1 }, key)));
...
export const Task = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Name: type("string"), Labels: type({ "[string]": type("string") }), Spec: TaskSpec, ServiceID: type("string"), Slot: type("number.integer"), NodeID: type("string"), AssignedGenericResources: GenericResources, Status: type({ Timestamp: type("string"), State: TaskState, Message: type("string"), Err: type("string"), ContainerStatus: type({ ContainerID: type("string"), PID: type("number.integer"), ExitCode: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ContainerID": 1, "PID": 1, "ExitCode": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Timestamp": 1, "State": 1, "Message": 1, "Err": 1, "ContainerStatus": 1 }, key))), DesiredState: TaskState, JobIteration: ObjectVersion }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Name": 1, "Labels": 1, "Spec": 1, "ServiceID": 1, "Slot": 1, "NodeID": 1, "AssignedGenericResources": 1, "Status": 1, "DesiredState": 1, "JobIteration": 1 }, key)));
export type Task = typeof Task.infer;

export const EndpointPortConfig = type({ Name: type("string"), Protocol: type.enumerated("tcp", "udp", "sctp"), TargetPort: type("number.integer"), PublishedPort: type("number.integer"), PublishMode: type.enumerated("ingress", "host") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Protocol": 1, "TargetPort": 1, "PublishedPort": 1, "PublishMode": 1 }, key)));
export type EndpointPortConfig = typeof EndpointPortConfig.infer;

export const EndpointSpec = type({ Mode: type.enumerated("vip", "dnsrr"), Ports: EndpointPortConfig.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Mode": 1, "Ports": 1 }, key)));
export type EndpointSpec = typeof EndpointSpec.infer;

export const ServiceSpec = type({ Name: type("string"), Labels: type({ "[string]": type("string") }), TaskTemplate: TaskSpec, Mode: type({ Replicated: type({ Replicas: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Replicas": 1 }, key))), Global: type({  }).partial().narrow((data) => Object.keys(data).every((key) => false)), ReplicatedJob: type({ MaxConcurrent: "number.integer = 1", TotalCompletions: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "MaxConcurrent": 1, "TotalCompletions": 1 }, key))), GlobalJob: type({  }).partial().narrow((data) => Object.keys(data).every((key) => false)) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Replicated": 1, "Global": 1, "ReplicatedJob": 1, "GlobalJob": 1 }, key))), UpdateConfig: type({ Parallelism: type("number.integer"), Delay: type("number.integer"), FailureAction: type.enumerated("continue", "pause", "rollback"), Monitor: type("number.integer"), MaxFailureRatio: type("number"), Order: type.enumerated("stop-first", "start-first") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Parallelism": 1, "Delay": 1, "FailureAction": 1, "Monitor": 1, "MaxFailureRatio": 1, "Order": 1 }, key))), RollbackConfig: type({ Parallelism: type("number.integer"), Delay: type("number.integer"), FailureAction: type.enumerated("continue", "pause"), Monitor: type("number.integer"), MaxFailureRatio: type("number"), Order: type.enumerated("stop-first", "start-first") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Parallelism": 1, "Delay": 1, "FailureAction": 1, "Monitor": 1, "MaxFailureRatio": 1, "Order": 1 }, key))), Networks: NetworkAttachmentConfig.array(), EndpointSpec: EndpointSpec }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "TaskTemplate": 1, "Mode": 1, "UpdateConfig": 1, "RollbackConfig": 1, "Networks": 1, "EndpointSpec": 1 }, key)));
export type ServiceSpec = typeof ServiceSpec.infer;

export const Service = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Spec: ServiceSpec, Endpoint: type({ Spec: EndpointSpec, Ports: EndpointPortConfig.array(), VirtualIPs: type({ NetworkID: type("string"), Addr: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NetworkID": 1, "Addr": 1 }, key))).array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Spec": 1, "Ports": 1, "VirtualIPs": 1 }, key))), UpdateStatus: type({ State: type.enumerated("updating", "paused", "completed"), StartedAt: type("string"), CompletedAt: type("string"), Message: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "State": 1, "StartedAt": 1, "CompletedAt": 1, "Message": 1 }, key))), ServiceStatus: type({ RunningTasks: type("number.integer"), DesiredTasks: type("number.integer"), CompletedTasks: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "RunningTasks": 1, "DesiredTasks": 1, "CompletedTasks": 1 }, key))), JobStatus: type({ JobIteration: ObjectVersion, LastExecution: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "JobIteration": 1, "LastExecution": 1 }, key))) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Endpoint": 1, "UpdateStatus": 1, "ServiceStatus": 1, "JobStatus": 1 }, key)));
export type Service = typeof Service.infer;

export const ImageDeleteResponseItem = type({ Untagged: type("string"), Deleted: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Untagged": 1, "Deleted": 1 }, key)));
export type ImageDeleteResponseItem = typeof ImageDeleteResponseItem.infer;

export const ServiceUpdateResponse = type({ Warnings: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Warnings": 1 }, key)));
export type ServiceUpdateResponse = typeof ServiceUpdateResponse.infer;

export const ContainerSummary = type({ Id: type("string"), Names: type("string").array(), Image: type("string"), ImageID: type("string"), Command: type("string"), Created: type("number.integer"), Ports: Port.array(), SizeRw: type("number.integer"), SizeRootFs: type("number.integer"), Labels: type({ "[string]": type("string") }), State: type("string"), Status: type("string"), HostConfig: type({ NetworkMode: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NetworkMode": 1 }, key))), NetworkSettings: type({ Networks: type({ "[string]": EndpointSettings }) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Networks": 1 }, key))), Mounts: MountPoint.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Names": 1, "Image": 1, "ImageID": 1, "Command": 1, "Created": 1, "Ports": 1, "SizeRw": 1, "SizeRootFs": 1, "Labels": 1, "State": 1, "Status": 1, "HostConfig": 1, "NetworkSettings": 1, "Mounts": 1 }, key)));
export type ContainerSummary = typeof ContainerSummary.infer;

export const Driver = type({ Name: type("string"), "Options?": type({ "[string]": type("string") }) }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key)));
export type Driver = typeof Driver.infer;

export const SecretSpec = type({ Name: type("string"), Labels: type({ "[string]": type("string") }), Data: type("string"), Driver: Driver, Templating: Driver }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Data": 1, "Driver": 1, "Templating": 1 }, key)));
export type SecretSpec = typeof SecretSpec.infer;

export const Secret = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Spec: SecretSpec }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1 }, key)));
export type Secret = typeof Secret.infer;

export const ConfigSpec = type({ Name: type("string"), Labels: type({ "[string]": type("string") }), Data: type("string"), Templating: Driver }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Data": 1, "Templating": 1 }, key)));
export type ConfigSpec = typeof ConfigSpec.infer;

export const Config = type({ ID: type("string"), Version: ObjectVersion, CreatedAt: type("string"), UpdatedAt: type("string"), Spec: ConfigSpec }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1 }, key)));
export type Config = typeof Config.infer;

export const ContainerState = type({ Status: type.enumerated("created", "running", "paused", "restarting", "removing", "exited", "dead"), Running: type("boolean"), Paused: type("boolean"), Restarting: type("boolean"), OOMKilled: type("boolean"), Dead: type("boolean"), Pid: type("number.integer"), ExitCode: type("number.integer"), Error: type("string"), StartedAt: type("string"), FinishedAt: type("string"), Health: Health }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Status": 1, "Running": 1, "Paused": 1, "Restarting": 1, "OOMKilled": 1, "Dead": 1, "Pid": 1, "ExitCode": 1, "Error": 1, "StartedAt": 1, "FinishedAt": 1, "Health": 1 }, key))).or(type("null"));
export type ContainerState = typeof ContainerState.infer;

export const ContainerCreateResponse = type({ Id: type("string"), Warnings: type("string").array() }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Warnings": 1 }, key)));
export type ContainerCreateResponse = typeof ContainerCreateResponse.infer;

export const ContainerWaitExitError = type({ Message: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Message": 1 }, key)));
export type ContainerWaitExitError = typeof ContainerWaitExitError.infer;

export const ContainerWaitResponse = type({ StatusCode: type("number.integer"), "Error?": ContainerWaitExitError }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "StatusCode": 1, "Error": 1 }, key)));
export type ContainerWaitResponse = typeof ContainerWaitResponse.infer;

export const SystemVersion = type({ Platform: type({ Name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1 }, key))), Components: type({ Name: type("string"), Version: type("string"), "Details?": type({  }).partial().narrow((data) => Object.keys(data).every((key) => false)).or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Version": 1, "Details": 1 }, key))).array(), Version: type("string"), ApiVersion: type("string"), MinAPIVersion: type("string"), GitCommit: type("string"), GoVersion: type("string"), Os: type("string"), Arch: type("string"), KernelVersion: type("string"), Experimental: type("boolean"), BuildTime: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Platform": 1, "Components": 1, "Version": 1, "ApiVersion": 1, "MinAPIVersion": 1, "GitCommit": 1, "GoVersion": 1, "Os": 1, "Arch": 1, "KernelVersion": 1, "Experimental": 1, "BuildTime": 1 }, key)));
export type SystemVersion = typeof SystemVersion.infer;

export const PluginsInfo = type({ Volume: type("string").array(), Network: type("string").array(), Authorization: type("string").array(), Log: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Volume": 1, "Network": 1, "Authorization": 1, "Log": 1 }, key)));
export type PluginsInfo = typeof PluginsInfo.infer;

export const IndexInfo = type({ Name: type("string"), Mirrors: type("string").array(), Secure: type("boolean"), Official: type("boolean") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Mirrors": 1, "Secure": 1, "Official": 1 }, key))).or(type("null"));
export type IndexInfo = typeof IndexInfo.infer;

export const RegistryServiceConfig = type({ AllowNondistributableArtifactsCIDRs: type("string").array(), AllowNondistributableArtifactsHostnames: type("string").array(), InsecureRegistryCIDRs: type("string").array(), IndexConfigs: type({ "[string]": IndexInfo }), Mirrors: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "AllowNondistributableArtifactsCIDRs": 1, "AllowNondistributableArtifactsHostnames": 1, "InsecureRegistryCIDRs": 1, "IndexConfigs": 1, "Mirrors": 1 }, key))).or(type("null"));
export type RegistryServiceConfig = typeof RegistryServiceConfig.infer;

export const Runtime = type({ path: type("string"), runtimeArgs: type("string").array().or(type("null")) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "path": 1, "runtimeArgs": 1 }, key)));
...
export const get_ContainerList = {
  ...
  parameters: { query: type({ all: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), limit: type("string.integer.parse"), size: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "all": 1, "limit": 1, "size": 1, "filters": 1 }, key))).optional() },
...
export const post_ContainerCreate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ name: type("string").narrow((s) => typeof s === "string" && new RegExp("^/?[a-zA-Z0-9][a-zA-Z0-9_.-]+$").test(s)), platform: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1, "platform": 1 }, key))).optional(), body: ContainerConfig.and(type({ HostConfig: HostConfig, NetworkingConfig: NetworkingConfig }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "HostConfig": 1, "NetworkingConfig": 1 }, key)))) },
...
export const get_ContainerTop = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ ps_args: "string = \"-ef\"" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ps_args": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
  responses: { 200: type({ Titles: type("string").array(), Processes: type("string").array().array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Titles": 1, "Processes": 1 }, key))).or(type({ Titles: type("string").array(), Processes: type("string").array().array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Titles": 1, "Processes": 1 }, key)))), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const get_ContainerLogs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ follow: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stdout: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stderr: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), since: type("string.integer.parse"), until: type("string.integer.parse"), timestamps: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), tail: "string = \"all\"" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "follow": 1, "stdout": 1, "stderr": 1, "since": 1, "until": 1, "timestamps": 1, "tail": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const get_ContainerChanges = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const get_ContainerStats = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ stream: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), "one-shot": type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "stream": 1, "one-shot": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_ContainerResize = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ h: type("string.integer.parse"), w: type("string.integer.parse") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "h": 1, "w": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
  responses: { 200: type("unknown"), 404: ErrorResponse.or(type("unknown")), 500: ErrorResponse },
};
...
export const post_ContainerStart = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ detachKeys: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "detachKeys": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_ContainerStop = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ signal: type("string"), t: type("string.integer.parse") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "signal": 1, "t": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
  responses: { 204: type("unknown"), 304: type("unknown"), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const post_ContainerKill = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ signal: "string = \"SIGKILL\"" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "signal": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_ContainerUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: Resources.and(type({ RestartPolicy: RestartPolicy }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "RestartPolicy": 1 }, key)))) },
  responses: { 200: type({ Warnings: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Warnings": 1 }, key))), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ContainerRename = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
  responses: { 204: type("unknown"), 404: ErrorResponse.or(ErrorResponse), 409: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const post_ContainerAttach = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ detachKeys: type("string"), logs: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stream: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stdin: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stdout: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stderr: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "detachKeys": 1, "logs": 1, "stream": 1, "stdin": 1, "stdout": 1, "stderr": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_ContainerWait = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ condition: type.enumerated("not-running", "next-exit", "removed") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "condition": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const delete_ContainerDelete = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ v: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), force: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), link: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "v": 1, "force": 1, "link": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const get_ContainerArchive = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ path: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "path": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const put_PutContainerArchive = {
  ...
  responseFormat: type("'json'"),
  parameters: { query: type({ path: type("string"), "noOverwriteDirNonDir?": type("string"), "copyUIDGID?": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "path": 1, "noOverwriteDirNonDir": 1, "copyUIDGID": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: type.instanceOf(Blob) },
...
export const head_ContainerArchiveInfo = {
  ...
  responseHeaders: { 200: type({ "X-Docker-Container-Path-Stat": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Docker-Container-Path-Stat": 1 }, key))) },
};
...
export const post_ContainerPrune = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))).optional() },
  responses: { 200: type({ ContainersDeleted: type("string").array(), SpaceReclaimed: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ContainersDeleted": 1, "SpaceReclaimed": 1 }, key))), 500: ErrorResponse },
};
...
export const get_ImageList = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ all: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), filters: type("string"), "shared-size": type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), digests: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "all": 1, "filters": 1, "shared-size": 1, "digests": 1 }, key))).optional() },
...
export const post_BuildPrune = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ "keep-storage": type("string.integer.parse"), all: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "keep-storage": 1, "all": 1, "filters": 1 }, key))).optional() },
  responses: { 200: type({ CachesDeleted: type("string").array(), SpaceReclaimed: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "CachesDeleted": 1, "SpaceReclaimed": 1 }, key))), 500: ErrorResponse },
};
...
export const post_ImageCreate = {
  ...
  responseFormat: type("'json'"),
  parameters: { query: type({ fromImage: type("string"), fromSrc: type("string"), repo: type("string"), tag: type("string"), message: type("string"), changes: type("string").array(), platform: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "fromImage": 1, "fromSrc": 1, "repo": 1, "tag": 1, "message": 1, "changes": 1, "platform": 1 }, key))).optional(), header: type({ "X-Registry-Auth": type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))).optional(), body: type("string") },
...
export const get_ImageInspect = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
...
export const get_ImageHistory = {
  ...
  responseFormat: type("'json'"),
  parameters: { path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
  responses: { 200: type({ Id: type("string"), Created: type("number.integer"), CreatedBy: type("string"), Tags: type("string").array(), Size: type("number.integer"), Comment: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Created": 1, "CreatedBy": 1, "Tags": 1, "Size": 1, "Comment": 1 }, key))).array(), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ImagePush = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ tag: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "tag": 1 }, key))).optional(), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))), header: type({ "X-Registry-Auth": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))) },
...
export const post_ImageTag = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ repo: type("string"), tag: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "repo": 1, "tag": 1 }, key))).optional(), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
...
export const delete_ImageDelete = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ force: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), noprune: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1, "noprune": 1 }, key))).optional(), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
...
export const get_ImageSearch = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ term: type("string"), "limit?": type("string.integer.parse"), "filters?": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "term": 1, "limit": 1, "filters": 1 }, key))) },
  responses: { 200: type({ description: type("string"), is_official: type("boolean"), is_automated: type("boolean"), name: type("string"), star_count: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "description": 1, "is_official": 1, "is_automated": 1, "name": 1, "star_count": 1 }, key))).array(), 500: ErrorResponse },
};
...
export const post_ImagePrune = {
  ...
  responseFormat: type("'json'"),
  parameters: { query: type({ filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))).optional() },
  responses: { 200: type({ ImagesDeleted: ImageDeleteResponseItem.array(), SpaceReclaimed: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ImagesDeleted": 1, "SpaceReclaimed": 1 }, key))), 500: ErrorResponse },
};
...
export const post_SystemAuth = {
  ...
  responses: { 200: type({ Status: type("string"), "IdentityToken?": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Status": 1, "IdentityToken": 1 }, key))), 204: type("unknown"), 401: ErrorResponse, 500: ErrorResponse },
};
...
export const get_SystemPing = {
  ...
  responseHeaders: { 200: type({ Swarm: type.enumerated("inactive", "pending", "error", "locked", "active/worker", "active/manager"), "Docker-Experimental": type("boolean"), "Cache-Control": "string = \"no-cache, no-store, must-revalidate\"", Pragma: "string = \"no-cache\"", "API-Version": type("string"), "Builder-Version": "string = \"2\"" }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Swarm": 1, "Docker-Experimental": 1, "Cache-Control": 1, "Pragma": 1, "API-Version": 1, "Builder-Version": 1 }, key))), 500: type({ "Cache-Control": "string = \"no-cache, no-store, must-revalidate\"", Pragma: "string = \"no-cache\"" }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Cache-Control": 1, "Pragma": 1 }, key))) },
};
...
export const head_SystemPingHead = {
  ...
  parameters: type("never"),
  responses: { 200: type("string"), 500: ErrorResponse },
  responseHeaders: { 200: type({ Swarm: type.enumerated("inactive", "pending", "error", "locked", "active/worker", "active/manager"), "Docker-Experimental": type("boolean"), "Cache-Control": "string = \"no-cache, no-store, must-revalidate\"", Pragma: "string = \"no-cache\"", "API-Version": type("string"), "Builder-Version": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Swarm": 1, "Docker-Experimental": 1, "Cache-Control": 1, "Pragma": 1, "API-Version": 1, "Builder-Version": 1 }, key))) },
};
...
export const post_ImageCommit = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ container: type("string"), repo: type("string"), tag: type("string"), comment: type("string"), author: type("string"), pause: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), changes: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "container": 1, "repo": 1, "tag": 1, "comment": 1, "author": 1, "pause": 1, "changes": 1 }, key))).optional(), body: ContainerConfig },
...
export const get_SystemEvents = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ since: type("string"), until: type("string"), filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "since": 1, "until": 1, "filters": 1 }, key))).optional() },
...
export const get_SystemDataUsage = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ type: type.enumerated("container", "image", "volume", "build-cache").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "type": 1 }, key))).optional() },
  responses: { 200: type({ LayersSize: type("number.integer"), Images: ImageSummary.array(), Containers: ContainerSummary.array(), Volumes: Volume.array(), BuildCache: BuildCache.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "LayersSize": 1, "Images": 1, "Containers": 1, "Volumes": 1, "BuildCache": 1 }, key))).or(type({ LayersSize: type("number.integer"), Images: ImageSummary.array(), Containers: ContainerSummary.array(), Volumes: Volume.array(), BuildCache: BuildCache.array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "LayersSize": 1, "Images": 1, "Containers": 1, "Volumes": 1, "BuildCache": 1 }, key)))), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const get_ImageGetAll = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ names: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "names": 1 }, key))).optional() },
  responses: { 200: type("unknown"), 500: type("unknown") },
};
...
export const post_ImageLoad = {
  ...
  requestFormat: type("'text'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ quiet: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "quiet": 1 }, key))).optional() },
...
export const post_ContainerExec = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: type({ AttachStdin: type("boolean"), AttachStdout: type("boolean"), AttachStderr: type("boolean"), ConsoleSize: type("number.integer >= 0").array().or(type("null")), DetachKeys: type("string"), Tty: type("boolean"), Env: type("string").array(), Cmd: type("string").array(), Privileged: "boolean = false", User: type("string"), WorkingDir: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "AttachStdin": 1, "AttachStdout": 1, "AttachStderr": 1, "ConsoleSize": 1, "DetachKeys": 1, "Tty": 1, "Env": 1, "Cmd": 1, "Privileged": 1, "User": 1, "WorkingDir": 1 }, key))).optional() },
...
export const post_ExecStart = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: type({ Detach: type("boolean"), Tty: type("boolean"), ConsoleSize: type("number.integer >= 0").array().or(type("null")) }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Detach": 1, "Tty": 1, "ConsoleSize": 1 }, key))).optional() },
...
export const put_VolumeUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ version: type("string.integer.parse") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key))), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))), body: type({ Spec: ClusterVolumeSpec }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Spec": 1 }, key))).optional() },
...
export const delete_VolumeDelete = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ force: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))).optional(), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
  responses: { 204: type("unknown"), 404: ErrorResponse.or(ErrorResponse), 409: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const post_VolumePrune = {
  ...
  responseFormat: type("'json'"),
  parameters: { query: type({ filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))).optional() },
  responses: { 200: type({ VolumesDeleted: type("string").array(), SpaceReclaimed: type("number.integer") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "VolumesDeleted": 1, "SpaceReclaimed": 1 }, key))), 500: ErrorResponse },
};
...
export const get_NetworkInspect = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ verbose: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), scope: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "verbose": 1, "scope": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_NetworkCreate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { body: type({ Name: type("string"), "CheckDuplicate?": type("boolean"), Driver: "string = \"bridge\"", "Internal?": type("boolean"), "Attachable?": type("boolean"), "Ingress?": type("boolean"), "IPAM?": IPAM, "EnableIPv6?": type("boolean"), "Options?": type({ "[string]": type("string") }), "Labels?": type({ "[string]": type("string") }) }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "CheckDuplicate": 1, "Driver": 1, "Internal": 1, "Attachable": 1, "Ingress": 1, "IPAM": 1, "EnableIPv6": 1, "Options": 1, "Labels": 1 }, key))) },
  responses: { 201: type({ Id: type("string"), Warning: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Warning": 1 }, key))), 403: ErrorResponse, 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_NetworkConnect = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: type({ Container: type("string"), EndpointConfig: EndpointSettings }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Container": 1, "EndpointConfig": 1 }, key))).optional() },
...
export const post_NetworkDisconnect = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: type({ Container: type("string"), Force: type("boolean") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "Container": 1, "Force": 1 }, key))).optional() },
  responses: { 200: type("unknown"), 403: ErrorResponse.or(ErrorResponse), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const post_NetworkPrune = {
  ...
  responseFormat: type("'json'"),
  parameters: { query: type({ filters: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))).optional() },
  responses: { 200: type({ NetworksDeleted: type("string").array() }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "NetworksDeleted": 1 }, key))), 500: ErrorResponse },
};
...
export const get_GetPluginPrivileges = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ remote: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "remote": 1 }, key))) },
...
export const post_PluginPull = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ remote: type("string"), "name?": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "remote": 1, "name": 1 }, key))), header: type({ "X-Registry-Auth": type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))).optional(), body: PluginPrivilege.array() },
...
export const post_PluginEnable = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ timeout: type("string.integer.parse") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "timeout": 1 }, key))).optional(), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
  responses: { 200: type("unknown"), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const post_PluginUpgrade = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ remote: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "remote": 1 }, key))), path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))), header: type({ "X-Registry-Auth": type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))).optional(), body: PluginPrivilege.array() },
  responses: { 204: type("unknown"), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const post_PluginCreate = {
  ...
  requestFormat: type("'text'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))) },
...
export const post_PluginSet = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ name: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key))), body: type("string").array() },
  responses: { 204: type("unknown"), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse) },
};
...
export const delete_NodeDelete = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ force: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_NodeUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ version: type("string.integer.parse") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: NodeSpec },
...
export const post_SwarmJoin = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { body: type({ ListenAddr: type("string"), AdvertiseAddr: type("string"), DataPathAddr: type("string"), RemoteAddrs: type("string").array(), JoinToken: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ListenAddr": 1, "AdvertiseAddr": 1, "DataPathAddr": 1, "RemoteAddrs": 1, "JoinToken": 1 }, key))).optional() },
...
export const post_SwarmLeave = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ force: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))).optional() },
...
export const post_SwarmUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ version: type("string.integer.parse"), rotateWorkerToken: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), rotateManagerToken: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), rotateManagerUnlockKey: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1, "rotateWorkerToken": 1, "rotateManagerToken": 1, "rotateManagerUnlockKey": 1 }, key))), body: SwarmSpec },
  responses: { 200: type("unknown"), 400: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse), 503: ErrorResponse.or(ErrorResponse) },
};
...
export const get_SwarmUnlockkey = {
  ...
  responseFormat: type("'json'"),
  parameters: type("never"),
  responses: { 200: type({ UnlockKey: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "UnlockKey": 1 }, key))).or(type({ UnlockKey: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "UnlockKey": 1 }, key)))), 500: ErrorResponse.or(ErrorResponse), 503: ErrorResponse.or(ErrorResponse) },
};
...
export const post_SwarmUnlock = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { body: type({ UnlockKey: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "UnlockKey": 1 }, key))).optional() },
...
export const get_ServiceList = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ filters: type("string"), status: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1, "status": 1 }, key))).optional() },
...
export const post_ServiceCreate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Registry-Auth": type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))).optional(), body: ServiceSpec.and(type({ "[string]": type("unknown") })) },
  responses: { 201: type({ ID: type("string"), Warning: type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Warning": 1 }, key))), 400: ErrorResponse, 403: ErrorResponse, 409: ErrorResponse, 500: ErrorResponse, 503: ErrorResponse },
};
...
export const get_ServiceInspect = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ insertDefaults: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "insertDefaults": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_ServiceUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ version: type("string.integer.parse"), registryAuthFrom: type.enumerated("spec", "previous-spec"), "rollback?": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1, "registryAuthFrom": 1, "rollback": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), header: type({ "X-Registry-Auth": type("string") }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))).optional(), body: ServiceSpec.and(type({ "[string]": type("unknown") })) },
...
export const get_ServiceLogs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ details: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), follow: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stdout: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stderr: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), since: type("string.integer.parse"), timestamps: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), tail: "string = \"all\"" }).partial().narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "details": 1, "follow": 1, "stdout": 1, "stderr": 1, "since": 1, "timestamps": 1, "tail": 1 }, key))).optional(), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))) },
...
export const post_SecretUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ version: type("string.integer.parse") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: SecretSpec },
  responses: { 200: type("unknown"), 400: ErrorResponse.or(ErrorResponse), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse), 503: ErrorResponse.or(ErrorResponse) },
};
...
export const post_ConfigUpdate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ version: type("string.integer.parse") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key))), path: type({ id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key))), body: ConfigSpec },
  responses: { 200: type("unknown"), 400: ErrorResponse.or(ErrorResponse), 404: ErrorResponse.or(ErrorResponse), 500: ErrorResponse.or(ErrorResponse), 503: ErrorResponse.or(ErrorResponse) },
};
