...
export const post_ContainerCreate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ name: type("string").narrow((s): s is string => new RegExp("^/?[a-zA-Z0-9][a-zA-Z0-9_.-]+$").test(s)), platform: type("string") }).partial().optional(), body: ContainerConfig.and(type({ HostConfig: HostConfig, NetworkingConfig: NetworkingConfig }).partial()) },
...
export const get_ContainerLogs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ follow: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stdout: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stderr: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), since: "string.integer.parse = 0", until: "string.integer.parse = 0", timestamps: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), tail: "string = \"all\"" }).partial().optional(), path: type({ id: type("string") }) },
...
export const post_PluginEnable = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ timeout: "string.integer.parse = 0" }).partial().optional(), path: type({ name: type("string") }) },
  responses: { 200: type("unknown"), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const get_ServiceLogs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ details: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), follow: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stdout: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), stderr: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), since: "string.integer.parse = 0", timestamps: type("boolean | string | number").pipe((x) => x === true || x === "true" || x === 1 || x === "1"), tail: "string = \"all\"" }).partial().optional(), path: type({ id: type("string") }) },
