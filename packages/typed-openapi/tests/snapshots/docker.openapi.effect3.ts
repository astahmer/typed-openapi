...
const Union_default_single_prop = S.optionalWith(S.Union(S.Literal("single"), S.Literal("multi")), {
  default: () => "single",
});
const Union_default_none_prop = S.optionalWith(
  S.Union(S.Literal("none"), S.Literal("readonly"), S.Literal("onewriter"), S.Literal("all")),
  { default: () => "none" },
);
const Union_default_active_prop = S.optionalWith(S.Union(S.Literal("active"), S.Literal("pause"), S.Literal("drain")), {
  default: () => "active",
});
const Int_default_neg_1_prop = S.optionalWith(S.Int, { default: () => -1 });
const Union_default_local_prop = S.optionalWith(S.Union(S.Literal("local"), S.Literal("global")), {
  default: () => "local",
});
...
const Union_default_ingress_prop = S.optionalWith(S.Union(S.Literal("ingress"), S.Literal("host")), {
  default: () => "ingress",
});
...
const Union_default_value = S.transform(
  S.UndefinedOr(
    S.Union(
      S.Literal(""),
      S.Literal("inactive"),
...
const Union_default_cgroupfs_prop = S.optionalWith(
  S.Union(S.Literal("cgroupfs"), S.Literal("systemd"), S.Literal("none")),
  { default: () => "cgroupfs" },
);
const Union_default_1_prop = S.optionalWith(S.Union(S.Literal("1"), S.Literal("2")), { default: () => "1" });
const String_default_https_index_docker_io_v1_prop = S.optionalWith(S.String, {
  default: () => "https://index.docker.io/v1/",
});
const String_default_runc_prop = S.optionalWith(S.String, { default: () => "runc" });
const Union_default_default_prop = S.optionalWith(
  S.Union(S.Literal("default"), S.Literal("hyperv"), S.Literal("process")),
  { default: () => "default" },
);
const Union_default_false_prop = S.optionalWith(
  S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, {
...
const Union_default_true_prop = S.optionalWith(
  S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, {
    decode: (x) => x === true || x === "true" || x === 1 || x === "1",
    encode: (a) => a,
  }),
...
const Union_default_notneg_running_prop = S.optionalWith(
  S.Union(S.Literal("not-running"), S.Literal("next-exit"), S.Literal("removed")),
  { default: () => "not-running" },
);
const String_default_Dockerfile_prop = S.optionalWith(S.String, { default: () => "Dockerfile" });
const Union_default_inactive_prop = S.optionalWith(
  S.Union(
    S.Literal("inactive"),
    S.Literal("pending"),
    S.Literal("error"),
    S.Literal("locked"),
    S.Literal("active/worker"),
    S.Literal("active/manager"),
  ),
  { default: () => "inactive" },
);
const String_default_noneg_cache_noneg_store_mustneg_revalida_prop = S.optionalWith(S.String, {
...
const Union_default_spec_prop = S.optionalWith(S.Union(S.Literal("spec"), S.Literal("previous-spec")), {
  default: () => "spec",
});
...
export const Port = S.Struct({
  ...
  PrivatePort: S.Int,
  PublicPort: S.optional(S.Int),
  Type: S.Union(S.Literal("tcp"), S.Literal("udp"), S.Literal("sctp")),
});
export type Port = S.Schema.Type<typeof Port>;

export const MountPoint = S.Struct({
  Type: S.optional(
    S.Union(S.Literal("bind"), S.Literal("volume"), S.Literal("tmpfs"), S.Literal("npipe"), S.Literal("cluster")),
  ),
...
export const ThrottleDevice = S.Struct({
  ...
  Rate: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0))),
});
  ...
  VolumeOptions: S.optional(
    S.Struct({
      ...
      DriverConfig: S.optional(
        S.Struct({ Name: S.optional(S.String), Options: S.optional(S.Record({ key: S.String, value: S.String })) }),
      ),
    }),
  ),
  TmpfsOptions: S.optional(S.Struct({ SizeBytes: S.optional(S.Int), Mode: S.optional(S.Int) })),
});
export type Mount = S.Schema.Type<typeof Mount>;

export const RestartPolicy = S.Struct({
  Name: S.optional(
    S.Union(S.Literal(""), S.Literal("no"), S.Literal("always"), S.Literal("unless-stopped"), S.Literal("on-failure")),
  ),
  MaximumRetryCount: S.optional(S.Int),
});
export type RestartPolicy = S.Schema.Type<typeof RestartPolicy>;

export const Resources = S.Struct({
  CpuShares: S.optional(S.Int),
  Memory: Int_default_0_prop,
  CgroupParent: S.optional(S.String),
  BlkioWeight: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(1000))),
  BlkioWeightDevice: S.optional(
    S.Array(S.Struct({ Path: S.optional(S.String), Weight: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0))) })),
  ),
  ...
  CpuPeriod: S.optional(S.Int),
  CpuQuota: S.optional(S.Int),
  CpuRealtimePeriod: S.optional(S.Int),
  CpuRealtimeRuntime: S.optional(S.Int),
  ...
  KernelMemoryTCP: S.optional(S.Int),
  MemoryReservation: S.optional(S.Int),
  MemorySwap: S.optional(S.Int),
  MemorySwappiness: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(100))),
  NanoCpus: S.optional(S.Int),
  OomKillDisable: S.optional(S.Boolean),
  Init: S.optional(S.NullOr(S.Boolean)),
  PidsLimit: S.optional(S.NullOr(S.Int)),
  Ulimits: S.optional(
    S.Array(S.Struct({ Name: S.optional(S.String), Soft: S.optional(S.Int), Hard: S.optional(S.Int) })),
  ),
  CpuCount: S.optional(S.Int),
  CpuPercent: S.optional(S.Int),
  IOMaximumIOps: S.optional(S.Int),
  IOMaximumBandwidth: S.optional(S.Int),
});
export type Resources = S.Schema.Type<typeof Resources>;

export const Limit = S.Struct({
  NanoCPUs: S.optional(S.Int),
  MemoryBytes: S.optional(S.Int),
...
export const GenericResources = S.Array(
  S.Struct({
    NamedResourceSpec: S.optional(S.Struct({ Kind: S.optional(S.String), Value: S.optional(S.String) })),
    DiscreteResourceSpec: S.optional(S.Struct({ Kind: S.optional(S.String), Value: S.optional(S.Int) })),
  }),
);
...
export const HealthConfig = S.Struct({
  ...
  Timeout: S.optional(S.Int),
  Retries: S.optional(S.Int),
  StartPeriod: S.optional(S.Int),
});
...
export const HealthcheckResult = S.Struct({
  ...
  ExitCode: S.optional(S.Int),
  Output: S.optional(S.String),
});
export type HealthcheckResult = S.Schema.Type<typeof HealthcheckResult> | null;

export const Health = S.Struct({
  Status: S.optional(S.Union(S.Literal("none"), S.Literal("starting"), S.Literal("healthy"), S.Literal("unhealthy"))),
  FailingStreak: S.optional(S.Int),
...
export const HostConfig = S.extend(
  Resources,
  S.Struct({
    Binds: S.optional(S.Array(S.String)),
    ContainerIDFile: S.optional(S.String),
    LogConfig: S.optional(
      S.Struct({
        Type: S.optional(
          S.Union(
            S.Literal("json-file"),
    ...
    ConsoleSize: S.optional(
      S.NullOr(S.Array(S.Int.pipe(S.greaterThanOrEqualTo(0))).pipe(S.minItems(2), S.maxItems(2))),
    ),
    ...
    ExtraHosts: S.optional(S.Array(S.String)),
    GroupAdd: S.optional(S.Array(S.String)),
    IpcMode: S.optional(S.String),
    Cgroup: S.optional(S.String),
    Links: S.optional(S.Array(S.String)),
    OomScoreAdj: S.optional(S.Int),
    ...
    SecurityOpt: S.optional(S.Array(S.String)),
    StorageOpt: S.optional(S.Record({ key: S.String, value: S.String })),
    Tmpfs: S.optional(S.Record({ key: S.String, value: S.String })),
    UTSMode: S.optional(S.String),
    UsernsMode: S.optional(S.String),
    ShmSize: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0))),
    Sysctls: S.optional(S.Record({ key: S.String, value: S.String })),
    Runtime: S.optional(S.String),
    Isolation: S.optional(S.Union(S.Literal("default"), S.Literal("process"), S.Literal("hyperv"))),
    MaskedPaths: S.optional(S.Array(S.String)),
...
export const ContainerConfig = S.Struct({
  ...
  ExposedPorts: S.optional(S.NullOr(S.Record({ key: S.String, value: S.Struct({}) }))),
  ...
  StopTimeout: S.optional(S.NullOr(S.Int)),
  Shell: S.optional(S.NullOr(S.Array(S.String))),
});
...
export const EndpointSettings = S.Struct({
  ...
  IPPrefixLen: S.optional(S.Int),
  IPv6Gateway: S.optional(S.String),
  GlobalIPv6Address: S.optional(S.String),
  GlobalIPv6PrefixLen: S.optional(S.Int),
  MacAddress: S.optional(S.String),
  DriverOpts: S.optional(S.NullOr(S.Record({ key: S.String, value: S.String }))),
});
...
export const NetworkSettings = S.Struct({
  ...
  LinkLocalIPv6PrefixLen: S.optional(S.Int),
  Ports: S.optional(PortMap),
  SandboxKey: S.optional(S.String),
  SecondaryIPAddresses: S.optional(S.NullOr(S.Array(Address))),
  SecondaryIPv6Addresses: S.optional(S.NullOr(S.Array(Address))),
  EndpointID: S.optional(S.String),
  Gateway: S.optional(S.String),
  GlobalIPv6Address: S.optional(S.String),
  GlobalIPv6PrefixLen: S.optional(S.Int),
...
export const ImageInspect = S.Struct({
  ...
  VirtualSize: S.optional(S.Int),
  GraphDriver: S.optional(GraphDriverData),
  RootFS: S.optional(S.Struct({ Type: S.String, Layers: S.optional(S.Array(S.String)) })),
...
export const ClusterVolumeSpec = S.Struct({
  ...
  AccessMode: S.optional(
    S.Struct({
      ...
      Secrets: S.optional(S.Array(S.Struct({ Key: S.optional(S.String), Secret: S.optional(S.String) }))),
      AccessibilityRequirements: S.optional(
        S.Struct({ Requisite: S.optional(S.Array(Topology)), Preferred: S.optional(S.Array(Topology)) }),
      ),
      CapacityRange: S.optional(S.Struct({ RequiredBytes: S.optional(S.Int), LimitBytes: S.optional(S.Int) })),
...
export const ClusterVolume = S.Struct({
  ...
  Info: S.optional(
    S.Struct({
      CapacityBytes: S.optional(S.Int),
  ...
  PublishStatus: S.optional(
    S.Array(
      S.Struct({
        ...
        State: S.optional(
          S.Union(
            S.Literal("pending-publish"),
            S.Literal("published"),
            S.Literal("pending-node-unpublish"),
            S.Literal("pending-controller-unpublish"),
          ),
        ),
...
export const Volume = S.Struct({
  ...
  Mountpoint: S.String,
  CreatedAt: S.optional(S.String),
  Status: S.optional(S.Record({ key: S.String, value: S.Struct({}) })),
  Labels: S.Record({ key: S.String, value: S.String }),
...
export const Network = S.Struct({
  ...
  Containers: S.optional(S.Record({ key: S.String, value: NetworkContainer })),
  Options: S.optional(S.Record({ key: S.String, value: S.String })),
  Labels: S.optional(S.Record({ key: S.String, value: S.String })),
});
...
export const BuildCache = S.Struct({
  ...
  Type: S.optional(
    S.Union(
      S.Literal("internal"),
      S.Literal("frontend"),
      S.Literal("source.local"),
      S.Literal("source.git.checkout"),
      S.Literal("exec.cachemount"),
      S.Literal("regular"),
    ),
  ),
...
export const Plugin = S.Struct({
  ...
  Config: S.Struct({
    ...
    Interface: S.Struct({
      ...
      Socket: S.String,
      ProtocolScheme: S.optional(S.Union(S.Literal(""), S.Literal("moby.plugins.http/v1"))),
    }),
    Entrypoint: S.Array(S.String),
    WorkDir: S.String,
    User: S.optional(S.Struct({ UID: S.optional(S.Int), GID: S.optional(S.Int) })),
    Network: S.Struct({ Type: S.String }),
    Linux: S.Struct({ Capabilities: S.Array(S.String), AllowAllDevices: S.Boolean, Devices: S.Array(PluginDevice) }),
    PropagatedMount: S.String,
    IpcHost: S.Boolean,
    PidHost: S.Boolean,
    Mounts: S.Array(PluginMount),
    Env: S.Array(PluginEnv),
    Args: S.Struct({ Name: S.String, Description: S.String, Settable: S.Array(S.String), Value: S.Array(S.String) }),
    rootfs: S.optional(S.Struct({ type: S.optional(S.String), diff_ids: S.optional(S.Array(S.String)) })),
  }),
});
...
export const NodeSpec = S.Struct({
  Name: S.optional(S.String),
  Labels: S.optional(S.Record({ key: S.String, value: S.String })),
  Role: S.optional(S.Union(S.Literal("worker"), S.Literal("manager"))),
  Availability: S.optional(S.Union(S.Literal("active"), S.Literal("pause"), S.Literal("drain"))),
});
...
export const EngineDescription = S.Struct({
  ...
  Labels: S.optional(S.Record({ key: S.String, value: S.String })),
  Plugins: S.optional(S.Array(S.Struct({ Type: S.optional(S.String), Name: S.optional(S.String) }))),
});
...
export const NodeState = S.Union(
  S.Literal("unknown"),
  S.Literal("down"),
  S.Literal("ready"),
...
export const SwarmSpec = S.Struct({
  Name: S.optional(S.String),
  Labels: S.optional(S.Record({ key: S.String, value: S.String })),
  Orchestration: S.optional(S.NullOr(S.Struct({ TaskHistoryRetentionLimit: S.optional(S.Int) }))),
  Raft: S.optional(
    S.Struct({
      SnapshotInterval: S.optional(S.Int),
      KeepOldSnapshots: S.optional(S.Int),
      LogEntriesForSlowFollowers: S.optional(S.Int),
      ElectionTick: S.optional(S.Int),
      HeartbeatTick: S.optional(S.Int),
    }),
  ),
  Dispatcher: S.optional(S.NullOr(S.Struct({ HeartbeatPeriod: S.optional(S.Int) }))),
  CAConfig: S.optional(
    S.NullOr(
      S.Struct({
        NodeCertExpiry: S.optional(S.Int),
        ...
        ForceRotate: S.optional(S.Int),
      }),
    ),
  ),
  EncryptionConfig: S.optional(S.Struct({ AutoLockManagers: S.optional(S.Boolean) })),
...
export const TaskSpec = S.Struct({
  ...
  ContainerSpec: S.optional(
    S.Struct({
      ...
      Privileges: S.optional(
        S.Struct({
          CredentialSpec: S.optional(
            S.Struct({ Config: S.optional(S.String), File: S.optional(S.String), Registry: S.optional(S.String) }),
          ),
      ...
      StopGracePeriod: S.optional(S.Int),
      HealthCheck: S.optional(HealthConfig),
  ...
  NetworkAttachmentSpec: S.optional(S.Struct({ ContainerID: S.optional(S.String) })),
  Resources: S.optional(S.Struct({ Limits: S.optional(Limit), Reservations: S.optional(ResourceObject) })),
  RestartPolicy: S.optional(
    S.Struct({
      Condition: S.optional(S.Union(S.Literal("none"), S.Literal("on-failure"), S.Literal("any"))),
  ...
  Placement: S.optional(
    S.Struct({
      ...
      Preferences: S.optional(
        S.Array(S.Struct({ Spread: S.optional(S.Struct({ SpreadDescriptor: S.optional(S.String) })) })),
      ),
      MaxReplicas: Int_default_0_prop,
      Platforms: S.optional(S.Array(Platform)),
    }),
  ),
  ForceUpdate: S.optional(S.Int),
  Runtime: S.optional(S.String),
...
export const TaskState = S.Union(
  S.Literal("new"),
  S.Literal("allocated"),
  S.Literal("pending"),
  S.Literal("assigned"),
...
export const Task = S.Struct({
  ...
  Status: S.optional(
    S.Struct({
      ...
      ContainerStatus: S.optional(
        S.Struct({ ContainerID: S.optional(S.String), PID: S.optional(S.Int), ExitCode: S.optional(S.Int) }),
      ),
    }),
  ),
...
export const EndpointPortConfig = S.Struct({
  Name: S.optional(S.String),
  Protocol: S.optional(S.Union(S.Literal("tcp"), S.Literal("udp"), S.Literal("sctp"))),
  TargetPort: S.optional(S.Int),
  PublishedPort: S.optional(S.Int),
...
export const ServiceSpec = S.Struct({
  ...
  Mode: S.optional(
    S.Struct({
      Replicated: S.optional(S.Struct({ Replicas: S.optional(S.Int) })),
      Global: S.optional(S.Struct({})),
      ReplicatedJob: S.optional(S.Struct({ MaxConcurrent: Int_default_1_prop, TotalCompletions: S.optional(S.Int) })),
      GlobalJob: S.optional(S.Struct({})),
    }),
  ),
  UpdateConfig: S.optional(
    S.Struct({
      Parallelism: S.optional(S.Int),
      Delay: S.optional(S.Int),
      FailureAction: S.optional(S.Union(S.Literal("continue"), S.Literal("pause"), S.Literal("rollback"))),
      Monitor: S.optional(S.Int),
      MaxFailureRatio: S.optional(S.Number),
      Order: S.optional(S.Union(S.Literal("stop-first"), S.Literal("start-first"))),
    }),
  ),
  RollbackConfig: S.optional(
    S.Struct({
      Parallelism: S.optional(S.Int),
      Delay: S.optional(S.Int),
      FailureAction: S.optional(S.Union(S.Literal("continue"), S.Literal("pause"))),
      Monitor: S.optional(S.Int),
      MaxFailureRatio: S.optional(S.Number),
      Order: S.optional(S.Union(S.Literal("stop-first"), S.Literal("start-first"))),
    }),
...
export const Service = S.Struct({
  ...
  Endpoint: S.optional(
    S.Struct({
      ...
      VirtualIPs: S.optional(S.Array(S.Struct({ NetworkID: S.optional(S.String), Addr: S.optional(S.String) }))),
    }),
  ),
  UpdateStatus: S.optional(
    S.Struct({
      State: S.optional(S.Union(S.Literal("updating"), S.Literal("paused"), S.Literal("completed"))),
  ...
  ServiceStatus: S.optional(
    S.Struct({ RunningTasks: S.optional(S.Int), DesiredTasks: S.optional(S.Int), CompletedTasks: S.optional(S.Int) }),
  ),
  JobStatus: S.optional(S.Struct({ JobIteration: S.optional(ObjectVersion), LastExecution: S.optional(S.String) })),
});
...
export const ContainerSummary = S.Struct({
  ...
  Created: S.optional(S.Int),
  Ports: S.optional(S.Array(Port)),
  SizeRw: S.optional(S.Int),
  SizeRootFs: S.optional(S.Int),
  Labels: S.optional(S.Record({ key: S.String, value: S.String })),
  State: S.optional(S.String),
  Status: S.optional(S.String),
  HostConfig: S.optional(S.Struct({ NetworkMode: S.optional(S.String) })),
  NetworkSettings: S.optional(S.Struct({ Networks: S.optional(S.Record({ key: S.String, value: EndpointSettings })) })),
...
export const SystemVersion = S.Struct({
  Platform: S.optional(S.Struct({ Name: S.String })),
  Components: S.optional(
    S.Array(S.Struct({ Name: S.String, Version: S.String, Details: S.optional(S.NullOr(S.Struct({}))) })),
  ),
...
export const RegistryServiceConfig = S.Struct({
  ...
  IndexConfigs: S.optional(S.Record({ key: S.String, value: IndexInfo })),
  Mirrors: S.optional(S.Array(S.String)),
});
...
export const SwarmInfo = S.Struct({
  ...
  RemoteManagers: S.optional(S.NullOr(S.Array(PeerNode))),
  Nodes: S.optional(S.NullOr(S.Int)),
  Managers: S.optional(S.NullOr(S.Int)),
...
export const SystemInfo = S.Struct({
  ID: S.optional(S.String),
  Containers: S.optional(S.Int),
  ContainersRunning: S.optional(S.Int),
  ContainersPaused: S.optional(S.Int),
  ContainersStopped: S.optional(S.Int),
  Images: S.optional(S.Int),
  Driver: S.optional(S.String),
  ...
  NFd: S.optional(S.Int),
  NGoroutines: S.optional(S.Int),
  ...
  NEventsListener: S.optional(S.Int),
  KernelVersion: S.optional(S.String),
  OperatingSystem: S.optional(S.String),
  OSVersion: S.optional(S.String),
  OSType: S.optional(S.String),
  Architecture: S.optional(S.String),
  NCPU: S.optional(S.Int),
  MemTotal: S.optional(S.Int),
  ...
  Runtimes: S.optional(S.Record({ key: S.String, value: Runtime })),
  ...
  DefaultAddressPools: S.optional(S.Array(S.Struct({ Base: S.optional(S.String), Size: S.optional(S.Int) }))),
  Warnings: S.optional(S.Array(S.String)),
});
...
export const EventMessage = S.Struct({
  ...
  scope: S.optional(S.Union(S.Literal("local"), S.Literal("swarm"))),
  time: S.optional(S.Int),
  timeNano: S.optional(S.Int),
});
  ...
  parameters: {
    query: S.optional(
      S.Struct({
        ...
        limit: S.optional(S.NumberFromString.pipe(S.int())),
...
export const post_ContainerCreate = {
  ...
  parameters: {
    query: S.optional(
      S.Struct({
        name: S.optional(S.String.pipe(S.pattern(new RegExp("^/?[a-zA-Z0-9][a-zA-Z0-9_.-]+$")))),
        platform: S.optional(S.String),
      }),
    ),
    body: S.extend(
      ContainerConfig,
      S.Struct({ HostConfig: S.optional(HostConfig), NetworkingConfig: S.optional(NetworkingConfig) }),
    ),
  },
  responses: {
...
export const get_ContainerTop = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ ps_args: String_default_neg_ef_prop })),
    path: S.Struct({ id: S.String }),
  },
  responses: {
    200: S.Struct({ Titles: S.optional(S.Array(S.String)), Processes: S.optional(S.Array(S.Array(S.String))) }),
    404: ErrorResponse,
    500: ErrorResponse,
  },
};
...
export const get_ContainerStats = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ stream: Union_default_true_prop, "one-shot": Union_default_false_prop })),
    path: S.Struct({ id: S.String }),
  },
...
export const post_ContainerResize = {
  ...
  parameters: {
    query: S.optional(
      S.Struct({ h: S.optional(S.NumberFromString.pipe(S.int())), w: S.optional(S.NumberFromString.pipe(S.int())) }),
    ),
    path: S.Struct({ id: S.String }),
  },
  responses: { 200: S.Unknown, 404: S.Unknown, 500: S.Unknown },
...
export const post_ContainerStop = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ signal: S.optional(S.String), t: S.optional(S.NumberFromString.pipe(S.int())) })),
    path: S.Struct({ id: S.String }),
  },
  responses: { 204: S.Unknown, 304: S.Unknown, 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ContainerKill = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ signal: String_default_SIGKILL_prop })),
    path: S.Struct({ id: S.String }),
  },
...
export const post_ContainerUpdate = {
  ...
  parameters: {
    path: S.Struct({ id: S.String }),
    body: S.extend(Resources, S.Struct({ RestartPolicy: S.optional(RestartPolicy) })),
  },
...
export const post_ContainerWait = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ condition: Union_default_notneg_running_prop })),
    path: S.Struct({ id: S.String }),
  },
...
export const delete_ContainerDelete = {
  ...
  parameters: {
    query: S.optional(
      S.Struct({ v: Union_default_false_prop, force: Union_default_false_prop, link: Union_default_false_prop }),
    ),
    path: S.Struct({ id: S.String }),
  },
...
export const put_PutContainerArchive = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.Struct({ path: S.String, noOverwriteDirNonDir: S.optional(S.String), copyUIDGID: S.optional(S.String) }),
    path: S.Struct({ id: S.String }),
...
export const post_ContainerPrune = {
  ...
  responses: {
    200: S.Struct({ ContainersDeleted: S.optional(S.Array(S.String)), SpaceReclaimed: S.optional(S.Int) }),
    500: ErrorResponse,
  },
};
  ...
  parameters: {
    query: S.optional(
      S.Struct({
        ...
        extrahosts: S.optional(S.String),
        remote: S.optional(S.String),
        ...
        memory: S.optional(S.NumberFromString.pipe(S.int())),
        memswap: S.optional(S.NumberFromString.pipe(S.int())),
        cpushares: S.optional(S.NumberFromString.pipe(S.int())),
        cpusetcpus: S.optional(S.String),
        cpuperiod: S.optional(S.NumberFromString.pipe(S.int())),
        cpuquota: S.optional(S.NumberFromString.pipe(S.int())),
        buildargs: S.optional(S.String),
        shmsize: S.optional(S.NumberFromString.pipe(S.int())),
        squash: S.optional(
          S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, {
            decode: (x) => x === true || x === "true" || x === 1 || x === "1",
            encode: (a) => a,
    ...
    header: S.optional(
      S.Struct({
        "Content-type": S.optional(S.Literal("application/x-tar")),
        "X-Registry-Config": S.optional(S.String),
      }),
    ),
    body: S.declare((v): v is Blob => typeof Blob !== "undefined" && v instanceof Blob),
  },
...
export const post_BuildPrune = {
  ...
  parameters: {
    query: S.optional(
      S.Struct({
        "keep-storage": S.optional(S.NumberFromString.pipe(S.int())),
        all: S.optional(
          S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, {
            decode: (x) => x === true || x === "true" || x === 1 || x === "1",
            encode: (a) => a,
  ...
  responses: {
    200: S.Struct({ CachesDeleted: S.optional(S.Array(S.String)), SpaceReclaimed: S.optional(S.Int) }),
    500: ErrorResponse,
  },
};
...
export const post_ImagePush = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ tag: S.optional(S.String) })),
    path: S.Struct({ name: S.String }),
    header: S.Struct({ "X-Registry-Auth": S.String }),
  },
  responses: { 200: S.Unknown, 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ImageTag = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ repo: S.optional(S.String), tag: S.optional(S.String) })),
    path: S.Struct({ name: S.String }),
  },
...
export const delete_ImageDelete = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ force: Union_default_false_prop, noprune: Union_default_false_prop })),
    path: S.Struct({ name: S.String }),
  },
...
export const post_ImagePrune = {
  ...
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String) })) },
  responses: {
    200: S.Struct({ ImagesDeleted: S.optional(S.Array(ImageDeleteResponseItem)), SpaceReclaimed: S.optional(S.Int) }),
    500: ErrorResponse,
  },
};
...
export const post_SystemAuth = {
  ...
  responses: {
    200: S.Struct({ Status: S.String, IdentityToken: S.optional(S.String) }),
    204: S.Unknown,
    401: ErrorResponse,
    500: ErrorResponse,
  },
...
export const get_SystemEvents = {
  ...
  parameters: {
    query: S.optional(
      S.Struct({ since: S.optional(S.String), until: S.optional(S.String), filters: S.optional(S.String) }),
    ),
  },
...
export const get_SystemDataUsage = {
  ...
  parameters: {
    query: S.optional(
      S.Struct({
        type: S.optional(
          S.Array(S.Union(S.Literal("container"), S.Literal("image"), S.Literal("volume"), S.Literal("build-cache"))),
        ),
      }),
    ),
  },
  responses: {
    200: S.Struct({
      LayersSize: S.optional(S.Int),
      Images: S.optional(S.Array(ImageSummary)),
      Containers: S.optional(S.Array(ContainerSummary)),
      Volumes: S.optional(S.Array(Volume)),
      BuildCache: S.optional(S.Array(BuildCache)),
    }),
    500: ErrorResponse,
  },
};
...
export const put_VolumeUpdate = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.Struct({ version: S.NumberFromString.pipe(S.int()) }),
    path: S.Struct({ name: S.String }),
    body: S.optional(S.Struct({ Spec: S.optional(ClusterVolumeSpec) })),
  },
...
export const post_VolumePrune = {
  ...
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String) })) },
  responses: {
    200: S.Struct({ VolumesDeleted: S.optional(S.Array(S.String)), SpaceReclaimed: S.optional(S.Int) }),
    500: ErrorResponse,
  },
};
...
export const get_NetworkInspect = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ verbose: Union_default_false_prop, scope: S.optional(S.String) })),
    path: S.Struct({ id: S.String }),
  },
...
export const post_NetworkCreate = {
  ...
  parameters: {
    body: S.Struct({
      Name: S.String,
      CheckDuplicate: S.optional(S.Boolean),
  ...
  responses: {
    201: S.Struct({ Id: S.optional(S.String), Warning: S.optional(S.String) }),
    403: ErrorResponse,
    404: ErrorResponse,
    500: ErrorResponse,
  },
...
export const post_NetworkConnect = {
  ...
  parameters: {
    path: S.Struct({ id: S.String }),
    body: S.optional(S.Struct({ Container: S.optional(S.String), EndpointConfig: S.optional(EndpointSettings) })),
  },
...
export const post_NetworkDisconnect = {
  ...
  parameters: {
    path: S.Struct({ id: S.String }),
    body: S.optional(S.Struct({ Container: S.optional(S.String), Force: S.optional(S.Boolean) })),
  },
  responses: { 200: S.Unknown, 403: ErrorResponse, 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_PluginPull = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.Struct({ remote: S.String, name: S.optional(S.String) }),
    header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) })),
    body: S.Array(PluginPrivilege),
  },
...
export const post_PluginUpgrade = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.Struct({ remote: S.String }),
    path: S.Struct({ name: S.String }),
    header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) })),
    body: S.Array(PluginPrivilege),
  },
...
export const post_SwarmUpdate = {
  ...
  parameters: {
    query: S.Struct({
      version: S.NumberFromString.pipe(S.int()),
...
export const post_ServiceCreate = {
  ...
  parameters: {
    header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) })),
    body: S.extend(ServiceSpec, S.Record({ key: S.String, value: S.Unknown })),
  },
  responses: {
    201: S.Struct({ ID: S.optional(S.String), Warning: S.optional(S.String) }),
    400: ErrorResponse,
...
export const get_ServiceInspect = {
  ...
  responseFormat: S.Literal("json"),
  parameters: {
    query: S.optional(S.Struct({ insertDefaults: Union_default_false_prop })),
    path: S.Struct({ id: S.String }),
  },
