...
// <Schemas>
export const Port = S.Struct({ IP: S.optional(S.String), PrivatePort: S.Int, PublicPort: S.optional(S.Int), Type: S.Union(S.Literal("tcp"), S.Literal("udp"), S.Literal("sctp")) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "IP": 1, "PrivatePort": 1, "PublicPort": 1, "Type": 1 }, key))));
export type Port = S.Schema.Type<typeof Port>;

export const MountPoint = S.Struct({ Type: S.optional(S.Union(S.Literal("bind"), S.Literal("volume"), S.Literal("tmpfs"), S.Literal("npipe"), S.Literal("cluster"))), Name: S.optional(S.String), Source: S.optional(S.String), Destination: S.optional(S.String), Driver: S.optional(S.String), Mode: S.optional(S.String), RW: S.optional(S.Boolean), Propagation: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1, "Name": 1, "Source": 1, "Destination": 1, "Driver": 1, "Mode": 1, "RW": 1, "Propagation": 1 }, key))));
export type MountPoint = S.Schema.Type<typeof MountPoint>;

export const DeviceMapping = S.Struct({ PathOnHost: S.optional(S.String), PathInContainer: S.optional(S.String), CgroupPermissions: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "PathOnHost": 1, "PathInContainer": 1, "CgroupPermissions": 1 }, key))));
export type DeviceMapping = S.Schema.Type<typeof DeviceMapping>;

export const DeviceRequest = S.Struct({ Driver: S.optional(S.String), Count: S.optional(S.Int), DeviceIDs: S.optional(S.Array(S.String)), Capabilities: S.optional(S.Array(S.Array(S.String))), Options: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Driver": 1, "Count": 1, "DeviceIDs": 1, "Capabilities": 1, "Options": 1 }, key))));
export type DeviceRequest = S.Schema.Type<typeof DeviceRequest>;

export const ThrottleDevice = S.Struct({ Path: S.optional(S.String), Rate: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Path": 1, "Rate": 1 }, key))));
export type ThrottleDevice = S.Schema.Type<typeof ThrottleDevice>;

export const Mount = S.Struct({ Target: S.optional(S.String), Source: S.optional(S.String), Type: S.optional(S.Union(S.Literal("bind"), S.Literal("volume"), S.Literal("tmpfs"), S.Literal("npipe"), S.Literal("cluster"))), ReadOnly: S.optional(S.Boolean), Consistency: S.optional(S.String), BindOptions: S.optional(S.Struct({ Propagation: S.optional(S.Union(S.Literal("private"), S.Literal("rprivate"), S.Literal("shared"), S.Literal("rshared"), S.Literal("slave"), S.Literal("rslave"))), NonRecursive: Boolean_default_false_prop, CreateMountpoint: Boolean_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Propagation": 1, "NonRecursive": 1, "CreateMountpoint": 1 }, key))))), VolumeOptions: S.optional(S.Struct({ NoCopy: Boolean_default_false_prop, Labels: S.optional(S.Record({ key: S.String, value: S.String })), DriverConfig: S.optional(S.Struct({ Name: S.optional(S.String), Options: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NoCopy": 1, "Labels": 1, "DriverConfig": 1 }, key))))), TmpfsOptions: S.optional(S.Struct({ SizeBytes: S.optional(S.Int), Mode: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "SizeBytes": 1, "Mode": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Target": 1, "Source": 1, "Type": 1, "ReadOnly": 1, "Consistency": 1, "BindOptions": 1, "VolumeOptions": 1, "TmpfsOptions": 1 }, key))));
export type Mount = S.Schema.Type<typeof Mount>;

export const RestartPolicy = S.Struct({ Name: S.optional(S.Union(S.Literal(""), S.Literal("no"), S.Literal("always"), S.Literal("unless-stopped"), S.Literal("on-failure"))), MaximumRetryCount: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "MaximumRetryCount": 1 }, key))));
export type RestartPolicy = S.Schema.Type<typeof RestartPolicy>;

export const Resources = S.Struct({ CpuShares: S.optional(S.Int), Memory: Int_default_0_prop, CgroupParent: S.optional(S.String), BlkioWeight: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(1000))), BlkioWeightDevice: S.optional(S.Array(S.Struct({ Path: S.optional(S.String), Weight: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Path": 1, "Weight": 1 }, key)))))), BlkioDeviceReadBps: S.optional(S.Array(ThrottleDevice)), BlkioDeviceWriteBps: S.optional(S.Array(ThrottleDevice)), BlkioDeviceReadIOps: S.optional(S.Array(ThrottleDevice)), BlkioDeviceWriteIOps: S.optional(S.Array(ThrottleDevice)), CpuPeriod: S.optional(S.Int), CpuQuota: S.optional(S.Int), CpuRealtimePeriod: S.optional(S.Int), CpuRealtimeRuntime: S.optional(S.Int), CpusetCpus: S.optional(S.String), CpusetMems: S.optional(S.String), Devices: S.optional(S.Array(DeviceMapping)), DeviceCgroupRules: S.optional(S.Array(S.String)), DeviceRequests: S.optional(S.Array(DeviceRequest)), KernelMemoryTCP: S.optional(S.Int), MemoryReservation: S.optional(S.Int), MemorySwap: S.optional(S.Int), MemorySwappiness: S.optional(S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(100))), NanoCpus: S.optional(S.Int), OomKillDisable: S.optional(S.Boolean), Init: S.optional(S.NullOr(S.Boolean)), PidsLimit: S.optional(S.NullOr(S.Int)), Ulimits: S.optional(S.Array(S.Struct({ Name: S.optional(S.String), Soft: S.optional(S.Int), Hard: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Soft": 1, "Hard": 1 }, key)))))), CpuCount: S.optional(S.Int), CpuPercent: S.optional(S.Int), IOMaximumIOps: S.optional(S.Int), IOMaximumBandwidth: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "CpuShares": 1, "Memory": 1, "CgroupParent": 1, "BlkioWeight": 1, "BlkioWeightDevice": 1, "BlkioDeviceReadBps": 1, "BlkioDeviceWriteBps": 1, "BlkioDeviceReadIOps": 1, "BlkioDeviceWriteIOps": 1, "CpuPeriod": 1, "CpuQuota": 1, "CpuRealtimePeriod": 1, "CpuRealtimeRuntime": 1, "CpusetCpus": 1, "CpusetMems": 1, "Devices": 1, "DeviceCgroupRules": 1, "DeviceRequests": 1, "KernelMemoryTCP": 1, "MemoryReservation": 1, "MemorySwap": 1, "MemorySwappiness": 1, "NanoCpus": 1, "OomKillDisable": 1, "Init": 1, "PidsLimit": 1, "Ulimits": 1, "CpuCount": 1, "CpuPercent": 1, "IOMaximumIOps": 1, "IOMaximumBandwidth": 1 }, key))));
export type Resources = S.Schema.Type<typeof Resources>;

export const Limit = S.Struct({ NanoCPUs: S.optional(S.Int), MemoryBytes: S.optional(S.Int), Pids: Int_default_0_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NanoCPUs": 1, "MemoryBytes": 1, "Pids": 1 }, key))));
export type Limit = S.Schema.Type<typeof Limit>;

export const GenericResources = S.Array(S.Struct({ NamedResourceSpec: S.optional(S.Struct({ Kind: S.optional(S.String), Value: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Kind": 1, "Value": 1 }, key))))), DiscreteResourceSpec: S.optional(S.Struct({ Kind: S.optional(S.String), Value: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Kind": 1, "Value": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NamedResourceSpec": 1, "DiscreteResourceSpec": 1 }, key)))));
export type GenericResources = S.Schema.Type<typeof GenericResources>;

export const ResourceObject = S.Struct({ NanoCPUs: S.optional(S.Int), MemoryBytes: S.optional(S.Int), GenericResources: S.optional(GenericResources) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NanoCPUs": 1, "MemoryBytes": 1, "GenericResources": 1 }, key))));
export type ResourceObject = S.Schema.Type<typeof ResourceObject>;

export const HealthConfig = S.Struct({ Test: S.optional(S.Array(S.String)), Interval: S.optional(S.Int), Timeout: S.optional(S.Int), Retries: S.optional(S.Int), StartPeriod: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Test": 1, "Interval": 1, "Timeout": 1, "Retries": 1, "StartPeriod": 1 }, key))));
export type HealthConfig = S.Schema.Type<typeof HealthConfig>;

export const HealthcheckResult = S.NullOr(S.Struct({ Start: S.optional(S.String), End: S.optional(S.String), ExitCode: S.optional(S.Int), Output: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Start": 1, "End": 1, "ExitCode": 1, "Output": 1 }, key)))));
export type HealthcheckResult = S.Schema.Type<typeof HealthcheckResult>;

export const Health = S.NullOr(S.Struct({ Status: S.optional(S.Union(S.Literal("none"), S.Literal("starting"), S.Literal("healthy"), S.Literal("unhealthy"))), FailingStreak: S.optional(S.Int), Log: S.optional(S.Array(HealthcheckResult)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Status": 1, "FailingStreak": 1, "Log": 1 }, key)))));
export type Health = S.Schema.Type<typeof Health>;

export const PortBinding = S.Struct({ HostIp: S.optional(S.String), HostPort: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "HostIp": 1, "HostPort": 1 }, key))));
...
export const FilesystemChange = S.Struct({ Path: S.String, Kind: ChangeType }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Path": 1, "Kind": 1 }, key))));
export type FilesystemChange = S.Schema.Type<typeof FilesystemChange>;

export const ImageInspect = S.Struct({ Id: S.optional(S.String), RepoTags: S.optional(S.Array(S.String)), RepoDigests: S.optional(S.Array(S.String)), Parent: S.optional(S.String), Comment: S.optional(S.String), Created: S.optional(S.String), Container: S.optional(S.String), ContainerConfig: S.optional(ContainerConfig), DockerVersion: S.optional(S.String), Author: S.optional(S.String), Config: S.optional(ContainerConfig), Architecture: S.optional(S.String), Variant: S.optional(S.NullOr(S.String)), Os: S.optional(S.String), OsVersion: S.optional(S.NullOr(S.String)), Size: S.optional(S.Int), VirtualSize: S.optional(S.Int), GraphDriver: S.optional(GraphDriverData), RootFS: S.optional(S.Struct({ Type: S.String, Layers: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1, "Layers": 1 }, key))))), Metadata: S.optional(S.Struct({ LastTagTime: S.optional(S.NullOr(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "LastTagTime": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "RepoTags": 1, "RepoDigests": 1, "Parent": 1, "Comment": 1, "Created": 1, "Container": 1, "ContainerConfig": 1, "DockerVersion": 1, "Author": 1, "Config": 1, "Architecture": 1, "Variant": 1, "Os": 1, "OsVersion": 1, "Size": 1, "VirtualSize": 1, "GraphDriver": 1, "RootFS": 1, "Metadata": 1 }, key))));
export type ImageInspect = S.Schema.Type<typeof ImageInspect>;

export const ImageSummary = S.Struct({ Id: S.String, ParentId: S.String, RepoTags: S.Array(S.String), RepoDigests: S.Array(S.String), Created: S.Int, Size: S.Int, SharedSize: S.Int, VirtualSize: S.optional(S.Int), Labels: S.Record({ key: S.String, value: S.String }), Containers: S.Int }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "ParentId": 1, "RepoTags": 1, "RepoDigests": 1, "Created": 1, "Size": 1, "SharedSize": 1, "VirtualSize": 1, "Labels": 1, "Containers": 1 }, key))));
export type ImageSummary = S.Schema.Type<typeof ImageSummary>;

export const AuthConfig = S.Struct({ username: S.optional(S.String), password: S.optional(S.String), email: S.optional(S.String), serveraddress: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "username": 1, "password": 1, "email": 1, "serveraddress": 1 }, key))));
export type AuthConfig = S.Schema.Type<typeof AuthConfig>;

export const ProcessConfig = S.Struct({ privileged: S.optional(S.Boolean), user: S.optional(S.String), tty: S.optional(S.Boolean), entrypoint: S.optional(S.String), arguments: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "privileged": 1, "user": 1, "tty": 1, "entrypoint": 1, "arguments": 1 }, key))));
export type ProcessConfig = S.Schema.Type<typeof ProcessConfig>;

export const ObjectVersion = S.Struct({ Index: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Index": 1 }, key))));
...
export const ClusterVolumeSpec = S.Struct({ Group: S.optional(S.String), AccessMode: S.optional(S.Struct({ Scope: Union_default_single_prop, Sharing: Union_default_none_prop, MountVolume: S.optional(S.Struct({  }).pipe(S.filter((data) => Object.keys(data).every((key) => false)))), Secrets: S.optional(S.Array(S.Struct({ Key: S.optional(S.String), Secret: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Key": 1, "Secret": 1 }, key)))))), AccessibilityRequirements: S.optional(S.Struct({ Requisite: S.optional(S.Array(Topology)), Preferred: S.optional(S.Array(Topology)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Requisite": 1, "Preferred": 1 }, key))))), CapacityRange: S.optional(S.Struct({ RequiredBytes: S.optional(S.Int), LimitBytes: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "RequiredBytes": 1, "LimitBytes": 1 }, key))))), Availability: Union_default_active_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Scope": 1, "Sharing": 1, "MountVolume": 1, "Secrets": 1, "AccessibilityRequirements": 1, "CapacityRange": 1, "Availability": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Group": 1, "AccessMode": 1 }, key))));
export type ClusterVolumeSpec = S.Schema.Type<typeof ClusterVolumeSpec>;

export const ClusterVolume = S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Spec: S.optional(ClusterVolumeSpec), Info: S.optional(S.Struct({ CapacityBytes: S.optional(S.Int), VolumeContext: S.optional(S.Record({ key: S.String, value: S.String })), VolumeID: S.optional(S.String), AccessibleTopology: S.optional(S.Array(Topology)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "CapacityBytes": 1, "VolumeContext": 1, "VolumeID": 1, "AccessibleTopology": 1 }, key))))), PublishStatus: S.optional(S.Array(S.Struct({ NodeID: S.optional(S.String), State: S.optional(S.Union(S.Literal("pending-publish"), S.Literal("published"), S.Literal("pending-node-unpublish"), S.Literal("pending-controller-unpublish"))), PublishContext: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NodeID": 1, "State": 1, "PublishContext": 1 }, key)))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Info": 1, "PublishStatus": 1 }, key))));
export type ClusterVolume = S.Schema.Type<typeof ClusterVolume>;

export const Volume = S.Struct({ Name: S.String, Driver: S.String, Mountpoint: S.String, CreatedAt: S.optional(S.String), Status: S.optional(S.Record({ key: S.String, value: S.Struct({  }).pipe(S.filter((data) => Object.keys(data).every((key) => false))) })), Labels: S.Record({ key: S.String, value: S.String }), Scope: Union_default_local_prop, ClusterVolume: S.optional(ClusterVolume), Options: S.Record({ key: S.String, value: S.String }), UsageData: S.optional(S.NullOr(S.Struct({ Size: Int_default_neg_1_prop, RefCount: Int_default_neg_1_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Size": 1, "RefCount": 1 }, key)))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Driver": 1, "Mountpoint": 1, "CreatedAt": 1, "Status": 1, "Labels": 1, "Scope": 1, "ClusterVolume": 1, "Options": 1, "UsageData": 1 }, key))));
export type Volume = S.Schema.Type<typeof Volume>;

export const VolumeCreateOptions = S.Struct({ Name: S.optional(S.String), Driver: String_default_local_prop, DriverOpts: S.optional(S.Record({ key: S.String, value: S.String })), Labels: S.optional(S.Record({ key: S.String, value: S.String })), ClusterVolumeSpec: S.optional(ClusterVolumeSpec) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Driver": 1, "DriverOpts": 1, "Labels": 1, "ClusterVolumeSpec": 1 }, key))));
export type VolumeCreateOptions = S.Schema.Type<typeof VolumeCreateOptions>;

export const VolumeListResponse = S.Struct({ Volumes: S.optional(S.Array(Volume)), Warnings: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Volumes": 1, "Warnings": 1 }, key))));
export type VolumeListResponse = S.Schema.Type<typeof VolumeListResponse>;

export const IPAMConfig = S.Struct({ Subnet: S.optional(S.String), IPRange: S.optional(S.String), Gateway: S.optional(S.String), AuxiliaryAddresses: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Subnet": 1, "IPRange": 1, "Gateway": 1, "AuxiliaryAddresses": 1 }, key))));
export type IPAMConfig = S.Schema.Type<typeof IPAMConfig>;

export const IPAM = S.Struct({ Driver: String_default_default_prop, Config: S.optional(S.Array(IPAMConfig)), Options: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Driver": 1, "Config": 1, "Options": 1 }, key))));
export type IPAM = S.Schema.Type<typeof IPAM>;

export const NetworkContainer = S.Struct({ Name: S.optional(S.String), EndpointID: S.optional(S.String), MacAddress: S.optional(S.String), IPv4Address: S.optional(S.String), IPv6Address: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "EndpointID": 1, "MacAddress": 1, "IPv4Address": 1, "IPv6Address": 1 }, key))));
export type NetworkContainer = S.Schema.Type<typeof NetworkContainer>;

export const Network = S.Struct({ Name: S.optional(S.String), Id: S.optional(S.String), Created: S.optional(S.String), Scope: S.optional(S.String), Driver: S.optional(S.String), EnableIPv6: S.optional(S.Boolean), IPAM: S.optional(IPAM), Internal: S.optional(S.Boolean), Attachable: S.optional(S.Boolean), Ingress: S.optional(S.Boolean), Containers: S.optional(S.Record({ key: S.String, value: NetworkContainer })), Options: S.optional(S.Record({ key: S.String, value: S.String })), Labels: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Id": 1, "Created": 1, "Scope": 1, "Driver": 1, "EnableIPv6": 1, "IPAM": 1, "Internal": 1, "Attachable": 1, "Ingress": 1, "Containers": 1, "Options": 1, "Labels": 1 }, key))));
export type Network = S.Schema.Type<typeof Network>;

export const ErrorDetail = S.Struct({ code: S.optional(S.Int), message: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "code": 1, "message": 1 }, key))));
export type ErrorDetail = S.Schema.Type<typeof ErrorDetail>;

export const ProgressDetail = S.Struct({ current: S.optional(S.Int), total: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "current": 1, "total": 1 }, key))));
export type ProgressDetail = S.Schema.Type<typeof ProgressDetail>;

export const ImageID = S.Struct({ ID: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1 }, key))));
export type ImageID = S.Schema.Type<typeof ImageID>;

export const BuildInfo = S.Struct({ id: S.optional(S.String), stream: S.optional(S.String), error: S.optional(S.String), errorDetail: S.optional(ErrorDetail), status: S.optional(S.String), progress: S.optional(S.String), progressDetail: S.optional(ProgressDetail), aux: S.optional(ImageID) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1, "stream": 1, "error": 1, "errorDetail": 1, "status": 1, "progress": 1, "progressDetail": 1, "aux": 1 }, key))));
export type BuildInfo = S.Schema.Type<typeof BuildInfo>;

export const BuildCache = S.Struct({ ID: S.optional(S.String), Parent: S.optional(S.NullOr(S.String)), Parents: S.optional(S.NullOr(S.Array(S.String))), Type: S.optional(S.Union(S.Literal("internal"), S.Literal("frontend"), S.Literal("source.local"), S.Literal("source.git.checkout"), S.Literal("exec.cachemount"), S.Literal("regular"))), Description: S.optional(S.String), InUse: S.optional(S.Boolean), Shared: S.optional(S.Boolean), Size: S.optional(S.Int), CreatedAt: S.optional(S.String), LastUsedAt: S.optional(S.NullOr(S.String)), UsageCount: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Parent": 1, "Parents": 1, "Type": 1, "Description": 1, "InUse": 1, "Shared": 1, "Size": 1, "CreatedAt": 1, "LastUsedAt": 1, "UsageCount": 1 }, key))));
export type BuildCache = S.Schema.Type<typeof BuildCache>;

export const CreateImageInfo = S.Struct({ id: S.optional(S.String), error: S.optional(S.String), errorDetail: S.optional(ErrorDetail), status: S.optional(S.String), progress: S.optional(S.String), progressDetail: S.optional(ProgressDetail) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1, "error": 1, "errorDetail": 1, "status": 1, "progress": 1, "progressDetail": 1 }, key))));
export type CreateImageInfo = S.Schema.Type<typeof CreateImageInfo>;

export const PushImageInfo = S.Struct({ error: S.optional(S.String), status: S.optional(S.String), progress: S.optional(S.String), progressDetail: S.optional(ProgressDetail) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "error": 1, "status": 1, "progress": 1, "progressDetail": 1 }, key))));
export type PushImageInfo = S.Schema.Type<typeof PushImageInfo>;

export const ErrorResponse = S.Struct({ message: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "message": 1 }, key))));
export type ErrorResponse = S.Schema.Type<typeof ErrorResponse>;

export const IdResponse = S.Struct({ Id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1 }, key))));
export type IdResponse = S.Schema.Type<typeof IdResponse>;

export const PluginMount = S.Struct({ Name: S.String, Description: S.String, Settable: S.Array(S.String), Source: S.String, Destination: S.String, Type: S.String, Options: S.Array(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Source": 1, "Destination": 1, "Type": 1, "Options": 1 }, key))));
export type PluginMount = S.Schema.Type<typeof PluginMount>;

export const PluginDevice = S.Struct({ Name: S.String, Description: S.String, Settable: S.Array(S.String), Path: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Path": 1 }, key))));
export type PluginDevice = S.Schema.Type<typeof PluginDevice>;

export const PluginEnv = S.Struct({ Name: S.String, Description: S.String, Settable: S.Array(S.String), Value: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Value": 1 }, key))));
export type PluginEnv = S.Schema.Type<typeof PluginEnv>;

export const PluginInterfaceType = S.Struct({ Prefix: S.String, Capability: S.String, Version: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Prefix": 1, "Capability": 1, "Version": 1 }, key))));
export type PluginInterfaceType = S.Schema.Type<typeof PluginInterfaceType>;

export const PluginPrivilege = S.Struct({ Name: S.optional(S.String), Description: S.optional(S.String), Value: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Value": 1 }, key))));
export type PluginPrivilege = S.Schema.Type<typeof PluginPrivilege>;

export const Plugin = S.Struct({ Id: S.optional(S.String), Name: S.String, Enabled: S.Boolean, Settings: S.Struct({ Mounts: S.Array(PluginMount), Env: S.Array(S.String), Args: S.Array(S.String), Devices: S.Array(PluginDevice) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Mounts": 1, "Env": 1, "Args": 1, "Devices": 1 }, key)))), PluginReference: S.optional(S.String), Config: S.Struct({ DockerVersion: S.optional(S.String), Description: S.String, Documentation: S.String, Interface: S.Struct({ Types: S.Array(PluginInterfaceType), Socket: S.String, ProtocolScheme: S.optional(S.Union(S.Literal(""), S.Literal("moby.plugins.http/v1"))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Types": 1, "Socket": 1, "ProtocolScheme": 1 }, key)))), Entrypoint: S.Array(S.String), WorkDir: S.String, User: S.optional(S.Struct({ UID: S.optional(S.Int), GID: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "UID": 1, "GID": 1 }, key))))), Network: S.Struct({ Type: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1 }, key)))), Linux: S.Struct({ Capabilities: S.Array(S.String), AllowAllDevices: S.Boolean, Devices: S.Array(PluginDevice) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Capabilities": 1, "AllowAllDevices": 1, "Devices": 1 }, key)))), PropagatedMount: S.String, IpcHost: S.Boolean, PidHost: S.Boolean, Mounts: S.Array(PluginMount), Env: S.Array(PluginEnv), Args: S.Struct({ Name: S.String, Description: S.String, Settable: S.Array(S.String), Value: S.Array(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Description": 1, "Settable": 1, "Value": 1 }, key)))), rootfs: S.optional(S.Struct({ type: S.optional(S.String), diff_ids: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "type": 1, "diff_ids": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "DockerVersion": 1, "Description": 1, "Documentation": 1, "Interface": 1, "Entrypoint": 1, "WorkDir": 1, "User": 1, "Network": 1, "Linux": 1, "PropagatedMount": 1, "IpcHost": 1, "PidHost": 1, "Mounts": 1, "Env": 1, "Args": 1, "rootfs": 1 }, key)))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Name": 1, "Enabled": 1, "Settings": 1, "PluginReference": 1, "Config": 1 }, key))));
export type Plugin = S.Schema.Type<typeof Plugin>;

export const NodeSpec = S.Struct({ Name: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Role: S.optional(S.Union(S.Literal("worker"), S.Literal("manager"))), Availability: S.optional(S.Union(S.Literal("active"), S.Literal("pause"), S.Literal("drain"))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Role": 1, "Availability": 1 }, key))));
export type NodeSpec = S.Schema.Type<typeof NodeSpec>;

export const Platform = S.Struct({ Architecture: S.optional(S.String), OS: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Architecture": 1, "OS": 1 }, key))));
export type Platform = S.Schema.Type<typeof Platform>;

export const EngineDescription = S.Struct({ EngineVersion: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Plugins: S.optional(S.Array(S.Struct({ Type: S.optional(S.String), Name: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Type": 1, "Name": 1 }, key)))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "EngineVersion": 1, "Labels": 1, "Plugins": 1 }, key))));
export type EngineDescription = S.Schema.Type<typeof EngineDescription>;

export const TLSInfo = S.Struct({ TrustRoot: S.optional(S.String), CertIssuerSubject: S.optional(S.String), CertIssuerPublicKey: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "TrustRoot": 1, "CertIssuerSubject": 1, "CertIssuerPublicKey": 1 }, key))));
export type TLSInfo = S.Schema.Type<typeof TLSInfo>;

export const NodeDescription = S.Struct({ Hostname: S.optional(S.String), Platform: S.optional(Platform), Resources: S.optional(ResourceObject), Engine: S.optional(EngineDescription), TLSInfo: S.optional(TLSInfo) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Hostname": 1, "Platform": 1, "Resources": 1, "Engine": 1, "TLSInfo": 1 }, key))));
...
export const NodeStatus = S.Struct({ State: S.optional(NodeState), Message: S.optional(S.String), Addr: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "State": 1, "Message": 1, "Addr": 1 }, key))));
...
export const ManagerStatus = S.NullOr(S.Struct({ Leader: Boolean_default_false_prop, Reachability: S.optional(Reachability), Addr: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Leader": 1, "Reachability": 1, "Addr": 1 }, key)))));
export type ManagerStatus = S.Schema.Type<typeof ManagerStatus>;

export const Node = S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Spec: S.optional(NodeSpec), Description: S.optional(NodeDescription), Status: S.optional(NodeStatus), ManagerStatus: S.optional(ManagerStatus) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Description": 1, "Status": 1, "ManagerStatus": 1 }, key))));
export type Node = S.Schema.Type<typeof Node>;

export const SwarmSpec = S.Struct({ Name: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Orchestration: S.optional(S.NullOr(S.Struct({ TaskHistoryRetentionLimit: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "TaskHistoryRetentionLimit": 1 }, key)))))), Raft: S.optional(S.Struct({ SnapshotInterval: S.optional(S.Int), KeepOldSnapshots: S.optional(S.Int), LogEntriesForSlowFollowers: S.optional(S.Int), ElectionTick: S.optional(S.Int), HeartbeatTick: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "SnapshotInterval": 1, "KeepOldSnapshots": 1, "LogEntriesForSlowFollowers": 1, "ElectionTick": 1, "HeartbeatTick": 1 }, key))))), Dispatcher: S.optional(S.NullOr(S.Struct({ HeartbeatPeriod: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "HeartbeatPeriod": 1 }, key)))))), CAConfig: S.optional(S.NullOr(S.Struct({ NodeCertExpiry: S.optional(S.Int), ExternalCAs: S.optional(S.Array(S.Struct({ Protocol: S.optional(S.Literal("cfssl")), URL: S.optional(S.String), Options: S.optional(S.Record({ key: S.String, value: S.String })), CACert: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Protocol": 1, "URL": 1, "Options": 1, "CACert": 1 }, key)))))), SigningCACert: S.optional(S.String), SigningCAKey: S.optional(S.String), ForceRotate: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NodeCertExpiry": 1, "ExternalCAs": 1, "SigningCACert": 1, "SigningCAKey": 1, "ForceRotate": 1 }, key)))))), EncryptionConfig: S.optional(S.Struct({ AutoLockManagers: S.optional(S.Boolean) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "AutoLockManagers": 1 }, key))))), TaskDefaults: S.optional(S.Struct({ LogDriver: S.optional(S.Struct({ Name: S.optional(S.String), Options: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "LogDriver": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Orchestration": 1, "Raft": 1, "Dispatcher": 1, "CAConfig": 1, "EncryptionConfig": 1, "TaskDefaults": 1 }, key))));
export type SwarmSpec = S.Schema.Type<typeof SwarmSpec>;

export const ClusterInfo = S.NullOr(S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Spec: S.optional(SwarmSpec), TLSInfo: S.optional(TLSInfo), RootRotationInProgress: S.optional(S.Boolean), DataPathPort: S.optional(S.Int), DefaultAddrPool: S.optional(S.Array(S.String)), SubnetSize: S.optional(S.Int.pipe(S.lessThanOrEqualTo(29))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "TLSInfo": 1, "RootRotationInProgress": 1, "DataPathPort": 1, "DefaultAddrPool": 1, "SubnetSize": 1 }, key)))));
export type ClusterInfo = S.Schema.Type<typeof ClusterInfo>;

export const JoinTokens = S.Struct({ Worker: S.optional(S.String), Manager: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Worker": 1, "Manager": 1 }, key))));
export type JoinTokens = S.Schema.Type<typeof JoinTokens>;

export const Swarm = ClusterInfo.pipe(S.filter((value) => S.is(S.Struct({ JoinTokens: S.optional(JoinTokens) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "JoinTokens": 1 }, key)))))(value)));
export type Swarm = S.Schema.Type<typeof Swarm>;

export const NetworkAttachmentConfig = S.Struct({ Target: S.optional(S.String), Aliases: S.optional(S.Array(S.String)), DriverOpts: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Target": 1, "Aliases": 1, "DriverOpts": 1 }, key))));
export type NetworkAttachmentConfig = S.Schema.Type<typeof NetworkAttachmentConfig>;

export const TaskSpec = S.Struct({ PluginSpec: S.optional(S.Struct({ Name: S.optional(S.String), Remote: S.optional(S.String), Disabled: S.optional(S.Boolean), PluginPrivilege: S.optional(S.Array(PluginPrivilege)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Remote": 1, "Disabled": 1, "PluginPrivilege": 1 }, key))))), ContainerSpec: S.optional(S.Struct({ Image: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Command: S.optional(S.Array(S.String)), Args: S.optional(S.Array(S.String)), Hostname: S.optional(S.String), Env: S.optional(S.Array(S.String)), Dir: S.optional(S.String), User: S.optional(S.String), Groups: S.optional(S.Array(S.String)), Privileges: S.optional(S.Struct({ CredentialSpec: S.optional(S.Struct({ Config: S.optional(S.String), File: S.optional(S.String), Registry: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Config": 1, "File": 1, "Registry": 1 }, key))))), SELinuxContext: S.optional(S.Struct({ Disable: S.optional(S.Boolean), User: S.optional(S.String), Role: S.optional(S.String), Type: S.optional(S.String), Level: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Disable": 1, "User": 1, "Role": 1, "Type": 1, "Level": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "CredentialSpec": 1, "SELinuxContext": 1 }, key))))), TTY: S.optional(S.Boolean), OpenStdin: S.optional(S.Boolean), ReadOnly: S.optional(S.Boolean), Mounts: S.optional(S.Array(Mount)), StopSignal: S.optional(S.String), StopGracePeriod: S.optional(S.Int), HealthCheck: S.optional(HealthConfig), Hosts: S.optional(S.Array(S.String)), DNSConfig: S.optional(S.Struct({ Nameservers: S.optional(S.Array(S.String)), Search: S.optional(S.Array(S.String)), Options: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Nameservers": 1, "Search": 1, "Options": 1 }, key))))), Secrets: S.optional(S.Array(S.Struct({ File: S.optional(S.Struct({ Name: S.optional(S.String), UID: S.optional(S.String), GID: S.optional(S.String), Mode: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "UID": 1, "GID": 1, "Mode": 1 }, key))))), SecretID: S.optional(S.String), SecretName: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "File": 1, "SecretID": 1, "SecretName": 1 }, key)))))), Configs: S.optional(S.Array(S.Struct({ File: S.optional(S.Struct({ Name: S.optional(S.String), UID: S.optional(S.String), GID: S.optional(S.String), Mode: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "UID": 1, "GID": 1, "Mode": 1 }, key))))), Runtime: S.optional(S.Struct({  }).pipe(S.filter((data) => Object.keys(data).every((key) => false)))), ConfigID: S.optional(S.String), ConfigName: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "File": 1, "Runtime": 1, "ConfigID": 1, "ConfigName": 1 }, key)))))), Isolation: S.optional(S.Union(S.Literal("default"), S.Literal("process"), S.Literal("hyperv"))), Init: S.optional(S.NullOr(S.Boolean)), Sysctls: S.optional(S.Record({ key: S.String, value: S.String })), CapabilityAdd: S.optional(S.Array(S.String)), CapabilityDrop: S.optional(S.Array(S.String)), Ulimits: S.optional(S.Array(S.Struct({ Name: S.optional(S.String), Soft: S.optional(S.Int), Hard: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Soft": 1, "Hard": 1 }, key)))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Image": 1, "Labels": 1, "Command": 1, "Args": 1, "Hostname": 1, "Env": 1, "Dir": 1, "User": 1, "Groups": 1, "Privileges": 1, "TTY": 1, "OpenStdin": 1, "ReadOnly": 1, "Mounts": 1, "StopSignal": 1, "StopGracePeriod": 1, "HealthCheck": 1, "Hosts": 1, "DNSConfig": 1, "Secrets": 1, "Configs": 1, "Isolation": 1, "Init": 1, "Sysctls": 1, "CapabilityAdd": 1, "CapabilityDrop": 1, "Ulimits": 1 }, key))))), NetworkAttachmentSpec: S.optional(S.Struct({ ContainerID: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ContainerID": 1 }, key))))), Resources: S.optional(S.Struct({ Limits: S.optional(Limit), Reservations: S.optional(ResourceObject) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Limits": 1, "Reservations": 1 }, key))))), RestartPolicy: S.optional(S.Struct({ Condition: S.optional(S.Union(S.Literal("none"), S.Literal("on-failure"), S.Literal("any"))), Delay: S.optional(S.Int), MaxAttempts: Int_default_0_prop, Window: Int_default_0_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Condition": 1, "Delay": 1, "MaxAttempts": 1, "Window": 1 }, key))))), Placement: S.optional(S.Struct({ Constraints: S.optional(S.Array(S.String)), Preferences: S.optional(S.Array(S.Struct({ Spread: S.optional(S.Struct({ SpreadDescriptor: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "SpreadDescriptor": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Spread": 1 }, key)))))), MaxReplicas: Int_default_0_prop, Platforms: S.optional(S.Array(Platform)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Constraints": 1, "Preferences": 1, "MaxReplicas": 1, "Platforms": 1 }, key))))), ForceUpdate: S.optional(S.Int), Runtime: S.optional(S.String), Networks: S.optional(S.Array(NetworkAttachmentConfig)), LogDriver: S.optional(S.Struct({ Name: S.optional(S.String), Options: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "PluginSpec": 1, "ContainerSpec": 1, "NetworkAttachmentSpec": 1, "Resources": 1, "RestartPolicy": 1, "Placement": 1, "ForceUpdate": 1, "Runtime": 1, "Networks": 1, "LogDriver": 1 }, key))));
...
export const Task = S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Name: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Spec: S.optional(TaskSpec), ServiceID: S.optional(S.String), Slot: S.optional(S.Int), NodeID: S.optional(S.String), AssignedGenericResources: S.optional(GenericResources), Status: S.optional(S.Struct({ Timestamp: S.optional(S.String), State: S.optional(TaskState), Message: S.optional(S.String), Err: S.optional(S.String), ContainerStatus: S.optional(S.Struct({ ContainerID: S.optional(S.String), PID: S.optional(S.Int), ExitCode: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ContainerID": 1, "PID": 1, "ExitCode": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Timestamp": 1, "State": 1, "Message": 1, "Err": 1, "ContainerStatus": 1 }, key))))), DesiredState: S.optional(TaskState), JobIteration: S.optional(ObjectVersion) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Name": 1, "Labels": 1, "Spec": 1, "ServiceID": 1, "Slot": 1, "NodeID": 1, "AssignedGenericResources": 1, "Status": 1, "DesiredState": 1, "JobIteration": 1 }, key))));
export type Task = S.Schema.Type<typeof Task>;

export const EndpointPortConfig = S.Struct({ Name: S.optional(S.String), Protocol: S.optional(S.Union(S.Literal("tcp"), S.Literal("udp"), S.Literal("sctp"))), TargetPort: S.optional(S.Int), PublishedPort: S.optional(S.Int), PublishMode: Union_default_ingress_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Protocol": 1, "TargetPort": 1, "PublishedPort": 1, "PublishMode": 1 }, key))));
export type EndpointPortConfig = S.Schema.Type<typeof EndpointPortConfig>;

export const EndpointSpec = S.Struct({ Mode: Union_default_vip_prop, Ports: S.optional(S.Array(EndpointPortConfig)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Mode": 1, "Ports": 1 }, key))));
export type EndpointSpec = S.Schema.Type<typeof EndpointSpec>;

export const ServiceSpec = S.Struct({ Name: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), TaskTemplate: S.optional(TaskSpec), Mode: S.optional(S.Struct({ Replicated: S.optional(S.Struct({ Replicas: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Replicas": 1 }, key))))), Global: S.optional(S.Struct({  }).pipe(S.filter((data) => Object.keys(data).every((key) => false)))), ReplicatedJob: S.optional(S.Struct({ MaxConcurrent: Int_default_1_prop, TotalCompletions: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "MaxConcurrent": 1, "TotalCompletions": 1 }, key))))), GlobalJob: S.optional(S.Struct({  }).pipe(S.filter((data) => Object.keys(data).every((key) => false)))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Replicated": 1, "Global": 1, "ReplicatedJob": 1, "GlobalJob": 1 }, key))))), UpdateConfig: S.optional(S.Struct({ Parallelism: S.optional(S.Int), Delay: S.optional(S.Int), FailureAction: S.optional(S.Union(S.Literal("continue"), S.Literal("pause"), S.Literal("rollback"))), Monitor: S.optional(S.Int), MaxFailureRatio: S.optional(S.Number), Order: S.optional(S.Union(S.Literal("stop-first"), S.Literal("start-first"))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Parallelism": 1, "Delay": 1, "FailureAction": 1, "Monitor": 1, "MaxFailureRatio": 1, "Order": 1 }, key))))), RollbackConfig: S.optional(S.Struct({ Parallelism: S.optional(S.Int), Delay: S.optional(S.Int), FailureAction: S.optional(S.Union(S.Literal("continue"), S.Literal("pause"))), Monitor: S.optional(S.Int), MaxFailureRatio: S.optional(S.Number), Order: S.optional(S.Union(S.Literal("stop-first"), S.Literal("start-first"))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Parallelism": 1, "Delay": 1, "FailureAction": 1, "Monitor": 1, "MaxFailureRatio": 1, "Order": 1 }, key))))), Networks: S.optional(S.Array(NetworkAttachmentConfig)), EndpointSpec: S.optional(EndpointSpec) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "TaskTemplate": 1, "Mode": 1, "UpdateConfig": 1, "RollbackConfig": 1, "Networks": 1, "EndpointSpec": 1 }, key))));
export type ServiceSpec = S.Schema.Type<typeof ServiceSpec>;

export const Service = S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Spec: S.optional(ServiceSpec), Endpoint: S.optional(S.Struct({ Spec: S.optional(EndpointSpec), Ports: S.optional(S.Array(EndpointPortConfig)), VirtualIPs: S.optional(S.Array(S.Struct({ NetworkID: S.optional(S.String), Addr: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NetworkID": 1, "Addr": 1 }, key)))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Spec": 1, "Ports": 1, "VirtualIPs": 1 }, key))))), UpdateStatus: S.optional(S.Struct({ State: S.optional(S.Union(S.Literal("updating"), S.Literal("paused"), S.Literal("completed"))), StartedAt: S.optional(S.String), CompletedAt: S.optional(S.String), Message: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "State": 1, "StartedAt": 1, "CompletedAt": 1, "Message": 1 }, key))))), ServiceStatus: S.optional(S.Struct({ RunningTasks: S.optional(S.Int), DesiredTasks: S.optional(S.Int), CompletedTasks: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "RunningTasks": 1, "DesiredTasks": 1, "CompletedTasks": 1 }, key))))), JobStatus: S.optional(S.Struct({ JobIteration: S.optional(ObjectVersion), LastExecution: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "JobIteration": 1, "LastExecution": 1 }, key))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1, "Endpoint": 1, "UpdateStatus": 1, "ServiceStatus": 1, "JobStatus": 1 }, key))));
export type Service = S.Schema.Type<typeof Service>;

export const ImageDeleteResponseItem = S.Struct({ Untagged: S.optional(S.String), Deleted: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Untagged": 1, "Deleted": 1 }, key))));
export type ImageDeleteResponseItem = S.Schema.Type<typeof ImageDeleteResponseItem>;

export const ServiceUpdateResponse = S.Struct({ Warnings: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Warnings": 1 }, key))));
export type ServiceUpdateResponse = S.Schema.Type<typeof ServiceUpdateResponse>;

export const ContainerSummary = S.Struct({ Id: S.optional(S.String), Names: S.optional(S.Array(S.String)), Image: S.optional(S.String), ImageID: S.optional(S.String), Command: S.optional(S.String), Created: S.optional(S.Int), Ports: S.optional(S.Array(Port)), SizeRw: S.optional(S.Int), SizeRootFs: S.optional(S.Int), Labels: S.optional(S.Record({ key: S.String, value: S.String })), State: S.optional(S.String), Status: S.optional(S.String), HostConfig: S.optional(S.Struct({ NetworkMode: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NetworkMode": 1 }, key))))), NetworkSettings: S.optional(S.Struct({ Networks: S.optional(S.Record({ key: S.String, value: EndpointSettings })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Networks": 1 }, key))))), Mounts: S.optional(S.Array(MountPoint)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Names": 1, "Image": 1, "ImageID": 1, "Command": 1, "Created": 1, "Ports": 1, "SizeRw": 1, "SizeRootFs": 1, "Labels": 1, "State": 1, "Status": 1, "HostConfig": 1, "NetworkSettings": 1, "Mounts": 1 }, key))));
export type ContainerSummary = S.Schema.Type<typeof ContainerSummary>;

export const Driver = S.Struct({ Name: S.String, Options: S.optional(S.Record({ key: S.String, value: S.String })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Options": 1 }, key))));
export type Driver = S.Schema.Type<typeof Driver>;

export const SecretSpec = S.Struct({ Name: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Data: S.optional(S.String), Driver: S.optional(Driver), Templating: S.optional(Driver) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Data": 1, "Driver": 1, "Templating": 1 }, key))));
export type SecretSpec = S.Schema.Type<typeof SecretSpec>;

export const Secret = S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Spec: S.optional(SecretSpec) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1 }, key))));
export type Secret = S.Schema.Type<typeof Secret>;

export const ConfigSpec = S.Struct({ Name: S.optional(S.String), Labels: S.optional(S.Record({ key: S.String, value: S.String })), Data: S.optional(S.String), Templating: S.optional(Driver) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Labels": 1, "Data": 1, "Templating": 1 }, key))));
export type ConfigSpec = S.Schema.Type<typeof ConfigSpec>;

export const Config = S.Struct({ ID: S.optional(S.String), Version: S.optional(ObjectVersion), CreatedAt: S.optional(S.String), UpdatedAt: S.optional(S.String), Spec: S.optional(ConfigSpec) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Version": 1, "CreatedAt": 1, "UpdatedAt": 1, "Spec": 1 }, key))));
export type Config = S.Schema.Type<typeof Config>;

export const ContainerState = S.NullOr(S.Struct({ Status: S.optional(S.Union(S.Literal("created"), S.Literal("running"), S.Literal("paused"), S.Literal("restarting"), S.Literal("removing"), S.Literal("exited"), S.Literal("dead"))), Running: S.optional(S.Boolean), Paused: S.optional(S.Boolean), Restarting: S.optional(S.Boolean), OOMKilled: S.optional(S.Boolean), Dead: S.optional(S.Boolean), Pid: S.optional(S.Int), ExitCode: S.optional(S.Int), Error: S.optional(S.String), StartedAt: S.optional(S.String), FinishedAt: S.optional(S.String), Health: S.optional(Health) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Status": 1, "Running": 1, "Paused": 1, "Restarting": 1, "OOMKilled": 1, "Dead": 1, "Pid": 1, "ExitCode": 1, "Error": 1, "StartedAt": 1, "FinishedAt": 1, "Health": 1 }, key)))));
export type ContainerState = S.Schema.Type<typeof ContainerState>;

export const ContainerCreateResponse = S.Struct({ Id: S.String, Warnings: S.Array(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Warnings": 1 }, key))));
export type ContainerCreateResponse = S.Schema.Type<typeof ContainerCreateResponse>;

export const ContainerWaitExitError = S.Struct({ Message: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Message": 1 }, key))));
export type ContainerWaitExitError = S.Schema.Type<typeof ContainerWaitExitError>;

export const ContainerWaitResponse = S.Struct({ StatusCode: S.Int, Error: S.optional(ContainerWaitExitError) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "StatusCode": 1, "Error": 1 }, key))));
export type ContainerWaitResponse = S.Schema.Type<typeof ContainerWaitResponse>;

export const SystemVersion = S.Struct({ Platform: S.optional(S.Struct({ Name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1 }, key))))), Components: S.optional(S.Array(S.Struct({ Name: S.String, Version: S.String, Details: S.optional(S.NullOr(S.Struct({  }).pipe(S.filter((data) => Object.keys(data).every((key) => false))))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Version": 1, "Details": 1 }, key)))))), Version: S.optional(S.String), ApiVersion: S.optional(S.String), MinAPIVersion: S.optional(S.String), GitCommit: S.optional(S.String), GoVersion: S.optional(S.String), Os: S.optional(S.String), Arch: S.optional(S.String), KernelVersion: S.optional(S.String), Experimental: S.optional(S.Boolean), BuildTime: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Platform": 1, "Components": 1, "Version": 1, "ApiVersion": 1, "MinAPIVersion": 1, "GitCommit": 1, "GoVersion": 1, "Os": 1, "Arch": 1, "KernelVersion": 1, "Experimental": 1, "BuildTime": 1 }, key))));
export type SystemVersion = S.Schema.Type<typeof SystemVersion>;

export const PluginsInfo = S.Struct({ Volume: S.optional(S.Array(S.String)), Network: S.optional(S.Array(S.String)), Authorization: S.optional(S.Array(S.String)), Log: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Volume": 1, "Network": 1, "Authorization": 1, "Log": 1 }, key))));
export type PluginsInfo = S.Schema.Type<typeof PluginsInfo>;

export const IndexInfo = S.NullOr(S.Struct({ Name: S.optional(S.String), Mirrors: S.optional(S.Array(S.String)), Secure: S.optional(S.Boolean), Official: S.optional(S.Boolean) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Name": 1, "Mirrors": 1, "Secure": 1, "Official": 1 }, key)))));
export type IndexInfo = S.Schema.Type<typeof IndexInfo>;

export const RegistryServiceConfig = S.NullOr(S.Struct({ AllowNondistributableArtifactsCIDRs: S.optional(S.Array(S.String)), AllowNondistributableArtifactsHostnames: S.optional(S.Array(S.String)), InsecureRegistryCIDRs: S.optional(S.Array(S.String)), IndexConfigs: S.optional(S.Record({ key: S.String, value: IndexInfo })), Mirrors: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "AllowNondistributableArtifactsCIDRs": 1, "AllowNondistributableArtifactsHostnames": 1, "InsecureRegistryCIDRs": 1, "IndexConfigs": 1, "Mirrors": 1 }, key)))));
export type RegistryServiceConfig = S.Schema.Type<typeof RegistryServiceConfig>;

export const Runtime = S.Struct({ path: S.optional(S.String), runtimeArgs: S.optional(S.NullOr(S.Array(S.String))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "path": 1, "runtimeArgs": 1 }, key))));
...
export const get_ContainerList = {
  ...
  parameters: { query: S.optional(S.Struct({ all: Union_default_false_prop, limit: S.optional(S.NumberFromString.pipe(S.int())), size: Union_default_false_prop, filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "all": 1, "limit": 1, "size": 1, "filters": 1 }, key))))) },
...
export const post_ContainerCreate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ name: S.optional(S.String.pipe(S.pattern(new RegExp("^/?[a-zA-Z0-9][a-zA-Z0-9_.-]+$")))), platform: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1, "platform": 1 }, key))))), body: S.extend(ContainerConfig, S.Struct({ HostConfig: S.optional(HostConfig), NetworkingConfig: S.optional(NetworkingConfig) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "HostConfig": 1, "NetworkingConfig": 1 }, key))))) },
...
export const get_ContainerTop = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ ps_args: String_default_neg_ef_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ps_args": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
  responses: { 200: S.Union(S.Struct({ Titles: S.optional(S.Array(S.String)), Processes: S.optional(S.Array(S.Array(S.String))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Titles": 1, "Processes": 1 }, key)))), S.Struct({ Titles: S.optional(S.Array(S.String)), Processes: S.optional(S.Array(S.Array(S.String))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Titles": 1, "Processes": 1 }, key))))), 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const get_ContainerLogs = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ follow: Union_default_false_prop, stdout: Union_default_false_prop, stderr: Union_default_false_prop, since: Schema_default_0_prop, until: Schema_default_0_prop, timestamps: Union_default_false_prop, tail: String_default_all_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "follow": 1, "stdout": 1, "stderr": 1, "since": 1, "until": 1, "timestamps": 1, "tail": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const get_ContainerChanges = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const get_ContainerStats = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ stream: Union_default_true_prop, "one-shot": Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "stream": 1, "one-shot": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const post_ContainerResize = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ h: S.optional(S.NumberFromString.pipe(S.int())), w: S.optional(S.NumberFromString.pipe(S.int())) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "h": 1, "w": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
  responses: { 200: S.Unknown, 404: S.Union(ErrorResponse, S.Unknown), 500: ErrorResponse },
};
...
export const post_ContainerStart = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ detachKeys: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "detachKeys": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const post_ContainerStop = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ signal: S.optional(S.String), t: S.optional(S.NumberFromString.pipe(S.int())) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "signal": 1, "t": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
  responses: { 204: S.Unknown, 304: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_ContainerKill = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ signal: String_default_SIGKILL_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "signal": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const post_ContainerUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: S.extend(Resources, S.Struct({ RestartPolicy: S.optional(RestartPolicy) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "RestartPolicy": 1 }, key))))) },
  responses: { 200: S.Struct({ Warnings: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Warnings": 1 }, key)))), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ContainerRename = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
  responses: { 204: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 409: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_ContainerWait = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ condition: Union_default_notneg_running_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "condition": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const delete_ContainerDelete = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ v: Union_default_false_prop, force: Union_default_false_prop, link: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "v": 1, "force": 1, "link": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const get_ContainerArchive = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ path: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "path": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const put_PutContainerArchive = {
  ...
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ path: S.String, noOverwriteDirNonDir: S.optional(S.String), copyUIDGID: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "path": 1, "noOverwriteDirNonDir": 1, "copyUIDGID": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: S.declare((v): v is Blob => typeof Blob !== "undefined" && v instanceof Blob) },
...
export const head_ContainerArchiveInfo = {
  ...
  responseHeaders: { 200: S.Struct({ "X-Docker-Container-Path-Stat": S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Docker-Container-Path-Stat": 1 }, key)))) },
};
...
export const post_ContainerPrune = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))))) },
  responses: { 200: S.Struct({ ContainersDeleted: S.optional(S.Array(S.String)), SpaceReclaimed: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ContainersDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const get_ImageList = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ all: Union_default_false_prop, filters: S.optional(S.String), "shared-size": Union_default_false_prop, digests: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "all": 1, "filters": 1, "shared-size": 1, "digests": 1 }, key))))) },
...
export const post_BuildPrune = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ "keep-storage": S.optional(S.NumberFromString.pipe(S.int())), all: S.optional(S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, { decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })), filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "keep-storage": 1, "all": 1, "filters": 1 }, key))))) },
  responses: { 200: S.Struct({ CachesDeleted: S.optional(S.Array(S.String)), SpaceReclaimed: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "CachesDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const post_ImageCreate = {
  ...
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ fromImage: S.optional(S.String), fromSrc: S.optional(S.String), repo: S.optional(S.String), tag: S.optional(S.String), message: S.optional(S.String), changes: S.optional(S.Array(S.String)), platform: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "fromImage": 1, "fromSrc": 1, "repo": 1, "tag": 1, "message": 1, "changes": 1, "platform": 1 }, key))))), header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))))), body: S.String },
...
export const get_ImageInspect = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
...
export const get_ImageHistory = {
  ...
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
  responses: { 200: S.Array(S.Struct({ Id: S.String, Created: S.Int, CreatedBy: S.String, Tags: S.Array(S.String), Size: S.Int, Comment: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Id": 1, "Created": 1, "CreatedBy": 1, "Tags": 1, "Size": 1, "Comment": 1 }, key))))), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ImagePush = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ tag: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "tag": 1 }, key))))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))), header: S.Struct({ "X-Registry-Auth": S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key)))) },
...
export const post_ImageTag = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ repo: S.optional(S.String), tag: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "repo": 1, "tag": 1 }, key))))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
...
export const delete_ImageDelete = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ force: Union_default_false_prop, noprune: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1, "noprune": 1 }, key))))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
...
export const get_ImageSearch = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ term: S.String, limit: S.optional(S.NumberFromString.pipe(S.int())), filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "term": 1, "limit": 1, "filters": 1 }, key)))) },
  responses: { 200: S.Array(S.Struct({ description: S.optional(S.String), is_official: S.optional(S.Boolean), is_automated: S.optional(S.Boolean), name: S.optional(S.String), star_count: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "description": 1, "is_official": 1, "is_automated": 1, "name": 1, "star_count": 1 }, key))))), 500: ErrorResponse },
};
...
export const post_ImagePrune = {
  ...
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))))) },
  responses: { 200: S.Struct({ ImagesDeleted: S.optional(S.Array(ImageDeleteResponseItem)), SpaceReclaimed: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ImagesDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const post_SystemAuth = {
  ...
  responses: { 200: S.Struct({ Status: S.String, IdentityToken: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Status": 1, "IdentityToken": 1 }, key)))), 204: S.Unknown, 401: ErrorResponse, 500: ErrorResponse },
};
...
export const get_SystemPing = {
  ...
  responseHeaders: { 200: S.Struct({ Swarm: Union_default_inactive_prop, "Docker-Experimental": S.Boolean, "Cache-Control": String_default_noneg_cache_noneg_store_mustneg_revalida_prop, Pragma: String_default_noneg_cache_prop, "API-Version": S.String, "Builder-Version": String_default_2_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Swarm": 1, "Docker-Experimental": 1, "Cache-Control": 1, "Pragma": 1, "API-Version": 1, "Builder-Version": 1 }, key)))), 500: S.Struct({ "Cache-Control": String_default_noneg_cache_noneg_store_mustneg_revalida_prop, Pragma: String_default_noneg_cache_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Cache-Control": 1, "Pragma": 1 }, key)))) },
};
...
export const head_SystemPingHead = {
  ...
  parameters: S.Never,
  responses: { 200: S.String, 500: ErrorResponse },
  responseHeaders: { 200: S.Struct({ Swarm: Union_default_inactive_prop, "Docker-Experimental": S.Boolean, "Cache-Control": String_default_noneg_cache_noneg_store_mustneg_revalida_prop, Pragma: String_default_noneg_cache_prop, "API-Version": S.String, "Builder-Version": S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Swarm": 1, "Docker-Experimental": 1, "Cache-Control": 1, "Pragma": 1, "API-Version": 1, "Builder-Version": 1 }, key)))) },
};
...
export const post_ImageCommit = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ container: S.optional(S.String), repo: S.optional(S.String), tag: S.optional(S.String), comment: S.optional(S.String), author: S.optional(S.String), pause: Union_default_true_prop, changes: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "container": 1, "repo": 1, "tag": 1, "comment": 1, "author": 1, "pause": 1, "changes": 1 }, key))))), body: ContainerConfig },
...
export const get_SystemEvents = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ since: S.optional(S.String), until: S.optional(S.String), filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "since": 1, "until": 1, "filters": 1 }, key))))) },
...
export const get_SystemDataUsage = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ type: S.optional(S.Array(S.Union(S.Literal("container"), S.Literal("image"), S.Literal("volume"), S.Literal("build-cache")))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "type": 1 }, key))))) },
  responses: { 200: S.Union(S.Struct({ LayersSize: S.optional(S.Int), Images: S.optional(S.Array(ImageSummary)), Containers: S.optional(S.Array(ContainerSummary)), Volumes: S.optional(S.Array(Volume)), BuildCache: S.optional(S.Array(BuildCache)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "LayersSize": 1, "Images": 1, "Containers": 1, "Volumes": 1, "BuildCache": 1 }, key)))), S.Struct({ LayersSize: S.optional(S.Int), Images: S.optional(S.Array(ImageSummary)), Containers: S.optional(S.Array(ContainerSummary)), Volumes: S.optional(S.Array(Volume)), BuildCache: S.optional(S.Array(BuildCache)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "LayersSize": 1, "Images": 1, "Containers": 1, "Volumes": 1, "BuildCache": 1 }, key))))), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const get_ImageGetAll = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ names: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "names": 1 }, key))))) },
  responses: { 200: S.Unknown, 500: S.Unknown },
};
...
export const post_ImageLoad = {
  ...
  requestFormat: S.Literal("text"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ quiet: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "quiet": 1 }, key))))) },
...
export const post_ContainerExec = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: S.optional(S.Struct({ AttachStdin: S.optional(S.Boolean), AttachStdout: S.optional(S.Boolean), AttachStderr: S.optional(S.Boolean), ConsoleSize: S.optional(S.NullOr(S.Array(S.Int.pipe(S.greaterThanOrEqualTo(0))).pipe(S.minItems(2), S.maxItems(2)))), DetachKeys: S.optional(S.String), Tty: S.optional(S.Boolean), Env: S.optional(S.Array(S.String)), Cmd: S.optional(S.Array(S.String)), Privileged: Boolean_default_false_prop, User: S.optional(S.String), WorkingDir: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "AttachStdin": 1, "AttachStdout": 1, "AttachStderr": 1, "ConsoleSize": 1, "DetachKeys": 1, "Tty": 1, "Env": 1, "Cmd": 1, "Privileged": 1, "User": 1, "WorkingDir": 1 }, key))))) },
...
export const post_ExecStart = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: S.optional(S.Struct({ Detach: S.optional(S.Boolean), Tty: S.optional(S.Boolean), ConsoleSize: S.optional(S.NullOr(S.Array(S.Int.pipe(S.greaterThanOrEqualTo(0))).pipe(S.minItems(2), S.maxItems(2)))) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Detach": 1, "Tty": 1, "ConsoleSize": 1 }, key))))) },
...
export const put_VolumeUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ version: S.NumberFromString.pipe(S.int()) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key)))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))), body: S.optional(S.Struct({ Spec: S.optional(ClusterVolumeSpec) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Spec": 1 }, key))))) },
...
export const delete_VolumeDelete = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ force: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
  responses: { 204: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 409: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_VolumePrune = {
  ...
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))))) },
  responses: { 200: S.Struct({ VolumesDeleted: S.optional(S.Array(S.String)), SpaceReclaimed: S.optional(S.Int) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "VolumesDeleted": 1, "SpaceReclaimed": 1 }, key)))), 500: ErrorResponse },
};
...
export const get_NetworkInspect = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ verbose: Union_default_false_prop, scope: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "verbose": 1, "scope": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const post_NetworkConnect = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: S.optional(S.Struct({ Container: S.optional(S.String), EndpointConfig: S.optional(EndpointSettings) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Container": 1, "EndpointConfig": 1 }, key))))) },
...
export const post_NetworkDisconnect = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: S.optional(S.Struct({ Container: S.optional(S.String), Force: S.optional(S.Boolean) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "Container": 1, "Force": 1 }, key))))) },
  responses: { 200: S.Unknown, 403: S.Union(ErrorResponse, ErrorResponse), 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_NetworkPrune = {
  ...
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1 }, key))))) },
  responses: { 200: S.Struct({ NetworksDeleted: S.optional(S.Array(S.String)) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "NetworksDeleted": 1 }, key)))), 500: ErrorResponse },
};
...
export const get_GetPluginPrivileges = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ remote: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "remote": 1 }, key)))) },
...
export const post_PluginPull = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ remote: S.String, name: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "remote": 1, "name": 1 }, key)))), header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))))), body: S.Array(PluginPrivilege) },
...
export const post_PluginEnable = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ timeout: Schema_default_0_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "timeout": 1 }, key))))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
  responses: { 200: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_PluginDisable = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ force: S.optional(S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, { decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
  responses: { 200: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_PluginUpgrade = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ remote: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "remote": 1 }, key)))), path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))), header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))))), body: S.Array(PluginPrivilege) },
  responses: { 204: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_PluginCreate = {
  ...
  requestFormat: S.Literal("text"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))) },
...
export const post_PluginSet = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { path: S.Struct({ name: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "name": 1 }, key)))), body: S.Array(S.String) },
  responses: { 204: S.Unknown, 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const delete_NodeDelete = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ force: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const post_NodeUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ version: S.NumberFromString.pipe(S.int()) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: NodeSpec },
...
export const post_SwarmInit = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { body: S.optional(S.Struct({ ListenAddr: S.optional(S.String), AdvertiseAddr: S.optional(S.String), DataPathAddr: S.optional(S.String), DataPathPort: S.optional(S.Int), DefaultAddrPool: S.optional(S.Array(S.String)), ForceNewCluster: S.optional(S.Boolean), SubnetSize: S.optional(S.Int), Spec: S.optional(SwarmSpec) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ListenAddr": 1, "AdvertiseAddr": 1, "DataPathAddr": 1, "DataPathPort": 1, "DefaultAddrPool": 1, "ForceNewCluster": 1, "SubnetSize": 1, "Spec": 1 }, key))))) },
...
export const post_SwarmJoin = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { body: S.optional(S.Struct({ ListenAddr: S.optional(S.String), AdvertiseAddr: S.optional(S.String), DataPathAddr: S.optional(S.String), RemoteAddrs: S.optional(S.Array(S.String)), JoinToken: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ListenAddr": 1, "AdvertiseAddr": 1, "DataPathAddr": 1, "RemoteAddrs": 1, "JoinToken": 1 }, key))))) },
...
export const post_SwarmLeave = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ force: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "force": 1 }, key))))) },
...
export const post_SwarmUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ version: S.NumberFromString.pipe(S.int()), rotateWorkerToken: Union_default_false_prop, rotateManagerToken: Union_default_false_prop, rotateManagerUnlockKey: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1, "rotateWorkerToken": 1, "rotateManagerToken": 1, "rotateManagerUnlockKey": 1 }, key)))), body: SwarmSpec },
  responses: { 200: S.Unknown, 400: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse), 503: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const get_SwarmUnlockkey = {
  ...
  responseFormat: S.Literal("json"),
  parameters: S.Never,
  responses: { 200: S.Union(S.Struct({ UnlockKey: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "UnlockKey": 1 }, key)))), S.Struct({ UnlockKey: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "UnlockKey": 1 }, key))))), 500: S.Union(ErrorResponse, ErrorResponse), 503: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_SwarmUnlock = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { body: S.optional(S.Struct({ UnlockKey: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "UnlockKey": 1 }, key))))) },
...
export const get_ServiceList = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ filters: S.optional(S.String), status: S.optional(S.transform(S.Union(S.Boolean, S.String, S.Number), S.Boolean, { decode: (x) => x === true || x === "true" || x === 1 || x === "1", encode: (a) => a })) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "filters": 1, "status": 1 }, key))))) },
...
export const post_ServiceCreate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))))), body: ServiceSpec.pipe(S.filter((value) => S.is(S.Record({ key: S.String, value: S.Unknown }))(value))) },
  responses: { 201: S.Struct({ ID: S.optional(S.String), Warning: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "ID": 1, "Warning": 1 }, key)))), 400: ErrorResponse, 403: ErrorResponse, 409: ErrorResponse, 500: ErrorResponse, 503: ErrorResponse },
};
...
export const get_ServiceInspect = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.optional(S.Struct({ insertDefaults: Union_default_false_prop }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "insertDefaults": 1 }, key))))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))) },
...
export const post_ServiceUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ version: S.NumberFromString.pipe(S.int()), registryAuthFrom: Union_default_spec_prop, rollback: S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1, "registryAuthFrom": 1, "rollback": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), header: S.optional(S.Struct({ "X-Registry-Auth": S.optional(S.String) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "X-Registry-Auth": 1 }, key))))), body: ServiceSpec.pipe(S.filter((value) => S.is(S.Record({ key: S.String, value: S.Unknown }))(value))) },
...
export const post_SecretUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ version: S.NumberFromString.pipe(S.int()) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: SecretSpec },
  responses: { 200: S.Unknown, 400: S.Union(ErrorResponse, ErrorResponse), 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse), 503: S.Union(ErrorResponse, ErrorResponse) },
};
...
export const post_ConfigUpdate = {
  ...
  requestFormat: S.Literal("json"),
  responseFormat: S.Literal("json"),
  parameters: { query: S.Struct({ version: S.NumberFromString.pipe(S.int()) }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "version": 1 }, key)))), path: S.Struct({ id: S.String }).pipe(S.filter((data) => Object.keys(data).every((key) => Object.hasOwn({ "id": 1 }, key)))), body: ConfigSpec },
  responses: { 200: S.Unknown, 400: S.Union(ErrorResponse, ErrorResponse), 404: S.Union(ErrorResponse, ErrorResponse), 500: S.Union(ErrorResponse, ErrorResponse), 503: S.Union(ErrorResponse, ErrorResponse) },
};
