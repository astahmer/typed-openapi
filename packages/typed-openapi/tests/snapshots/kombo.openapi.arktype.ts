...
const __schemas = type.module({
  ...
  PostAiApplyApplyRequestBody: { submission_token: type("string"), candidate_email: type("string.email"), "query_params?": { "[string]": type("string") }, screening_question_answers: type({ question_id: type("string"), answer: [[type("string"), "|", [type("string").array(), "|", [type("number"), "|", [type("boolean"), "|", { name: type("string"), content_type: type("string"), data: type("string") }]]]], ":", (data) => [type("string").allows(data), type("string").array().allows(data), type("number").allows(data), type("boolean").allows(data), type({ name: type("string"), content_type: type("string"), data: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "name": 1, "content_type": 1, "data": 1 }, key))).allows(data)].filter(Boolean).length === 1] }).array(), "additional_clicks?": type("0 <= number.integer <= 30"), "additional_clicks_scatter_duration?": type("number.integer >= 1") },
...
export const get_GetCheckApiKey = {
  ...
  responses: { 200: GetCheckApiKeyPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostForceSync = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostForceSyncRequestBody },
  responses: { 200: PostForceSyncPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostPassthroughToolApi = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ tool: PostPassthroughToolApiParameterTool, api: PostPassthroughToolApiParameterApi }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "tool": 1, "api": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostPassthroughToolApiRequestBody },
  responses: { 200: PostPassthroughToolApiPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const delete_DeleteIntegrationsIntegrationId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: DeleteIntegrationsIntegrationIdParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))), body: DeleteIntegrationsIntegrationIdRequestBody },
...
export const get_GetIntegrationsIntegrationId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: GetIntegrationsIntegrationIdParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))) },
  responses: { 200: GetIntegrationsIntegrationIdPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const put_PutIntegrationsIntegrationIdEnabled = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PutIntegrationsIntegrationIdEnabledParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))), body: PutIntegrationsIntegrationIdEnabledRequestBody },
  responses: { 200: PutIntegrationsIntegrationIdEnabledPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostIntegrationsIntegrationIdRelink = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PostIntegrationsIntegrationIdRelinkParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))), body: PostIntegrationsIntegrationIdRelinkRequestBody },
...
export const post_PostIntegrationsIntegrationIdSetupLink = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PostIntegrationsIntegrationIdSetupLinkParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))), body: PostIntegrationsIntegrationIdSetupLinkRequestBody },
...
export const get_GetIntegrationsIntegrationIdIntegrationFields = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetIntegrationsIntegrationIdIntegrationFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdIntegrationFieldsParameterPageSize }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1 }, key))).optional(), path: type({ integration_id: GetIntegrationsIntegrationIdIntegrationFieldsParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))) },
...
export const patch_PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdParameterIntegrationId, integration_field_id: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdParameterIntegrationFieldId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1, "integration_field_id": 1 }, key))), body: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdRequestBody },
  responses: { 200: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetIntegrationsIntegrationIdCustomFields = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetIntegrationsIntegrationIdCustomFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdCustomFieldsParameterPageSize }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1 }, key))).optional(), path: type({ integration_id: GetIntegrationsIntegrationIdCustomFieldsParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1 }, key))) },
  responses: { 200: GetIntegrationsIntegrationIdCustomFieldsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const put_PutIntegrationsIntegrationIdCustomFieldsCustomFieldId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterIntegrationId, custom_field_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterCustomFieldId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "integration_id": 1, "custom_field_id": 1 }, key))), body: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdRequestBody },
  responses: { 200: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetToolsCategory = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ category: GetToolsCategoryParameterCategory }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "category": 1 }, key))) },
  responses: { 200: GetToolsCategoryPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostHrisProvisioningGroupsGroupIdSetupLinks = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ group_id: PostHrisProvisioningGroupsGroupIdSetupLinksParameterGroupId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "group_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisProvisioningGroupsGroupIdSetupLinksRequestBody },
...
export const post_PostHrisEmployees = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisEmployeesRequestBody },
...
export const get_GetHrisEmployeesForm = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostHrisEmployeesForm = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisEmployeesFormRequestBody },
...
export const patch_PatchHrisEmployeesEmployeeId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PatchHrisEmployeesEmployeeIdParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PatchHrisEmployeesEmployeeIdRequestBody },
...
export const post_PostHrisEmployeesEmployeeIdDocuments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostHrisEmployeesEmployeeIdDocumentsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisEmployeesEmployeeIdDocumentsRequestBody },
...
export const get_GetHrisEmployeeDocumentCategories = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisEmployeeDocumentCategoriesParameterCursor, page_size: GetHrisEmployeeDocumentCategoriesParameterPageSize, updated_after: GetHrisEmployeeDocumentCategoriesParameterUpdatedAfter, include_deleted: GetHrisEmployeeDocumentCategoriesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisEmployeeDocumentCategoriesParameterIgnoreUnsupportedFilters, ids: GetHrisEmployeeDocumentCategoriesParameterIds, remote_ids: GetHrisEmployeeDocumentCategoriesParameterRemoteIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const get_GetHrisTeams = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisTeamsParameterCursor, page_size: GetHrisTeamsParameterPageSize, updated_after: GetHrisTeamsParameterUpdatedAfter, include_deleted: GetHrisTeamsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisTeamsParameterIgnoreUnsupportedFilters, ids: GetHrisTeamsParameterIds, remote_ids: GetHrisTeamsParameterRemoteIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const get_GetHrisGroups = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisGroupsParameterCursor, page_size: GetHrisGroupsParameterPageSize, updated_after: GetHrisGroupsParameterUpdatedAfter, include_deleted: GetHrisGroupsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisGroupsParameterIgnoreUnsupportedFilters, ids: GetHrisGroupsParameterIds, remote_ids: GetHrisGroupsParameterRemoteIds, types: GetHrisGroupsParameterTypes, name_contains: GetHrisGroupsParameterNameContains }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1, "types": 1, "name_contains": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const get_GetHrisAbsences = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisAbsencesParameterCursor, page_size: GetHrisAbsencesParameterPageSize, updated_after: GetHrisAbsencesParameterUpdatedAfter, include_deleted: GetHrisAbsencesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisAbsencesParameterIgnoreUnsupportedFilters, ids: GetHrisAbsencesParameterIds, remote_ids: GetHrisAbsencesParameterRemoteIds, date_from: GetHrisAbsencesParameterDateFrom, date_until: GetHrisAbsencesParameterDateUntil, type_ids: GetHrisAbsencesParameterTypeIds, employee_id: GetHrisAbsencesParameterEmployeeId, time_from: GetHrisAbsencesParameterTimeFrom, time_until: GetHrisAbsencesParameterTimeUntil }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1, "date_from": 1, "date_until": 1, "type_ids": 1, "employee_id": 1, "time_from": 1, "time_until": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostHrisAbsences = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisAbsencesRequestBody },
...
export const delete_DeleteHrisAbsencesAbsenceId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ absence_id: DeleteHrisAbsencesAbsenceIdParameterAbsenceId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "absence_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: DeleteHrisAbsencesAbsenceIdRequestBody },
...
export const get_GetHrisSkills = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ ids: GetHrisSkillsParameterIds, remote_ids: GetHrisSkillsParameterRemoteIds, name_contains: GetHrisSkillsParameterNameContains }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "ids": 1, "remote_ids": 1, "name_contains": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostHrisSkills = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisSkillsRequestBody },
...
export const patch_PatchHrisSkillsSkillId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ skill_id: PatchHrisSkillsSkillIdParameterSkillId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "skill_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PatchHrisSkillsSkillIdRequestBody },
...
export const delete_DeleteHrisSkillsSkillId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ skill_id: DeleteHrisSkillsSkillIdParameterSkillId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "skill_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: DeleteHrisSkillsSkillIdRequestBody },
...
export const post_PostHrisEmployeeSkillAssignments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostHrisEmployeeSkillAssignmentsRequestBody },
...
export const patch_PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_skill_assignment_id: PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_skill_assignment_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody },
...
export const put_PutAtsApplicationsApplicationIdStage = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PutAtsApplicationsApplicationIdStageParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PutAtsApplicationsApplicationIdStageRequestBody },
...
export const post_PostAtsApplicationsApplicationIdResultLinks = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdResultLinksParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsApplicationsApplicationIdResultLinksRequestBody },
...
export const post_PostAtsApplicationsApplicationIdNotes = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdNotesParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsApplicationsApplicationIdNotesRequestBody },
...
export const get_GetAtsApplicationsApplicationIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: GetAtsApplicationsApplicationIdAttachmentsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostAtsApplicationsApplicationIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdAttachmentsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsApplicationsApplicationIdAttachmentsRequestBody },
...
export const post_PostAtsApplicationsApplicationIdReject = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdRejectParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsApplicationsApplicationIdRejectRequestBody },
...
export const post_PostAtsApplicationsApplicationIdInterviews = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdInterviewsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsApplicationsApplicationIdInterviewsRequestBody },
...
export const patch_PatchAtsApplicationsApplicationIdInterviews = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PatchAtsApplicationsApplicationIdInterviewsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "application_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PatchAtsApplicationsApplicationIdInterviewsRequestBody },
...
export const post_PostAtsCandidates = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsCandidatesRequestBody },
...
export const get_GetAtsCandidatesCandidateIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: GetAtsCandidatesCandidateIdAttachmentsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "candidate_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostAtsCandidatesCandidateIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: PostAtsCandidatesCandidateIdAttachmentsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "candidate_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsCandidatesCandidateIdAttachmentsRequestBody },
...
export const post_PostAtsCandidatesCandidateIdResultLinks = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: PostAtsCandidatesCandidateIdResultLinksParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "candidate_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsCandidatesCandidateIdResultLinksRequestBody },
...
export const post_PostAtsCandidatesCandidateIdTags = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: PostAtsCandidatesCandidateIdTagsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "candidate_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsCandidatesCandidateIdTagsRequestBody },
...
export const delete_DeleteAtsCandidatesCandidateIdTags = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: DeleteAtsCandidatesCandidateIdTagsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "candidate_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: DeleteAtsCandidatesCandidateIdTagsRequestBody },
...
export const post_PostAtsJobsJobIdApplications = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_id: PostAtsJobsJobIdApplicationsParameterJobId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "job_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsJobsJobIdApplicationsRequestBody },
...
export const get_GetAtsUsers = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAtsUsersParameterCursor, page_size: GetAtsUsersParameterPageSize, updated_after: GetAtsUsersParameterUpdatedAfter, include_deleted: GetAtsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetAtsUsersParameterIgnoreUnsupportedFilters, ids: GetAtsUsersParameterIds, remote_ids: GetAtsUsersParameterRemoteIds, emails: GetAtsUsersParameterEmails }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1, "emails": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const get_GetAtsRoles = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAtsRolesParameterCursor, page_size: GetAtsRolesParameterPageSize, updated_after: GetAtsRolesParameterUpdatedAfter, include_deleted: GetAtsRolesParameterIncludeDeleted, ignore_unsupported_filters: GetAtsRolesParameterIgnoreUnsupportedFilters, ids: GetAtsRolesParameterIds, remote_ids: GetAtsRolesParameterRemoteIds, scopes: GetAtsRolesParameterScopes }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1, "scopes": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostAtsImportTrackedApplication = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsImportTrackedApplicationRequestBody },
...
export const post_PostAtsCustomAvionteSyncedJobs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostAtsCustomAvionteSyncedJobsRequestBody },
...
export const delete_DeleteAtsCustomAvionteSyncedJobsJobRemoteId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_remote_id: DeleteAtsCustomAvionteSyncedJobsJobRemoteIdParameterJobRemoteId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "job_remote_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: DeleteAtsCustomAvionteSyncedJobsJobRemoteIdRequestBody },
...
export const put_PutAssessmentPackages = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PutAssessmentPackagesRequestBody },
...
export const get_GetAssessmentOrdersOpen = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAssessmentOrdersOpenParameterCursor, page_size: GetAssessmentOrdersOpenParameterPageSize }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const put_PutAssessmentOrdersAssessmentOrderIdResult = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ assessment_order_id: PutAssessmentOrdersAssessmentOrderIdResultParameterAssessmentOrderId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "assessment_order_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PutAssessmentOrdersAssessmentOrderIdResultRequestBody },
...
export const get_GetLmsUsers = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsUsersParameterCursor, page_size: GetLmsUsersParameterPageSize, updated_after: GetLmsUsersParameterUpdatedAfter, include_deleted: GetLmsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetLmsUsersParameterIgnoreUnsupportedFilters, ids: GetLmsUsersParameterIds, remote_ids: GetLmsUsersParameterRemoteIds, work_emails: GetLmsUsersParameterWorkEmails }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1, "work_emails": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetLmsUsersPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetLmsCourseProgressions = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsCourseProgressionsParameterCursor, page_size: GetLmsCourseProgressionsParameterPageSize, updated_after: GetLmsCourseProgressionsParameterUpdatedAfter, include_deleted: GetLmsCourseProgressionsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCourseProgressionsParameterIgnoreUnsupportedFilters, ids: GetLmsCourseProgressionsParameterIds, remote_ids: GetLmsCourseProgressionsParameterRemoteIds, user_ids: GetLmsCourseProgressionsParameterUserIds, course_ids: GetLmsCourseProgressionsParameterCourseIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1, "user_ids": 1, "course_ids": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetLmsCourseProgressionsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostLmsCourseProgressions = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostLmsCourseProgressionsRequestBody },
  responses: { 200: PostLmsCourseProgressionsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostLmsCourseProgressionsCourseProgressionIdComplete = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ course_progression_id: PostLmsCourseProgressionsCourseProgressionIdCompleteParameterCourseProgressionId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "course_progression_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostLmsCourseProgressionsCourseProgressionIdCompleteRequestBody },
...
export const get_GetLmsCourses = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsCoursesParameterCursor, page_size: GetLmsCoursesParameterPageSize, updated_after: GetLmsCoursesParameterUpdatedAfter, include_deleted: GetLmsCoursesParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCoursesParameterIgnoreUnsupportedFilters, ids: GetLmsCoursesParameterIds, remote_ids: GetLmsCoursesParameterRemoteIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetLmsCoursesPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostLmsCoursesBulk = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostLmsCoursesBulkRequestBody },
  responses: { 200: PostLmsCoursesBulkPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetLmsCoursesBulkTaskId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ task_id: GetLmsCoursesBulkTaskIdParameterTaskId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "task_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetLmsCoursesBulkTaskIdPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostLmsCoursesCourseIdDeactivate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ course_id: PostLmsCoursesCourseIdDeactivateParameterCourseId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "course_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostLmsCoursesCourseIdDeactivateRequestBody },
...
export const get_GetLmsSkills = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsSkillsParameterCursor, page_size: GetLmsSkillsParameterPageSize, updated_after: GetLmsSkillsParameterUpdatedAfter, include_deleted: GetLmsSkillsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsSkillsParameterIgnoreUnsupportedFilters, ids: GetLmsSkillsParameterIds, remote_ids: GetLmsSkillsParameterRemoteIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "updated_after": 1, "include_deleted": 1, "ignore_unsupported_filters": 1, "ids": 1, "remote_ids": 1 }, key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetLmsSkillsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostAiApplyCareerSites = {
  ...
  responses: { 200: PostAiApplyCareerSitesPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetAiApplyCareerSites = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyCareerSitesParameterCursor, page_size: GetAiApplyCareerSitesParameterPageSize, ids: GetAiApplyCareerSitesParameterIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "ids": 1 }, key))).optional() },
  responses: { 200: GetAiApplyCareerSitesPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetAiApplyPostings = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyPostingsParameterCursor, page_size: GetAiApplyPostingsParameterPageSize, ids: GetAiApplyPostingsParameterIds, career_site_ids: GetAiApplyPostingsParameterCareerSiteIds, job_codes: GetAiApplyPostingsParameterJobCodes }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "ids": 1, "career_site_ids": 1, "job_codes": 1 }, key))).optional() },
  responses: { 200: GetAiApplyPostingsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostAiApplyPostings = {
  ...
  responses: { 200: PostAiApplyPostingsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostAiApplyPostingsPostingIdInquire = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ posting_id: PostAiApplyPostingsPostingIdInquireParameterPostingId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "posting_id": 1 }, key))), body: PostAiApplyPostingsPostingIdInquireRequestBody },
  responses: { 200: PostAiApplyPostingsPostingIdInquirePositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostAiApplyApply = {
  ...
  responses: { 200: PostAiApplyApplyPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetAiApplyApplications = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyApplicationsParameterCursor, page_size: GetAiApplyApplicationsParameterPageSize, ids: GetAiApplyApplicationsParameterIds, job_posting_ids: GetAiApplyApplicationsParameterJobPostingIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "ids": 1, "job_posting_ids": 1 }, key))).optional() },
  responses: { 200: GetAiApplyApplicationsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetAiApplyUnifiedApiJobs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyUnifiedApiJobsParameterCursor, page_size: GetAiApplyUnifiedApiJobsParameterPageSize, ids: GetAiApplyUnifiedApiJobsParameterIds, remote_ids: GetAiApplyUnifiedApiJobsParameterRemoteIds, job_codes: GetAiApplyUnifiedApiJobsParameterJobCodes, career_site_ids: GetAiApplyUnifiedApiJobsParameterCareerSiteIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "ids": 1, "remote_ids": 1, "job_codes": 1, "career_site_ids": 1 }, key))).optional() },
  responses: { 200: GetAiApplyUnifiedApiJobsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostAiApplyUnifiedApiJobsJobIdApplications = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_id: PostAiApplyUnifiedApiJobsJobIdApplicationsParameterJobId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "job_id": 1 }, key))), body: PostAiApplyUnifiedApiJobsJobIdApplicationsRequestBody },
...
export const get_GetAiApplyJobFeeds = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyJobFeedsParameterCursor, page_size: GetAiApplyJobFeedsParameterPageSize, ids: GetAiApplyJobFeedsParameterIds }).partial().narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "cursor": 1, "page_size": 1, "ids": 1 }, key))).optional() },
  responses: { 200: GetAiApplyJobFeedsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostAiApplyJobFeeds = {
  ...
  responses: { 200: PostAiApplyJobFeedsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetConnectIntegrationByTokenToken = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ token: GetConnectIntegrationByTokenTokenParameterToken }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "token": 1 }, key))) },
  responses: { 200: GetConnectIntegrationByTokenTokenPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostConnectActivateIntegration = {
  ...
  responses: { 200: PostConnectActivateIntegrationPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostCustomDatevPassthrough = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomDatevPassthroughRequestBody },
  responses: { 200: PostCustomDatevPassthroughPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetCustomDatevCheckEauPermission = {
  ...
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetCustomDatevCheckEauPermissionPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetCustomDatevEauRequestsEauId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ eau_id: GetCustomDatevEauRequestsEauIdParameterEauId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "eau_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetCustomDatevEauRequestsEauIdPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetCustomDatevCheckDocumentPermission = {
  ...
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetCustomDatevCheckDocumentPermissionPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetCustomDatevAvailableDocuments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ period: GetCustomDatevAvailableDocumentsParameterPeriod }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "period": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
...
export const post_PostCustomDatevDownloadDocument = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomDatevDownloadDocumentRequestBody },
  responses: { 200: PostCustomDatevDownloadDocumentPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostCustomDatevEmployeesEmployeeIdDownloadDocument = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostCustomDatevEmployeesEmployeeIdDownloadDocumentParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomDatevEmployeesEmployeeIdDownloadDocumentRequestBody },
...
export const post_PostCustomDatevEmployeesEmployeeIdEauRequests = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostCustomDatevEmployeesEmployeeIdEauRequestsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomDatevEmployeesEmployeeIdEauRequestsRequestBody },
...
export const put_PutCustomDatevEmployeesEmployeeIdPreparePayroll = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PutCustomDatevEmployeesEmployeeIdPreparePayrollParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PutCustomDatevEmployeesEmployeeIdPreparePayrollRequestBody },
...
export const put_PutCustomDatevEmployeesEmployeeIdCompensations = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PutCustomDatevEmployeesEmployeeIdCompensationsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PutCustomDatevEmployeesEmployeeIdCompensationsRequestBody },
  responses: { 200: PutCustomDatevEmployeesEmployeeIdCompensationsPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetCustomDatevCheckWritePermission = {
  ...
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetCustomDatevCheckWritePermissionPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const get_GetCustomDatevDataPushes = {
  ...
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))) },
  responses: { 200: GetCustomDatevDataPushesPositiveResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
...
export const post_PostCustomDatevPushDataGeneral = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomDatevPushDataGeneralRequestBody },
...
export const post_PostCustomDatevPushDataPayroll = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomDatevPushDataPayrollRequestBody },
...
export const post_PostCustomSilaeEmployeesEmployeeIdPayrollSupplements = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "employee_id": 1 }, key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "X-Integration-Id": 1 }, key))), body: PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsRequestBody },
...
export const post_PostAiApplyJobFeedsBulkImport = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_feed_id: type("string") }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "job_feed_id": 1 }, key))), body: type("string") },
  responses: { 200: BulkImportResponse, default: type({ status: type("'error'"), error: type({ code: type.enumerated("PLATFORM.RATE_LIMIT_EXCEEDED", "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED", "PLATFORM.INTEGRATION_NOT_FOUND", "PLATFORM.INPUT_INVALID", "PLATFORM.UNKNOWN_ERROR", "PLATFORM.IP_NOT_WHITELISTED", "PLATFORM.AUTHENTICATION_INVALID", "PLATFORM.TASK_TIMED_OUT", "REMOTE.SERVICE_UNAVAILABLE", "REMOTE.RATE_LIMIT_EXCEEDED", "REMOTE.INPUT_INVALID", "REMOTE.UNKNOWN_HTTP_ERROR", "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING", "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT").or(type("null")), title: type("string").or(type("null")), message: type("string"), log_url: type("string.url").or(type("null")) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "code": 1, "title": 1, "message": 1, "log_url": 1 }, key))) }).narrow((data) => Object.keys(data).every((key) => Object.prototype.hasOwnProperty.call({ "status": 1, "error": 1 }, key))) },
};
