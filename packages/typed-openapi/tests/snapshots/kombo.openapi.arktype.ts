...
const __schemas = type.module({
  ...
  PostAiApplyApplyRequestBody: { submission_token: type("string"), candidate_email: type("string.email"), "query_params?": { "[string]": type("string") }, screening_question_answers: type({ question_id: type("string"), answer: [[type("string"), "|", [type("string").array(), "|", [type("number"), "|", [type("boolean"), "|", { name: type("string"), content_type: type("string"), data: type("string") }]]]], ":", (data) => [type("string").allows(data), type("string").array().allows(data), type("number").allows(data), type("boolean").allows(data), type({ name: type("string"), content_type: type("string"), data: type("string") }).allows(data)].filter(Boolean).length === 1] }).array(), "additional_clicks?": type("0 <= number.integer <= 30"), "additional_clicks_scatter_duration?": type("number.integer >= 1") },
...
export const post_PostForceSync = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostForceSyncRequestBody },
...
export const post_PostPassthroughToolApi = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ tool: PostPassthroughToolApiParameterTool, api: PostPassthroughToolApiParameterApi }).narrow((data) => Object.keys(data).every((key) => ["tool", "api"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostPassthroughToolApiRequestBody },
...
export const delete_DeleteIntegrationsIntegrationId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: DeleteIntegrationsIntegrationIdParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))), body: DeleteIntegrationsIntegrationIdRequestBody },
...
export const get_GetIntegrationsIntegrationId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: GetIntegrationsIntegrationIdParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))) },
...
export const put_PutIntegrationsIntegrationIdEnabled = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PutIntegrationsIntegrationIdEnabledParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))), body: PutIntegrationsIntegrationIdEnabledRequestBody },
...
export const post_PostIntegrationsIntegrationIdRelink = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PostIntegrationsIntegrationIdRelinkParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))), body: PostIntegrationsIntegrationIdRelinkRequestBody },
...
export const post_PostIntegrationsIntegrationIdSetupLink = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PostIntegrationsIntegrationIdSetupLinkParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))), body: PostIntegrationsIntegrationIdSetupLinkRequestBody },
...
export const get_GetIntegrationsIntegrationIdIntegrationFields = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetIntegrationsIntegrationIdIntegrationFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdIntegrationFieldsParameterPageSize }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size"].includes(key))).optional(), path: type({ integration_id: GetIntegrationsIntegrationIdIntegrationFieldsParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))) },
...
export const get_GetIntegrationsIntegrationIdCustomFields = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetIntegrationsIntegrationIdCustomFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdCustomFieldsParameterPageSize }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size"].includes(key))).optional(), path: type({ integration_id: GetIntegrationsIntegrationIdCustomFieldsParameterIntegrationId }).narrow((data) => Object.keys(data).every((key) => ["integration_id"].includes(key))) },
...
export const put_PutIntegrationsIntegrationIdCustomFieldsCustomFieldId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ integration_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterIntegrationId, custom_field_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterCustomFieldId }).narrow((data) => Object.keys(data).every((key) => ["integration_id", "custom_field_id"].includes(key))), body: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdRequestBody },
...
export const get_GetToolsCategory = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ category: GetToolsCategoryParameterCategory }).narrow((data) => Object.keys(data).every((key) => ["category"].includes(key))) },
...
export const post_PostHrisProvisioningGroupsGroupIdDiff = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ group_id: PostHrisProvisioningGroupsGroupIdDiffParameterGroupId }).narrow((data) => Object.keys(data).every((key) => ["group_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisProvisioningGroupsGroupIdDiffRequestBody },
...
export const post_PostHrisProvisioningGroupsGroupIdSetupLinks = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ group_id: PostHrisProvisioningGroupsGroupIdSetupLinksParameterGroupId }).narrow((data) => Object.keys(data).every((key) => ["group_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisProvisioningGroupsGroupIdSetupLinksRequestBody },
...
export const post_PostHrisEmployees = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisEmployeesRequestBody },
...
export const get_GetHrisEmployeesForm = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostHrisEmployeesForm = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisEmployeesFormRequestBody },
...
export const patch_PatchHrisEmployeesEmployeeId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PatchHrisEmployeesEmployeeIdParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PatchHrisEmployeesEmployeeIdRequestBody },
...
export const post_PostHrisEmployeesEmployeeIdDocuments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostHrisEmployeesEmployeeIdDocumentsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisEmployeesEmployeeIdDocumentsRequestBody },
...
export const get_GetHrisTeams = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisTeamsParameterCursor, page_size: GetHrisTeamsParameterPageSize, updated_after: GetHrisTeamsParameterUpdatedAfter, include_deleted: GetHrisTeamsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisTeamsParameterIgnoreUnsupportedFilters, ids: GetHrisTeamsParameterIds, remote_ids: GetHrisTeamsParameterRemoteIds }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisGroups = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisGroupsParameterCursor, page_size: GetHrisGroupsParameterPageSize, updated_after: GetHrisGroupsParameterUpdatedAfter, include_deleted: GetHrisGroupsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisGroupsParameterIgnoreUnsupportedFilters, ids: GetHrisGroupsParameterIds, remote_ids: GetHrisGroupsParameterRemoteIds, types: GetHrisGroupsParameterTypes, name_contains: GetHrisGroupsParameterNameContains }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "types", "name_contains"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisAbsences = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetHrisAbsencesParameterCursor, page_size: GetHrisAbsencesParameterPageSize, updated_after: GetHrisAbsencesParameterUpdatedAfter, include_deleted: GetHrisAbsencesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisAbsencesParameterIgnoreUnsupportedFilters, ids: GetHrisAbsencesParameterIds, remote_ids: GetHrisAbsencesParameterRemoteIds, date_from: GetHrisAbsencesParameterDateFrom, date_until: GetHrisAbsencesParameterDateUntil, type_ids: GetHrisAbsencesParameterTypeIds, employee_id: GetHrisAbsencesParameterEmployeeId, time_from: GetHrisAbsencesParameterTimeFrom, time_until: GetHrisAbsencesParameterTimeUntil }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "date_from", "date_until", "type_ids", "employee_id", "time_from", "time_until"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostHrisAbsences = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisAbsencesRequestBody },
...
export const delete_DeleteHrisAbsencesAbsenceId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ absence_id: DeleteHrisAbsencesAbsenceIdParameterAbsenceId }).narrow((data) => Object.keys(data).every((key) => ["absence_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: DeleteHrisAbsencesAbsenceIdRequestBody },
...
export const get_GetHrisSkills = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ ids: GetHrisSkillsParameterIds, remote_ids: GetHrisSkillsParameterRemoteIds, name_contains: GetHrisSkillsParameterNameContains }).partial().narrow((data) => Object.keys(data).every((key) => ["ids", "remote_ids", "name_contains"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostHrisSkills = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisSkillsRequestBody },
...
export const patch_PatchHrisSkillsSkillId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ skill_id: PatchHrisSkillsSkillIdParameterSkillId }).narrow((data) => Object.keys(data).every((key) => ["skill_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PatchHrisSkillsSkillIdRequestBody },
...
export const delete_DeleteHrisSkillsSkillId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ skill_id: DeleteHrisSkillsSkillIdParameterSkillId }).narrow((data) => Object.keys(data).every((key) => ["skill_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: DeleteHrisSkillsSkillIdRequestBody },
...
export const post_PostHrisEmployeeSkillAssignments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostHrisEmployeeSkillAssignmentsRequestBody },
...
export const patch_PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_skill_assignment_id: PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId }).narrow((data) => Object.keys(data).every((key) => ["employee_skill_assignment_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody },
...
export const delete_DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_skill_assignment_id: DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId }).narrow((data) => Object.keys(data).every((key) => ["employee_skill_assignment_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody },
...
export const put_PutAtsApplicationsApplicationIdStage = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PutAtsApplicationsApplicationIdStageParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PutAtsApplicationsApplicationIdStageRequestBody },
...
export const post_PostAtsApplicationsApplicationIdResultLinks = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdResultLinksParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsApplicationsApplicationIdResultLinksRequestBody },
...
export const post_PostAtsApplicationsApplicationIdNotes = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdNotesParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsApplicationsApplicationIdNotesRequestBody },
...
export const get_GetAtsApplicationsApplicationIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: GetAtsApplicationsApplicationIdAttachmentsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsApplicationsApplicationIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdAttachmentsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsApplicationsApplicationIdAttachmentsRequestBody },
...
export const post_PostAtsApplicationsApplicationIdReject = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdRejectParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsApplicationsApplicationIdRejectRequestBody },
...
export const post_PostAtsApplicationsApplicationIdInterviews = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PostAtsApplicationsApplicationIdInterviewsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsApplicationsApplicationIdInterviewsRequestBody },
...
export const patch_PatchAtsApplicationsApplicationIdInterviews = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ application_id: PatchAtsApplicationsApplicationIdInterviewsParameterApplicationId }).narrow((data) => Object.keys(data).every((key) => ["application_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PatchAtsApplicationsApplicationIdInterviewsRequestBody },
...
export const post_PostAtsCandidates = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsCandidatesRequestBody },
...
export const get_GetAtsCandidatesCandidateIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: GetAtsCandidatesCandidateIdAttachmentsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => ["candidate_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsCandidatesCandidateIdAttachments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: PostAtsCandidatesCandidateIdAttachmentsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => ["candidate_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsCandidatesCandidateIdAttachmentsRequestBody },
...
export const post_PostAtsCandidatesCandidateIdResultLinks = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: PostAtsCandidatesCandidateIdResultLinksParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => ["candidate_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsCandidatesCandidateIdResultLinksRequestBody },
...
export const post_PostAtsCandidatesCandidateIdTags = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: PostAtsCandidatesCandidateIdTagsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => ["candidate_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsCandidatesCandidateIdTagsRequestBody },
...
export const delete_DeleteAtsCandidatesCandidateIdTags = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ candidate_id: DeleteAtsCandidatesCandidateIdTagsParameterCandidateId }).narrow((data) => Object.keys(data).every((key) => ["candidate_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: DeleteAtsCandidatesCandidateIdTagsRequestBody },
...
export const post_PostAtsJobsJobIdApplications = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_id: PostAtsJobsJobIdApplicationsParameterJobId }).narrow((data) => Object.keys(data).every((key) => ["job_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsJobsJobIdApplicationsRequestBody },
...
export const get_GetAtsRoles = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAtsRolesParameterCursor, page_size: GetAtsRolesParameterPageSize, updated_after: GetAtsRolesParameterUpdatedAfter, include_deleted: GetAtsRolesParameterIncludeDeleted, ignore_unsupported_filters: GetAtsRolesParameterIgnoreUnsupportedFilters, ids: GetAtsRolesParameterIds, remote_ids: GetAtsRolesParameterRemoteIds, scopes: GetAtsRolesParameterScopes }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "scopes"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsImportTrackedApplication = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsImportTrackedApplicationRequestBody },
...
export const post_PostAtsCustomAvionteSyncedJobs = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostAtsCustomAvionteSyncedJobsRequestBody },
...
export const delete_DeleteAtsCustomAvionteSyncedJobsJobRemoteId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_remote_id: DeleteAtsCustomAvionteSyncedJobsJobRemoteIdParameterJobRemoteId }).narrow((data) => Object.keys(data).every((key) => ["job_remote_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: DeleteAtsCustomAvionteSyncedJobsJobRemoteIdRequestBody },
...
export const put_PutAssessmentPackages = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PutAssessmentPackagesRequestBody },
...
export const get_GetAssessmentOrdersOpen = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAssessmentOrdersOpenParameterCursor, page_size: GetAssessmentOrdersOpenParameterPageSize }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const put_PutAssessmentOrdersAssessmentOrderIdResult = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ assessment_order_id: PutAssessmentOrdersAssessmentOrderIdResultParameterAssessmentOrderId }).narrow((data) => Object.keys(data).every((key) => ["assessment_order_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PutAssessmentOrdersAssessmentOrderIdResultRequestBody },
...
export const get_GetLmsUsers = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsUsersParameterCursor, page_size: GetLmsUsersParameterPageSize, updated_after: GetLmsUsersParameterUpdatedAfter, include_deleted: GetLmsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetLmsUsersParameterIgnoreUnsupportedFilters, ids: GetLmsUsersParameterIds, remote_ids: GetLmsUsersParameterRemoteIds, work_emails: GetLmsUsersParameterWorkEmails }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "work_emails"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetLmsCourseProgressions = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsCourseProgressionsParameterCursor, page_size: GetLmsCourseProgressionsParameterPageSize, updated_after: GetLmsCourseProgressionsParameterUpdatedAfter, include_deleted: GetLmsCourseProgressionsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCourseProgressionsParameterIgnoreUnsupportedFilters, ids: GetLmsCourseProgressionsParameterIds, remote_ids: GetLmsCourseProgressionsParameterRemoteIds, user_ids: GetLmsCourseProgressionsParameterUserIds, course_ids: GetLmsCourseProgressionsParameterCourseIds }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "user_ids", "course_ids"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostLmsCourseProgressions = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostLmsCourseProgressionsRequestBody },
...
export const post_PostLmsCourseProgressionsCourseProgressionIdComplete = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ course_progression_id: PostLmsCourseProgressionsCourseProgressionIdCompleteParameterCourseProgressionId }).narrow((data) => Object.keys(data).every((key) => ["course_progression_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostLmsCourseProgressionsCourseProgressionIdCompleteRequestBody },
...
export const get_GetLmsCourses = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetLmsCoursesParameterCursor, page_size: GetLmsCoursesParameterPageSize, updated_after: GetLmsCoursesParameterUpdatedAfter, include_deleted: GetLmsCoursesParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCoursesParameterIgnoreUnsupportedFilters, ids: GetLmsCoursesParameterIds, remote_ids: GetLmsCoursesParameterRemoteIds }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))).optional(), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostLmsCoursesBulk = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostLmsCoursesBulkRequestBody },
...
export const get_GetLmsCoursesBulkTaskId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ task_id: GetLmsCoursesBulkTaskIdParameterTaskId }).narrow((data) => Object.keys(data).every((key) => ["task_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostLmsCoursesCourseIdDeactivate = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ course_id: PostLmsCoursesCourseIdDeactivateParameterCourseId }).narrow((data) => Object.keys(data).every((key) => ["course_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostLmsCoursesCourseIdDeactivateRequestBody },
...
export const get_GetAiApplyCareerSites = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyCareerSitesParameterCursor, page_size: GetAiApplyCareerSitesParameterPageSize, ids: GetAiApplyCareerSitesParameterIds }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "ids"].includes(key))).optional() },
...
export const get_GetAiApplyPostings = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyPostingsParameterCursor, page_size: GetAiApplyPostingsParameterPageSize, ids: GetAiApplyPostingsParameterIds, career_site_ids: GetAiApplyPostingsParameterCareerSiteIds, job_codes: GetAiApplyPostingsParameterJobCodes }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "ids", "career_site_ids", "job_codes"].includes(key))).optional() },
...
export const post_PostAiApplyPostingsPostingIdInquire = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ posting_id: PostAiApplyPostingsPostingIdInquireParameterPostingId }).narrow((data) => Object.keys(data).every((key) => ["posting_id"].includes(key))), body: PostAiApplyPostingsPostingIdInquireRequestBody },
...
export const get_GetAiApplyApplications = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyApplicationsParameterCursor, page_size: GetAiApplyApplicationsParameterPageSize, ids: GetAiApplyApplicationsParameterIds, job_posting_ids: GetAiApplyApplicationsParameterJobPostingIds }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "ids", "job_posting_ids"].includes(key))).optional() },
...
export const post_PostAiApplyUnifiedApiJobsJobIdApplications = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_id: PostAiApplyUnifiedApiJobsJobIdApplicationsParameterJobId }).narrow((data) => Object.keys(data).every((key) => ["job_id"].includes(key))), body: PostAiApplyUnifiedApiJobsJobIdApplicationsRequestBody },
...
export const get_GetAiApplyJobFeeds = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ cursor: GetAiApplyJobFeedsParameterCursor, page_size: GetAiApplyJobFeedsParameterPageSize, ids: GetAiApplyJobFeedsParameterIds }).partial().narrow((data) => Object.keys(data).every((key) => ["cursor", "page_size", "ids"].includes(key))).optional() },
...
export const get_GetConnectIntegrationByTokenToken = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ token: GetConnectIntegrationByTokenTokenParameterToken }).narrow((data) => Object.keys(data).every((key) => ["token"].includes(key))) },
...
export const post_PostCustomDatevPassthrough = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomDatevPassthroughRequestBody },
...
export const get_GetCustomDatevEauRequestsEauId = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ eau_id: GetCustomDatevEauRequestsEauIdParameterEauId }).narrow((data) => Object.keys(data).every((key) => ["eau_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetCustomDatevAvailableDocuments = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { query: type({ period: GetCustomDatevAvailableDocumentsParameterPeriod }).narrow((data) => Object.keys(data).every((key) => ["period"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostCustomDatevDownloadDocument = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomDatevDownloadDocumentRequestBody },
...
export const post_PostCustomDatevEmployeesEmployeeIdDownloadDocument = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostCustomDatevEmployeesEmployeeIdDownloadDocumentParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomDatevEmployeesEmployeeIdDownloadDocumentRequestBody },
...
export const post_PostCustomDatevEmployeesEmployeeIdEauRequests = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostCustomDatevEmployeesEmployeeIdEauRequestsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomDatevEmployeesEmployeeIdEauRequestsRequestBody },
...
export const put_PutCustomDatevEmployeesEmployeeIdPreparePayroll = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PutCustomDatevEmployeesEmployeeIdPreparePayrollParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PutCustomDatevEmployeesEmployeeIdPreparePayrollRequestBody },
...
export const put_PutCustomDatevEmployeesEmployeeIdCompensations = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PutCustomDatevEmployeesEmployeeIdCompensationsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PutCustomDatevEmployeesEmployeeIdCompensationsRequestBody },
...
export const post_PostCustomDatevPushDataGeneral = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomDatevPushDataGeneralRequestBody },
...
export const post_PostCustomDatevPushDataPayroll = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomDatevPushDataPayrollRequestBody },
...
export const post_PostCustomSilaeEmployeesEmployeeIdPayrollSupplements = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ employee_id: PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsParameterEmployeeId }).narrow((data) => Object.keys(data).every((key) => ["employee_id"].includes(key))), header: type({ "X-Integration-Id": type("string") }).narrow((data) => Object.keys(data).every((key) => ["X-Integration-Id"].includes(key))), body: PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsRequestBody },
...
export const post_PostAiApplyJobFeedsBulkImport = {
  ...
  requestFormat: type("'json'"),
  responseFormat: type("'json'"),
  parameters: { path: type({ job_feed_id: type("string") }).narrow((data) => Object.keys(data).every((key) => ["job_feed_id"].includes(key))), body: type("string") },
