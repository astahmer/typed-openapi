...
export type DistributionInspect = { Descriptor: OCIDescriptor, Platforms: Array<OCIPlatform> }
  ...
  export type get_ContainerList = {
      ...
      responses: {200: Array<Schemas.ContainerSummary>,
...
export type post_ContainerCreate = {
      ...
      parameters: {
        ...
        body:  (Schemas.ContainerConfig & Partial<{ HostConfig: Schemas.HostConfig, NetworkingConfig: Schemas.NetworkingConfig }>),
          }
...
export type get_ContainerInspect = {
      ...
      responses: {200: Partial<{ Id: string, Created: string, Path: string, Args: Array<string>, State: Schemas.ContainerState, Image: string, ResolvConfPath: string, HostnamePath: string, HostsPath: string, LogPath: string, Name: string, RestartCount: number, Driver: string, Platform: string, MountLabel: string, ProcessLabel: string, AppArmorProfile: string, ExecIDs: (Array<string> | null), HostConfig: Schemas.HostConfig, GraphDriver: Schemas.GraphDriverData, SizeRw: number, SizeRootFs: number, Mounts: Array<Schemas.MountPoint>, Config: Schemas.ContainerConfig, NetworkSettings: Schemas.NetworkSettings }>,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type get_ContainerLogs = {
      ...
      responseFormat: "json",
      parameters: {
            query?:  Partial<{ follow: boolean, stdout: boolean, stderr: boolean, since: number, until: number, timestamps: boolean, tail: string }>,
        path:  { id: string },
...
export type get_ContainerChanges = {
      ...
      responses: {200: Array<Schemas.FilesystemChange>,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type post_ContainerUpdate = {
      ...
      responses: {200: Partial<{ Warnings: Array<string> }>,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type post_ContainerAttach = {
      ...
      responseFormat: "json",
      parameters: {
            query?:  Partial<{ detachKeys: string, logs: boolean, stream: boolean, stdin: boolean, stdout: boolean, stderr: boolean }>,
        path:  { id: string },
...
export type post_ContainerWait = {
      ...
      responses: {200: Schemas.ContainerWaitResponse,
400: Schemas.ErrorResponse,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type post_ContainerPrune = {
      ...
      responses: {200: Partial<{ ContainersDeleted: Array<string>, SpaceReclaimed: number }>,
500: Schemas.ErrorResponse,
},
...
export type get_ImageList = {
      ...
      responses: {200: Array<Schemas.ImageSummary>,
500: Schemas.ErrorResponse,
},
...
export type post_ImageBuild = {
      ...
      responseFormat: "json",
      parameters: {
            query?:  Partial<{ dockerfile: string, t: string, extrahosts: string, remote: string, q: boolean, nocache: boolean, cachefrom: string, pull: string, rm: boolean, forcerm: boolean, memory: number, memswap: number, cpushares: number, cpusetcpus: string, cpuperiod: number, cpuquota: number, buildargs: string, shmsize: number, squash: boolean, labels: string, networkmode: string, platform: string, target: string, outputs: string }>,
...
export type post_BuildPrune = {
      ...
      responses: {200: Partial<{ CachesDeleted: Array<string>, SpaceReclaimed: number }>,
500: Schemas.ErrorResponse,
},
...
export type post_ImageCreate = {
      ...
      responseFormat: "json",
      parameters: {
            query?:  Partial<{ fromImage: string, fromSrc: string, repo: string, tag: string, message: string, changes: Array<string>, platform: string }>,
...
export type get_ImageInspect = {
      ...
      responses: {200: Schemas.ImageInspect,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type delete_ImageDelete = {
      ...
      responses: {200: Array<Schemas.ImageDeleteResponseItem>,
404: Schemas.ErrorResponse,
409: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type get_ImageSearch = {
      ...
      responses: {200: Array<Partial<{ description: string, is_official: boolean, is_automated: boolean, name: string, star_count: number }>>,
500: Schemas.ErrorResponse,
},
...
export type post_ImagePrune = {
      ...
      responses: {200: Partial<{ ImagesDeleted: Array<Schemas.ImageDeleteResponseItem>, SpaceReclaimed: number }>,
500: Schemas.ErrorResponse,
},
...
export type get_SystemInfo = {
      ...
      responseFormat: "json",
      parameters: never,
      responses: {200: Schemas.SystemInfo,
500: Schemas.ErrorResponse,
},
...
export type get_SystemVersion = {
      ...
      responseFormat: "json",
      parameters: never,
      responses: {200: Schemas.SystemVersion,
500: Schemas.ErrorResponse,
},
...
export type post_ImageCommit = {
      ...
      responseFormat: "json",
      parameters: {
            query?:  Partial<{ container: string, repo: string, tag: string, comment: string, author: string, pause: boolean, changes: string }>,
        
        
        
        body:  Schemas.ContainerConfig,
          }
      responses: {201: Schemas.IdResponse,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type get_SystemEvents = {
      ...
      responses: {200: Schemas.EventMessage,
400: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type post_ContainerExec = {
      ...
      parameters: {
        ...
        body?:  Partial<{ AttachStdin: boolean, AttachStdout: boolean, AttachStderr: boolean, ConsoleSize: (Array<number> | null), DetachKeys: string, Tty: boolean, Env: Array<string>, Cmd: Array<string>, Privileged: boolean, User: string, WorkingDir: string }>,
          }
      responses: {201: Schemas.IdResponse,
404: Schemas.ErrorResponse,
409: Schemas.ErrorResponse,
...
export type get_ExecInspect = {
      ...
      responses: {200: Partial<{ CanRemove: boolean, DetachKeys: string, ID: string, Running: boolean, ExitCode: number, ProcessConfig: Schemas.ProcessConfig, OpenStdin: boolean, OpenStderr: boolean, OpenStdout: boolean, ContainerID: string, Pid: number }>,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
...
export type get_VolumeList = {
      ...
      responses: {200: Schemas.VolumeListResponse,
500: Schemas.ErrorResponse,
},
...
export type post_VolumePrune = {
      ...
      responses: {200: Partial<{ VolumesDeleted: Array<string>, SpaceReclaimed: number }>,
500: Schemas.ErrorResponse,
},
...
export type get_NetworkList = {
      ...
      responses: {200: Array<Schemas.Network>,
500: Schemas.ErrorResponse,
},
...
export type post_NetworkPrune = {
      ...
      responses: {200: Partial<{ NetworksDeleted: Array<string> }>,
500: Schemas.ErrorResponse,
},
...
export type get_PluginList = {
      ...
      responses: {200: Array<Schemas.Plugin>,
500: Schemas.ErrorResponse,
},
...
export type post_SwarmUpdate = {
      ...
      responseFormat: "json",
      parameters: {
            query:  { version: number, rotateWorkerToken?: boolean, rotateManagerToken?: boolean, rotateManagerUnlockKey?: boolean },
...
export type post_ServiceUpdate = {
      ...
      responses: {200: Schemas.ServiceUpdateResponse,
400: Schemas.ErrorResponse,
404: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
503: Schemas.ErrorResponse,
...
export type get_ServiceLogs = {
      ...
      responseFormat: "json",
      parameters: {
            query?:  Partial<{ details: boolean, follow: boolean, stdout: boolean, stderr: boolean, since: number, timestamps: boolean, tail: string }>,
        path:  { id: string },
...
export type get_TaskList = {
      ...
      responses: {200: Array<Schemas.Task>,
500: Schemas.ErrorResponse,
503: Schemas.ErrorResponse,
},
...
export type get_SecretList = {
      ...
      responses: {200: Array<Schemas.Secret>,
500: Schemas.ErrorResponse,
503: Schemas.ErrorResponse,
},
...
export type get_ConfigList = {
      ...
      responses: {200: Array<Schemas.Config>,
500: Schemas.ErrorResponse,
503: Schemas.ErrorResponse,
},
...
export type get_DistributionInspect = {
      ...
      responses: {200: Schemas.DistributionInspect,
401: Schemas.ErrorResponse,
500: Schemas.ErrorResponse,
},
