...
export namespace Endpoints {
  ...
  export type post_SystemAuth = {
    ...
    responses: {
      200: { Status: string; IdentityToken?: string };
      204: unknown;
...
export const endpointRequestFormats = {
  get: {
    ...
    "/containers/{id}/json": "json",
    "/containers/{id}/top": "json",
    "/containers/{id}/logs": "json",
    "/containers/{id}/changes": "json",
    "/containers/{id}/export": "json",
    "/containers/{id}/stats": "json",
    "/containers/{id}/attach/ws": "json",
    "/containers/{id}/archive": "json",
    "/images/json": "json",
    "/images/{name}/json": "json",
    "/images/{name}/history": "json",
    "/images/search": "json",
    "/info": "json",
    "/version": "json",
    "/_ping": "json",
    ...
    "/networks/{id}": "json",
    "/plugins": "json",
    "/plugins/privileges": "json",
    "/plugins/{name}/json": "json",
    "/nodes": "json",
    "/nodes/{id}": "json",
    "/swarm": "json",
    "/swarm/unlockkey": "json",
    "/services": "json",
    "/services/{id}": "json",
    "/services/{id}/logs": "json",
    "/tasks": "json",
    "/tasks/{id}": "json",
    "/tasks/{id}/logs": "json",
    "/secrets": "json",
    ...
    "/configs": "json",
    "/configs/{id}": "json",
    "/distribution/{name}/json": "json",
  },
  post: {
    "/containers/create": "json",
    "/containers/{id}/resize": "json",
    "/containers/{id}/start": "json",
    "/containers/{id}/stop": "json",
    "/containers/{id}/restart": "json",
    "/containers/{id}/kill": "json",
    "/containers/{id}/update": "json",
    "/containers/{id}/rename": "json",
    "/containers/{id}/pause": "json",
    "/containers/{id}/unpause": "json",
    "/containers/{id}/attach": "json",
    "/containers/{id}/wait": "json",
    "/containers/prune": "json",
    "/build": "binary",
    "/build/prune": "json",
    "/images/create": "text",
    "/images/{name}/push": "json",
    "/images/{name}/tag": "json",
    "/images/prune": "json",
    "/auth": "json",
    "/commit": "json",
    "/images/load": "text",
    "/containers/{id}/exec": "json",
    "/exec/{id}/start": "json",
    "/exec/{id}/resize": "json",
    "/volumes/create": "json",
    "/volumes/prune": "json",
    "/networks/create": "json",
    "/networks/{id}/connect": "json",
    "/networks/{id}/disconnect": "json",
    "/networks/prune": "json",
    "/plugins/pull": "json",
    "/plugins/{name}/enable": "json",
    "/plugins/{name}/disable": "json",
    "/plugins/{name}/upgrade": "json",
    "/plugins/create": "text",
    "/plugins/{name}/push": "json",
    "/plugins/{name}/set": "json",
    "/nodes/{id}/update": "json",
    "/swarm/init": "json",
    "/swarm/join": "json",
    "/swarm/leave": "json",
    "/swarm/update": "json",
    ...
    "/services/{id}/update": "json",
    "/secrets/create": "json",
    "/secrets/{id}/update": "json",
    "/configs/create": "json",
    "/configs/{id}/update": "json",
    "/session": "json",
  },
  delete: {
    "/containers/{id}": "json",
