...
export const PostPassthroughToolApiPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ url: z.string().url(), status: z.number().int(), headers: z.record(z.string(), z.union([z.string(), z.array(z.string())])), data: z.unknown().optional() }), warnings: z.array(z.object({ message: z.string() })) });
...
export const Schema4: z.ZodType<Schema4> = z.lazy(() => z.union([z.string(), z.number().min(-1.7976931348623157e+308), z.boolean(), z.lazy(() => Schema5), Schema6]));
