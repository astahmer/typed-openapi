...
export const PostIntegrationsIntegrationIdRelinkPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ link: z.string().url() }) });
...
export const PostIntegrationsIntegrationIdSetupLinkPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ link: z.string().url() }) });
...
export const PostHrisProvisioningGroupsGroupIdSetupLinksPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ url: z.string().url(), expires_at: z.string().datetime() }) });
...
export const GetAiApplyPostingsPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ results: z.array(z.object({ id: z.string(), career_site: z.object({ id: z.string(), label: z.string() }), url: z.string(), job_code: z.string().nullable(), created_at: z.string().datetime(), updated_at: z.string().datetime(), archived_at: z.string().datetime().nullable(), archived_reason: z.enum(["JOB_POSTING_TAKEN_OFFLINE", "MANUAL_ARCHIVE", "REMOVED_FROM_JOB_FEED"]).nullable(), availability: z.enum(["APPLYABLE", "PENDING", "ARCHIVED", "UNAVAILABLE"]) })), next: z.string().nullable() }) });

export type PostAiApplyPostingsPositiveResponse = z.infer<typeof PostAiApplyPostingsPositiveResponse>;
export const PostAiApplyPostingsPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ id: z.string(), career_site: z.object({ id: z.string(), label: z.string() }), url: z.string(), job_code: z.string().nullable(), created_at: z.string().datetime(), updated_at: z.string().datetime(), archived_at: z.string().datetime().nullable(), archived_reason: z.enum(["JOB_POSTING_TAKEN_OFFLINE", "MANUAL_ARCHIVE", "REMOVED_FROM_JOB_FEED"]).nullable(), availability: z.enum(["APPLYABLE", "PENDING", "ARCHIVED", "UNAVAILABLE"]) }) });
...
export const PostAiApplyApplyPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ id: z.string(), posting_id: z.string(), status: z.string(), created_at: z.string().datetime(), updated_at: z.string().datetime() }) });

export type PostAiApplyApplyRequestBody = z.infer<typeof PostAiApplyApplyRequestBody>;
export const PostAiApplyApplyRequestBody = z.object({ submission_token: z.string(), candidate_email: z.string().email(), query_params: z.record(z.string(), z.string()).optional(), screening_question_answers: z.array(z.object({ question_id: z.string(), answer: z.union([z.string(), z.array(z.string()), z.number().min(-1.7976931348623157e+308), z.boolean(), z.object({ name: z.string(), content_type: z.string(), data: z.string() })]).refine((data) => [z.string().safeParse(data).success, z.array(z.string()).safeParse(data).success, z.number().min(-1.7976931348623157e+308).safeParse(data).success, z.boolean().safeParse(data).success, z.object({ name: z.string(), content_type: z.string(), data: z.string() }).safeParse(data).success].filter(Boolean).length === 1, { message: "oneOf" }) })), additional_clicks: z.number().int().min(0).max(30).optional(), additional_clicks_scatter_duration: z.number().int().min(1).optional() });
...
export const GetAiApplyApplicationsPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ results: z.array(z.object({ id: z.string(), job_posting_id: z.string(), status: z.enum(["SUBMITTED", "DUPLICATE", "PENDING", "FAILED"]), created_at: z.string().datetime(), updated_at: z.string().datetime() })), next: z.string().nullable() }) });
...
export const PostConnectCreateLinkPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ link: z.string().url() }) });
...
export const PostCustomDatevDownloadDocumentPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ data_url: z.string().url(), file_name: z.string(), content_type: z.string() }), warnings: z.array(z.object({ message: z.string() })) });
...
export const PostCustomDatevEmployeesEmployeeIdDownloadDocumentPositiveResponse = z.object({ status: z.literal("success"), data: z.object({ data_url: z.string().url(), file_name: z.string(), content_type: z.string() }), warnings: z.array(z.object({ message: z.string() })) });
