...
// <Schemas>
export type GetCheckApiKeyPositiveResponse = ({ status: "success", data: ({ environment_id: string, customer_id: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostForceSyncPositiveResponse = ({ status: "success", data: ({ already_queued: boolean, sync_id: string, type: ("FULL" | "DELTA") } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostPassthroughToolApiPositiveResponse = ({ status: "success", data: ({ url: string, status: number, headers: Record<string, (string | Array<string>)>, data?: unknown } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
export const isPostPassthroughToolApiPositiveResponse = ((input: unknown): input is ({ status: "success", data: ({ url: string, status: number, headers: Record<string, (string | Array<string>)>, data?: unknown } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ status: "success", data: ({ url: string, status: number, headers: Record<string, (string | Array<string>)>, data?: unknown } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "data") || (((input: unknown): input is ({ url: string, status: number, headers: Record<string, (string | Array<string>)>, data?: unknown } & Record<string, unknown>) => typia.createIs<({ url: string, status: number, headers: Record<string, (string | Array<string>)>, data?: unknown } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "headers") || (((input: unknown): input is Record<string, (string | Array<string>)> => typia.createIs<Record<string, (string | Array<string>)>>()(input) && Object.values(input as Record<string, unknown>).every((item) => (((input: unknown): input is (string | Array<string>) => typia.createIs<(string | Array<string>)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<Array<string>>())(input)].filter(Boolean).length === 1))(item))))((input as Record<string, unknown>)["headers"]))))((input as Record<string, unknown>)["data"])));
export const assertPostPassthroughToolApiPositiveResponse = (input: unknown): PostPassthroughToolApiPositiveResponse => { if (!isPostPassthroughToolApiPositiveResponse(input)) throw new Error("typia validation failed"); return input as PostPassthroughToolApiPositiveResponse; };
export const validatePostPassthroughToolApiPositiveResponse = (input: unknown): typia.IValidation<PostPassthroughToolApiPositiveResponse> => isPostPassthroughToolApiPositiveResponse(input) ? { success: true, data: input as PostPassthroughToolApiPositiveResponse } : { success: false, data: input, errors: [] };

export type PostPassthroughToolApiRequestBody = ({ method: ("GET" | "POST" | "DELETE" | "PUT" | "PATCH"), path: string, headers?: Record<string, string>, params?: Record<string, string>, data?: unknown, response_as_base64?: boolean, multipart_form_data?: Array<({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)>, api_options?: Record<string, string> } & Record<string, unknown>);
export const isPostPassthroughToolApiRequestBody = ((input: unknown): input is ({ method: ("GET" | "POST" | "DELETE" | "PUT" | "PATCH"), path: string, headers?: Record<string, string>, params?: Record<string, string>, data?: unknown, response_as_base64?: boolean, multipart_form_data?: Array<({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)>, api_options?: Record<string, string> } & Record<string, unknown>) => typia.createIs<({ method: ("GET" | "POST" | "DELETE" | "PUT" | "PATCH"), path: string, headers?: Record<string, string>, params?: Record<string, string>, data?: unknown, response_as_base64?: boolean, multipart_form_data?: Array<({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)>, api_options?: Record<string, string> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "multipart_form_data") || (((input: unknown): input is Array<({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)> => typia.createIs<Array<({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ name: string, value: (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "value") || (((input: unknown): input is (string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) => typia.createIs<(string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>))>()(input) && [(typia.createIs<string>())(input), (typia.createIs<({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["value"]))))(item))))((input as Record<string, unknown>)["multipart_form_data"])));
export const assertPostPassthroughToolApiRequestBody = (input: unknown): PostPassthroughToolApiRequestBody => { if (!isPostPassthroughToolApiRequestBody(input)) throw new Error("typia validation failed"); return input as PostPassthroughToolApiRequestBody; };
export const validatePostPassthroughToolApiRequestBody = (input: unknown): typia.IValidation<PostPassthroughToolApiRequestBody> => isPostPassthroughToolApiRequestBody(input) ? { success: true, data: input as PostPassthroughToolApiRequestBody } : { success: false, data: input, errors: [] };
...
export type DeleteIntegrationsIntegrationIdPositiveResponse = ({ status: "success", data: Record<string, unknown> } & Record<string, unknown>);
...
export type GetIntegrationsIntegrationIdPositiveResponse = ({ status: "success", data: ({ id: string, tool: ({ id: string, label: string, internal_label: (string | null), logo_url: string, icon_url: string } & Record<string, unknown>), category: ("HRIS" | "ATS" | "ASSESSMENT" | "LMS"), status: ("ACTIVE" | "INVALID" | "INACTIVE"), setup_status: ("INCOMPLETE" | "FINAL_SYNC_PENDING" | "COMPLETED"), end_user: ({ organization_name: string, creator_email: (string | null), origin_id: (string | null) } & Record<string, unknown>), scope_config: ({ id: string, name: (string | null) } & Record<string, unknown>), data_expired_at: (string | null), created_at: string, beta: boolean, read_models: Array<({ id: string, label: string, is_available: boolean, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN"), scope_config_setting: ("ENABLED" | "DISABLED" | "OPTIONAL"), opted_out_by_customer: boolean, fields: Array<({ id: string, is_available: boolean, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN"), scope_config_setting: ("ENABLED" | "DISABLED" | "OPTIONAL"), opted_out_by_customer: boolean } & Record<string, unknown>)> } & Record<string, unknown>)>, write_actions: Array<({ id: string, label: string, is_available: boolean, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN"), scope_config_setting: ("ENABLED" | "DISABLED" | "OPTIONAL"), opted_out_by_customer: boolean, fields: Array<({ id: string, is_available: boolean, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN") } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PutIntegrationsIntegrationIdEnabledPositiveResponse = ({ status: "success", data: Record<string, unknown> } & Record<string, unknown>);
...
export type PutIntegrationsIntegrationIdEnabledRequestBody = ({ value: boolean } & Record<string, unknown>);
...
export type PostIntegrationsIntegrationIdRelinkPositiveResponse = ({ status: "success", data: ({ link: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostIntegrationsIntegrationIdSetupLinkPositiveResponse = ({ status: "success", data: ({ link: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostIntegrationsIntegrationIdSetupLinkRequestBody = ({ language?: (("en" | "de" | "fr" | "it" | "es") | null), link_type: ("EMBEDDED" | "MAGIC_LINK") } & Record<string, unknown>);
...
export type GetIntegrationsIntegrationIdIntegrationFieldsPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, key: string, model: string, type: ("DEFAULT" | "CUSTOM"), label: (string | null), is_passthrough_enabled: boolean, is_writable: false } & Record<string, unknown>)>, next_cursor: (string | null), next: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdPositiveResponse = ({ status: "success", data: ({ id: string, key: string, model: string, type: ("DEFAULT" | "CUSTOM"), label: (string | null), is_passthrough_enabled: boolean, is_writable: false } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdRequestBody = ({ enable_passthrough: (boolean | null) } & Record<string, unknown>);
...
export type GetIntegrationsIntegrationIdCustomFieldsPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, key: string, integration_field: (({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), label: (string | null) } & Record<string, unknown>) | null), model: string, label: (string | null), description: (string | null) } & Record<string, unknown>)>, next_cursor: (string | null), next: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdRequestBody = ({ integration_field_id: (string | null) } & Record<string, unknown>);
...
export type GetToolsCategoryPositiveResponse = ({ status: "success", data: ({ tools: Array<({ id: string, label: string, internal_label: (string | null), assets: ({ logo_url: string, icon_url: string, icon_black_url: string } & Record<string, unknown>), paid_api_details_markdown: (string | null), fast_track_details_markdown: (string | null), partner_only_details_markdown: (string | null), connection_guide_url: (string | null), coverage: ({ read_models: Array<({ id: string, label: string, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN"), fields: Array<({ id: string, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN") } & Record<string, unknown>)> } & Record<string, unknown>)>, write_actions: Array<({ id: string, label: string, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN"), fields: Array<({ id: string, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN") } & Record<string, unknown>)> } & Record<string, unknown>)>, features: Array<({ id: string, label: string, coverage_status: ("SUPPORTED" | "UNSUPPORTED" | "NOT_IMPLEMENTED" | "UNKNOWN") } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisProvisioningGroupsGroupIdDiffPositiveResponse = ({ status: "success", data: ({ users: ({ to_provision: Array<({ email: (string | null), employee: Partial<{ id: string, remote_id: (string | null), first_name: (string | null), last_name: (string | null), groups: Array<({ id: string, remote_id: (string | null), name: (string | null) } & Record<string, unknown>)>, avatar: (string | null), work_location_id: (string | null), legal_entity_id: (string | null) }> } & Record<string, unknown>)>, to_deprovision: Array<({ origin_id: string, email: string } & Record<string, unknown>)>, already_provisioned: Array<({ origin_id: string, email: string, employee: Partial<{ id: string, remote_id: (string | null), first_name: (string | null), last_name: (string | null), groups: Array<({ id: string, remote_id: (string | null), name: (string | null) } & Record<string, unknown>)>, avatar: (string | null), work_location_id: (string | null), legal_entity_id: (string | null) }> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisProvisioningGroupsGroupIdDiffRequestBody = ({ provisioned_users: Array<({ origin_id: string, email: string } & Record<string, unknown>)>, options: ({ employee_fields: Array<("id" | "remote_id" | "first_name" | "last_name" | "groups" | "avatar" | "work_location_id" | "legal_entity_id")> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisProvisioningGroupsGroupIdSetupLinksPositiveResponse = ({ status: "success", data: ({ url: string, expires_at: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisEmployeesPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, employee_number: (string | null), first_name: (string | null), last_name: (string | null), nationality: (string | null), display_full_name: (string | null), job_title: (string | null), work_email?: (string | null), personal_email?: (string | null), mobile_phone_number: (string | null), ssn: (string | null), tax_id: (string | null), gender?: (("MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED") | string | null), ethnicity?: (("WHITE" | "ASIAN" | "HISPANIC_LATINO" | "HAWAIIAN" | "NATIVE_AMERICAN" | "BLACK_AFRICAN_AMERICAN" | "MULTIPLE_ETHNICITIES" | "DECLINE_TO_SPECIFY") | string | null), marital_status?: (("SINGLE" | "MARRIED" | "DOMESTIC_PARTNERSHIP" | "WIDOWED" | "DIVORCED" | "SEPARATED" | "NOT_MARRIED") | string | null), employment_status?: (("ACTIVE" | "PENDING" | "INACTIVE" | "LEAVE") | string | null), employment_type?: (("FULL_TIME" | "PART_TIME" | "CONTRACT" | "INTERNSHIP" | "FREELANCE" | "WORKING_STUDENT" | "APPRENTICESHIP" | "TRAINING") | string | null), weekly_hours: (number | null), avatar: (string | null), work_location_id: (string | null), legal_entity_id: (string | null), manager_id: (string | null), home_address?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), bank_accounts?: (Array<Partial<{ iban: (string | null), bic: (string | null), account_number: (string | null), holder_name: (string | null), bank_name: (string | null), domestic_bank_routing: (({ number: string, type: (("GB_SORT_CODE" | "DE_BANKLEITZAHL" | "US_ABA_ROUTING_TRANSIT_NUMBER" | "CA_ROUTING_NUMBER" | "AU_BSB_CODE" | "FR_RIB") | null) } & Record<string, unknown>) | null) }>> | null), date_of_birth: (string | null), start_date: (string | null), termination_date: (string | null), remote_created_at: (string | null), changed_at: string, remote_deleted_at: (string | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_data: (Record<string, unknown> | null) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostHrisEmployeesRequestBody = ({ first_name: string, last_name: string, work_email?: string, gender?: ("MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED"), job_title?: string, home_address?: Partial<{ street_1: string, street_2: string, city: string, state: string, zip_code: string, country: string }>, date_of_birth?: string, mobile_phone_number?: string, home_phone_number?: string, nationality?: string, start_date?: string, legal_entity_id?: string, location_id?: string, remote_fields?: Partial<{ humaans: Partial<{ employee: Record<string, unknown> }>, hibob: Partial<{ employee: Record<string, unknown> }>, sympa: Partial<{ GenericNewHire: Record<string, unknown> }>, silae: Partial<{ siret: string, employee: Record<string, unknown>, employment: Record<string, unknown> }>, peoplehr: Partial<{ job_role_effective_date: string, department: string }>, zohopeople: Partial<{ employee_id: string }>, workday: Partial<{ job_requisition_id: string, position_id: string, ssn: string, bank_account: ({ iban: string, bic: string, bank_name: string } & Record<string, unknown>) }>, deel: ({ candidate_id: string, candidate_link: string } & Record<string, unknown>), bamboohr: Partial<{ employee: Record<string, unknown> }>, oracle: ({ group_id: string, department_id: string } & Record<string, unknown>), adpworkforcenow: ({ onboarding_template_code: string, applicant_payroll_profile_group_code: string, manager_position_id?: string, home_organization_unit_code?: string, personal_email?: string } & Record<string, unknown>), azuread: ({ password: string } & Record<string, unknown>), paycor: ({ paygroupRemoteId: string, departmentRemoteId: string } & Record<string, unknown>), planday: ({ department_remote_id: string } & Record<string, unknown>), dayforce: ({ social_security_number: string, pay_type: string, pay_class: string, pay_group: string, base_rate: number, role: string, location: string, department: string, job: string, country: string } & Record<string, unknown>) }> } & Record<string, unknown>);
...
export interface Schema1 { [key: string]: (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)) }
export const isSchema1 = ((input: unknown): input is Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> => typia.createIs<Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))>>()(input) && Object.values(input as Record<string, unknown>).every((item) => (((input: unknown): input is (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)) => typia.createIs<(({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))>()(input) && [(typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>)>())(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>)>())(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>)>())(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "options") || (((input: unknown): input is (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) => typia.createIs<(({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "entries") || (((input: unknown): input is Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> => typia.createIs<Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>) => typia.createIs<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "remote_id") || (((input: unknown): input is (string | number) => typia.createIs<(string | number)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["remote_id"]))))(item))))((input as Record<string, unknown>)["entries"]))))(input), (typia.createIs<({ type: "referenced", link: string } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["options"]))))(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "options") || (((input: unknown): input is (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) => typia.createIs<(({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "entries") || (((input: unknown): input is Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> => typia.createIs<Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>) => typia.createIs<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "remote_id") || (((input: unknown): input is (string | number) => typia.createIs<(string | number)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["remote_id"]))))(item))))((input as Record<string, unknown>)["entries"]))))(input), (typia.createIs<({ type: "referenced", link: string } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["options"]))))(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>)>())(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "properties") || (((input: unknown): input is Schema1 => typia.createIs<Schema1>()(input)))((input as Record<string, unknown>)["properties"]))))(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "item_type") || (((input: unknown): input is Schema2 => typia.createIs<Schema2>()(input)))((input as Record<string, unknown>)["item_type"]))))(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))(item)));
export const assertSchema1 = (input: unknown): Schema1 => { if (!isSchema1(input)) throw new Error("typia validation failed"); return input as Schema1; };
export const validateSchema1 = (input: unknown): typia.IValidation<Schema1> => isSchema1(input) ? { success: true, data: input as Schema1 } : { success: false, data: input, errors: [] };
...
export const isSchema2 = ((input: unknown): input is (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)) => typia.createIs<(({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))>()(input) && [(typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>)>())(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>)>())(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>)>())(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "options") || (((input: unknown): input is (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) => typia.createIs<(({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "entries") || (((input: unknown): input is Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> => typia.createIs<Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>) => typia.createIs<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "remote_id") || (((input: unknown): input is (string | number) => typia.createIs<(string | number)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["remote_id"]))))(item))))((input as Record<string, unknown>)["entries"]))))(input), (typia.createIs<({ type: "referenced", link: string } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["options"]))))(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "options") || (((input: unknown): input is (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) => typia.createIs<(({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "entries") || (((input: unknown): input is Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> => typia.createIs<Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>) => typia.createIs<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "remote_id") || (((input: unknown): input is (string | number) => typia.createIs<(string | number)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["remote_id"]))))(item))))((input as Record<string, unknown>)["entries"]))))(input), (typia.createIs<({ type: "referenced", link: string } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["options"]))))(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>)>())(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "properties") || (((input: unknown): input is Schema1 => typia.createIs<Schema1>()(input)))((input as Record<string, unknown>)["properties"]))))(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "item_type") || (((input: unknown): input is Schema2 => typia.createIs<Schema2>()(input)))((input as Record<string, unknown>)["item_type"]))))(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0);
export const assertSchema2 = (input: unknown): Schema2 => { if (!isSchema2(input)) throw new Error("typia validation failed"); return input as Schema2; };
export const validateSchema2 = (input: unknown): typia.IValidation<Schema2> => isSchema2(input) ? { success: true, data: input as Schema2 } : { success: false, data: input, errors: [] };

export type GetHrisEmployeesFormPositiveResponse = ({ status: "success", data: ({ properties: Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
export const isGetHrisEmployeesFormPositiveResponse = ((input: unknown): input is ({ status: "success", data: ({ properties: Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ status: "success", data: ({ properties: Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "data") || (((input: unknown): input is ({ properties: Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> } & Record<string, unknown>) => typia.createIs<({ properties: Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "properties") || (((input: unknown): input is Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))> => typia.createIs<Record<string, (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))>>()(input) && Object.values(input as Record<string, unknown>).every((item) => (((input: unknown): input is (({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)) => typia.createIs<(({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) | ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>))>()(input) && [(typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "text", min_length?: (number | null), max_length?: (number | null), reg_exp?: (string | null) } & Record<string, unknown>)>())(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "number", min?: (number | null), max?: (number | null) } & Record<string, unknown>)>())(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "date" } & Record<string, unknown>)>())(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "single_select", options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "options") || (((input: unknown): input is (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) => typia.createIs<(({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "entries") || (((input: unknown): input is Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> => typia.createIs<Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>) => typia.createIs<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "remote_id") || (((input: unknown): input is (string | number) => typia.createIs<(string | number)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["remote_id"]))))(item))))((input as Record<string, unknown>)["entries"]))))(input), (typia.createIs<({ type: "referenced", link: string } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["options"]))))(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (string | null), type: "multi_select", min_items?: (number | null), max_items?: (number | null), options: (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "options") || (((input: unknown): input is (({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>)) => typia.createIs<(({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) | ({ type: "referenced", link: string } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>) => typia.createIs<({ type: "inline", entries: Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "entries") || (((input: unknown): input is Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)> => typia.createIs<Array<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>) => typia.createIs<({ id: string, label: string, unified_value?: string, remote_id: (string | number) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "remote_id") || (((input: unknown): input is (string | number) => typia.createIs<(string | number)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["remote_id"]))))(item))))((input as Record<string, unknown>)["entries"]))))(input), (typia.createIs<({ type: "referenced", link: string } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["options"]))))(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "checkbox" } & Record<string, unknown>)>())(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "object", properties: Schema1 } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "properties") || (((input: unknown): input is Schema1 => typia.createIs<Schema1>()(input)))((input as Record<string, unknown>)["properties"]))))(input), (((input: unknown): input is ({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>) => typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "array", item_type: Schema2, min_items?: (number | null), max_items?: (number | null) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "item_type") || (((input: unknown): input is Schema2 => typia.createIs<Schema2>()(input)))((input as Record<string, unknown>)["item_type"]))))(input), (typia.createIs<({ label: string, required: boolean, description?: (string | null), unified_key?: (("first_name" | "last_name" | "date_of_birth" | "gender" | "home_address.city" | "home_address.country" | "home_address.state" | "home_address.street_1" | "home_address.street_2" | "home_address.zip_code" | "job_title" | "legal_entity_id" | "location_id" | "mobile_phone_number" | "home_phone_number" | "nationality" | "start_date" | "work_email" | "private_email" | "yearly_salary") | null), type: "file", file_restrictions: ({ accepted_mime_types: Array<string>, max_file_size?: (number | null) } & Record<string, unknown>) } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))(item))))((input as Record<string, unknown>)["properties"]))))((input as Record<string, unknown>)["data"])));
export const assertGetHrisEmployeesFormPositiveResponse = (input: unknown): GetHrisEmployeesFormPositiveResponse => { if (!isGetHrisEmployeesFormPositiveResponse(input)) throw new Error("typia validation failed"); return input as GetHrisEmployeesFormPositiveResponse; };
export const validateGetHrisEmployeesFormPositiveResponse = (input: unknown): typia.IValidation<GetHrisEmployeesFormPositiveResponse> => isGetHrisEmployeesFormPositiveResponse(input) ? { success: true, data: input as GetHrisEmployeesFormPositiveResponse } : { success: false, data: input, errors: [] };

export type PostHrisEmployeesFormPositiveResponse = ({ status: "success", data: ({ id: (string | null), remote_id: (string | null), prehire: ({ remote_id: (string | null) } & Record<string, unknown>) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export const isSchema6 = ((input: unknown): input is Array<Schema4> => typia.createIs<Array<Schema4>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is Schema4 => typia.createIs<Schema4>()(input)))(item)));
export const assertSchema6 = (input: unknown): Schema6 => { if (!isSchema6(input)) throw new Error("typia validation failed"); return input as Schema6; };
export const validateSchema6 = (input: unknown): typia.IValidation<Schema6> => isSchema6(input) ? { success: true, data: input as Schema6 } : { success: false, data: input, errors: [] };

export type Schema4 = (string | number | boolean | Schema5 | Schema6);
export const isSchema4 = ((input: unknown): input is (string | number | boolean | Schema5 | Schema6) => typia.createIs<(string | number | boolean | Schema5 | Schema6)>()(input) && [(typia.createIs<string>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input), (typia.createIs<boolean>())(input), (((input: unknown): input is Schema5 => typia.createIs<Schema5>()(input)))(input), (((input: unknown): input is Schema6 => typia.createIs<Schema6>()(input)))(input)].filter(Boolean).length === 1);
export const assertSchema4 = (input: unknown): Schema4 => { if (!isSchema4(input)) throw new Error("typia validation failed"); return input as Schema4; };
export const validateSchema4 = (input: unknown): typia.IValidation<Schema4> => isSchema4(input) ? { success: true, data: input as Schema4 } : { success: false, data: input, errors: [] };

export interface Schema5 { [key: string]: Schema4 }
export const isSchema5 = ((input: unknown): input is Record<string, Schema4> => typia.createIs<Record<string, Schema4>>()(input) && Object.values(input as Record<string, unknown>).every((item) => (((input: unknown): input is Schema4 => typia.createIs<Schema4>()(input)))(item)));
export const assertSchema5 = (input: unknown): Schema5 => { if (!isSchema5(input)) throw new Error("typia validation failed"); return input as Schema5; };
export const validateSchema5 = (input: unknown): typia.IValidation<Schema5> => isSchema5(input) ? { success: true, data: input as Schema5 } : { success: false, data: input, errors: [] };

export type Schema3 = Record<string, Schema4>;
export const isSchema3 = ((input: unknown): input is Record<string, Schema4> => typia.createIs<Record<string, Schema4>>()(input) && Object.values(input as Record<string, unknown>).every((item) => (((input: unknown): input is Schema4 => typia.createIs<Schema4>()(input)))(item)));
export const assertSchema3 = (input: unknown): Schema3 => { if (!isSchema3(input)) throw new Error("typia validation failed"); return input as Schema3; };
export const validateSchema3 = (input: unknown): typia.IValidation<Schema3> => isSchema3(input) ? { success: true, data: input as Schema3 } : { success: false, data: input, errors: [] };

export type PostHrisEmployeesFormRequestBody = ({ properties: Schema3 } & Record<string, unknown>);
export const isPostHrisEmployeesFormRequestBody = ((input: unknown): input is ({ properties: Schema3 } & Record<string, unknown>) => typia.createIs<({ properties: Schema3 } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "properties") || (((input: unknown): input is Schema3 => typia.createIs<Schema3>()(input)))((input as Record<string, unknown>)["properties"])));
export const assertPostHrisEmployeesFormRequestBody = (input: unknown): PostHrisEmployeesFormRequestBody => { if (!isPostHrisEmployeesFormRequestBody(input)) throw new Error("typia validation failed"); return input as PostHrisEmployeesFormRequestBody; };
export const validatePostHrisEmployeesFormRequestBody = (input: unknown): typia.IValidation<PostHrisEmployeesFormRequestBody> => isPostHrisEmployeesFormRequestBody(input) ? { success: true, data: input as PostHrisEmployeesFormRequestBody } : { success: false, data: input, errors: [] };
...
export type PatchHrisEmployeesEmployeeIdPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, employee_number: (string | null), first_name: (string | null), last_name: (string | null), nationality: (string | null), display_full_name: (string | null), job_title: (string | null), work_email?: (string | null), personal_email?: (string | null), mobile_phone_number: (string | null), ssn: (string | null), tax_id: (string | null), gender?: (("MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED") | string | null), ethnicity?: (("WHITE" | "ASIAN" | "HISPANIC_LATINO" | "HAWAIIAN" | "NATIVE_AMERICAN" | "BLACK_AFRICAN_AMERICAN" | "MULTIPLE_ETHNICITIES" | "DECLINE_TO_SPECIFY") | string | null), marital_status?: (("SINGLE" | "MARRIED" | "DOMESTIC_PARTNERSHIP" | "WIDOWED" | "DIVORCED" | "SEPARATED" | "NOT_MARRIED") | string | null), employment_status?: (("ACTIVE" | "PENDING" | "INACTIVE" | "LEAVE") | string | null), employment_type?: (("FULL_TIME" | "PART_TIME" | "CONTRACT" | "INTERNSHIP" | "FREELANCE" | "WORKING_STUDENT" | "APPRENTICESHIP" | "TRAINING") | string | null), weekly_hours: (number | null), avatar: (string | null), work_location_id: (string | null), legal_entity_id: (string | null), manager_id: (string | null), home_address?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), bank_accounts?: (Array<Partial<{ iban: (string | null), bic: (string | null), account_number: (string | null), holder_name: (string | null), bank_name: (string | null), domestic_bank_routing: (({ number: string, type: (("GB_SORT_CODE" | "DE_BANKLEITZAHL" | "US_ABA_ROUTING_TRANSIT_NUMBER" | "CA_ROUTING_NUMBER" | "AU_BSB_CODE" | "FR_RIB") | null) } & Record<string, unknown>) | null) }>> | null), date_of_birth: (string | null), start_date: (string | null), termination_date: (string | null), remote_created_at: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PatchHrisEmployeesEmployeeIdRequestBody = ({ first_name?: string, last_name?: string, work_email: string, gender?: ("MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED"), job_title?: string, home_address?: Partial<{ street_1: string, street_2: string, city: string, state: string, zip_code: string, country: string }>, date_of_birth?: string, mobile_phone_number?: string, home_phone_number?: string, nationality?: string, start_date?: string, legal_entity_id?: string, location_id?: string, remote_fields?: Partial<{ humaans: Partial<{ employee: Record<string, unknown> }>, hibob: Partial<{ employee: Record<string, unknown> }>, sympa: Partial<{ GenericNewHire: Record<string, unknown> }>, silae: Partial<{ siret: string, employee: Record<string, unknown>, employment: Record<string, unknown> }>, peoplehr: Partial<{ job_role_effective_date: string, department: string }>, zohopeople: Partial<{ employee_id: string }>, workday: Partial<{ job_requisition_id: string, position_id: string, ssn: string, bank_account: ({ iban: string, bic: string, bank_name: string } & Record<string, unknown>) }>, deel: ({ candidate_id: string, candidate_link: string } & Record<string, unknown>), bamboohr: Partial<{ employee: Record<string, unknown> }>, oracle: ({ group_id: string, department_id: string } & Record<string, unknown>), adpworkforcenow: ({ onboarding_template_code: string, applicant_payroll_profile_group_code: string, manager_position_id?: string, home_organization_unit_code?: string, personal_email?: string } & Record<string, unknown>), azuread: ({ password: string } & Record<string, unknown>), paycor: ({ paygroupRemoteId: string, departmentRemoteId: string } & Record<string, unknown>), planday: ({ department_remote_id: string } & Record<string, unknown>), dayforce: ({ social_security_number: string, pay_type: string, pay_class: string, pay_group: string, base_rate: number, role: string, location: string, department: string, job: string, country: string } & Record<string, unknown>) }>, ssn?: string, marital_status?: ("SINGLE" | "MARRIED" | "DOMESTIC_PARTNERSHIP" | "WIDOWED" | "DIVORCED" | "SEPARATED" | "NOT_MARRIED"), termination_date?: string, tax_id?: string } & Record<string, unknown>);
...
export type PostHrisEmployeesEmployeeIdDocumentsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostHrisEmployeesEmployeeIdDocumentsRequestBody = ({ category_id: string, document: ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisEmployeeDocumentCategoriesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), name: (string | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisTeamsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), changed_at: string, remote_deleted_at: (string | null), type: (("DEPARTMENT" | "TEAM" | "COST_CENTER") | null), parent_id: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisGroupsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), changed_at: string, remote_deleted_at: (string | null), type: (("DEPARTMENT" | "TEAM" | "COST_CENTER") | null), parent_id: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisEmploymentsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), employee_id: string, job_title: (string | null), pay_rate: (number | null), pay_period?: (("HOUR" | "DAY" | "WEEK" | "TWO_WEEKS" | "HALF_MONTH" | "MONTH" | "TWO_MONTHS" | "QUARTER" | "HALF_YEAR" | "YEAR") | string | null), pay_frequency?: (("DAILY" | "WEEKLY" | "BIWEEKLY" | "MONTHLY" | "SEMIMONTHLY" | "QUARTERLY" | "SEMIANNUALLY" | "ANNUALLY" | "PRO_RATA") | string | null), employment_type?: (("FULL_TIME" | "PART_TIME" | "CONTRACT" | "INTERNSHIP" | "FREELANCE" | "WORKING_STUDENT" | "APPRENTICESHIP" | "TRAINING") | string | null), pay_currency: (string | null), effective_date: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisLocationsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), name: (string | null), address?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), type: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisAbsenceTypesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), unit: (("HOURS" | "DAYS") | null), half_days_supported: (boolean | null), exact_times_supported: (boolean | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisTimeOffBalancesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), employee_id: string, type_id: string, balance: (number | null), balance_unit: (("HOURS" | "DAYS") | null), changed_at: string, remote_deleted_at: (string | null), used: (number | null), used_unit: (("HOURS" | "DAYS") | null), remote_data: (Record<string, unknown> | null), type: ({ id: string, remote_id: string, name: (string | null), unit: (("HOURS" | "DAYS") | null), half_days_supported: (boolean | null), exact_times_supported: (boolean | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type DeleteHrisAbsencesAbsenceIdPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: (string | null), employee_id: string, approver_id: (string | null), start_date: null, end_date: null, start_half_day: (boolean | null), end_half_day: (boolean | null), start_time: null, end_time: null, amount: (number | null), unit: (("HOURS" | "DAYS") | null), status?: (("REQUESTED" | "APPROVED" | "DECLINED" | "CANCELLED" | "DELETED") | string | null), employee_note: (string | null), type_id: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetHrisLegalEntitiesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), name: (string | null), address?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisTimesheetsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), employee_id: string, started_at: (string | null), ended_at: (string | null), timezone: (string | null), payable_hours: (number | null), unpaid_break_minutes: (number | null), breaks?: (Array<({ ended_at: (string | string), paid: boolean, started_at: (string | string) } & Record<string, unknown>)> | null), approval_status: (string | null), approved_at: (string | null), comment: (string | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisPerformanceReviewCyclesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), review_period_start_date: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisPerformanceReviewsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, type: (("MANAGER" | "DIRECT_REPORT" | "PEER" | "SELF") | null), summary_comment: (string | null), summary_rating?: (({ type: "NUMERIC", min: (number | null), max: (number | null), value: (number | null) } & Record<string, unknown>) | ({ type: "SINGLE_SELECT", ordered_options: (Array<string> | null), value: (string | null) } & Record<string, unknown>) | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null), reviewee: ({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), display_full_name: (string | null), work_email?: (string | null), remote_deleted_at: (string | null) } & Record<string, unknown>), reviewer: (({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), display_full_name: (string | null), work_email?: (string | null), remote_deleted_at: (string | null) } & Record<string, unknown>) | null), review_cycle: (({ id: string, remote_id: string, name: (string | null), review_period_start_date: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>) | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisSkillsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: string, description: (string | null), ordered_levels: (Array<string> | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisSkillsPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, name: string, description: (string | null), ordered_levels: (Array<string> | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisSkillsRequestBody = ({ name: string, levels?: Array<string> } & Record<string, unknown>);
...
export type PatchHrisSkillsSkillIdPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, name: string, description: (string | null), ordered_levels: (Array<string> | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type DeleteHrisSkillsSkillIdPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, name: string, description: (string | null), ordered_levels: (Array<string> | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisEmployeeSkillAssignmentsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, employee_id: string, skill_id: string, current_level: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisEmployeeSkillAssignmentsPositiveResponse = ({ status: "success", data: ({ id: string, employee_id: string, skill_id: string, current_level: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostHrisEmployeeSkillAssignmentsRequestBody = ({ employee_id: string, skill_id: string, current_level?: string } & Record<string, unknown>);
...
export type PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdPositiveResponse = ({ status: "success", data: ({ id: string, employee_id: string, skill_id: string, current_level: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody = ({ current_level: (string | null) } & Record<string, unknown>);
...
export type DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdPositiveResponse = ({ status: "success", data: ({ id: string, employee_id: string, skill_id: string, current_level: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetHrisStaffingEntitiesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), model_type: (("JOB" | "POSITION" | "REQUISITION") | null), description: (string | null), status: (("OPEN_LIMITED" | "OPEN_UNLIMITED" | "PENDING" | "FROZEN" | "FILLED" | "CLOSED") | null), employment_types?: (Array<({ remote_label: string, unified_type: (("FULL_TIME" | "PART_TIME" | "CONTRACT" | "INTERNSHIP" | "FREELANCE" | "WORKING_STUDENT" | "APPRENTICESHIP" | "TRAINING") | null) } & Record<string, unknown>)> | null), number_of_openings: (number | null), parent_id: (string | null), remote_url: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), changed_at: string, remote_deleted_at: (string | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_data: (Record<string, unknown> | null), locations: Array<({ id: string, remote_id: (string | null), name: (string | null), type: (string | null) } & Record<string, unknown>)>, legal_entities: Array<({ id: string, remote_id: (string | null), name: (string | null) } & Record<string, unknown>)>, groups: Array<({ id: string, remote_id: string, name: (string | null), type: (("DEPARTMENT" | "TEAM" | "COST_CENTER") | null) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAtsApplicationsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), outcome: (("PENDING" | "HIRED" | "DECLINED") | null), rejection_reason_name: (string | null), rejected_at: (string | null), current_stage_id: (string | null), job_id: (string | null), candidate_id: (string | null), screening_question_answers?: (Array<(({ answer: ({ content: (string | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "TEXT" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ choice: (string | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "SINGLE_SELECT" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: Partial<{ choices: Array<string> }>, question: ({ remote_id: (string | null), title: string, type: "MULTI_SELECT" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ checked: (boolean | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "BOOLEAN" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ number: (number | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "NUMBER" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ date: (string | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "DATE" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: Partial<{ raw: null }>, question: ({ remote_id: (string | null), title: string, type: "UNKNOWN" } & Record<string, unknown>) } & Record<string, unknown>))> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_url: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), remote_data: (Record<string, unknown> | null), candidate: (({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), email_addresses?: (Array<({ email_address?: (string | null), type: (string | null) } & Record<string, unknown>)> | null), phone_numbers?: (Array<({ phone_number: string, type?: (string | null) } & Record<string, unknown>)> | null), social_media?: (Array<Partial<{ link: (string | null), type: (string | null), username: (string | null) }>> | null), source: (string | null), remote_url: (string | null), tags: Array<({ id: string, remote_id: (string | null), name: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) | null), current_stage: (({ id: string, remote_id: (string | null), name: (string | null), index: (number | null) } & Record<string, unknown>) | null), job: (({ id: string, remote_id: string, name: (string | null) } & Record<string, unknown>) | null), interviews: Array<({ id: string, remote_id: (string | null), title: (string | null), starting_at: (string | null), ending_at: (string | null), location?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), canceled: (boolean | null) } & Record<string, unknown>)>, offers: Array<({ id: string, remote_id: (string | null), status: (("ACCEPTED" | "DECLINED" | "SENT" | "APPROVED" | "DRAFT" | "ABANDONED") | null) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PutAtsApplicationsApplicationIdStagePositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PutAtsApplicationsApplicationIdStageRequestBody = ({ stage_id: string, remote_fields?: (Partial<{ workday: Partial<{ Workflow_Step_ID: string, Step_Type: ("Next_Step_Reference" | "Disposition_Step_Reference") }> }> & Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }>) } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdResultLinksPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdResultLinksRequestBody = ({ label: string, url: string, details?: ({ custom_field_name_prefix: string, attributes: Array<({ key: string, value: string } & Record<string, unknown>)> } & Record<string, unknown>), remote_fields?: (Partial<{ icims: Partial<{ assessment_package_id: string }>, oracle: Partial<{ override_document_category: ("IRC_CANDIDATE_RESUME" | "IRC_CANDIDATE_COVERLETTER" | "MISC" | "IRC_INTERNAL"), multi_post_to_all_current_applications: boolean }> }> & Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }>) } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdNotesPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdNotesRequestBody = ({ content: string, content_type: "PLAIN_TEXT", remote_fields?: (Partial<{ teamtailor: Partial<{ user_id: string }>, greenhouse: Partial<{ visibility: ("admin_only" | "private" | "public") }>, recruitee: Partial<{ visibility: unknown, is_json: boolean }>, bullhorn: Partial<{ action: string }>, lever: Partial<{ perform_as: string }> }> & Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }>) } & Record<string, unknown>);
...
export type GetAtsApplicationsApplicationIdAttachmentsPositiveResponse = ({ status: "success", data: ({ results: Array<({ type: ("CV" | "COVER_LETTER" | "OTHER"), id: string, remote_id: string, data_url: string, file_name: string, content_type: string, remote_created_at: (string | null), remote_updated_at: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdAttachmentsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdAttachmentsRequestBody = ({ attachment: ({ name: string, content_type?: string, data_url?: string, data?: string, type: ("CV" | "COVER_LETTER" | "OTHER") } & Record<string, unknown>), remote_fields?: (Partial<{ oracle: Partial<{ override_document_category: ("IRC_CANDIDATE_RESUME" | "IRC_CANDIDATE_COVERLETTER" | "MISC" | "IRC_INTERNAL"), multi_post_to_all_current_applications: boolean }> }> & Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }>) } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdRejectPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdInterviewsPositiveResponse = ({ status: "success", data: Record<string, unknown> } & Record<string, unknown>);
...
export type PostAtsApplicationsApplicationIdInterviewsRequestBody = ({ title: string, start_time: string, end_time: string, interviewer_user_ids: Array<string>, organizer_user_id: string, location: ({ type: ("PHYSICAL" | "VIRTUAL"), address?: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PatchAtsApplicationsApplicationIdInterviewsPositiveResponse = ({ status: "success", data: Record<string, unknown> } & Record<string, unknown>);
...
export type PatchAtsApplicationsApplicationIdInterviewsRequestBody = ({ interview_id: string, title: string, start_time: string, end_time: string, interviewer_user_ids: Array<string>, organizer_user_id: string, location: ({ type: ("PHYSICAL" | "VIRTUAL"), address?: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAtsCandidatesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), company: (string | null), title: (string | null), confidential: (boolean | null), source: (string | null), phone_numbers?: (Array<({ phone_number: string, type?: (string | null) } & Record<string, unknown>)> | null), email_addresses?: (Array<({ email_address?: (string | null), type: (string | null) } & Record<string, unknown>)> | null), social_media?: (Array<Partial<{ link: (string | null), type: (string | null), username: (string | null) }>> | null), location?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_url: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null), applications: Array<({ id: string, remote_id: (string | null), outcome: (("PENDING" | "HIRED" | "DECLINED") | null), rejection_reason_name: (string | null), rejected_at: (string | null), remote_url: (string | null), changed_at: string, remote_created_at: (string | null), remote_updated_at: (string | null), current_stage: (({ id: string, name: (string | null), remote_id: (string | null), index: (number | null) } & Record<string, unknown>) | null), job: (({ id: string, name: (string | null), remote_id: string } & Record<string, unknown>) | null) } & Record<string, unknown>)>, tags: Array<({ id: string, name: (string | null), remote_id: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAtsCandidatesPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), company: (string | null), title: (string | null), confidential: (boolean | null), source: (string | null), phone_numbers?: (Array<({ phone_number: string, type?: (string | null) } & Record<string, unknown>)> | null), email_addresses?: (Array<({ email_address?: (string | null), type: (string | null) } & Record<string, unknown>)> | null), social_media?: (Array<Partial<{ link: (string | null), type: (string | null), username: (string | null) }>> | null), location?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_url: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null), applications: Array<({ id: string, remote_id: (string | null), outcome: (("PENDING" | "HIRED" | "DECLINED") | null), rejection_reason_name: (string | null), rejected_at: (string | null), remote_url: (string | null), changed_at: string, remote_created_at: (string | null), remote_updated_at: (string | null), current_stage: (({ id: string, name: (string | null), remote_id: (string | null), index: (number | null) } & Record<string, unknown>) | null), job: (({ id: string, name: (string | null), remote_id: string } & Record<string, unknown>) | null) } & Record<string, unknown>)>, tags: Array<({ id: string, name: (string | null), remote_id: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsCandidatesRequestBody = ({ candidate: ({ first_name: string, last_name: string, email_address: string, additional_email_addresses?: Array<({ type: ("PERSONAL" | "WORK" | "OTHER"), email_address: string } & Record<string, unknown>)>, company?: string, title?: string, phone_number?: string, additional_phone_numbers?: Array<({ type: ("PERSONAL" | "WORK" | "OTHER"), phone_number: string } & Record<string, unknown>)>, location?: ({ city?: string, country: string, state?: string, street_1?: string, zip_code?: string } & Record<string, unknown>), gender?: ("MALE" | "FEMALE" | "OTHER"), availability_date?: string, salary_expectations?: ({ period: ("MONTH" | "YEAR"), amount: number } & Record<string, unknown>), social_links?: Array<({ url: string } & Record<string, unknown>)> } & Record<string, unknown>), application: ({ job_id: string, stage_id?: string } & Record<string, unknown>), screening_question_answers?: Array<({ question_id: string, answer: (string | boolean | number | Array<string> | string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)>, attachments?: Array<({ name: string, content_type?: string, data_url?: string, data?: string, type: ("CV" | "COVER_LETTER" | "OTHER") } & Record<string, unknown>)>, source?: Partial<{ name: string, unified_key: string, id: string }>, sourced_by?: ({ user_id: string } & Record<string, unknown>), gdpr_consent?: Partial<{ expires_at: string, given: boolean }>, remote_fields?: (Partial<{ successfactors: Partial<{ Candidate: Record<string, unknown>, JobApplication: Record<string, unknown>, copyJobApplicationAttachments: boolean, update_existing_candidate: (boolean | null) }>, personio: Partial<{ application: Record<string, unknown> }>, talentsoft: Partial<{ applicant: Record<string, unknown>, application: Record<string, unknown> }>, teamtailor: Partial<{ candidate: Record<string, unknown>, application: Partial<{ attributes: Record<string, unknown> }> }>, greenhouse: Partial<{ candidate: Record<string, unknown>, application: Record<string, unknown> }>, lever: Partial<{ candidate: Record<string, unknown> }>, workable: Partial<{ candidate: Record<string, unknown> }>, workday: Partial<{ Candidate_Data: Partial<{ Name_Detail_Data: Partial<{ Middle_Name: string, Social_Suffix_Reference: ({ Predefined_Name_Component_ID: string } & Record<string, unknown>) }>, Language_Reference: ({ WID: string } & Record<string, unknown>), Job_Application_Data: Partial<{ Job_Applied_To_Data: Partial<{ Global_Personal_Information_Data: Partial<{ Date_of_Birth: string }> }>, Resume_Data: Partial<{ Education_Data: Array<Partial<{ School_Name: string, First_Year_Attended: number, Last_Year_Attended: number, Field_of_Study_Reference: ({ WID: string } & Record<string, unknown>), Degree_Reference: ({ WID: string } & Record<string, unknown>), Grade_Average: string }>>, Skill_Data: Array<Partial<{ Skill_Name: string }>>, Language_Data: Array<Partial<{ Language_Reference: Partial<{ WID: string }>, Language: ({ Native?: boolean, Language_Ability: Array<Partial<{ Language_Ability_Data: Partial<{ Language_Proficiency_Reference: ({ WID: string } & Record<string, unknown>), Language_Ability_Type_Reference: ({ WID: string } & Record<string, unknown>) }> }>> } & Record<string, unknown>) }>>, Experience_Data: Array<({ Company_Name: string, Title: string, Location?: string, Start_Date: string, End_Date?: string, Currently_Work_Here?: boolean, Description?: string } & Record<string, unknown>)> }> }>, Contact_Data: Partial<{ Location_Data: Partial<{ Address_Line_1: string, Address_Line_2: string, Region_Subdivision_1: string, Country_Region_Reference: ({ Country_Region_ID: string } & Record<string, unknown>), Country_City_Reference: ({ WID: string } & Record<string, unknown>) }> }>, Worker_Reference: Partial<{ WID: string, Employee_ID: string }> }>, Override_Source_Reference_WID: string }>, zohorecruit: Partial<{ candidate: Record<string, unknown> }>, bullhorn: Partial<{ candidate: Record<string, unknown>, job_submission: Record<string, unknown> }>, smartrecruiters: Partial<{ candidate_with_questions: Record<string, unknown>, candidate_without_questions: Record<string, unknown>, candidate: Record<string, unknown>, consent_decisions: Partial<{ SINGLE: boolean, SMART_RECRUIT: boolean, SMART_CRM: boolean, SMART_MESSAGE_SMS: boolean, SMART_MESSAGE_WHATSAPP: boolean }> }>, talentadore: Partial<{ applications: Record<string, unknown> }>, guidecom: Partial<{ candidate: Record<string, unknown> }>, dvinci: Partial<{ application: Record<string, unknown>, candidate: Record<string, unknown> }>, hrworks: Partial<{ jobApplication: Record<string, unknown> }>, jobylon: Partial<{ application: Partial<{ message: string }> }>, avature: Partial<{ workflow: Partial<{ step: ({ id: number } & Record<string, unknown>) }> }>, recruitee: Partial<{ candidate: Partial<{ cover_letter_text: string }> }>, rexx: Partial<{ candidate: Record<string, unknown> }>, umantis: Partial<{ person: Record<string, unknown> }>, piloga: Partial<{ candidate: Partial<{ street: string }> }>, pinpoint: Partial<{ candidate: Record<string, unknown> }>, covetorest: Partial<{ candidate: Partial<{ mandant: number }> }> }> & Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }>) } & Record<string, unknown>);
...
export type GetAtsCandidatesCandidateIdAttachmentsPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, application_id: (string | null), candidate_id: string, type: ("CV" | "COVER_LETTER" | "OTHER"), remote_id: string, data_url: string, file_name: string, content_type: string, remote_created_at: (string | null), remote_updated_at: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsCandidatesCandidateIdAttachmentsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsCandidatesCandidateIdAttachmentsRequestBody = ({ attachment: ({ name: string, content_type?: string, data_url?: string, data?: string, type: ("CV" | "COVER_LETTER" | "OTHER") } & Record<string, unknown>), remote_fields?: Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }> } & Record<string, unknown>);
...
export type PostAtsCandidatesCandidateIdResultLinksPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsCandidatesCandidateIdTagsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsCandidatesCandidateIdTagsRequestBody = ({ tag: ({ name: string } & Record<string, unknown>), remote_fields?: Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }> } & Record<string, unknown>);
...
export type DeleteAtsCandidatesCandidateIdTagsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type DeleteAtsCandidatesCandidateIdTagsRequestBody = ({ tag: ({ name: string } & Record<string, unknown>), remote_fields?: Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }> } & Record<string, unknown>);
...
export type GetAtsTagsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), name: (string | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAtsJobsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), job_code: (string | null), description: (string | null), confidential: (boolean | null), weekly_hours: (number | null), employment_type?: (("FULL_TIME" | "PART_TIME" | "CONTRACT" | "SEASONAL" | "INTERNSHIP") | string | null), status?: (("OPEN" | "CLOSED" | "DRAFT" | "ARCHIVED") | string | null), visibility?: (("PUBLIC" | "INTERNAL" | "UNLISTED" | "CONFIDENTIAL") | string | null), category: (string | null), department: (string | null), post_url: (string | null), experience_level: (string | null), remote_work_status?: (("REMOTE" | "HYBRID" | "TEMPORARY" | "ON_SITE") | string | null), salary_amount: (number | null), salary_amount_from: (number | null), salary_amount_to: (number | null), salary_currency: (string | null), salary_period?: (("YEAR" | "MONTH" | "TWO_WEEKS" | "WEEK" | "DAY" | "HOUR") | string | null), location?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_url: (string | null), opened_at: (string | null), closed_at: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), contact_id: (string | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null), stages: Array<({ id: string, remote_id: (string | null), name: (string | null), remote_data: (Record<string, unknown> | null), index?: (number | null) } & Record<string, unknown>)>, screening_questions: Array<({ id: string, remote_id: (string | null), title: (string | null), description: (string | null), format?: (({ display_type?: (("SINGLE_LINE" | "MULTI_LINE" | "EMAIL" | "URL") | null), max_length?: (number | null), type: "TEXT" } & Record<string, unknown>) | ({ display_type?: (("SLIDER" | "FIELD") | null), max?: (number | null), min?: (number | null), type: "NUMBER" } & Record<string, unknown>) | ({ accepted_mime_types?: (Array<string> | null), max_file_size_bytes?: (number | null), type: "FILE" } & Record<string, unknown>) | ({ display_type?: (("DROPDOWN" | "RADIO") | null), options: Array<({ id: string, remote_id?: (string | null), name: string } & Record<string, unknown>)>, type: "SINGLE_SELECT" } & Record<string, unknown>) | ({ type: "BOOLEAN" } & Record<string, unknown>) | ({ type: "DATE" } & Record<string, unknown>) | ({ options: Array<({ id: string, remote_id?: (string | null), name: string } & Record<string, unknown>)>, type: "MULTI_SELECT" } & Record<string, unknown>) | ({ type: "INFORMATION" } & Record<string, unknown>) | ({ raw_question?: unknown, type: "UNKNOWN" } & Record<string, unknown>) | null), category: (("EEO" | "DEMOGRAPHIC") | null), index?: (number | null), required: (boolean | null), precondition_question_id?: (string | null), precondition_options?: (Array<string> | Array<boolean> | null) } & Record<string, unknown>)>, job_postings: Array<({ id: string, remote_id: (string | null), title: (string | null), description_html: (string | null), status: (("ACTIVE" | "INACTIVE" | "DRAFT") | null), visibility: (("PUBLIC" | "INTERNAL" | "UNLISTED") | null), url: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)>, hiring_team: Array<({ id: string, remote_id: (string | null), first_name: (string | null), last_name: (string | null), email?: (string | null), hiring_team_roles: Array<("RECRUITER" | "HIRING_MANAGER" | "COORDINATOR" | "SOURCER" | "INTERVIEWER")>, job_roles: Array<({ remote_id: (string | null), remote_label: (string | null), scope: (("SYSTEM" | "JOB") | null), unified_type: (("HIRING_MANAGER" | "RECRUITER" | "COORDINATOR" | "SOURCER" | "INTERVIEWER" | "ADMIN") | null) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAtsJobsJobIdApplicationsPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: (string | null), outcome: (("PENDING" | "HIRED" | "DECLINED") | null), rejection_reason_name: (string | null), rejected_at: (string | null), current_stage_id: (string | null), job_id: (string | null), candidate_id: (string | null), screening_question_answers?: (Array<(({ answer: ({ content: (string | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "TEXT" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ choice: (string | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "SINGLE_SELECT" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: Partial<{ choices: Array<string> }>, question: ({ remote_id: (string | null), title: string, type: "MULTI_SELECT" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ checked: (boolean | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "BOOLEAN" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ number: (number | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "NUMBER" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: ({ date: (string | null) } & Record<string, unknown>), question: ({ remote_id: (string | null), title: string, type: "DATE" } & Record<string, unknown>) } & Record<string, unknown>) | ({ answer: Partial<{ raw: null }>, question: ({ remote_id: (string | null), title: string, type: "UNKNOWN" } & Record<string, unknown>) } & Record<string, unknown>))> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_url: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), remote_data: (Record<string, unknown> | null), current_stage: (({ id: string, name: (string | null), remote_id: (string | null), index: (number | null) } & Record<string, unknown>) | null), job: (({ id: string, name: (string | null), remote_id: string } & Record<string, unknown>) | null), candidate: (({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), company: (string | null), title: (string | null), confidential: (boolean | null), source: (string | null), phone_numbers?: (Array<({ phone_number: string, type?: (string | null) } & Record<string, unknown>)> | null), email_addresses?: (Array<({ email_address?: (string | null), type: (string | null) } & Record<string, unknown>)> | null), social_media?: (Array<Partial<{ link: (string | null), type: (string | null), username: (string | null) }>> | null), location?: (Partial<{ city: (string | null), country: (string | null), raw: (string | null), state: (string | null), street_1: (string | null), street_2: (string | null), zip_code: (string | null) }> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, remote_url: (string | null), remote_created_at: (string | null), remote_updated_at: (string | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null), tags: Array<({ id: string, name: (string | null), remote_id: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) | null) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsJobsJobIdApplicationsRequestBody = ({ stage_id?: string, candidate: ({ first_name: string, last_name: string, email_address: string, additional_email_addresses?: Array<({ type: ("PERSONAL" | "WORK" | "OTHER"), email_address: string } & Record<string, unknown>)>, company?: string, title?: string, phone_number?: string, additional_phone_numbers?: Array<({ type: ("PERSONAL" | "WORK" | "OTHER"), phone_number: string } & Record<string, unknown>)>, location?: ({ city?: string, country: string, state?: string, street_1?: string, zip_code?: string } & Record<string, unknown>), gender?: ("MALE" | "FEMALE" | "OTHER"), availability_date?: string, salary_expectations?: ({ period: ("MONTH" | "YEAR"), amount: number } & Record<string, unknown>), social_links?: Array<({ url: string } & Record<string, unknown>)> } & Record<string, unknown>), attachments?: Array<({ name: string, content_type?: string, data_url?: string, data?: string, type: ("CV" | "COVER_LETTER" | "OTHER") } & Record<string, unknown>)>, source?: Partial<{ name: string, unified_key: string, id: string }>, sourced_by?: ({ user_id: string } & Record<string, unknown>), gdpr_consent?: Partial<{ expires_at: string, given: boolean }>, remote_fields?: (Partial<{ successfactors: Partial<{ Candidate: Record<string, unknown>, JobApplication: Record<string, unknown>, copyJobApplicationAttachments: boolean, update_existing_candidate: (boolean | null) }>, personio: Partial<{ application: Record<string, unknown> }>, talentsoft: Partial<{ applicant: Record<string, unknown>, application: Record<string, unknown> }>, teamtailor: Partial<{ candidate: Record<string, unknown>, application: Partial<{ attributes: Record<string, unknown> }> }>, greenhouse: Partial<{ candidate: Record<string, unknown>, application: Record<string, unknown> }>, lever: Partial<{ candidate: Record<string, unknown> }>, workable: Partial<{ candidate: Record<string, unknown> }>, workday: Partial<{ Candidate_Data: Partial<{ Name_Detail_Data: Partial<{ Middle_Name: string, Social_Suffix_Reference: ({ Predefined_Name_Component_ID: string } & Record<string, unknown>) }>, Language_Reference: ({ WID: string } & Record<string, unknown>), Job_Application_Data: Partial<{ Job_Applied_To_Data: Partial<{ Global_Personal_Information_Data: Partial<{ Date_of_Birth: string }> }>, Resume_Data: Partial<{ Education_Data: Array<Partial<{ School_Name: string, First_Year_Attended: number, Last_Year_Attended: number, Field_of_Study_Reference: ({ WID: string } & Record<string, unknown>), Degree_Reference: ({ WID: string } & Record<string, unknown>), Grade_Average: string }>>, Skill_Data: Array<Partial<{ Skill_Name: string }>>, Language_Data: Array<Partial<{ Language_Reference: Partial<{ WID: string }>, Language: ({ Native?: boolean, Language_Ability: Array<Partial<{ Language_Ability_Data: Partial<{ Language_Proficiency_Reference: ({ WID: string } & Record<string, unknown>), Language_Ability_Type_Reference: ({ WID: string } & Record<string, unknown>) }> }>> } & Record<string, unknown>) }>>, Experience_Data: Array<({ Company_Name: string, Title: string, Location?: string, Start_Date: string, End_Date?: string, Currently_Work_Here?: boolean, Description?: string } & Record<string, unknown>)> }> }>, Contact_Data: Partial<{ Location_Data: Partial<{ Address_Line_1: string, Address_Line_2: string, Region_Subdivision_1: string, Country_Region_Reference: ({ Country_Region_ID: string } & Record<string, unknown>), Country_City_Reference: ({ WID: string } & Record<string, unknown>) }> }>, Worker_Reference: Partial<{ WID: string, Employee_ID: string }> }>, Override_Source_Reference_WID: string }>, zohorecruit: Partial<{ candidate: Record<string, unknown> }>, bullhorn: Partial<{ candidate: Record<string, unknown>, job_submission: Record<string, unknown> }>, smartrecruiters: Partial<{ candidate_with_questions: Record<string, unknown>, candidate_without_questions: Record<string, unknown>, candidate: Record<string, unknown>, consent_decisions: Partial<{ SINGLE: boolean, SMART_RECRUIT: boolean, SMART_CRM: boolean, SMART_MESSAGE_SMS: boolean, SMART_MESSAGE_WHATSAPP: boolean }> }>, talentadore: Partial<{ applications: Record<string, unknown> }>, guidecom: Partial<{ candidate: Record<string, unknown> }>, dvinci: Partial<{ application: Record<string, unknown>, candidate: Record<string, unknown> }>, hrworks: Partial<{ jobApplication: Record<string, unknown> }>, jobylon: Partial<{ application: Partial<{ message: string }> }>, avature: Partial<{ workflow: Partial<{ step: ({ id: number } & Record<string, unknown>) }> }>, recruitee: Partial<{ candidate: Partial<{ cover_letter_text: string }> }>, rexx: Partial<{ candidate: Record<string, unknown> }>, umantis: Partial<{ person: Record<string, unknown> }>, piloga: Partial<{ candidate: Partial<{ street: string }> }>, pinpoint: Partial<{ candidate: Record<string, unknown> }>, covetorest: Partial<{ candidate: Partial<{ mandant: number }> }> }> & Partial<{ greenhouse: Partial<{ post_headers: Partial<{ "On-Behalf-Of": (string | null) }> }>, workable: Partial<{ on_behalf_of_user_remote_id: string }> }>), screening_question_answers?: Array<({ question_id: string, answer: (string | boolean | number | Array<string> | string | ({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)) } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetAtsRolesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), remote_label: (string | null), scope: (("SYSTEM" | "JOB") | null), unified_type: (("HIRING_MANAGER" | "RECRUITER" | "COORDINATOR" | "SOURCER" | "INTERVIEWER" | "ADMIN") | null), remote_data: (Record<string, unknown> | null), changed_at: string, remote_deleted_at: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAtsRejectionReasonsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, name: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAtsActionsAtsCreateCandidatePositiveResponse = ({ status: "success", data: Partial<{ attachment_restrictions: (({ total_size_bytes: (number | null), types: ({ CV: (({ is_supported: true, min_amount: (number | null), max_amount: (number | null), max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)), COVER_LETTER: (({ is_supported: true, min_amount: (number | null), max_amount: (number | null), max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)), OTHER: (({ is_supported: true, min_amount: (number | null), max_amount: (number | null), max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)) } & Record<string, unknown>) } & Record<string, unknown>) | null) }> } & Record<string, unknown>);
...
export type GetAtsActionsAtsAddApplicationAttachmentPositiveResponse = ({ status: "success", data: Partial<{ attachment_restrictions: (({ types: ({ CV: (({ is_supported: true, max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)), COVER_LETTER: (({ is_supported: true, max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)), OTHER: (({ is_supported: true, max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)) } & Record<string, unknown>) } & Record<string, unknown>) | null) }> } & Record<string, unknown>);
...
export type GetAtsActionsAtsAddCandidateAttachmentPositiveResponse = ({ status: "success", data: Partial<{ attachment_restrictions: (({ types: ({ CV: (({ is_supported: true, max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)), COVER_LETTER: (({ is_supported: true, max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)), OTHER: (({ is_supported: true, max_file_size_bytes: (number | null), accepted_mime_types: (Array<string> | null) } & Record<string, unknown>) | ({ is_supported: false } & Record<string, unknown>)) } & Record<string, unknown>) } & Record<string, unknown>) | null) }> } & Record<string, unknown>);
...
export type PostAtsImportTrackedApplicationPositiveResponse = ({ status: "success", data: ({ id: string, tracked_at: (string | null), imported_id: Partial<{ erecruiter: (({ id_type: "application_and_job_remote_ids", application_remote_id: string, job_remote_id: string } & Record<string, unknown>) | ({ id_type: "application_and_candidate_remote_ids", candidate_remote_id: string, application_remote_id: string } & Record<string, unknown>)), successfactors: ({ id_type: "application_remote_id", application_remote_id: string } & Record<string, unknown>), recruitee: ({ id_type: "placement_id", placement_id: string } & Record<string, unknown>), greenhouse: ({ id_type: "application_id", application_id: string } & Record<string, unknown>), onlyfy: ({ id_type: "application_id", application_id: string } & Record<string, unknown>), smartrecruiters: ({ id_type: "candidate_and_job_remote_ids", candidate_remote_id: string, job_remote_id: string } & Record<string, unknown>) }> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostAtsImportTrackedApplicationRequestBody = ({ erecruiter?: (({ id_type: "application_and_job_remote_ids", application_remote_id: string, job_remote_id: string } & Record<string, unknown>) | ({ id_type: "application_and_candidate_remote_ids", candidate_remote_id: string, application_remote_id: string } & Record<string, unknown>)), successfactors?: ({ id_type: "application_remote_id", application_remote_id: string } & Record<string, unknown>), recruitee?: ({ id_type: "placement_id", placement_id: string } & Record<string, unknown>), greenhouse?: ({ id_type: "application_id", application_id: string } & Record<string, unknown>), onlyfy?: ({ id_type: "application_id", application_id: string } & Record<string, unknown>), smartrecruiters?: ({ id_type: "candidate_and_job_remote_ids", candidate_remote_id: string, job_remote_id: string } & Record<string, unknown>), tracked_at: (string | null) } & Record<string, unknown>);
...
export type PostAtsCustomAvionteSyncedJobsPositiveResponse = ({ status: "success", data: Record<string, unknown> } & Record<string, unknown>);
...
export type PostAtsCustomAvionteSyncedJobsRequestBody = ({ job_remote_id: string } & Record<string, unknown>);
...
export type DeleteAtsCustomAvionteSyncedJobsJobRemoteIdPositiveResponse = ({ status: "success", data: Record<string, unknown> } & Record<string, unknown>);
...
export type GetAssessmentPackagesPositiveResponse = ({ status: "success", data: ({ packages: Array<({ id: string, name: string, description: string, updated_at: (string | null), type: (("BEHAVIORAL" | "VIDEO_INTERVIEW" | "SKILLS_TEST" | "BACKGROUND_CHECK" | "REFERENCE_CHECK") | null) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PutAssessmentPackagesPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PutAssessmentPackagesRequestBody = ({ packages: Array<({ id: string, type: ("BEHAVIORAL" | "VIDEO_INTERVIEW" | "SKILLS_TEST" | "BACKGROUND_CHECK" | "REFERENCE_CHECK"), name: string, description: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetAssessmentOrdersPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, package_id: string, status: ("OPEN" | "COMPLETED" | "CANCELLED" | "REJECTED"), candidate: ({ remote_id: (string | null), email: string, first_name: (string | null), last_name: (string | null), phone: (string | null) } & Record<string, unknown>), application: ({ remote_id: (string | null) } & Record<string, unknown>), job: ({ remote_id: (string | null), name: (string | null), job_code: (string | null), description: (string | null), location: (Partial<{ street_1: (string | null), street_2: (string | null), city: (string | null), state: (string | null), zip_code: (string | null), country: (string | null), raw: (string | null) }> | null), hiring_team: Array<({ remote_id: (string | null), email: (string | null), first_name: (string | null), last_name: (string | null), hiring_team_roles: Array<("RECRUITER" | "HIRING_MANAGER")> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAssessmentOrdersOpenPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, package_id: string, candidate: ({ remote_id: (string | null), email: string, first_name: (string | null), last_name: (string | null), phone: (string | null) } & Record<string, unknown>), application: ({ remote_id: (string | null) } & Record<string, unknown>), job: ({ remote_id: (string | null), name: (string | null), job_code: (string | null), description: (string | null), location: (Partial<{ street_1: (string | null), street_2: (string | null), city: (string | null), state: (string | null), zip_code: (string | null), country: (string | null), raw: (string | null) }> | null), hiring_team: Array<({ remote_id: (string | null), email: (string | null), first_name: (string | null), last_name: (string | null), hiring_team_roles: Array<("RECRUITER" | "HIRING_MANAGER")> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PutAssessmentOrdersAssessmentOrderIdResultPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PutAssessmentOrdersAssessmentOrderIdResultRequestBody = ({ status: ("COMPLETED" | "CANCELLED" | "OPEN"), result_url: string, completed_at?: string, score?: number, max_score?: number, attributes?: Array<(({ type: "TEXT", label: string, value: string } & Record<string, unknown>) | ({ type: "SUB_RESULT", id: string, label: string, score: ({ value: number, max: number } & Record<string, unknown>), status: ("COMPLETED" | "CANCELLED") } & Record<string, unknown>))>, attachments?: Array<({ name: string, content_type?: string, data_url?: string, data?: string } & Record<string, unknown>)>, remote_fields?: Partial<{ smartrecruiters: Partial<{ scoreLabel: string }>, recruitee: Partial<{ subtitle: string }> }> } & Record<string, unknown>);
...
export type GetLmsCourseProgressionsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, user_id: string, course_revision_id: string, status: (("ENROLLED" | "IN_PROGRESS" | "COMPLETED" | "DROPPED") | null), enrolled_at: (string | null), completed_at: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null), user: ({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), work_email: (string | null) } & Record<string, unknown>), course_revision: ({ id: string, remote_id: string, title: (string | null), course: (({ id: string, remote_id: string } & Record<string, unknown>) | null) } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostLmsCourseProgressionsPositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, user_id: string, course_revision_id: string, status: (("ENROLLED" | "IN_PROGRESS" | "COMPLETED" | "DROPPED") | null), enrolled_at: (string | null), completed_at: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null), user: ({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), work_email: (string | null) } & Record<string, unknown>), course_revision: ({ id: string, remote_id: string, title: (string | null), course: (({ id: string, remote_id: string } & Record<string, unknown>) | null) } & Record<string, unknown>) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostLmsCourseProgressionsRequestBody = ({ user_id: string, course_revision_id: string } & Record<string, unknown>);
...
export type PostLmsCourseProgressionsCourseProgressionIdCompletePositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, user_id: string, course_revision_id: string, status: (("ENROLLED" | "IN_PROGRESS" | "COMPLETED" | "DROPPED") | null), enrolled_at: (string | null), completed_at: (string | null), changed_at: string, remote_deleted_at: (string | null), remote_data: (Record<string, unknown> | null), user: ({ id: string, remote_id: string, first_name: (string | null), last_name: (string | null), work_email: (string | null) } & Record<string, unknown>), course_revision: ({ id: string, remote_id: string, title: (string | null), course: (({ id: string, remote_id: string } & Record<string, unknown>) | null) } & Record<string, unknown>) } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetLmsCoursesPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: string, provider_id: (string | null), origin_id: (string | null), remote_created_at: (string | null), remote_deleted_at: (string | null), changed_at: string, remote_data: (Record<string, unknown> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, provider: (({ id: string, remote_id: string, name: (string | null) } & Record<string, unknown>) | null), revisions: Array<({ id: string, remote_id: string, course_id: (string | null), title: (string | null), description: (string | null), remote_url: (string | null), status: (("ACTIVE" | "INACTIVE") | null), remote_created_at: (string | null), remote_deleted_at: (string | null), changed_at: string, remote_data: (Record<string, unknown> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, skill_assignments: Array<({ skill: ({ id: string, remote_id: (string | null), name: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostLmsCoursesBulkPositiveResponse = ({ status: "success", data: ({ task_id: string } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostLmsCoursesBulkRequestBody = ({ items: Array<({ origin_id: string, course: ({ type: "EXTERNAL", title: string, description?: (string | null), course_url: string, thumbnail_url?: (string | null), duration?: (number | null), languages?: (Array<string> | null) } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetLmsCoursesBulkTaskIdPositiveResponse = ({ status: "success", data: (({ task_id: string, created_at: string, status: "PENDING", completed_at: null } & Record<string, unknown>) | ({ task_id: string, created_at: string, status: "COMPLETED", data: Array<(({ origin_id: string, status: "SUCCEEDED", data: ({ id: string } & Record<string, unknown>) } & Record<string, unknown>) | ({ origin_id: string, status: "FAILED", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "INTEGRATION.PERMISSION_MISSING" | "INTEGRATION.AUTHENTICATION_INVALID" | "INTEGRATION.QA_FAILED" | "INTEGRATION.SETUP_SYNC_PENDING" | "INTEGRATION.SETUP_INCOMPLETE" | "INTEGRATION.INACTIVE" | "INTEGRATION.MODEL_NOT_AVAILABLE" | "INTEGRATION.MODEL_DISABLED" | "INTEGRATION.ACTION_NOT_AVAILABLE" | "INTEGRATION.ACTION_DISABLED" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "HRIS.EMPLOYEE_ALREADY_EXISTS" | "ATS.JOB_CLOSED" | "ATS.APPLICATION_ALREADY_EXISTS" | "LMS.COURSE_UPDATE_NOT_SUPPORTED" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>))>, completed_at: string } & Record<string, unknown>) | ({ task_id: string, created_at: string, status: "FAILED", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "INTEGRATION.PERMISSION_MISSING" | "INTEGRATION.AUTHENTICATION_INVALID" | "INTEGRATION.QA_FAILED" | "INTEGRATION.SETUP_SYNC_PENDING" | "INTEGRATION.SETUP_INCOMPLETE" | "INTEGRATION.INACTIVE" | "INTEGRATION.MODEL_NOT_AVAILABLE" | "INTEGRATION.MODEL_DISABLED" | "INTEGRATION.ACTION_NOT_AVAILABLE" | "INTEGRATION.ACTION_DISABLED" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "HRIS.EMPLOYEE_ALREADY_EXISTS" | "ATS.JOB_CLOSED" | "ATS.APPLICATION_ALREADY_EXISTS" | "LMS.COURSE_UPDATE_NOT_SUPPORTED" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>), completed_at: string } & Record<string, unknown>)) } & Record<string, unknown>);
...
export type PostLmsCoursesCourseIdDeactivatePositiveResponse = ({ status: "success", data: ({ id: string, remote_id: string, provider_id: (string | null), origin_id: (string | null), remote_created_at: (string | null), remote_deleted_at: (string | null), changed_at: string, remote_data: (Record<string, unknown> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, provider: (({ id: string, remote_id: string, name: (string | null) } & Record<string, unknown>) | null), revisions: Array<({ id: string, remote_id: string, course_id: (string | null), title: (string | null), description: (string | null), remote_url: (string | null), status: (("ACTIVE" | "INACTIVE") | null), remote_created_at: (string | null), remote_deleted_at: (string | null), changed_at: string, remote_data: (Record<string, unknown> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)>, skill_assignments: Array<({ skill: ({ id: string, remote_id: (string | null), name: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetLmsSkillsPositiveResponse = ({ status: "success", data: ({ next: (string | null), results: Array<({ id: string, remote_id: (string | null), name: (string | null), remote_created_at: (string | null), remote_deleted_at: (string | null), changed_at: string, remote_data: (Record<string, unknown> | null), custom_fields: (Record<string, unknown> | null), integration_fields: Array<({ id: string, key: string, type: ("DEFAULT" | "CUSTOM"), value?: null, label: (string | null) } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyCareerSitesPositiveResponse = ({ status: "success", data: ({ id: string, label: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyCareerSitesRequestBody = ({ label: string } & Record<string, unknown>);
...
export type GetAiApplyCareerSitesPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, label: string } & Record<string, unknown>)>, next: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAiApplyPostingsPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, career_site: ({ id: string, label: string } & Record<string, unknown>), url: string, job_code: (string | null), created_at: string, updated_at: string, archived_at: (string | null), archived_reason: (("JOB_POSTING_TAKEN_OFFLINE" | "MANUAL_ARCHIVE" | "REMOVED_FROM_JOB_FEED") | null), availability: ("APPLYABLE" | "PENDING" | "ARCHIVED" | "UNAVAILABLE") } & Record<string, unknown>)>, next: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyPostingsPositiveResponse = ({ status: "success", data: ({ id: string, career_site: ({ id: string, label: string } & Record<string, unknown>), url: string, job_code: (string | null), created_at: string, updated_at: string, archived_at: (string | null), archived_reason: (("JOB_POSTING_TAKEN_OFFLINE" | "MANUAL_ARCHIVE" | "REMOVED_FROM_JOB_FEED") | null), availability: ("APPLYABLE" | "PENDING" | "ARCHIVED" | "UNAVAILABLE") } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyPostingsPostingIdInquirePositiveResponse = ({ status: "success", data: ({ application_form: Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>, submission_token: string } & Record<string, unknown>) } & Record<string, unknown>);
export const isPostAiApplyPostingsPostingIdInquirePositiveResponse = ((input: unknown): input is ({ status: "success", data: ({ application_form: Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>, submission_token: string } & Record<string, unknown>) } & Record<string, unknown>) => typia.createIs<({ status: "success", data: ({ application_form: Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>, submission_token: string } & Record<string, unknown>) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "data") || (((input: unknown): input is ({ application_form: Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>, submission_token: string } & Record<string, unknown>) => typia.createIs<({ application_form: Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>, submission_token: string } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "application_form") || (((input: unknown): input is Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))> => typia.createIs<Array<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is (({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>)) => typia.createIs<(({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) | ({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>))>()(input) && [(((input: unknown): input is ({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>) => typia.createIs<({ block_type: "QUESTION", question_id: string, label: string, description: (string | null), required: boolean, category: ("EEO" | null), question_type: ("TEXT" | "NUMBER" | "BOOLEAN" | "FILE" | "DATE" | "SINGLE_SELECT" | "MULTI_SELECT"), unified_key: (("EMAIL" | "RESIDENCE_TYPE" | "RESIDENCE_FULL_STRING" | "RESIDENCE_COUNTRY" | "RESIDENCE_CITY" | "RESIDENCE_STATE" | "RESIDENCE_LINE_1" | "RESIDENCE_LINE_2" | "RESIDENCE_ZIP_CODE" | "APPLICANT_POOL_CONSENT" | "TERMS_AND_CONDITIONS" | "FIRST_NAME" | "LAST_NAME" | "FULL_NAME" | "GENDER" | "EXPECTED_START_DATE" | "RESUME" | "BIRTH_DATE" | "PHONE_NUMBER_TYPE" | "FULL_PHONE_NUMBER" | "PHONE_COUNTRY_CODE" | "PHONE_NATIONAL_NUMBER" | "PHONE_EXTENSION") | null), options: (Array<({ id: string, label: string, unified_key: (("HOME" | "WORK" | "MAILING" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "YE" | "YT" | "ZA" | "ZM" | "ZW" | "MALE" | "FEMALE" | "NON_BINARY" | "NOT_SPECIFIED" | "MOBILE" | "LANDLINE" | "SOURCE_OTHER" | "SOURCE_OTHER_JOB_BOARD") | null) } & Record<string, unknown>)> | null), display_when: (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "display_when") || (((input: unknown): input is (({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null) => typia.createIs<(({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) | null)>()(input) && [(((input: unknown): input is ({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ question_id: string, answer_equals: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "answer_equals") || (((input: unknown): input is (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>)) => typia.createIs<(string | Array<string> | number | boolean | ({ name: string, content_type: string, data: unknown } & Record<string, unknown>))>()(input) && [(typia.createIs<string>())(input), (typia.createIs<Array<string>>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input), (typia.createIs<boolean>())(input), (typia.createIs<({ name: string, content_type: string, data: unknown } & Record<string, unknown>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["answer_equals"]))))(input), (typia.createIs<null>())(input)].filter(Boolean).length > 0))((input as Record<string, unknown>)["display_when"]))))(input), (typia.createIs<({ block_type: "SECTION", label: string, children: Array<Record<string, unknown>> } & Record<string, unknown>)>())(input)].filter(Boolean).length > 0))(item))))((input as Record<string, unknown>)["application_form"]))))((input as Record<string, unknown>)["data"])));
export const assertPostAiApplyPostingsPostingIdInquirePositiveResponse = (input: unknown): PostAiApplyPostingsPostingIdInquirePositiveResponse => { if (!isPostAiApplyPostingsPostingIdInquirePositiveResponse(input)) throw new Error("typia validation failed"); return input as PostAiApplyPostingsPostingIdInquirePositiveResponse; };
export const validatePostAiApplyPostingsPostingIdInquirePositiveResponse = (input: unknown): typia.IValidation<PostAiApplyPostingsPostingIdInquirePositiveResponse> => isPostAiApplyPostingsPostingIdInquirePositiveResponse(input) ? { success: true, data: input as PostAiApplyPostingsPostingIdInquirePositiveResponse } : { success: false, data: input, errors: [] };
...
export type PostAiApplyApplyPositiveResponse = ({ status: "success", data: ({ id: string, posting_id: string, status: string, created_at: string, updated_at: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyApplyRequestBody = ({ submission_token: string, candidate_email: string, query_params?: Record<string, string>, screening_question_answers: Array<({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>)>, additional_clicks?: number, additional_clicks_scatter_duration?: number } & Record<string, unknown>);
export const isPostAiApplyApplyRequestBody = ((input: unknown): input is ({ submission_token: string, candidate_email: string, query_params?: Record<string, string>, screening_question_answers: Array<({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>)>, additional_clicks?: number, additional_clicks_scatter_duration?: number } & Record<string, unknown>) => typia.createIs<({ submission_token: string, candidate_email: string, query_params?: Record<string, string>, screening_question_answers: Array<({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>)>, additional_clicks?: number, additional_clicks_scatter_duration?: number } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "screening_question_answers") || (((input: unknown): input is Array<({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>)> => typia.createIs<Array<({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>)>>()(input) && (input as unknown[]).every((item) => (((input: unknown): input is ({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>) => typia.createIs<({ question_id: string, answer: (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) } & Record<string, unknown>)>()(input) && (!Object.prototype.hasOwnProperty.call(input, "answer") || (((input: unknown): input is (string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>)) => typia.createIs<(string | Array<string> | number | boolean | ({ name: string, content_type: string, data: string } & Record<string, unknown>))>()(input) && [(typia.createIs<string>())(input), (typia.createIs<Array<string>>())(input), (typia.createIs<(number & tags.Minimum<-1.7976931348623157e+308>)>())(input), (typia.createIs<boolean>())(input), (typia.createIs<({ name: string, content_type: string, data: string } & Record<string, unknown>)>())(input)].filter(Boolean).length === 1))((input as Record<string, unknown>)["answer"]))))(item))))((input as Record<string, unknown>)["screening_question_answers"])));
export const assertPostAiApplyApplyRequestBody = (input: unknown): PostAiApplyApplyRequestBody => { if (!isPostAiApplyApplyRequestBody(input)) throw new Error("typia validation failed"); return input as PostAiApplyApplyRequestBody; };
export const validatePostAiApplyApplyRequestBody = (input: unknown): typia.IValidation<PostAiApplyApplyRequestBody> => isPostAiApplyApplyRequestBody(input) ? { success: true, data: input as PostAiApplyApplyRequestBody } : { success: false, data: input, errors: [] };
...
export type GetAiApplyApplicationsPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, job_posting_id: string, status: ("SUBMITTED" | "DUPLICATE" | "PENDING" | "FAILED"), created_at: string, updated_at: string } & Record<string, unknown>)>, next: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetAiApplyJobFeedsPositiveResponse = ({ status: "success", data: ({ results: Array<({ id: string, label: string } & Record<string, unknown>)>, next: (string | null) } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyJobFeedsPositiveResponse = ({ status: "success", data: ({ id: string, label: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostAiApplyJobFeedsRequestBody = ({ label: string } & Record<string, unknown>);
...
export type PostConnectCreateLinkPositiveResponse = ({ status: "success", data: ({ link: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type GetConnectIntegrationByTokenTokenPositiveResponse = ({ status: "success", data: ({ tool: string, id: string, end_user_origin_id: (string | null), end_user_organization_name: string, end_user_email: (string | null), setup_status: ("INCOMPLETE" | "FINAL_SYNC_PENDING" | "COMPLETED") } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostConnectActivateIntegrationPositiveResponse = ({ status: "success", data: ({ tool: string, id: string, end_user_origin_id: (string | null), end_user_organization_name: string, end_user_email: (string | null), setup_status: ("INCOMPLETE" | "FINAL_SYNC_PENDING" | "COMPLETED") } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostConnectActivateIntegrationRequestBody = ({ token: string } & Record<string, unknown>);
...
export type GetCustomDatevSystemInformationPositiveResponse = ({ status: "success", data: ({ consultant_number: number, client_number: number, target_system: ("LODAS" | "LuG") } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostCustomDatevPassthroughPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevPassthroughRequestBody = ({ file_content: string, accounting_month: string, target_system: ("LODAS" | "LuG"), file_type: ("STAMMDATEN" | "BEWEGUNGSDATEN"), file_name: string } & Record<string, unknown>);
...
export type GetCustomDatevCheckEauPermissionPositiveResponse = ({ status: "success", data: ({ ready: boolean, error?: string } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetCustomDatevCheckDocumentPermissionPositiveResponse = ({ status: "success", data: (({ ready: boolean, documents_granted: Array<string> } & Record<string, unknown>) | ({ ready: boolean, error: string } & Record<string, unknown>)), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetCustomDatevAvailableDocumentsPositiveResponse = ({ status: "success", data: ({ results: Array<({ document_type: string, available_for_employees: Array<({ id: (string | null), remote_id: string } & Record<string, unknown>)>, is_company_document: boolean } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevDownloadDocumentPositiveResponse = ({ status: "success", data: ({ data_url: string, file_name: string, content_type: string } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevDownloadDocumentRequestBody = ({ accounting_month: string, document_type: ("AANB" | "ABEG" | "BUBE" | "DAWE" | "KBNW" | "KOST" | "KOTR" | "LKTO" | "LOBN" | "LJOE" | "LOJE" | "LOJO" | "LOPE" | "LOPN" | "LOPS" | "LORE" | "LOWE" | "LSTA" | "LSTB" | "LSTE" | "PDAT" | "PFAN" | "PRZA" | "SBNW" | "SVNW" | "WEAN" | "ZABR" | "ZAKF" | "ZAUW"), employee_id: (string | null) } & Record<string, unknown>);
...
export type PostCustomDatevEmployeesEmployeeIdDownloadDocumentPositiveResponse = ({ status: "success", data: ({ data_url: string, file_name: string, content_type: string } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevEmployeesEmployeeIdDownloadDocumentRequestBody = ({ accounting_month: string, document_type: ("AANB" | "ABEG" | "BUBE" | "DAWE" | "KBNW" | "KOST" | "KOTR" | "LKTO" | "LOBN" | "LJOE" | "LOJE" | "LOJO" | "LOPE" | "LOPN" | "LOPS" | "LORE" | "LOWE" | "LSTA" | "LSTB" | "LSTE" | "PDAT" | "PFAN" | "PRZA" | "SBNW" | "SVNW" | "WEAN" | "ZABR" | "ZAKF" | "ZAUW") } & Record<string, unknown>);
...
export type PostCustomDatevEmployeesEmployeeIdEauRequestsPositiveResponse = ({ status: "success", data: ({ eau_id: string } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevEmployeesEmployeeIdEauRequestsRequestBody = ({ start_work_incapacity: string, notification?: ({ email: string } & Record<string, unknown>), contact_person?: ({ gender: ("M" | "W" | "X" | "D"), name: string, telephone: string, fax: string, email: string, company_name: string, postal_code: string, city: string, street: string, house_number: string } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PutCustomDatevEmployeesEmployeeIdPreparePayrollPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PutCustomDatevEmployeesEmployeeIdPreparePayrollRequestBody = ({ payroll_run: ({ date: string } & Record<string, unknown>), hourly_payments: Array<({ hours: number, lohnart: number } & Record<string, unknown>)>, fixed_payments: Array<({ amount: number, lohnart: number } & Record<string, unknown>)>, custom_lodas?: Array<({ amount: number, lohnart: number, bearbeitungsschluessel: number } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PutCustomDatevEmployeesEmployeeIdCompensationsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PutCustomDatevEmployeesEmployeeIdCompensationsRequestBody = ({ effective_date: string, compensations: Array<({ amount: number, currency: "EUR", period: ("HOUR" | "MONTH"), lohnart?: number } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetCustomDatevCheckWritePermissionPositiveResponse = ({ status: "success", data: ({ ready: boolean, error?: string } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type GetCustomDatevDataPushesPositiveResponse = ({ status: "success", data: ({ data_pushes: Array<({ id: string, type: ("GENERAL" | "PAYROLL"), created_at: string, upload_jobs: Array<({ id: string, file_name: string, state: ("FAILED" | "UPLOADED" | "IMPORTED" | "CORRUPTED" | "DELETED" | "AUTO_DELETED"), file: string } & Record<string, unknown>)> } & Record<string, unknown>)> } & Record<string, unknown>) } & Record<string, unknown>);
...
export type PostCustomDatevPushDataGeneralPositiveResponse = ({ status: "success", data: ({ files: Array<({ name: string, content: string } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevPushDataPayrollPositiveResponse = ({ status: "success", data: ({ files: Array<({ name: string, content: string } & Record<string, unknown>)> } & Record<string, unknown>), warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomDatevPushDataPayrollRequestBody = ({ payroll_month: string } & Record<string, unknown>);
...
export type PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsPositiveResponse = ({ status: "success", data: Record<string, unknown>, warnings: Array<({ message: string } & Record<string, unknown>)> } & Record<string, unknown>);
...
export type PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsRequestBody = ({ supplement_code: string, effective_date: string, element_amount?: number, element_string?: string } & Record<string, unknown>);
...
export const isDataChangedWebhookPayload = ((input: unknown): input is DataChangedWebhookPayload => typia.createIs<DataChangedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isConnectionFlowFailedWebhookPayload = ((input: unknown): input is ConnectionFlowFailedWebhookPayload => typia.createIs<ConnectionFlowFailedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isIntegrationCreatedWebhookPayload = ((input: unknown): input is IntegrationCreatedWebhookPayload => typia.createIs<IntegrationCreatedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isIntegrationDeletedWebhookPayload = ((input: unknown): input is IntegrationDeletedWebhookPayload => typia.createIs<IntegrationDeletedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isAssessmentOrderReceivedWebhookPayload = ((input: unknown): input is AssessmentOrderReceivedWebhookPayload => typia.createIs<AssessmentOrderReceivedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isInlineAssessmentOrderReceivedWebhookPayload = ((input: unknown): input is InlineAssessmentOrderReceivedWebhookPayload => typia.createIs<InlineAssessmentOrderReceivedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isIntegrationStateChangedWebhookPayload = ((input: unknown): input is IntegrationStateChangedWebhookPayload => typia.createIs<IntegrationStateChangedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isAiApplyApplicationStatusUpdatedWebhookPayload = ((input: unknown): input is AiApplyApplicationStatusUpdatedWebhookPayload => typia.createIs<AiApplyApplicationStatusUpdatedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isAiApplyJobPostingStatusUpdatedWebhookPayload = ((input: unknown): input is AiApplyJobPostingStatusUpdatedWebhookPayload => typia.createIs<AiApplyJobPostingStatusUpdatedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export const isSyncFinishedWebhookPayload = ((input: unknown): input is SyncFinishedWebhookPayload => typia.createIs<SyncFinishedWebhookPayload>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["id", "type", "data"].includes(key)));
...
export type BulkImportJobPostingLocation = ({ country: string, postal_code?: string } & Record<string, unknown>);
...
export type BulkImportJobPostingInput = ({ url: string, career_site_label: string, job_code?: string, location?: (BulkImportJobPostingLocation | null) } & Record<string, unknown>);
...
export type BulkImportResponse = ({ status: "success", data: ({ created: number, processed: number, archived: number } & Record<string, unknown>) } & Record<string, unknown>);
...
export const get_GetCheckApiKey = {
  ...
  responses: { 200: isGetCheckApiKeyPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostForceSync = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostForceSyncRequestBody },
  responses: { 200: isPostForceSyncPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostPassthroughToolApi = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { tool: PostPassthroughToolApiParameterTool, api: PostPassthroughToolApiParameterApi } => typia.createIs<{ tool: PostPassthroughToolApiParameterTool, api: PostPassthroughToolApiParameterApi }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["tool", "api"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: ((input: unknown): input is PostPassthroughToolApiRequestBody => typia.createIs<PostPassthroughToolApiRequestBody>()(input)) },
  responses: { 200: ((input: unknown): input is PostPassthroughToolApiPositiveResponse => typia.createIs<PostPassthroughToolApiPositiveResponse>()(input)), default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const delete_DeleteIntegrationsIntegrationId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: DeleteIntegrationsIntegrationIdParameterIntegrationId } => typia.createIs<{ integration_id: DeleteIntegrationsIntegrationIdParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))), body: isDeleteIntegrationsIntegrationIdRequestBody },
  responses: { 200: isDeleteIntegrationsIntegrationIdPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetIntegrationsIntegrationId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: GetIntegrationsIntegrationIdParameterIntegrationId } => typia.createIs<{ integration_id: GetIntegrationsIntegrationIdParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))) },
  responses: { 200: isGetIntegrationsIntegrationIdPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const put_PutIntegrationsIntegrationIdEnabled = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: PutIntegrationsIntegrationIdEnabledParameterIntegrationId } => typia.createIs<{ integration_id: PutIntegrationsIntegrationIdEnabledParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))), body: isPutIntegrationsIntegrationIdEnabledRequestBody },
  responses: { 200: isPutIntegrationsIntegrationIdEnabledPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostIntegrationsIntegrationIdRelink = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: PostIntegrationsIntegrationIdRelinkParameterIntegrationId } => typia.createIs<{ integration_id: PostIntegrationsIntegrationIdRelinkParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))), body: isPostIntegrationsIntegrationIdRelinkRequestBody },
  responses: { 200: isPostIntegrationsIntegrationIdRelinkPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostIntegrationsIntegrationIdSetupLink = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: PostIntegrationsIntegrationIdSetupLinkParameterIntegrationId } => typia.createIs<{ integration_id: PostIntegrationsIntegrationIdSetupLinkParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))), body: isPostIntegrationsIntegrationIdSetupLinkRequestBody },
...
export const get_GetIntegrationsIntegrationIdIntegrationFields = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetIntegrationsIntegrationIdIntegrationFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdIntegrationFieldsParameterPageSize }> => typia.createIs<Partial<{ cursor: GetIntegrationsIntegrationIdIntegrationFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdIntegrationFieldsParameterPageSize }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size"].includes(key))), path: ((input: unknown): input is { integration_id: GetIntegrationsIntegrationIdIntegrationFieldsParameterIntegrationId } => typia.createIs<{ integration_id: GetIntegrationsIntegrationIdIntegrationFieldsParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))) },
  responses: { 200: isGetIntegrationsIntegrationIdIntegrationFieldsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const patch_PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdParameterIntegrationId, integration_field_id: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdParameterIntegrationFieldId } => typia.createIs<{ integration_id: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdParameterIntegrationId, integration_field_id: PatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdParameterIntegrationFieldId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id", "integration_field_id"].includes(key))), body: isPatchIntegrationsIntegrationIdIntegrationFieldsIntegrationFieldIdRequestBody },
...
export const get_GetIntegrationsIntegrationIdCustomFields = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetIntegrationsIntegrationIdCustomFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdCustomFieldsParameterPageSize }> => typia.createIs<Partial<{ cursor: GetIntegrationsIntegrationIdCustomFieldsParameterCursor, page_size: GetIntegrationsIntegrationIdCustomFieldsParameterPageSize }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size"].includes(key))), path: ((input: unknown): input is { integration_id: GetIntegrationsIntegrationIdCustomFieldsParameterIntegrationId } => typia.createIs<{ integration_id: GetIntegrationsIntegrationIdCustomFieldsParameterIntegrationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id"].includes(key))) },
...
export const put_PutIntegrationsIntegrationIdCustomFieldsCustomFieldId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { integration_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterIntegrationId, custom_field_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterCustomFieldId } => typia.createIs<{ integration_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterIntegrationId, custom_field_id: PutIntegrationsIntegrationIdCustomFieldsCustomFieldIdParameterCustomFieldId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["integration_id", "custom_field_id"].includes(key))), body: isPutIntegrationsIntegrationIdCustomFieldsCustomFieldIdRequestBody },
  responses: { 200: isPutIntegrationsIntegrationIdCustomFieldsCustomFieldIdPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetToolsCategory = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { category: GetToolsCategoryParameterCategory } => typia.createIs<{ category: GetToolsCategoryParameterCategory }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["category"].includes(key))) },
...
export const post_PostHrisProvisioningGroupsGroupIdDiff = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { group_id: PostHrisProvisioningGroupsGroupIdDiffParameterGroupId } => typia.createIs<{ group_id: PostHrisProvisioningGroupsGroupIdDiffParameterGroupId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["group_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisProvisioningGroupsGroupIdDiffRequestBody },
  responses: { 200: isPostHrisProvisioningGroupsGroupIdDiffPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "INTEGRATION.PERMISSION_MISSING" | "INTEGRATION.AUTHENTICATION_INVALID" | "INTEGRATION.QA_FAILED" | "INTEGRATION.SETUP_SYNC_PENDING" | "INTEGRATION.SETUP_INCOMPLETE" | "INTEGRATION.INACTIVE" | "INTEGRATION.MODEL_NOT_AVAILABLE" | "INTEGRATION.MODEL_DISABLED" | "INTEGRATION.ACTION_NOT_AVAILABLE" | "INTEGRATION.ACTION_DISABLED" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "HRIS.EMPLOYEE_ALREADY_EXISTS") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostHrisProvisioningGroupsGroupIdSetupLinks = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { group_id: PostHrisProvisioningGroupsGroupIdSetupLinksParameterGroupId } => typia.createIs<{ group_id: PostHrisProvisioningGroupsGroupIdSetupLinksParameterGroupId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["group_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisProvisioningGroupsGroupIdSetupLinksRequestBody },
...
export const post_PostHrisEmployees = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisEmployeesRequestBody },
...
export const get_GetHrisEmployeesForm = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
  responses: { 200: ((input: unknown): input is GetHrisEmployeesFormPositiveResponse => typia.createIs<GetHrisEmployeesFormPositiveResponse>()(input)), default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "INTEGRATION.PERMISSION_MISSING" | "INTEGRATION.AUTHENTICATION_INVALID" | "INTEGRATION.QA_FAILED" | "INTEGRATION.SETUP_SYNC_PENDING" | "INTEGRATION.SETUP_INCOMPLETE" | "INTEGRATION.INACTIVE" | "INTEGRATION.MODEL_NOT_AVAILABLE" | "INTEGRATION.MODEL_DISABLED" | "INTEGRATION.ACTION_NOT_AVAILABLE" | "INTEGRATION.ACTION_DISABLED" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "HRIS.EMPLOYEE_ALREADY_EXISTS") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostHrisEmployeesForm = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: ((input: unknown): input is PostHrisEmployeesFormRequestBody => typia.createIs<PostHrisEmployeesFormRequestBody>()(input)) },
...
export const patch_PatchHrisEmployeesEmployeeId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PatchHrisEmployeesEmployeeIdParameterEmployeeId } => typia.createIs<{ employee_id: PatchHrisEmployeesEmployeeIdParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPatchHrisEmployeesEmployeeIdRequestBody },
...
export const post_PostHrisEmployeesEmployeeIdDocuments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PostHrisEmployeesEmployeeIdDocumentsParameterEmployeeId } => typia.createIs<{ employee_id: PostHrisEmployeesEmployeeIdDocumentsParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisEmployeesEmployeeIdDocumentsRequestBody },
...
export const get_GetHrisEmployeeDocumentCategories = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisEmployeeDocumentCategoriesParameterCursor, page_size: GetHrisEmployeeDocumentCategoriesParameterPageSize, updated_after: GetHrisEmployeeDocumentCategoriesParameterUpdatedAfter, include_deleted: GetHrisEmployeeDocumentCategoriesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisEmployeeDocumentCategoriesParameterIgnoreUnsupportedFilters, ids: GetHrisEmployeeDocumentCategoriesParameterIds, remote_ids: GetHrisEmployeeDocumentCategoriesParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetHrisEmployeeDocumentCategoriesParameterCursor, page_size: GetHrisEmployeeDocumentCategoriesParameterPageSize, updated_after: GetHrisEmployeeDocumentCategoriesParameterUpdatedAfter, include_deleted: GetHrisEmployeeDocumentCategoriesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisEmployeeDocumentCategoriesParameterIgnoreUnsupportedFilters, ids: GetHrisEmployeeDocumentCategoriesParameterIds, remote_ids: GetHrisEmployeeDocumentCategoriesParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisTeams = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisTeamsParameterCursor, page_size: GetHrisTeamsParameterPageSize, updated_after: GetHrisTeamsParameterUpdatedAfter, include_deleted: GetHrisTeamsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisTeamsParameterIgnoreUnsupportedFilters, ids: GetHrisTeamsParameterIds, remote_ids: GetHrisTeamsParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetHrisTeamsParameterCursor, page_size: GetHrisTeamsParameterPageSize, updated_after: GetHrisTeamsParameterUpdatedAfter, include_deleted: GetHrisTeamsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisTeamsParameterIgnoreUnsupportedFilters, ids: GetHrisTeamsParameterIds, remote_ids: GetHrisTeamsParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisGroups = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisGroupsParameterCursor, page_size: GetHrisGroupsParameterPageSize, updated_after: GetHrisGroupsParameterUpdatedAfter, include_deleted: GetHrisGroupsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisGroupsParameterIgnoreUnsupportedFilters, ids: GetHrisGroupsParameterIds, remote_ids: GetHrisGroupsParameterRemoteIds, types: GetHrisGroupsParameterTypes, name_contains: GetHrisGroupsParameterNameContains }> => typia.createIs<Partial<{ cursor: GetHrisGroupsParameterCursor, page_size: GetHrisGroupsParameterPageSize, updated_after: GetHrisGroupsParameterUpdatedAfter, include_deleted: GetHrisGroupsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisGroupsParameterIgnoreUnsupportedFilters, ids: GetHrisGroupsParameterIds, remote_ids: GetHrisGroupsParameterRemoteIds, types: GetHrisGroupsParameterTypes, name_contains: GetHrisGroupsParameterNameContains }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "types", "name_contains"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisEmployments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisEmploymentsParameterCursor, page_size: GetHrisEmploymentsParameterPageSize, updated_after: GetHrisEmploymentsParameterUpdatedAfter, include_deleted: GetHrisEmploymentsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisEmploymentsParameterIgnoreUnsupportedFilters, ids: GetHrisEmploymentsParameterIds, remote_ids: GetHrisEmploymentsParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetHrisEmploymentsParameterCursor, page_size: GetHrisEmploymentsParameterPageSize, updated_after: GetHrisEmploymentsParameterUpdatedAfter, include_deleted: GetHrisEmploymentsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisEmploymentsParameterIgnoreUnsupportedFilters, ids: GetHrisEmploymentsParameterIds, remote_ids: GetHrisEmploymentsParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisLocations = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisLocationsParameterCursor, page_size: GetHrisLocationsParameterPageSize, updated_after: GetHrisLocationsParameterUpdatedAfter, include_deleted: GetHrisLocationsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisLocationsParameterIgnoreUnsupportedFilters, ids: GetHrisLocationsParameterIds, remote_ids: GetHrisLocationsParameterRemoteIds, name_contains: GetHrisLocationsParameterNameContains }> => typia.createIs<Partial<{ cursor: GetHrisLocationsParameterCursor, page_size: GetHrisLocationsParameterPageSize, updated_after: GetHrisLocationsParameterUpdatedAfter, include_deleted: GetHrisLocationsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisLocationsParameterIgnoreUnsupportedFilters, ids: GetHrisLocationsParameterIds, remote_ids: GetHrisLocationsParameterRemoteIds, name_contains: GetHrisLocationsParameterNameContains }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "name_contains"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisAbsenceTypes = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisAbsenceTypesParameterCursor, page_size: GetHrisAbsenceTypesParameterPageSize, updated_after: GetHrisAbsenceTypesParameterUpdatedAfter, include_deleted: GetHrisAbsenceTypesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisAbsenceTypesParameterIgnoreUnsupportedFilters, ids: GetHrisAbsenceTypesParameterIds, remote_ids: GetHrisAbsenceTypesParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetHrisAbsenceTypesParameterCursor, page_size: GetHrisAbsenceTypesParameterPageSize, updated_after: GetHrisAbsenceTypesParameterUpdatedAfter, include_deleted: GetHrisAbsenceTypesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisAbsenceTypesParameterIgnoreUnsupportedFilters, ids: GetHrisAbsenceTypesParameterIds, remote_ids: GetHrisAbsenceTypesParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisAbsences = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisAbsencesParameterCursor, page_size: GetHrisAbsencesParameterPageSize, updated_after: GetHrisAbsencesParameterUpdatedAfter, include_deleted: GetHrisAbsencesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisAbsencesParameterIgnoreUnsupportedFilters, ids: GetHrisAbsencesParameterIds, remote_ids: GetHrisAbsencesParameterRemoteIds, date_from: GetHrisAbsencesParameterDateFrom, date_until: GetHrisAbsencesParameterDateUntil, type_ids: GetHrisAbsencesParameterTypeIds, employee_id: GetHrisAbsencesParameterEmployeeId, time_from: GetHrisAbsencesParameterTimeFrom, time_until: GetHrisAbsencesParameterTimeUntil }> => typia.createIs<Partial<{ cursor: GetHrisAbsencesParameterCursor, page_size: GetHrisAbsencesParameterPageSize, updated_after: GetHrisAbsencesParameterUpdatedAfter, include_deleted: GetHrisAbsencesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisAbsencesParameterIgnoreUnsupportedFilters, ids: GetHrisAbsencesParameterIds, remote_ids: GetHrisAbsencesParameterRemoteIds, date_from: GetHrisAbsencesParameterDateFrom, date_until: GetHrisAbsencesParameterDateUntil, type_ids: GetHrisAbsencesParameterTypeIds, employee_id: GetHrisAbsencesParameterEmployeeId, time_from: GetHrisAbsencesParameterTimeFrom, time_until: GetHrisAbsencesParameterTimeUntil }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "date_from", "date_until", "type_ids", "employee_id", "time_from", "time_until"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostHrisAbsences = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisAbsencesRequestBody },
...
export const delete_DeleteHrisAbsencesAbsenceId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { absence_id: DeleteHrisAbsencesAbsenceIdParameterAbsenceId } => typia.createIs<{ absence_id: DeleteHrisAbsencesAbsenceIdParameterAbsenceId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["absence_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isDeleteHrisAbsencesAbsenceIdRequestBody },
...
export const get_GetHrisLegalEntities = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisLegalEntitiesParameterCursor, page_size: GetHrisLegalEntitiesParameterPageSize, updated_after: GetHrisLegalEntitiesParameterUpdatedAfter, include_deleted: GetHrisLegalEntitiesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisLegalEntitiesParameterIgnoreUnsupportedFilters, ids: GetHrisLegalEntitiesParameterIds, remote_ids: GetHrisLegalEntitiesParameterRemoteIds, name_contains: GetHrisLegalEntitiesParameterNameContains }> => typia.createIs<Partial<{ cursor: GetHrisLegalEntitiesParameterCursor, page_size: GetHrisLegalEntitiesParameterPageSize, updated_after: GetHrisLegalEntitiesParameterUpdatedAfter, include_deleted: GetHrisLegalEntitiesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisLegalEntitiesParameterIgnoreUnsupportedFilters, ids: GetHrisLegalEntitiesParameterIds, remote_ids: GetHrisLegalEntitiesParameterRemoteIds, name_contains: GetHrisLegalEntitiesParameterNameContains }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "name_contains"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisTimesheets = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisTimesheetsParameterCursor, page_size: GetHrisTimesheetsParameterPageSize, updated_after: GetHrisTimesheetsParameterUpdatedAfter, include_deleted: GetHrisTimesheetsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisTimesheetsParameterIgnoreUnsupportedFilters, ids: GetHrisTimesheetsParameterIds, remote_ids: GetHrisTimesheetsParameterRemoteIds, employee_id: GetHrisTimesheetsParameterEmployeeId, started_before: GetHrisTimesheetsParameterStartedBefore, started_after: GetHrisTimesheetsParameterStartedAfter, ended_before: GetHrisTimesheetsParameterEndedBefore, ended_after: GetHrisTimesheetsParameterEndedAfter }> => typia.createIs<Partial<{ cursor: GetHrisTimesheetsParameterCursor, page_size: GetHrisTimesheetsParameterPageSize, updated_after: GetHrisTimesheetsParameterUpdatedAfter, include_deleted: GetHrisTimesheetsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisTimesheetsParameterIgnoreUnsupportedFilters, ids: GetHrisTimesheetsParameterIds, remote_ids: GetHrisTimesheetsParameterRemoteIds, employee_id: GetHrisTimesheetsParameterEmployeeId, started_before: GetHrisTimesheetsParameterStartedBefore, started_after: GetHrisTimesheetsParameterStartedAfter, ended_before: GetHrisTimesheetsParameterEndedBefore, ended_after: GetHrisTimesheetsParameterEndedAfter }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "employee_id", "started_before", "started_after", "ended_before", "ended_after"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisPerformanceReviewCycles = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisPerformanceReviewCyclesParameterCursor, page_size: GetHrisPerformanceReviewCyclesParameterPageSize, updated_after: GetHrisPerformanceReviewCyclesParameterUpdatedAfter, include_deleted: GetHrisPerformanceReviewCyclesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisPerformanceReviewCyclesParameterIgnoreUnsupportedFilters, ids: GetHrisPerformanceReviewCyclesParameterIds, remote_ids: GetHrisPerformanceReviewCyclesParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetHrisPerformanceReviewCyclesParameterCursor, page_size: GetHrisPerformanceReviewCyclesParameterPageSize, updated_after: GetHrisPerformanceReviewCyclesParameterUpdatedAfter, include_deleted: GetHrisPerformanceReviewCyclesParameterIncludeDeleted, ignore_unsupported_filters: GetHrisPerformanceReviewCyclesParameterIgnoreUnsupportedFilters, ids: GetHrisPerformanceReviewCyclesParameterIds, remote_ids: GetHrisPerformanceReviewCyclesParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisPerformanceReviews = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetHrisPerformanceReviewsParameterCursor, page_size: GetHrisPerformanceReviewsParameterPageSize, updated_after: GetHrisPerformanceReviewsParameterUpdatedAfter, include_deleted: GetHrisPerformanceReviewsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisPerformanceReviewsParameterIgnoreUnsupportedFilters, ids: GetHrisPerformanceReviewsParameterIds, remote_ids: GetHrisPerformanceReviewsParameterRemoteIds, types: GetHrisPerformanceReviewsParameterTypes, review_cycle_ids: GetHrisPerformanceReviewsParameterReviewCycleIds, reviewee_ids: GetHrisPerformanceReviewsParameterRevieweeIds }> => typia.createIs<Partial<{ cursor: GetHrisPerformanceReviewsParameterCursor, page_size: GetHrisPerformanceReviewsParameterPageSize, updated_after: GetHrisPerformanceReviewsParameterUpdatedAfter, include_deleted: GetHrisPerformanceReviewsParameterIncludeDeleted, ignore_unsupported_filters: GetHrisPerformanceReviewsParameterIgnoreUnsupportedFilters, ids: GetHrisPerformanceReviewsParameterIds, remote_ids: GetHrisPerformanceReviewsParameterRemoteIds, types: GetHrisPerformanceReviewsParameterTypes, review_cycle_ids: GetHrisPerformanceReviewsParameterReviewCycleIds, reviewee_ids: GetHrisPerformanceReviewsParameterRevieweeIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "types", "review_cycle_ids", "reviewee_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetHrisSkills = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ ids: GetHrisSkillsParameterIds, remote_ids: GetHrisSkillsParameterRemoteIds, name_contains: GetHrisSkillsParameterNameContains }> => typia.createIs<Partial<{ ids: GetHrisSkillsParameterIds, remote_ids: GetHrisSkillsParameterRemoteIds, name_contains: GetHrisSkillsParameterNameContains }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["ids", "remote_ids", "name_contains"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostHrisSkills = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisSkillsRequestBody },
...
export const patch_PatchHrisSkillsSkillId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { skill_id: PatchHrisSkillsSkillIdParameterSkillId } => typia.createIs<{ skill_id: PatchHrisSkillsSkillIdParameterSkillId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["skill_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPatchHrisSkillsSkillIdRequestBody },
...
export const delete_DeleteHrisSkillsSkillId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { skill_id: DeleteHrisSkillsSkillIdParameterSkillId } => typia.createIs<{ skill_id: DeleteHrisSkillsSkillIdParameterSkillId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["skill_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isDeleteHrisSkillsSkillIdRequestBody },
...
export const get_GetHrisEmployeeSkillAssignments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ ids: GetHrisEmployeeSkillAssignmentsParameterIds, remote_ids: GetHrisEmployeeSkillAssignmentsParameterRemoteIds, employee_ids: GetHrisEmployeeSkillAssignmentsParameterEmployeeIds, skill_ids: GetHrisEmployeeSkillAssignmentsParameterSkillIds }> => typia.createIs<Partial<{ ids: GetHrisEmployeeSkillAssignmentsParameterIds, remote_ids: GetHrisEmployeeSkillAssignmentsParameterRemoteIds, employee_ids: GetHrisEmployeeSkillAssignmentsParameterEmployeeIds, skill_ids: GetHrisEmployeeSkillAssignmentsParameterSkillIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["ids", "remote_ids", "employee_ids", "skill_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostHrisEmployeeSkillAssignments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostHrisEmployeeSkillAssignmentsRequestBody },
...
export const patch_PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_skill_assignment_id: PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId } => typia.createIs<{ employee_skill_assignment_id: PatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_skill_assignment_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPatchHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody },
...
export const delete_DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_skill_assignment_id: DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId } => typia.createIs<{ employee_skill_assignment_id: DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdParameterEmployeeSkillAssignmentId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_skill_assignment_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isDeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody },
...
export const put_PutAtsApplicationsApplicationIdStage = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PutAtsApplicationsApplicationIdStageParameterApplicationId } => typia.createIs<{ application_id: PutAtsApplicationsApplicationIdStageParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPutAtsApplicationsApplicationIdStageRequestBody },
...
export const post_PostAtsApplicationsApplicationIdResultLinks = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PostAtsApplicationsApplicationIdResultLinksParameterApplicationId } => typia.createIs<{ application_id: PostAtsApplicationsApplicationIdResultLinksParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsApplicationsApplicationIdResultLinksRequestBody },
...
export const post_PostAtsApplicationsApplicationIdNotes = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PostAtsApplicationsApplicationIdNotesParameterApplicationId } => typia.createIs<{ application_id: PostAtsApplicationsApplicationIdNotesParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsApplicationsApplicationIdNotesRequestBody },
...
export const get_GetAtsApplicationsApplicationIdAttachments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: GetAtsApplicationsApplicationIdAttachmentsParameterApplicationId } => typia.createIs<{ application_id: GetAtsApplicationsApplicationIdAttachmentsParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsApplicationsApplicationIdAttachments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PostAtsApplicationsApplicationIdAttachmentsParameterApplicationId } => typia.createIs<{ application_id: PostAtsApplicationsApplicationIdAttachmentsParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsApplicationsApplicationIdAttachmentsRequestBody },
...
export const post_PostAtsApplicationsApplicationIdReject = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PostAtsApplicationsApplicationIdRejectParameterApplicationId } => typia.createIs<{ application_id: PostAtsApplicationsApplicationIdRejectParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsApplicationsApplicationIdRejectRequestBody },
...
export const post_PostAtsApplicationsApplicationIdInterviews = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PostAtsApplicationsApplicationIdInterviewsParameterApplicationId } => typia.createIs<{ application_id: PostAtsApplicationsApplicationIdInterviewsParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsApplicationsApplicationIdInterviewsRequestBody },
...
export const patch_PatchAtsApplicationsApplicationIdInterviews = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { application_id: PatchAtsApplicationsApplicationIdInterviewsParameterApplicationId } => typia.createIs<{ application_id: PatchAtsApplicationsApplicationIdInterviewsParameterApplicationId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["application_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPatchAtsApplicationsApplicationIdInterviewsRequestBody },
...
export const post_PostAtsCandidates = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsCandidatesRequestBody },
...
export const get_GetAtsCandidatesCandidateIdAttachments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { candidate_id: GetAtsCandidatesCandidateIdAttachmentsParameterCandidateId } => typia.createIs<{ candidate_id: GetAtsCandidatesCandidateIdAttachmentsParameterCandidateId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["candidate_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsCandidatesCandidateIdAttachments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { candidate_id: PostAtsCandidatesCandidateIdAttachmentsParameterCandidateId } => typia.createIs<{ candidate_id: PostAtsCandidatesCandidateIdAttachmentsParameterCandidateId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["candidate_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsCandidatesCandidateIdAttachmentsRequestBody },
...
export const post_PostAtsCandidatesCandidateIdResultLinks = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { candidate_id: PostAtsCandidatesCandidateIdResultLinksParameterCandidateId } => typia.createIs<{ candidate_id: PostAtsCandidatesCandidateIdResultLinksParameterCandidateId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["candidate_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsCandidatesCandidateIdResultLinksRequestBody },
...
export const post_PostAtsCandidatesCandidateIdTags = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { candidate_id: PostAtsCandidatesCandidateIdTagsParameterCandidateId } => typia.createIs<{ candidate_id: PostAtsCandidatesCandidateIdTagsParameterCandidateId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["candidate_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsCandidatesCandidateIdTagsRequestBody },
...
export const delete_DeleteAtsCandidatesCandidateIdTags = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { candidate_id: DeleteAtsCandidatesCandidateIdTagsParameterCandidateId } => typia.createIs<{ candidate_id: DeleteAtsCandidatesCandidateIdTagsParameterCandidateId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["candidate_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isDeleteAtsCandidatesCandidateIdTagsRequestBody },
...
export const get_GetAtsTags = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAtsTagsParameterCursor, page_size: GetAtsTagsParameterPageSize, updated_after: GetAtsTagsParameterUpdatedAfter, include_deleted: GetAtsTagsParameterIncludeDeleted, ignore_unsupported_filters: GetAtsTagsParameterIgnoreUnsupportedFilters, ids: GetAtsTagsParameterIds, remote_ids: GetAtsTagsParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetAtsTagsParameterCursor, page_size: GetAtsTagsParameterPageSize, updated_after: GetAtsTagsParameterUpdatedAfter, include_deleted: GetAtsTagsParameterIncludeDeleted, ignore_unsupported_filters: GetAtsTagsParameterIgnoreUnsupportedFilters, ids: GetAtsTagsParameterIds, remote_ids: GetAtsTagsParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetAtsApplicationStages = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAtsApplicationStagesParameterCursor, page_size: GetAtsApplicationStagesParameterPageSize, updated_after: GetAtsApplicationStagesParameterUpdatedAfter, include_deleted: GetAtsApplicationStagesParameterIncludeDeleted, ignore_unsupported_filters: GetAtsApplicationStagesParameterIgnoreUnsupportedFilters, ids: GetAtsApplicationStagesParameterIds, remote_ids: GetAtsApplicationStagesParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetAtsApplicationStagesParameterCursor, page_size: GetAtsApplicationStagesParameterPageSize, updated_after: GetAtsApplicationStagesParameterUpdatedAfter, include_deleted: GetAtsApplicationStagesParameterIncludeDeleted, ignore_unsupported_filters: GetAtsApplicationStagesParameterIgnoreUnsupportedFilters, ids: GetAtsApplicationStagesParameterIds, remote_ids: GetAtsApplicationStagesParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsJobsJobIdApplications = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { job_id: PostAtsJobsJobIdApplicationsParameterJobId } => typia.createIs<{ job_id: PostAtsJobsJobIdApplicationsParameterJobId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["job_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsJobsJobIdApplicationsRequestBody },
...
export const get_GetAtsUsers = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAtsUsersParameterCursor, page_size: GetAtsUsersParameterPageSize, updated_after: GetAtsUsersParameterUpdatedAfter, include_deleted: GetAtsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetAtsUsersParameterIgnoreUnsupportedFilters, ids: GetAtsUsersParameterIds, remote_ids: GetAtsUsersParameterRemoteIds, emails: GetAtsUsersParameterEmails }> => typia.createIs<Partial<{ cursor: GetAtsUsersParameterCursor, page_size: GetAtsUsersParameterPageSize, updated_after: GetAtsUsersParameterUpdatedAfter, include_deleted: GetAtsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetAtsUsersParameterIgnoreUnsupportedFilters, ids: GetAtsUsersParameterIds, remote_ids: GetAtsUsersParameterRemoteIds, emails: GetAtsUsersParameterEmails }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "emails"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetAtsRoles = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAtsRolesParameterCursor, page_size: GetAtsRolesParameterPageSize, updated_after: GetAtsRolesParameterUpdatedAfter, include_deleted: GetAtsRolesParameterIncludeDeleted, ignore_unsupported_filters: GetAtsRolesParameterIgnoreUnsupportedFilters, ids: GetAtsRolesParameterIds, remote_ids: GetAtsRolesParameterRemoteIds, scopes: GetAtsRolesParameterScopes }> => typia.createIs<Partial<{ cursor: GetAtsRolesParameterCursor, page_size: GetAtsRolesParameterPageSize, updated_after: GetAtsRolesParameterUpdatedAfter, include_deleted: GetAtsRolesParameterIncludeDeleted, ignore_unsupported_filters: GetAtsRolesParameterIgnoreUnsupportedFilters, ids: GetAtsRolesParameterIds, remote_ids: GetAtsRolesParameterRemoteIds, scopes: GetAtsRolesParameterScopes }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "scopes"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetAtsOffers = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAtsOffersParameterCursor, page_size: GetAtsOffersParameterPageSize, updated_after: GetAtsOffersParameterUpdatedAfter, include_deleted: GetAtsOffersParameterIncludeDeleted, ignore_unsupported_filters: GetAtsOffersParameterIgnoreUnsupportedFilters, ids: GetAtsOffersParameterIds, remote_ids: GetAtsOffersParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetAtsOffersParameterCursor, page_size: GetAtsOffersParameterPageSize, updated_after: GetAtsOffersParameterUpdatedAfter, include_deleted: GetAtsOffersParameterIncludeDeleted, ignore_unsupported_filters: GetAtsOffersParameterIgnoreUnsupportedFilters, ids: GetAtsOffersParameterIds, remote_ids: GetAtsOffersParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetAtsInterviews = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAtsInterviewsParameterCursor, page_size: GetAtsInterviewsParameterPageSize, updated_after: GetAtsInterviewsParameterUpdatedAfter, include_deleted: GetAtsInterviewsParameterIncludeDeleted, ignore_unsupported_filters: GetAtsInterviewsParameterIgnoreUnsupportedFilters, ids: GetAtsInterviewsParameterIds, remote_ids: GetAtsInterviewsParameterRemoteIds, job_ids: GetAtsInterviewsParameterJobIds }> => typia.createIs<Partial<{ cursor: GetAtsInterviewsParameterCursor, page_size: GetAtsInterviewsParameterPageSize, updated_after: GetAtsInterviewsParameterUpdatedAfter, include_deleted: GetAtsInterviewsParameterIncludeDeleted, ignore_unsupported_filters: GetAtsInterviewsParameterIgnoreUnsupportedFilters, ids: GetAtsInterviewsParameterIds, remote_ids: GetAtsInterviewsParameterRemoteIds, job_ids: GetAtsInterviewsParameterJobIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "job_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAtsImportTrackedApplication = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsImportTrackedApplicationRequestBody },
...
export const post_PostAtsCustomAvionteSyncedJobs = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostAtsCustomAvionteSyncedJobsRequestBody },
...
export const delete_DeleteAtsCustomAvionteSyncedJobsJobRemoteId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { job_remote_id: DeleteAtsCustomAvionteSyncedJobsJobRemoteIdParameterJobRemoteId } => typia.createIs<{ job_remote_id: DeleteAtsCustomAvionteSyncedJobsJobRemoteIdParameterJobRemoteId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["job_remote_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isDeleteAtsCustomAvionteSyncedJobsJobRemoteIdRequestBody },
...
export const put_PutAssessmentPackages = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPutAssessmentPackagesRequestBody },
...
export const get_GetAssessmentOrders = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAssessmentOrdersParameterCursor, page_size: GetAssessmentOrdersParameterPageSize, ids: GetAssessmentOrdersParameterIds, statuses: GetAssessmentOrdersParameterStatuses, created_after: GetAssessmentOrdersParameterCreatedAfter }> => typia.createIs<Partial<{ cursor: GetAssessmentOrdersParameterCursor, page_size: GetAssessmentOrdersParameterPageSize, ids: GetAssessmentOrdersParameterIds, statuses: GetAssessmentOrdersParameterStatuses, created_after: GetAssessmentOrdersParameterCreatedAfter }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "ids", "statuses", "created_after"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const get_GetAssessmentOrdersOpen = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAssessmentOrdersOpenParameterCursor, page_size: GetAssessmentOrdersOpenParameterPageSize }> => typia.createIs<Partial<{ cursor: GetAssessmentOrdersOpenParameterCursor, page_size: GetAssessmentOrdersOpenParameterPageSize }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const put_PutAssessmentOrdersAssessmentOrderIdResult = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { assessment_order_id: PutAssessmentOrdersAssessmentOrderIdResultParameterAssessmentOrderId } => typia.createIs<{ assessment_order_id: PutAssessmentOrdersAssessmentOrderIdResultParameterAssessmentOrderId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["assessment_order_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPutAssessmentOrdersAssessmentOrderIdResultRequestBody },
...
export const get_GetLmsUsers = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetLmsUsersParameterCursor, page_size: GetLmsUsersParameterPageSize, updated_after: GetLmsUsersParameterUpdatedAfter, include_deleted: GetLmsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetLmsUsersParameterIgnoreUnsupportedFilters, ids: GetLmsUsersParameterIds, remote_ids: GetLmsUsersParameterRemoteIds, work_emails: GetLmsUsersParameterWorkEmails }> => typia.createIs<Partial<{ cursor: GetLmsUsersParameterCursor, page_size: GetLmsUsersParameterPageSize, updated_after: GetLmsUsersParameterUpdatedAfter, include_deleted: GetLmsUsersParameterIncludeDeleted, ignore_unsupported_filters: GetLmsUsersParameterIgnoreUnsupportedFilters, ids: GetLmsUsersParameterIds, remote_ids: GetLmsUsersParameterRemoteIds, work_emails: GetLmsUsersParameterWorkEmails }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "work_emails"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
  responses: { 200: isGetLmsUsersPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetLmsCourseProgressions = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetLmsCourseProgressionsParameterCursor, page_size: GetLmsCourseProgressionsParameterPageSize, updated_after: GetLmsCourseProgressionsParameterUpdatedAfter, include_deleted: GetLmsCourseProgressionsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCourseProgressionsParameterIgnoreUnsupportedFilters, ids: GetLmsCourseProgressionsParameterIds, remote_ids: GetLmsCourseProgressionsParameterRemoteIds, user_ids: GetLmsCourseProgressionsParameterUserIds, course_ids: GetLmsCourseProgressionsParameterCourseIds }> => typia.createIs<Partial<{ cursor: GetLmsCourseProgressionsParameterCursor, page_size: GetLmsCourseProgressionsParameterPageSize, updated_after: GetLmsCourseProgressionsParameterUpdatedAfter, include_deleted: GetLmsCourseProgressionsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCourseProgressionsParameterIgnoreUnsupportedFilters, ids: GetLmsCourseProgressionsParameterIds, remote_ids: GetLmsCourseProgressionsParameterRemoteIds, user_ids: GetLmsCourseProgressionsParameterUserIds, course_ids: GetLmsCourseProgressionsParameterCourseIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids", "user_ids", "course_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostLmsCourseProgressions = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostLmsCourseProgressionsRequestBody },
  responses: { 200: isPostLmsCourseProgressionsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostLmsCourseProgressionsCourseProgressionIdComplete = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { course_progression_id: PostLmsCourseProgressionsCourseProgressionIdCompleteParameterCourseProgressionId } => typia.createIs<{ course_progression_id: PostLmsCourseProgressionsCourseProgressionIdCompleteParameterCourseProgressionId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["course_progression_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostLmsCourseProgressionsCourseProgressionIdCompleteRequestBody },
...
export const get_GetLmsCourses = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetLmsCoursesParameterCursor, page_size: GetLmsCoursesParameterPageSize, updated_after: GetLmsCoursesParameterUpdatedAfter, include_deleted: GetLmsCoursesParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCoursesParameterIgnoreUnsupportedFilters, ids: GetLmsCoursesParameterIds, remote_ids: GetLmsCoursesParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetLmsCoursesParameterCursor, page_size: GetLmsCoursesParameterPageSize, updated_after: GetLmsCoursesParameterUpdatedAfter, include_deleted: GetLmsCoursesParameterIncludeDeleted, ignore_unsupported_filters: GetLmsCoursesParameterIgnoreUnsupportedFilters, ids: GetLmsCoursesParameterIds, remote_ids: GetLmsCoursesParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostLmsCoursesBulk = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostLmsCoursesBulkRequestBody },
  responses: { 200: isPostLmsCoursesBulkPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetLmsCoursesBulkTaskId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { task_id: GetLmsCoursesBulkTaskIdParameterTaskId } => typia.createIs<{ task_id: GetLmsCoursesBulkTaskIdParameterTaskId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["task_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostLmsCoursesCourseIdDeactivate = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { course_id: PostLmsCoursesCourseIdDeactivateParameterCourseId } => typia.createIs<{ course_id: PostLmsCoursesCourseIdDeactivateParameterCourseId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["course_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostLmsCoursesCourseIdDeactivateRequestBody },
...
export const get_GetLmsSkills = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetLmsSkillsParameterCursor, page_size: GetLmsSkillsParameterPageSize, updated_after: GetLmsSkillsParameterUpdatedAfter, include_deleted: GetLmsSkillsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsSkillsParameterIgnoreUnsupportedFilters, ids: GetLmsSkillsParameterIds, remote_ids: GetLmsSkillsParameterRemoteIds }> => typia.createIs<Partial<{ cursor: GetLmsSkillsParameterCursor, page_size: GetLmsSkillsParameterPageSize, updated_after: GetLmsSkillsParameterUpdatedAfter, include_deleted: GetLmsSkillsParameterIncludeDeleted, ignore_unsupported_filters: GetLmsSkillsParameterIgnoreUnsupportedFilters, ids: GetLmsSkillsParameterIds, remote_ids: GetLmsSkillsParameterRemoteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "updated_after", "include_deleted", "ignore_unsupported_filters", "ids", "remote_ids"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostAiApplyCareerSites = {
  ...
  responses: { 200: isPostAiApplyCareerSitesPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetAiApplyCareerSites = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAiApplyCareerSitesParameterCursor, page_size: GetAiApplyCareerSitesParameterPageSize, ids: GetAiApplyCareerSitesParameterIds }> => typia.createIs<Partial<{ cursor: GetAiApplyCareerSitesParameterCursor, page_size: GetAiApplyCareerSitesParameterPageSize, ids: GetAiApplyCareerSitesParameterIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "ids"].includes(key))) },
  responses: { 200: isGetAiApplyCareerSitesPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetAiApplyPostings = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAiApplyPostingsParameterCursor, page_size: GetAiApplyPostingsParameterPageSize, ids: GetAiApplyPostingsParameterIds, career_site_ids: GetAiApplyPostingsParameterCareerSiteIds, job_codes: GetAiApplyPostingsParameterJobCodes }> => typia.createIs<Partial<{ cursor: GetAiApplyPostingsParameterCursor, page_size: GetAiApplyPostingsParameterPageSize, ids: GetAiApplyPostingsParameterIds, career_site_ids: GetAiApplyPostingsParameterCareerSiteIds, job_codes: GetAiApplyPostingsParameterJobCodes }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "ids", "career_site_ids", "job_codes"].includes(key))) },
  responses: { 200: isGetAiApplyPostingsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostAiApplyPostings = {
  ...
  responses: { 200: isPostAiApplyPostingsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostAiApplyPostingsPostingIdInquire = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { posting_id: PostAiApplyPostingsPostingIdInquireParameterPostingId } => typia.createIs<{ posting_id: PostAiApplyPostingsPostingIdInquireParameterPostingId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["posting_id"].includes(key))), body: isPostAiApplyPostingsPostingIdInquireRequestBody },
  responses: { 200: ((input: unknown): input is PostAiApplyPostingsPostingIdInquirePositiveResponse => typia.createIs<PostAiApplyPostingsPostingIdInquirePositiveResponse>()(input)), default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostAiApplyApply = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { body: ((input: unknown): input is PostAiApplyApplyRequestBody => typia.createIs<PostAiApplyApplyRequestBody>()(input)) },
...
export const get_GetAiApplyApplications = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAiApplyApplicationsParameterCursor, page_size: GetAiApplyApplicationsParameterPageSize, ids: GetAiApplyApplicationsParameterIds, job_posting_ids: GetAiApplyApplicationsParameterJobPostingIds }> => typia.createIs<Partial<{ cursor: GetAiApplyApplicationsParameterCursor, page_size: GetAiApplyApplicationsParameterPageSize, ids: GetAiApplyApplicationsParameterIds, job_posting_ids: GetAiApplyApplicationsParameterJobPostingIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "ids", "job_posting_ids"].includes(key))) },
...
export const get_GetAiApplyUnifiedApiJobs = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAiApplyUnifiedApiJobsParameterCursor, page_size: GetAiApplyUnifiedApiJobsParameterPageSize, ids: GetAiApplyUnifiedApiJobsParameterIds, remote_ids: GetAiApplyUnifiedApiJobsParameterRemoteIds, job_codes: GetAiApplyUnifiedApiJobsParameterJobCodes, career_site_ids: GetAiApplyUnifiedApiJobsParameterCareerSiteIds }> => typia.createIs<Partial<{ cursor: GetAiApplyUnifiedApiJobsParameterCursor, page_size: GetAiApplyUnifiedApiJobsParameterPageSize, ids: GetAiApplyUnifiedApiJobsParameterIds, remote_ids: GetAiApplyUnifiedApiJobsParameterRemoteIds, job_codes: GetAiApplyUnifiedApiJobsParameterJobCodes, career_site_ids: GetAiApplyUnifiedApiJobsParameterCareerSiteIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "ids", "remote_ids", "job_codes", "career_site_ids"].includes(key))) },
  responses: { 200: isGetAiApplyUnifiedApiJobsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostAiApplyUnifiedApiJobsJobIdApplications = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { job_id: PostAiApplyUnifiedApiJobsJobIdApplicationsParameterJobId } => typia.createIs<{ job_id: PostAiApplyUnifiedApiJobsJobIdApplicationsParameterJobId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["job_id"].includes(key))), body: isPostAiApplyUnifiedApiJobsJobIdApplicationsRequestBody },
  responses: { 200: isPostAiApplyUnifiedApiJobsJobIdApplicationsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetAiApplyJobFeeds = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is Partial<{ cursor: GetAiApplyJobFeedsParameterCursor, page_size: GetAiApplyJobFeedsParameterPageSize, ids: GetAiApplyJobFeedsParameterIds }> => typia.createIs<Partial<{ cursor: GetAiApplyJobFeedsParameterCursor, page_size: GetAiApplyJobFeedsParameterPageSize, ids: GetAiApplyJobFeedsParameterIds }>>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["cursor", "page_size", "ids"].includes(key))) },
  responses: { 200: isGetAiApplyJobFeedsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostAiApplyJobFeeds = {
  ...
  responses: { 200: isPostAiApplyJobFeedsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT" | "REMOTE.SERVICE_UNAVAILABLE" | "REMOTE.RATE_LIMIT_EXCEEDED" | "REMOTE.INPUT_INVALID" | "REMOTE.UNKNOWN_HTTP_ERROR" | "AI_APPLY.JOB_FEED_IMPORT_ALREADY_RUNNING" | "AI_APPLY.JOB_FEED_IMPORT_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostConnectCreateLink = {
  ...
  responses: { 200: isPostConnectCreateLinkPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetConnectIntegrationByTokenToken = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { token: GetConnectIntegrationByTokenTokenParameterToken } => typia.createIs<{ token: GetConnectIntegrationByTokenTokenParameterToken }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["token"].includes(key))) },
  responses: { 200: isGetConnectIntegrationByTokenTokenPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostConnectActivateIntegration = {
  ...
  responses: { 200: isPostConnectActivateIntegrationPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostCustomDatevPassthrough = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomDatevPassthroughRequestBody },
  responses: { 200: isPostCustomDatevPassthroughPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetCustomDatevEauRequestsEauId = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { eau_id: GetCustomDatevEauRequestsEauIdParameterEauId } => typia.createIs<{ eau_id: GetCustomDatevEauRequestsEauIdParameterEauId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["eau_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
  responses: { 200: isGetCustomDatevEauRequestsEauIdPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const get_GetCustomDatevAvailableDocuments = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { query: ((input: unknown): input is { period: GetCustomDatevAvailableDocumentsParameterPeriod } => typia.createIs<{ period: GetCustomDatevAvailableDocumentsParameterPeriod }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["period"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
...
export const post_PostCustomDatevDownloadDocument = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomDatevDownloadDocumentRequestBody },
  responses: { 200: isPostCustomDatevDownloadDocumentPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostCustomDatevEmployeesEmployeeIdDownloadDocument = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PostCustomDatevEmployeesEmployeeIdDownloadDocumentParameterEmployeeId } => typia.createIs<{ employee_id: PostCustomDatevEmployeesEmployeeIdDownloadDocumentParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomDatevEmployeesEmployeeIdDownloadDocumentRequestBody },
  responses: { 200: isPostCustomDatevEmployeesEmployeeIdDownloadDocumentPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostCustomDatevEmployeesEmployeeIdEauRequests = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PostCustomDatevEmployeesEmployeeIdEauRequestsParameterEmployeeId } => typia.createIs<{ employee_id: PostCustomDatevEmployeesEmployeeIdEauRequestsParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomDatevEmployeesEmployeeIdEauRequestsRequestBody },
  responses: { 200: isPostCustomDatevEmployeesEmployeeIdEauRequestsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const put_PutCustomDatevEmployeesEmployeeIdPreparePayroll = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PutCustomDatevEmployeesEmployeeIdPreparePayrollParameterEmployeeId } => typia.createIs<{ employee_id: PutCustomDatevEmployeesEmployeeIdPreparePayrollParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPutCustomDatevEmployeesEmployeeIdPreparePayrollRequestBody },
  responses: { 200: isPutCustomDatevEmployeesEmployeeIdPreparePayrollPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const put_PutCustomDatevEmployeesEmployeeIdCompensations = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PutCustomDatevEmployeesEmployeeIdCompensationsParameterEmployeeId } => typia.createIs<{ employee_id: PutCustomDatevEmployeesEmployeeIdCompensationsParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPutCustomDatevEmployeesEmployeeIdCompensationsRequestBody },
...
export const get_GetCustomDatevDataPushes = {
  ...
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))) },
  responses: { 200: isGetCustomDatevDataPushesPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostCustomDatevPushDataGeneral = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomDatevPushDataGeneralRequestBody },
  responses: { 200: isPostCustomDatevPushDataGeneralPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostCustomDatevPushDataPayroll = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomDatevPushDataPayrollRequestBody },
  responses: { 200: isPostCustomDatevPushDataPayrollPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostCustomSilaeEmployeesEmployeeIdPayrollSupplements = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { employee_id: PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsParameterEmployeeId } => typia.createIs<{ employee_id: PostCustomSilaeEmployeesEmployeeIdPayrollSupplementsParameterEmployeeId }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["employee_id"].includes(key))), header: ((input: unknown): input is { "X-Integration-Id": string } => typia.createIs<{ "X-Integration-Id": string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["X-Integration-Id"].includes(key))), body: isPostCustomSilaeEmployeesEmployeeIdPayrollSupplementsRequestBody },
  responses: { 200: isPostCustomSilaeEmployeesEmployeeIdPayrollSupplementsPositiveResponse, default: typia.createIs<({ status: "error", error: ({ code: (("PLATFORM.RATE_LIMIT_EXCEEDED" | "PLATFORM.CONCURRENCY_LIMIT_EXCEEDED" | "PLATFORM.INTEGRATION_NOT_FOUND" | "PLATFORM.INPUT_INVALID" | "PLATFORM.UNKNOWN_ERROR" | "PLATFORM.IP_NOT_WHITELISTED" | "PLATFORM.AUTHENTICATION_INVALID" | "PLATFORM.TASK_TIMED_OUT") | null), title: (string | null), message: string, log_url: (string | null) } & Record<string, unknown>) } & Record<string, unknown>)>() },
};
...
export const post_PostAiApplyJobFeedsBulkImport = {
  ...
  requestFormat: typia.createIs<"json">(),
  responseFormat: typia.createIs<"json">(),
  parameters: { path: ((input: unknown): input is { job_feed_id: string } => typia.createIs<{ job_feed_id: string }>()(input) && input !== null && typeof input === "object" && Object.keys(input).every((key) => ["job_feed_id"].includes(key))), body: typia.createIs<string>() },
