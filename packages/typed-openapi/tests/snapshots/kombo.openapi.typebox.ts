...
const __schemas = Type.Module({
  ...
  PostPassthroughToolApiPositiveResponse: Type.Object({ status: Type.Literal("success"), data: Type.Object({ url: Type.String({ format: "uri" }), status: Type.Integer(), headers: Type.Record(Type.String(), __typedOpenapiOneOf([Type.String(), Type.Array(Type.String())])), data: Type.Optional(Type.Unknown()) }), warnings: Type.Array(Type.Object({ message: Type.String() })) }),
  ...
  PostAiApplyApplyRequestBody: Type.Object({ submission_token: Type.String(), candidate_email: Type.String({ format: "email" }), query_params: Type.Optional(Type.Record(Type.String(), Type.String())), screening_question_answers: Type.Array(Type.Object({ question_id: Type.String(), answer: __typedOpenapiOneOf([Type.String(), Type.Array(Type.String()), Type.Number({ minimum: -1.7976931348623157e+308 }), Type.Boolean(), Type.Object({ name: Type.String(), content_type: Type.String(), data: Type.String() })]) })), additional_clicks: Type.Optional(Type.Integer({ minimum: 0, maximum: 30 })), additional_clicks_scatter_duration: Type.Optional(Type.Integer({ minimum: 1 })) }),
