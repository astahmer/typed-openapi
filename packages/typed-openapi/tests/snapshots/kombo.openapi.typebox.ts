...
const __schemas = Type.Module({
  ...
  PutAtsApplicationsApplicationIdStageRequestBody: Type.Object({ stage_id: Type.String(), remote_fields: Type.Optional(Type.Composite([Type.Partial(Type.Object({ workday: Type.Partial(Type.Object({ Workflow_Step_ID: Type.String(), Step_Type: Type.Union([Type.Literal("Next_Step_Reference"), Type.Literal("Disposition_Step_Reference")]) }, { additionalProperties: false })) }, { additionalProperties: false })), Type.Partial(Type.Object({ greenhouse: Type.Partial(Type.Object({ post_headers: Type.Partial(Type.Object({ "On-Behalf-Of": Type.Union([Type.String(), Type.Null()]) }, { additionalProperties: false })) }, { additionalProperties: false })), workable: Type.Partial(Type.Object({ on_behalf_of_user_remote_id: Type.String() }, { additionalProperties: false })) }, { additionalProperties: false }))], { additionalProperties: false })) }, { additionalProperties: false }),
  ...
  PostAtsApplicationsApplicationIdNotesRequestBody: Type.Object({ content: Type.String(), content_type: Type.Literal("PLAIN_TEXT"), remote_fields: Type.Optional(Type.Composite([Type.Partial(Type.Object({ teamtailor: Type.Partial(Type.Object({ user_id: Type.String() }, { additionalProperties: false })), greenhouse: Type.Partial(Type.Object({ visibility: Type.Union([Type.Literal("admin_only"), Type.Literal("private"), Type.Literal("public")]) }, { additionalProperties: false })), recruitee: Type.Partial(Type.Object({ visibility: Type.Unknown(), is_json: Type.Boolean() }, { additionalProperties: false })), bullhorn: Type.Partial(Type.Object({ action: Type.String() }, { additionalProperties: false })), lever: Type.Partial(Type.Object({ perform_as: Type.String() }, { additionalProperties: false })) }, { additionalProperties: false })), Type.Partial(Type.Object({ greenhouse: Type.Partial(Type.Object({ post_headers: Type.Partial(Type.Object({ "On-Behalf-Of": Type.Union([Type.String(), Type.Null()]) }, { additionalProperties: false })) }, { additionalProperties: false })), workable: Type.Partial(Type.Object({ on_behalf_of_user_remote_id: Type.String() }, { additionalProperties: false })) }, { additionalProperties: false }))], { additionalProperties: false })) }, { additionalProperties: false }),
  ...
  PostAtsApplicationsApplicationIdAttachmentsRequestBody: Type.Object({ attachment: Type.Object({ name: Type.String(), content_type: Type.Optional(Type.String({ pattern: "^[\\w.-]+\\/[\\w.-]+$" })), data_url: Type.Optional(Type.String({ format: "uri" })), data: Type.Optional(Type.String()), type: Type.Union([Type.Literal("CV"), Type.Literal("COVER_LETTER"), Type.Literal("OTHER")]) }, { additionalProperties: false }), remote_fields: Type.Optional(Type.Composite([Type.Partial(Type.Object({ oracle: Type.Partial(Type.Object({ override_document_category: Type.Union([Type.Literal("IRC_CANDIDATE_RESUME"), Type.Literal("IRC_CANDIDATE_COVERLETTER"), Type.Literal("MISC"), Type.Literal("IRC_INTERNAL")]), multi_post_to_all_current_applications: Type.Boolean() }, { additionalProperties: false })) }, { additionalProperties: false })), Type.Partial(Type.Object({ greenhouse: Type.Partial(Type.Object({ post_headers: Type.Partial(Type.Object({ "On-Behalf-Of": Type.Union([Type.String(), Type.Null()]) }, { additionalProperties: false })) }, { additionalProperties: false })), workable: Type.Partial(Type.Object({ on_behalf_of_user_remote_id: Type.String() }, { additionalProperties: false })) }, { additionalProperties: false }))], { additionalProperties: false })) }, { additionalProperties: false }),
  ...
  PostAtsApplicationsApplicationIdRejectRequestBody: Type.Object({ rejection_reason_id: Type.String(), note: Type.Optional(Type.String()), remote_fields: Type.Optional(Type.Composite([Type.Partial(Type.Object({ greenhouse: Type.Partial(Type.Object({ rejection_email: Type.Record(Type.String(), Type.Unknown()) }, { additionalProperties: false })), teamtailor: Type.Partial(Type.Object({ user_id: Type.String() }, { additionalProperties: false })) }, { additionalProperties: false })), Type.Partial(Type.Object({ greenhouse: Type.Partial(Type.Object({ post_headers: Type.Partial(Type.Object({ "On-Behalf-Of": Type.Union([Type.String(), Type.Null()]) }, { additionalProperties: false })) }, { additionalProperties: false })), workable: Type.Partial(Type.Object({ on_behalf_of_user_remote_id: Type.String() }, { additionalProperties: false })) }, { additionalProperties: false }))], { additionalProperties: false })) }, { additionalProperties: false }),
