...
export const PostPassthroughToolApiPositiveResponse = S.Struct({ status: S.Literal("success"), data: S.Struct({ url: S.String, status: S.Int, headers: S.Record({ key: S.String, value: S.Union(S.String, S.Array(S.String)) }), data: S.optional(S.Unknown) }), warnings: S.Array(S.Struct({ message: S.String })) });
...
export const Schema4: S.Schema<Schema4> = S.suspend(() => S.Union(S.String, S.Number.pipe(S.greaterThanOrEqualTo(-1.7976931348623157e+308)), S.Boolean, S.suspend(() => Schema5), Schema6));
