...
export const Schema6: S.Schema<Schema6> = S.suspend(() => S.Array(Schema4));

export type Schema4 = (string | number | boolean | Schema5 | Schema6)
export const Schema4: S.Schema<Schema4> = S.suspend(() => S.Union(S.String, S.Number.pipe(S.greaterThanOrEqualTo(-1.7976931348623157e+308)), S.Boolean, Schema5, Schema6));
