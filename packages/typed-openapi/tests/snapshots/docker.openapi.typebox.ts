...
export const Port = Type.Object({
  IP: Type.Optional(Type.String({ format: "ip-address" })),
  PrivatePort: Type.Integer(),
  PublicPort: Type.Optional(Type.Integer()),
...
export const DeviceMapping = Type.Partial(
  Type.Object({ PathOnHost: Type.String(), PathInContainer: Type.String(), CgroupPermissions: Type.String() }),
);
    ...
    VolumeOptions: Type.Partial(
      Type.Object({
        ...
        DriverConfig: Type.Partial(
          Type.Object({ Name: Type.String(), Options: Type.Record(Type.String(), Type.String()) }),
        ),
      }),
    ),
    TmpfsOptions: Type.Partial(Type.Object({ SizeBytes: Type.Integer(), Mode: Type.Integer() })),
  }),
);
...
export const Resources = Type.Partial(
  Type.Object({
    ...
    BlkioWeight: Type.Integer({ minimum: 0, maximum: 1000 }),
    BlkioWeightDevice: Type.Array(
      Type.Partial(Type.Object({ Path: Type.String(), Weight: Type.Integer({ minimum: 0 }) })),
    ),
    ...
    KernelMemoryTCP: Type.Integer(),
    MemoryReservation: Type.Integer(),
    MemorySwap: Type.Integer(),
    MemorySwappiness: Type.Integer({ minimum: 0, maximum: 100 }),
    NanoCpus: Type.Integer(),
    OomKillDisable: Type.Boolean(),
    Init: Type.Union([Type.Boolean(), Type.Null()]),
    PidsLimit: Type.Union([Type.Integer(), Type.Null()]),
    Ulimits: Type.Array(Type.Partial(Type.Object({ Name: Type.String(), Soft: Type.Integer(), Hard: Type.Integer() }))),
...
export const Limit = Type.Partial(
  Type.Object({ NanoCPUs: Type.Integer(), MemoryBytes: Type.Integer(), Pids: Type.Integer() }),
);
...
export const GenericResources = Type.Array(
  Type.Partial(
    Type.Object({
      NamedResourceSpec: Type.Partial(Type.Object({ Kind: Type.String(), Value: Type.String() })),
      DiscreteResourceSpec: Type.Partial(Type.Object({ Kind: Type.String(), Value: Type.Integer() })),
    }),
  ),
);
...
export const ResourceObject = Type.Partial(
  Type.Object({ NanoCPUs: Type.Integer(), MemoryBytes: Type.Integer(), GenericResources: GenericResources }),
);
...
export const HostConfig = Type.Intersect([
  ...
  Type.Partial(
    Type.Object({
      ...
      ConsoleSize: Type.Union([Type.Array(Type.Integer({ minimum: 0 }), { minItems: 2, maxItems: 2 }), Type.Null()]),
...
export const ContainerConfig = Type.Partial(
  Type.Object({
    ...
    StopTimeout: Type.Union([Type.Integer(), Type.Null()]),
...
export const EndpointIPAMConfig = Type.Union([
  Type.Partial(
    Type.Object({ IPv4Address: Type.String(), IPv6Address: Type.String(), LinkLocalIPs: Type.Array(Type.String()) }),
  ),
  Type.Null(),
]);
...
export const NetworkingConfig = Type.Partial(
  Type.Object({ EndpointsConfig: Type.Record(Type.String(), EndpointSettings) }),
);
...
export const NetworkSettings = Type.Partial(
  Type.Object({
    ...
    LinkLocalIPv6PrefixLen: Type.Integer(),
    Ports: PortMap,
...
export const ImageInspect = Type.Partial(
  Type.Object({
    ...
    RootFS: Type.Object({ Type: Type.String(), Layers: Type.Optional(Type.Array(Type.String())) }),
    Metadata: Type.Partial(
      Type.Object({ LastTagTime: Type.Union([Type.String({ format: "dateTime" }), Type.Null()]) }),
    ),
  }),
);
...
export const ImageSummary = Type.Object({
  ...
  VirtualSize: Type.Optional(Type.Integer()),
  Labels: Type.Record(Type.String(), Type.String()),
...
export const AuthConfig = Type.Partial(
  Type.Object({ username: Type.String(), password: Type.String(), email: Type.String(), serveraddress: Type.String() }),
);
  ...
  Type.Object({
    ...
    AccessMode: Type.Partial(
      Type.Object({
        ...
        Secrets: Type.Array(Type.Partial(Type.Object({ Key: Type.String(), Secret: Type.String() }))),
        AccessibilityRequirements: Type.Partial(
          Type.Object({ Requisite: Type.Array(Topology), Preferred: Type.Array(Topology) }),
        ),
        CapacityRange: Type.Partial(Type.Object({ RequiredBytes: Type.Integer(), LimitBytes: Type.Integer() })),
...
export const Volume = Type.Object({
  ...
  CreatedAt: Type.Optional(Type.String({ format: "dateTime" })),
  Status: Type.Optional(Type.Record(Type.String(), Type.Partial(Type.Object({})))),
  Labels: Type.Record(Type.String(), Type.String()),
  Scope: Type.Union([Type.Literal("local"), Type.Literal("global")]),
  ClusterVolume: Type.Optional(ClusterVolume),
  Options: Type.Record(Type.String(), Type.String()),
  UsageData: Type.Optional(Type.Union([Type.Object({ Size: Type.Integer(), RefCount: Type.Integer() }), Type.Null()])),
});
...
export const VolumeListResponse = Type.Partial(
  Type.Object({ Volumes: Type.Array(Volume), Warnings: Type.Array(Type.String()) }),
);
...
export const BuildCache = Type.Partial(
  Type.Object({
    ...
    Size: Type.Integer(),
    CreatedAt: Type.String({ format: "dateTime" }),
    LastUsedAt: Type.Union([Type.String({ format: "dateTime" }), Type.Null()]),
...
export const PushImageInfo = Type.Partial(
  Type.Object({ error: Type.String(), status: Type.String(), progress: Type.String(), progressDetail: ProgressDetail }),
);
...
export const PluginPrivilege = Type.Partial(
  Type.Object({ Name: Type.String(), Description: Type.String(), Value: Type.Array(Type.String()) }),
);
...
export const Plugin = Type.Object({
  ...
  PluginReference: Type.Optional(Type.String()),
  Config: Type.Object({
    DockerVersion: Type.Optional(Type.String()),
    Description: Type.String(),
    Documentation: Type.String(),
    Interface: Type.Object({
      Types: Type.Array(PluginInterfaceType),
      Socket: Type.String(),
      ProtocolScheme: Type.Optional(Type.Union([Type.Literal(""), Type.Literal("moby.plugins.http/v1")])),
    }),
    Entrypoint: Type.Array(Type.String()),
    WorkDir: Type.String(),
    User: Type.Optional(Type.Partial(Type.Object({ UID: Type.Integer(), GID: Type.Integer() }))),
    Network: Type.Object({ Type: Type.String() }),
    Linux: Type.Object({
    ...
    rootfs: Type.Optional(Type.Partial(Type.Object({ type: Type.String(), diff_ids: Type.Array(Type.String()) }))),
  }),
});
...
export const EngineDescription = Type.Partial(
  Type.Object({
    ...
    Labels: Type.Record(Type.String(), Type.String()),
    Plugins: Type.Array(Type.Partial(Type.Object({ Type: Type.String(), Name: Type.String() }))),
  }),
);

export type TLSInfo = Static<typeof TLSInfo>;
export const TLSInfo = Type.Partial(
  Type.Object({ TrustRoot: Type.String(), CertIssuerSubject: Type.String(), CertIssuerPublicKey: Type.String() }),
);
...
export const ManagerStatus = Type.Union([
  Type.Partial(Type.Object({ Leader: Type.Boolean(), Reachability: Reachability, Addr: Type.String() })),
  Type.Null(),
]);
...
export const SwarmSpec = Type.Partial(
  Type.Object({
    Name: Type.String(),
    Labels: Type.Record(Type.String(), Type.String()),
    Orchestration: Type.Union([Type.Partial(Type.Object({ TaskHistoryRetentionLimit: Type.Integer() })), Type.Null()]),
    Raft: Type.Partial(
      Type.Object({
        SnapshotInterval: Type.Integer(),
        KeepOldSnapshots: Type.Integer(),
        LogEntriesForSlowFollowers: Type.Integer(),
        ElectionTick: Type.Integer(),
        HeartbeatTick: Type.Integer(),
      }),
    ),
    Dispatcher: Type.Union([Type.Partial(Type.Object({ HeartbeatPeriod: Type.Integer() })), Type.Null()]),
    CAConfig: Type.Union([
      Type.Partial(
        Type.Object({
          NodeCertExpiry: Type.Integer(),
          ...
          ForceRotate: Type.Integer(),
        }),
      ),
      Type.Null(),
    ]),
    EncryptionConfig: Type.Partial(Type.Object({ AutoLockManagers: Type.Boolean() })),
...
export const ClusterInfo = Type.Union([
  Type.Partial(
    Type.Object({
      ...
      DataPathPort: Type.Integer(),
      DefaultAddrPool: Type.Array(Type.String({ format: "CIDR" })),
      SubnetSize: Type.Integer({ maximum: 29 }),
    }),
  ),
  Type.Null(),
]);
      ...
      Type.Object({
        ...
        Privileges: Type.Partial(
          Type.Object({
            CredentialSpec: Type.Partial(
              Type.Object({ Config: Type.String(), File: Type.String(), Registry: Type.String() }),
            ),
        ...
        Secrets: Type.Array(
          Type.Partial(
            Type.Object({
              File: Type.Partial(
                Type.Object({ Name: Type.String(), UID: Type.String(), GID: Type.String(), Mode: Type.Integer() }),
              ),
        ...
        Ulimits: Type.Array(
          Type.Partial(Type.Object({ Name: Type.String(), Soft: Type.Integer(), Hard: Type.Integer() })),
        ),
      }),
    ),
    NetworkAttachmentSpec: Type.Partial(Type.Object({ ContainerID: Type.String() })),
    Resources: Type.Partial(Type.Object({ Limits: Limit, Reservations: ResourceObject })),
    ...
    Placement: Type.Partial(
      Type.Object({
        ...
        Preferences: Type.Array(
          Type.Partial(Type.Object({ Spread: Type.Partial(Type.Object({ SpreadDescriptor: Type.String() })) })),
        ),
        MaxReplicas: Type.Integer(),
        Platforms: Type.Array(Platform),
      }),
    ),
    ForceUpdate: Type.Integer(),
    Runtime: Type.String(),
    Networks: Type.Array(NetworkAttachmentConfig),
    LogDriver: Type.Partial(Type.Object({ Name: Type.String(), Options: Type.Record(Type.String(), Type.String()) })),
  }),
);
    ...
    Status: Type.Partial(
      Type.Object({
        ...
        ContainerStatus: Type.Partial(
          Type.Object({ ContainerID: Type.String(), PID: Type.Integer(), ExitCode: Type.Integer() }),
        ),
      }),
    ),
...
export const ServiceSpec = Type.Partial(
  Type.Object({
    ...
    Mode: Type.Partial(
      Type.Object({
        Replicated: Type.Partial(Type.Object({ Replicas: Type.Integer() })),
        Global: Type.Partial(Type.Object({})),
        ReplicatedJob: Type.Partial(Type.Object({ MaxConcurrent: Type.Integer(), TotalCompletions: Type.Integer() })),
  ...
  Type.Object({
    ...
    Endpoint: Type.Partial(
      Type.Object({
        Spec: EndpointSpec,
        Ports: Type.Array(EndpointPortConfig),
        VirtualIPs: Type.Array(Type.Partial(Type.Object({ NetworkID: Type.String(), Addr: Type.String() }))),
      }),
    ),
    ...
    ServiceStatus: Type.Partial(
      Type.Object({ RunningTasks: Type.Integer(), DesiredTasks: Type.Integer(), CompletedTasks: Type.Integer() }),
    ),
    JobStatus: Type.Partial(
      Type.Object({ JobIteration: ObjectVersion, LastExecution: Type.String({ format: "dateTime" }) }),
    ),
  }),
);
...
export const ContainerSummary = Type.Partial(
  Type.Object({
    ...
    State: Type.String(),
    Status: Type.String(),
    HostConfig: Type.Partial(Type.Object({ NetworkMode: Type.String() })),
    NetworkSettings: Type.Partial(Type.Object({ Networks: Type.Record(Type.String(), EndpointSettings) })),
...
export const ContainerWaitResponse = Type.Object({
  ...
  Error: Type.Optional(ContainerWaitExitError),
});

export type SystemVersion = Static<typeof SystemVersion>;
export const SystemVersion = Type.Partial(
  Type.Object({
    Platform: Type.Object({ Name: Type.String() }),
    Components: Type.Array(
      Type.Object({
        Name: Type.String(),
        Version: Type.String(),
        Details: Type.Optional(Type.Union([Type.Partial(Type.Object({})), Type.Null()])),
      }),
    ),
    Version: Type.String(),
...
export const Runtime = Type.Partial(
  Type.Object({ path: Type.String(), runtimeArgs: Type.Union([Type.Array(Type.String()), Type.Null()]) }),
);
...
export const SwarmInfo = Type.Partial(
  Type.Object({
    ...
    Nodes: Type.Union([Type.Integer(), Type.Null()]),
    Managers: Type.Union([Type.Integer(), Type.Null()]),
    Cluster: ClusterInfo,
  }),
);
...
export const SystemInfo = Type.Partial(
  Type.Object({
    ...
    DefaultAddressPools: Type.Array(Type.Partial(Type.Object({ Base: Type.String(), Size: Type.Integer() }))),
...
export const EventActor = Type.Partial(
  Type.Object({ ID: Type.String(), Attributes: Type.Record(Type.String(), Type.String()) }),
);
...
export const get_ContainerList = {
  ...
  parameters: {
    query: Type.Optional(
      Type.Partial(
        Type.Object({ all: Type.Boolean(), limit: Type.Integer(), size: Type.Boolean(), filters: Type.String() }),
      ),
    ),
  },
...
export const post_ContainerCreate = {
  ...
  parameters: {
    query: Type.Optional(
      Type.Partial(
        Type.Object({ name: Type.String({ pattern: "^/?[a-zA-Z0-9][a-zA-Z0-9_.-]+$" }), platform: Type.String() }),
      ),
    ),
    body: Type.Intersect([
      ContainerConfig,
      Type.Partial(Type.Object({ HostConfig: HostConfig, NetworkingConfig: NetworkingConfig })),
    ]),
  },
  responses: {
...
export const get_ContainerInspect = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ size: Type.Boolean() }))),
...
export const get_ContainerTop = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ ps_args: Type.String() }))),
    path: Type.Object({ id: Type.String() }),
  },
  responses: {
    200: Type.Partial(
      Type.Object({ Titles: Type.Array(Type.String()), Processes: Type.Array(Type.Array(Type.String())) }),
    ),
    404: ErrorResponse,
    500: ErrorResponse,
  },
...
export const get_ContainerStats = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ stream: Type.Boolean(), "one-shot": Type.Boolean() }))),
    path: Type.Object({ id: Type.String() }),
  },
...
export const post_ContainerResize = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ h: Type.Integer(), w: Type.Integer() }))),
    path: Type.Object({ id: Type.String() }),
  },
  responses: { 200: Type.Unknown(), 404: Type.Unknown(), 500: Type.Unknown() },
};
...
export const post_ContainerStart = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ detachKeys: Type.String() }))),
    path: Type.Object({ id: Type.String() }),
  },
...
export const post_ContainerStop = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ signal: Type.String(), t: Type.Integer() }))),
    path: Type.Object({ id: Type.String() }),
  },
  responses: { 204: Type.Unknown(), 304: Type.Unknown(), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ContainerKill = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ signal: Type.String() }))),
    path: Type.Object({ id: Type.String() }),
  },
...
export const post_ContainerUpdate = {
  ...
  parameters: {
    path: Type.Object({ id: Type.String() }),
    body: Type.Intersect([Resources, Type.Partial(Type.Object({ RestartPolicy: RestartPolicy }))]),
  },
  responses: {
    200: Type.Partial(Type.Object({ Warnings: Type.Array(Type.String()) })),
    404: ErrorResponse,
    500: ErrorResponse,
  },
};
...
export const delete_ContainerDelete = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ v: Type.Boolean(), force: Type.Boolean(), link: Type.Boolean() }))),
    path: Type.Object({ id: Type.String() }),
  },
...
export const put_PutContainerArchive = {
  ...
  parameters: {
    query: Type.Object({
      path: Type.String(),
      noOverwriteDirNonDir: Type.Optional(Type.String()),
      copyUIDGID: Type.Optional(Type.String()),
    }),
    path: Type.Object({ id: Type.String() }),
...
export const post_ContainerPrune = {
  ...
  responses: {
    200: Type.Partial(Type.Object({ ContainersDeleted: Type.Array(Type.String()), SpaceReclaimed: Type.Integer() })),
    500: ErrorResponse,
  },
};
...
export const post_ImageBuild = {
  ...
  parameters: {
    query: Type.Optional(
      Type.Partial(
        Type.Object({
          ...
          memory: Type.Integer(),
          memswap: Type.Integer(),
          cpushares: Type.Integer(),
          cpusetcpus: Type.String(),
          cpuperiod: Type.Integer(),
          cpuquota: Type.Integer(),
          buildargs: Type.String(),
          shmsize: Type.Integer(),
          squash: Type.Boolean(),
          labels: Type.String(),
          networkmode: Type.String(),
          platform: Type.String(),
    ...
    header: Type.Optional(
      Type.Partial(
        Type.Object({ "Content-type": Type.Literal("application/x-tar"), "X-Registry-Config": Type.String() }),
      ),
    ),
    body: Type.Unsafe<Blob>({ type: "string", format: "binary" }),
  },
...
export const post_BuildPrune = {
  ...
  parameters: {
    query: Type.Optional(
      Type.Partial(Type.Object({ "keep-storage": Type.Integer(), all: Type.Boolean(), filters: Type.String() })),
    ),
  },
  responses: {
    200: Type.Partial(Type.Object({ CachesDeleted: Type.Array(Type.String()), SpaceReclaimed: Type.Integer() })),
    500: ErrorResponse,
  },
};
...
export const post_ImageCreate = {
  ...
  parameters: {
    ...
    header: Type.Optional(Type.Partial(Type.Object({ "X-Registry-Auth": Type.String() }))),
    body: Type.String(),
  },
...
export const post_ImagePush = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ tag: Type.String() }))),
    path: Type.Object({ name: Type.String() }),
    header: Type.Object({ "X-Registry-Auth": Type.String() }),
  },
  responses: { 200: Type.Unknown(), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_ImageTag = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ repo: Type.String(), tag: Type.String() }))),
    path: Type.Object({ name: Type.String() }),
  },
...
export const delete_ImageDelete = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ force: Type.Boolean(), noprune: Type.Boolean() }))),
    path: Type.Object({ name: Type.String() }),
  },
...
export const post_ImagePrune = {
  ...
  responses: {
    200: Type.Partial(
      Type.Object({ ImagesDeleted: Type.Array(ImageDeleteResponseItem), SpaceReclaimed: Type.Integer() }),
    ),
    500: ErrorResponse,
  },
};
...
export const post_SystemAuth = {
  ...
  responses: {
    200: Type.Object({ Status: Type.String(), IdentityToken: Type.Optional(Type.String()) }),
    204: Type.Unknown(),
    401: ErrorResponse,
    500: ErrorResponse,
  },
...
export const get_SystemPing = {
  ...
  responseHeaders: {
    ...
    500: Type.Object({ "Cache-Control": Type.String(), Pragma: Type.String() }),
  },
};
...
export const get_SystemEvents = {
  ...
  parameters: {
    query: Type.Optional(
      Type.Partial(Type.Object({ since: Type.String(), until: Type.String(), filters: Type.String() })),
    ),
  },
...
export const put_VolumeUpdate = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Object({ version: Type.Integer() }),
    path: Type.Object({ name: Type.String() }),
    body: Type.Optional(Type.Partial(Type.Object({ Spec: ClusterVolumeSpec }))),
  },
...
export const delete_VolumeDelete = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ force: Type.Boolean() }))),
    path: Type.Object({ name: Type.String() }),
  },
  responses: { 204: Type.Unknown(), 404: ErrorResponse, 409: ErrorResponse, 500: ErrorResponse },
};
...
export const post_VolumePrune = {
  ...
  parameters: { query: Type.Optional(Type.Partial(Type.Object({ filters: Type.String() }))) },
  responses: {
    200: Type.Partial(Type.Object({ VolumesDeleted: Type.Array(Type.String()), SpaceReclaimed: Type.Integer() })),
    500: ErrorResponse,
  },
};
...
export const get_NetworkInspect = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ verbose: Type.Boolean(), scope: Type.String() }))),
    path: Type.Object({ id: Type.String() }),
  },
...
export const post_NetworkCreate = {
  ...
  parameters: {
    body: Type.Object({
      Name: Type.String(),
      CheckDuplicate: Type.Optional(Type.Boolean()),
      Driver: Type.Optional(Type.String()),
      Internal: Type.Optional(Type.Boolean()),
      Attachable: Type.Optional(Type.Boolean()),
      Ingress: Type.Optional(Type.Boolean()),
      IPAM: Type.Optional(IPAM),
      EnableIPv6: Type.Optional(Type.Boolean()),
      Options: Type.Optional(Type.Record(Type.String(), Type.String())),
      Labels: Type.Optional(Type.Record(Type.String(), Type.String())),
    }),
  },
  responses: {
    201: Type.Partial(Type.Object({ Id: Type.String(), Warning: Type.String() })),
    403: ErrorResponse,
    404: ErrorResponse,
    500: ErrorResponse,
  },
...
export const post_NetworkConnect = {
  ...
  parameters: {
    path: Type.Object({ id: Type.String() }),
    body: Type.Optional(Type.Partial(Type.Object({ Container: Type.String(), EndpointConfig: EndpointSettings }))),
  },
...
export const post_NetworkDisconnect = {
  ...
  parameters: {
    path: Type.Object({ id: Type.String() }),
    body: Type.Optional(Type.Partial(Type.Object({ Container: Type.String(), Force: Type.Boolean() }))),
  },
  responses: { 200: Type.Unknown(), 403: ErrorResponse, 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_PluginPull = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Object({ remote: Type.String(), name: Type.Optional(Type.String()) }),
    header: Type.Optional(Type.Partial(Type.Object({ "X-Registry-Auth": Type.String() }))),
...
export const post_PluginEnable = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ timeout: Type.Integer() }))),
    path: Type.Object({ name: Type.String() }),
  },
  responses: { 200: Type.Unknown(), 404: ErrorResponse, 500: ErrorResponse },
};
...
export const post_PluginUpgrade = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Object({ remote: Type.String() }),
    path: Type.Object({ name: Type.String() }),
    header: Type.Optional(Type.Partial(Type.Object({ "X-Registry-Auth": Type.String() }))),
    body: Type.Array(PluginPrivilege),
  },
...
export const post_SwarmUpdate = {
  ...
  parameters: {
    query: Type.Object({
      ...
      rotateWorkerToken: Type.Optional(Type.Boolean()),
      rotateManagerToken: Type.Optional(Type.Boolean()),
      rotateManagerUnlockKey: Type.Optional(Type.Boolean()),
    }),
    body: SwarmSpec,
  },
  responses: { 200: Type.Unknown(), 400: ErrorResponse, 500: ErrorResponse, 503: ErrorResponse },
...
export const get_ServiceInspect = {
  ...
  responseFormat: Type.Literal("json"),
  parameters: {
    query: Type.Optional(Type.Partial(Type.Object({ insertDefaults: Type.Boolean() }))),
    path: Type.Object({ id: Type.String() }),
  },
...
export const post_ServiceUpdate = {
  ...
  parameters: {
    query: Type.Object({
      version: Type.Integer(),
      registryAuthFrom: Type.Optional(Type.Union([Type.Literal("spec"), Type.Literal("previous-spec")])),
