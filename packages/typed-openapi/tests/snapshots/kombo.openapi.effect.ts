...
export const Schema4: Schema.Schema<Schema4> = Schema.suspend(() => Schema.Union([Schema.String, Schema.Number.check(Schema.isGreaterThanOrEqualTo(-1.7976931348623157e+308)), Schema.Boolean, Schema.suspend(() => Schema5), Schema6]));
