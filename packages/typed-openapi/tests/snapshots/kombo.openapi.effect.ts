...
export const PostPassthroughToolApiPositiveResponse = Schema.Struct({ status: Schema.Literal("success"), data: Schema.Struct({ url: Schema.String, status: Schema.Int, headers: Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Array(Schema.String)]).check(Schema.makeFilter((data) => [Schema.is(Schema.String)(data), Schema.is(Schema.Array(Schema.String))(data)].filter(Boolean).length === 1))), data: Schema.optional(Schema.Unknown) }), warnings: Schema.Array(Schema.Struct({ message: Schema.String })) });
export type PostPassthroughToolApiPositiveResponse = Schema.Schema.Type<typeof PostPassthroughToolApiPositiveResponse>;

export const PostPassthroughToolApiRequestBody = Schema.Struct({ method: Schema.Literals(["GET", "POST", "DELETE", "PUT", "PATCH"]), path: Schema.String, headers: Schema.optional(Schema.Record(Schema.String, Schema.String)), params: Schema.optional(Schema.Record(Schema.String, Schema.String)), data: Schema.optional(Schema.Unknown), response_as_base64: Schema.optional(Schema.Boolean), multipart_form_data: Schema.optional(Schema.Array(Schema.Struct({ name: Schema.String, value: Schema.Union([Schema.String, Schema.Struct({ name: Schema.String, content_type: Schema.optional(Schema.String.check(Schema.isPattern(new RegExp("^[\\w.-]+\\/[\\w.-]+$")))), data_url: Schema.optional(Schema.String), data: Schema.optional(Schema.String) })]).check(Schema.makeFilter((data) => [Schema.is(Schema.String)(data), Schema.is(Schema.Struct({ name: Schema.String, content_type: Schema.optional(Schema.String.check(Schema.isPattern(new RegExp("^[\\w.-]+\\/[\\w.-]+$")))), data_url: Schema.optional(Schema.String), data: Schema.optional(Schema.String) }))(data)].filter(Boolean).length === 1)) }))), api_options: Schema.optional(Schema.Record(Schema.String, Schema.String)) });
...
export const DeleteIntegrationsIntegrationIdRequestBody = Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)));
...
export const DeleteHrisSkillsSkillIdRequestBody = Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)));
...
export const DeleteHrisEmployeeSkillAssignmentsEmployeeSkillAssignmentIdRequestBody = Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)));
...
export const DeleteAtsCustomAvionteSyncedJobsJobRemoteIdRequestBody = Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)));
...
export const PostLmsCoursesCourseIdDeactivateRequestBody = Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)));
...
export const PostAiApplyPostingsPostingIdInquireRequestBody = Schema.Struct({  }).check(Schema.makeFilter((data) => Object.keys(data).every((key) => false)));
...
export const PostAiApplyApplyRequestBody = Schema.Struct({ submission_token: Schema.String, candidate_email: Schema.String.check(Schema.isPattern(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)), query_params: Schema.optional(Schema.Record(Schema.String, Schema.String)), screening_question_answers: Schema.Array(Schema.Struct({ question_id: Schema.String, answer: Schema.Union([Schema.String, Schema.Array(Schema.String), Schema.Number.check(Schema.isGreaterThanOrEqualTo(-1.7976931348623157e+308)), Schema.Boolean, Schema.Struct({ name: Schema.String, content_type: Schema.String, data: Schema.String })]).check(Schema.makeFilter((data) => [Schema.is(Schema.String)(data), Schema.is(Schema.Array(Schema.String))(data), Schema.is(Schema.Number.check(Schema.isGreaterThanOrEqualTo(-1.7976931348623157e+308)))(data), Schema.is(Schema.Boolean)(data), Schema.is(Schema.Struct({ name: Schema.String, content_type: Schema.String, data: Schema.String }))(data)].filter(Boolean).length === 1)) })), additional_clicks: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(0), Schema.isLessThanOrEqualTo(30))), additional_clicks_scatter_duration: Schema.optional(Schema.Int.check(Schema.isGreaterThanOrEqualTo(1))) });
